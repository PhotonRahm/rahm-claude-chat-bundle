...
last_updated_utc: 2026-07-03T05:10:01+00:00
...
- Generated for Claude-in-chat startup at 2026-07-03T00:10:01-05:00; missing artifacts render UNAVAILABLE instead of breaking sync.
- Full-picture artifact: FULL PICTURE - 2026-07-03 12:00 AM

### Reconciliation and Cash
- Gemini: Cash balance: $22.85
- Gemini reconciliation: Reconciliation: resolved_pnl=$-12871.19 open_cost=$0.80 open_fees=$0.07 recon_adj=$-2139.96 expected_cash=$22.85 cash_gap=$+0.00 unrealized=-$0.80 [MATCH]
- Kalshi: Cash balance: $1,189.56
- Kalshi reconciliation: Reconciliation: resolved_pnl=$-1498.88 open_cost=$1.33 open_fees=$0.04 recon_adj=$189.81 expected_cash=$1189.56 cash_gap=$+0.00 unrealized=$-1.08 [MATCH]
- IBKR: NLV: $1,949.48
- IBKR state: Status: ⚠️ Flex sync 199h stale | ❌ Gateway DOWN | ❌ KILL switch active
...
- Codex Kalshi live-pilot slot: No new live pilot was launched. The live-pilot slot remains available, but no current candidate cleared source/live proof, native-forward readiness, and executable quote quality at the same time.
...
- • Combined true P&L: **$-16330.87**
- • True lifetime P&L (bots − one-time − recurring): **$-19194.60**
...
- reconciliation:
  ...
  - Reconciliation: resolved_pnl=$-12871.19 open_cost=$0.80 open_fees=$0.07 recon_adj=$-2139.96 expected_cash=$22.85 cash_gap=$+0.00 unrealized=-$0.80 [MATCH]
...
- strategy/cohort excerpts:
  ...
  - 24h P&L: +$0.00 (0W-0L resolved, 3 placed)
  - Today's P&L: +$0.00
  ...
  - Next decision gate: 2026-07-03T06:30:00+00:00 - direct-index DS next resolution (136 rows/6 events unresolved | current qty5: 86 rows/6 events unresolved | micro qty1: 50 rows/5 events unresolved) resolution checks; no live expansion before event-collapsed results
...
- reconciliation:
  - Reconciliation: resolved_pnl=$-1498.88 open_cost=$1.33 open_fees=$0.04 recon_adj=$189.81 expected_cash=$1189.56 cash_gap=$+0.00 unrealized=$-1.08 [MATCH]
  - ✓ HARD CHECK PASSED — gap $0.00
  - Reconciliation adjustment: $189.81 (auto-computed from exchange balance)
  - Expected cash: $1189.56
  - Actual cash (API): $1189.56
- selected env:
...
- strategy/cohort excerpts:
  - Lifetime P&L: -$1,242.55 across 3209 resolved trades
  - 24h P&L: -$0.13 (1W-3L resolved, 4 placed)
  - Historical realized buckets (14; sum must equal lifetime):
  - ✓ Kalshi: lifetime -$1,242.55 / 3209 realized rows; bucket sum -$1,242.55 / 3209 rows
  ...
  - Live-matched v2 first-ticker: 218W-12L (94.8%) | taker -$69.16 | Wilson 91.1% vs BE 95.1% | 7d -$288.61 | gate=NOT_LIVE_DEPLOYABLE
  ...
  - Validation vs shadow: shadow WR 82.6% / -$289.00 (spread<=0.05 + allowed assets, matches pilot) | live WR 82.8% | shadow P&L negative; no revival
  ...
  - Mean reversion shadow freshness: last_row=2026-04-22T03:02:54Z age=72.1d live_match_last=2026-04-21T02:43:31Z post_kill_shadow_rows=0 post_kill_live_placements=0 | gate=STALE_NO_FORWARD_EVIDENCE
  ...
  - Forecast accuracy YES 90-93 above-live-threshold: event-first 115W-1L n=116 | +$1,652.43 avg_ask=0.915 | Wilson 95.3% vs BE 92.6% margin=+2.7pp | recent 35W-0L n=35 Wilson 90.1% vs BE 92.7% | pending=4 stale_pending=1 | gate=THIN_MARGIN_RECENT_UNDERPOWERED_FORWARD_ONLY | next_pending=KXLOWTCHI-26JUL02-B77.5 city=CHI due=2026-07-03T05:59:59.945606+00:00 ask=0.92 reason=ask_above_max(0.92>0.90)
  - Forecast accuracy high-ask NO event-first: ask>=0.98 all 926W-4L n=930 | +$1,686.86 avg_ask=0.986 | Wilson 98.9% vs BE 98.8%
  - Forecast accuracy high-ask NO ex-LAX: 850W-1L n=851 | +$2,076.68 avg_ask=0.986 | Wilson 99.3% vs BE 98.8% | unresolved_live_est_events=32 | gate=FORWARD_WATCH_ONLY
  - Forecast accuracy high-ask NO native preflight: rows=46286 events=182 actionable_qty1=841 latest=2026-07-03T05:06:40+00:00 | reasons: missing_native_no_ask=41264, nonpositive_qty1_win:0.0000=3036, actionable_qty1_fee_positive=841, native_no_ask_out_of_band:0.9700=250 | latest_run=2026-07-03T05:06:40+00:00 candidates=20 checked=20 actionable=0 run_reasons={"missing_native_no_ask": 15, "native_no_ask_out_of_band:0.5200": 1, "nonpositive_qty1_win:0.0000": 4}
  - Forecast accuracy high-ask NO latest actionables: captured=2026-07-03T05:06:40+00:00 events=20 actionable_events=0 top_reason=missing_native_no_ask
  ...
  - Forecast accuracy NO candidate-cell preflight: rows=30221 cohorts=2 events=67 actionable_qty1=8480 latest=2026-07-03T05:06:49+00:00 | latest_run=2026-07-03T05:06:49+00:00 candidates=13 checked=13 actionable=2 run_reasons={"no_90_95_min_probe_v1:missing_native_no_ask": 1, "no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive": 2, "no_95_98_zero_loss_cities_v1:missing_native_no_ask": 6, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9100": 1, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9400": 1, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9900": 2}
  - Forecast accuracy NO candidate-cell cohorts: no_95_98_zero_loss_cities_v1 rows=27376 events=67 actionable=7777; no_90_95_min_probe_v1 rows=2845 events=8 actionable=703
  - Forecast accuracy NO candidate-cell latest cohort actionables: no_90_95_min_probe_v1 captured=2026-07-03T05:06:49+00:00 events=1 actionable_events=0 top_reason=missing_native_no_ask; no_95_98_zero_loss_cities_v1 captured=2026-07-03T05:06:49+00:00 events=12 actionable_events=2 best=KXLOWTMIA-26JUL03-T81 city=MIA event=KXLOWTMIA-26JUL03 due=2026-07-04T19:00:00+00:00 no_ask=0.97 depth=100.00 win1=+$0.02 loss1=-$0.98
  ...
  - Legacy weather-city NO shadow: bid>=0.88 first-ticker-side 5326W-255L n=5581 | +$10,103.14 | avg_bid=0.932 | Wilson 94.9% vs modeled BE 93.6% margin=+1.2pp | pending=218 | gate=LEGACY_MAKER_FORWARD_REQUIRED
  - Legacy weather-city NO recency: since_2026-06-17 1914W-76L n=1990 +$3,787.47 pending=216 Wilson 95.2% vs modeled BE 94.3% | forward_since_2026-06-25T09:35Z resolved=847 pending=216 | blocked 1527W-85L +$1,848.43, unblocked 3799W-170L +$8,254.71 | best=KXLOWTNYC 219W-5L +$1,041.65; worst=KXLOWTDEN 220W-19L -$380.38 | next_pending=KXHIGHCHI-26JUL02-T93 city=CHI due_est=2026-07-03T05:58:59.096959+00:00 ttl_at_capture=33.9h bid=0.89 overdue_pending=43 | bid-side/maker-priced shadow, not taker-executable
  ...
  - Crypto long-expiry maker/cancel proxy: v2 crypto side_bid=0.90-0.95 candidates=464 markets=252 fills=101 pending_fills=0 resolved_indep=101/50 93W-8L pnl=-$15.52 Wilson 85.1% vs modeled BE 93.6% | 24hplus_candidates=93 24hplus_fills=9 24hplus_pending_fills=0 | cancels=343 late_cross_ttl=40 open=20 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel shadow: v2 side_bid=0.92-0.94 candidates=244 markets=144 fills=57 filled_units=57 pending_fills=0 resolved_indep=57/50 53W-4L pnl=-$6.82 Wilson 83.3% vs modeled BE 94.2% | cancels=178 late_cross_ttl=21 open=9 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel sides: NO rows=127 markets=67 fills=22 pending=0 resolved_rows=22; YES rows=117 markets=77 fills=35 pending=0 resolved_rows=35 | source=kalshi_high_price_maker_cancel_shadow | no live orders
  - Crypto legacy taker NO shadow: ask=0.90-0.95 12-24h first-ticker-side 243W-14L n=257 | +$648.32 | avg_ask=0.915 | Wilson 91.1% vs modeled BE 92.0% margin=-1.0pp | pending=2 | gate=NO_GO
  - Crypto favorite taker native preflight: rows=9176 cohorts=2 contracts=50 actionable_obs=1935 latest=2026-07-02T20:55:22+00:00 | latest_run=2026-07-03T05:08:20+00:00 candidates=0 checked=0 actionable=0 reasons={} | no order path
  ...
  - Crypto contrarian NO recency: since_2026-06-17 13W-14L n=27 +$638.16 pending=0 Wilson 30.7% vs modeled BE 24.5% | forward_since_2026-06-25T10:40Z resolved=9 pending=0 | 2026-04 8W-27L -$37.12, 2026-06 13W-11L +$711.92 | BTC 8W-18L +$167.58 pending=0, ETH 9W-9L +$477.11 pending=0, SOL 4W-14L -$43.65 pending=1 | next_pending=KXSOLD-26APR2417-T83.9999 event=KXSOLD-26APR2417 due_est=2026-04-24T20:59:59.002927+00:00 ttl=-1664.2h ask=0.22 spread=0.09 active_pending=0 stale_pending=1 unknown_pending=0 | exploratory ask-priced shadow; no live orders
  - Crypto last-hour longshot NO shadow: event-first 1180W-75L n=1255 | +$6,351.04 avg_ask=0.883 | Wilson 92.6% vs modeled BE 89.0% | recent 759W-61L +$2,517.22 | gate=LIQUIDITY_PROXY_FAIL_FORWARD_ONLY
  - Crypto last-hour longshot liquidity: volume=0 598W-8L +$6,842.40; volume>=500/spread<=5c 377W-41L -$246.32 Wilson 87.0% vs BE 90.8%; 80-85c volume-backed 33W-5L +$115.93 Wilson 72.7% vs BE 83.8%; 90-95c volume-backed 251W-21L -$147.15 Wilson 88.5% vs BE 92.8%; 95-99c volume-backed 573W-22L -$493.35 Wilson 94.5% vs BE 97.1%; forward_since_2026-06-25T11:20Z 383W-37L +$531.44 Wilson 88.1% vs BE 89.9% resolved=420 pending=2 | no live orders
  - Crypto last-hour longshot native preflight: rows=5385 events=421 actionable_qty1=1410 latest=2026-07-03T05:05:24+00:00 | latest_run=2026-07-03T05:05:24+00:00 candidates=2 checked=2 actionable=1 reasons={"actionable_qty1_fee_positive": 1, "native_no_ask_out_of_band:0.7800": 1} | no order path
  - Crypto last-hour longshot latest actionables: captured=2026-07-03T05:05:24+00:00 events=2 contracts=2 actionable_contracts=1 best=KXSOLD-26JUL0302-T80.9999 asset=SOL event=KXSOLD-26JUL0302 due=2026-07-03T05:59:59.416433+00:00 no_ask=0.89 depth=600.00 win1=+$0.10 loss1=-$0.90
  - Crypto last-hour longshot native gate: native_events=315 resolved=314 pending=1 active_pending=1 stale_pending=0 unknown_pending=0 283W-31L native_pnl=-$2.41 Wilson 86.3% vs BE 90.9% next_pending=KXSOLD-26JUL0302-T80.9999 asset=SOL event=KXSOLD-26JUL0302 due=2026-07-03T05:59:59.416433+00:00 no_ask=0.89 depth=600.00 win1=+$0.10 loss1=-$0.90 | gate=NATIVE_FORWARD_ACCUMULATING
  ...
  - Weather near-expiry favorite shadow: 1-4h ask>=0.90 event-first 46W-0L n=46 +$261.00 avg_ask=0.943 Wilson 92.3% vs modeled BE 94.7% pending=1 overdue_pending=1 | gate=UNDERPOWERED_BELOW_BREAKEVEN
  - Weather near-expiry favorite recency: since_2026-06-17 31W-0L n=31 +$185.00 pending=1 Wilson 89.0% vs modeled BE 94.4% | best_event_price_cell=2-4h/p90_95 28W-0L n=28 +$212.00 pending=0 | next_pending=KXLOWTMIA-26JUL02-B77.5 event=KXLOWTMIA-26JUL02 due_est=2026-07-03T05:00:09+00:00 ask=0.96 spread=0.13 | ask-priced near-expiry shadow; no live orders
  ...
  - Summary: rows=7095 open=189 fills=1784 markets=1607 cancels=5122 late_cross_ttl=434 resolved=1306 markets=1211 pnl=-2670.38 last=2026-07-03T05:07:18+00:00
  - Pending fills: unresolved=478 markets=396 next=KXHIGHNY-26JUL02-T99 weather NO close=2026-07-03T04:59:00+00:00 expiration=2026-07-09T14:00:00+00:00 | units=478 active=469 stale=9 unknown=0
  - Overall independent fills: resolved=1306 878W-428L pnl=-2670.38 wilson_low=64.6% breakeven=87.7% toxic=428 status=NO_GO_REVIEW
  - Review progress: best_cell=sports NO resolved_independent=388/50 indep=304W-84L pnl=-353.93 wilson_low=74.0% breakeven=87.5% toxic=84 pending_markets=283 filled_markets=671 next_close=2026-07-03T22:35:00+00:00 status=NO_GO_REVIEW
  - Cell scan: resolved_cells=7 edge_positive_cells=0 leader=sports NO resolved_indep=388 best_edge_positive=none best_alternate=crypto YES resolved_indep=297 170W-127L pnl=-870.07 wilson_low=51.6% breakeven=86.5% toxic=127 status=NO_GO_REVIEW
  - KALSHI CRYPTO LOW-PRICE NO CELL AUDIT
  - Status: SHADOW_ONLY | broad low-price NO kill=present | standard DS kill=present
  - NO <10c first-market: n=94 84W-10L wr=89.4% wilson_low=81.5% breakeven=4.6% pnl=+79.95 avg=+0.8505
  - NO <10c first-eligible: n=136 125W-11L wr=91.9% wilson_low=86.1% breakeven=4.9% pnl=+118.74 avg=+0.8731
  - NO <10c concentration: underliers=3 top=BTC n=100 share=73.5% pnl=+87.51 worst=SOL n=19 pnl=+14.97
  - NO <10c day stability: days=2 positive=2 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - NO <10c UTC-hour stability: hours=13 positive=12 losing=1 worst=19Z n=2 pnl=-0.06
  - Post-kill NO <10c first-market: n=94 84W-10L wr=89.4% wilson_low=81.5% breakeven=4.6% pnl=+79.95 avg=+0.8505
  - Post-kill NO <10c first-eligible: n=136 125W-11L wr=91.9% wilson_low=86.1% breakeven=4.9% pnl=+118.74 avg=+0.8731
  - Review: post-kill NO <10c first-eligible progress 136/50 status=NOT_READY reason=native taker NO ask <10c evidence absent
  - Post-kill NO <10c first-eligible concentration: underliers=3 top=BTC n=100 share=73.5% pnl=+87.51 worst=SOL n=19 pnl=+14.97
  - Post-kill NO <10c first-eligible day stability: days=2 positive=2 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - Post-kill NO <10c first-eligible UTC-hour stability: hours=13 positive=12 losing=1 worst=19Z n=2 pnl=-0.06
  - Post-kill NO <10c first-eligible loss cluster: losses=11 loss_hours=4 top_hour=13Z top_hour_losses=5/11 share=45.5% top_underlier=BTC 4/5 | excluding_top_loss_hour=POST_HOC_FORWARD_ONLY n=128 122W-6L pnl=+116.19 Wilson 90.2% vs modeled BE 4.8%
  - Post-kill NO <10c first-eligible source provenance: rows=136 sources=1 top=kalshi.shadow_deterministic_settlement n=136 distinct_source_row_ids=136 missing_source_row_ids=0
  - Post-kill NO <10c first-eligible native source check: source_ids=136 checked=131 native_taker_ask_lt10c=0/131 min=0.6900 avg=0.9608 max=0.9900
  - Fresh non-04Z NO <10c first-eligible: n=136 125W-11L wr=91.9% wilson_low=86.1% breakeven=4.9% pnl=+118.74 avg=+0.8731
  - Forward gate: fresh non-04Z NO <10c first-eligible start=2026-06-25T08:30:00+00:00 excluded_hour=04Z progress 136/50 pending_markets=0 status=NOT_READY reason=wilson 86.1% < 90.0%; native taker NO ask <10c evidence absent
  - Fresh non-04Z NO <10c first-eligible pending horizon: resolved=136/50 pending_markets=0 max_if_all_pending_resolve=50/50 need_new_after_pending=0 next_due=unknown last_due=unknown next_backfill_after=unknown last_backfill_after=unknown
  - Fresh 04Z excluded-control NO <10c first-eligible: no resolved rows
  - Fresh non-04Z NO <10c first-eligible source provenance: rows=136 sources=1 top=kalshi.shadow_deterministic_settlement n=136 distinct_source_row_ids=136 missing_source_row_ids=0
  - Fresh non-04Z NO <10c first-eligible native source check: source_ids=136 checked=131 native_taker_ask_lt10c=0/131 min=0.6900 avg=0.9608 max=0.9900
  - Fresh non-04Z NO <10c first-eligible concentration: underliers=3 top=BTC n=100 share=73.5% pnl=+87.51 worst=SOL n=19 pnl=+14.97
  - Fresh non-04Z NO <10c first-eligible day stability: days=2 positive=2 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - Fresh non-04Z NO <10c first-eligible UTC-hour stability: hours=13 positive=12 losing=1 worst=19Z n=2 pnl=-0.06
  ...
  - Post-kill NO <10c first-eligible pending horizon: resolved=136/50 pending_markets=0 max_if_all_pending_resolve=50/50 need_new_after_pending=0 next_due=unknown last_due=unknown next_backfill_after=unknown last_backfill_after=unknown
  - Post-kill NO <10c first-eligible live pending preview: pending_first_eligible=0 live_actionable=0 settlement_pending_or_ineligible=0 now=2026-07-03T05:10:17+00:00 | no order path
  - Pilot readiness: NOT_READY | proposed_strategy=kalshi_crypto_no_lt10c_first_eligible_pilot | new identity required; do not revive ds_low_price_no | reason=wilson 86.1% < 90.0%; native taker NO ask <10c evidence absent
...
-   Disk: 172.29 GiB used / 936.79 GiB total (18.4%), 716.84 GiB free
-   Envelope: TARGET 50.0%, WARN 65.0%, CRITICAL 75.0%, HARD_LIMIT 85.0%
-   DS storage: active 1.17 GiB (state TARGET), hot 30.55 GiB, warm 0.02 GiB, cold 0.00 GiB, archive_state TARGET_EXCEEDED, total 31.76 GiB (3.4% of disk)
-   Archive sidecars: OK
...
-   Tier rotation: last=2026-07-03T00:18:25+00:00 status=DRY_RUN actions=2
...
- latest_run: id=22 captured_at=2026-07-03T04:51:34+00:00 | markets_seen=40000 post_expiration_open_unresolved=0 candidate_count=0 | direct_market_recheck=True pages=40 page_cap=True rate_limited=False | trigger_fields={} | top_series=none
...
- latest_run: id=31 captured_at=2026-07-03T04:52:46+00:00 | mode=global_open_cursor markets_seen=30000 grouped_markets=29997 duplicate_groups=407 candidate_count=0 | pages=30 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=25557, KXMVECROSSCATEGORY=4429, KXITFMATCH=6, KXWCGOAL=4, KXWCTEAMFIRSTGOAL=1
...
- latest_run: id=28 captured_at=2026-07-03T03:50:52+00:00 | mode=global_open_cursor markets=100000 parsed=0 groups=0 relations=0 candidates=0 | pages=100 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=83404, KXMVECROSSCATEGORY=16194, KXMLBKS=59, KXMLBTEAMTOTAL=42, KXMLBHRR=40 | parse_rejects=not_strict_binary_labels=100000
...
- latest_run: id=47 captured_at=2026-07-03T04:53:29+00:00 | mode=whole_universe markets=30000 parsed=102 families=102 multi_row=0 relations=0 candidates=0 top_net=none | pages=30 page_cap=true rate_limited=false
...
- latest_run: id=31 captured_at=2026-07-03T04:53:49+00:00 | mode=global_open_cursor markets=30000 parsed=16346 groups=15040 partitions=0/984 candidates=0 | pages=30 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=25560, KXMVECROSSCATEGORY=4429, KXITFMATCH=6, KXWCGOAL=4, KXWCTEAMFIRSTGOAL=1 | non_partition=missing_lower_tail=984
...
- latest_run: id=34 captured_at=2026-07-03T03:55:24+00:00 | mode=global_open_cursor markets=100000 parsed=53306 groups=45276 relations=0 candidates=0 | pages=100 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=83332, KXMVECROSSCATEGORY=16266, KXMLBKS=59, KXMLBTEAMTOTAL=42, KXMLBHRR=40 | parse_rejects=not_interval_title=46694
...
- latest_run: id=34 captured_at=2026-07-03T04:56:38+00:00 | mode=global_open_cursor markets=25000 parsed=3714 groups=3570 relations=0 candidates=0 | pages=25 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=21238, KXMVECROSSCATEGORY=3760, KXWCGOAL=2 | parse_rejects=not_single_threshold_title=21286
...
- latest_run: id=19 captured_at=2026-07-03T04:51:34+00:00 | markets_seen=40000 post_close_open_unresolved=0 candidates=0 min_age_min=1.00 max_ask=0.30 max_spread=0.15 min_depth=1 | pages=40 page_cap=true rate_limited=false | categories=none | top_series=unknown
...
- latest_run: id=22 captured_at=2026-07-03T04:51:34+00:00 | markets_seen=40000 public_result_active=0 candidates=0 max_ask=0.30 max_spread=0.15 min_depth=1 | pages=40 page_cap=true rate_limited=false | results=none | categories=none | top_series=unknown
...
- latest_run: id=15 captured_at=2026-07-03T04:52:46+00:00 | version=event_result_propagation_v1 events_seen=7054 events_examined=2302 mutex_events=601 details=600/600 detail_cap=true markets=5659 locked=0 actionable_qty1=0 max_ask=0.25 min_depth=1 | pages=36 page_cap=false rate_limited=false | reasons=event_not_mutually_exclusive_summary=1701, no_exhaustive_proof=600, detail_cap_reached=1
...
- latest_run: id=18 captured_at=2026-07-03T04:55:58+00:00 | events_seen=6000 mutex_events=2455 details=600/600 markets=5659 tradable_no=2906 candidates=0 top_net=-2.0pp | pages=30 page_cap=true rate_limited=false | categories=Elections=1066, Sports=1015, Entertainment=156, Economics=73, Climate and Weather=49, Politics=39 | detail_errors=none
- nearest_no_bundles: KXNCAAFCONF-26 KXNCAAFCONF k=5 floor=4.00 cost=3.95 fees=0.07 net=-2.0pp tickers=KXNCAAFCONF-26-B10,KXNCAAFCONF-26-SEC,KXNCAAFCONF-26-OTHER ; KXPRIMARYPLACE-SENATEMID26-2 KXPRIMARYPLACE k=3 floor=2.00 cost=1.99 fees=0.03 net=-2.0pp tickers=KXPRIMARYPLACE-SENATEMID26-2-HSTE,KXPRIMARYPLACE-SENATEMID26-2-AELS,KXPRIMARYPLACE-SENATEMID26-2-MMCM ; KXPRIMARYMOV-COPRIMARY01D26 KXPRIMARYMOV k=2 floor=1.00 cost=1.00 fees=0.02 net=-2.0pp tickers=KXPRIMARYMOV-COPRIMARY01D26-MKIR-P13,KXPRIMARYMOV-COPRIMARY01D26-MKIR-P57 ; KXCAGOVPRIMARY1ST-26JUN02-1ST KXCAGOVPRIMARY1ST k=2 floor=1.00 cost=1.00 fees=0.02 net=-2.1pp tickers=KXCAGOVPRIMARY1ST-26JUN02-1ST-XBEC,KXCAGOVPRIMARY1ST-26JUN02-1ST-SHIL ; KXGOVCA-26 KXGOVCA k=2 floor=1.00 cost=1.00 fees=0.02 net=-2.5pp tickers=KXGOVCA-26-XBEC,KXGOVCA-26-SHIL
- unsafe_all_yes_positive_requires_exhaustive_validation: count=10 best_net=+72.7pp
...
- latest_run: id=11 captured_at=2026-07-03T04:57:10+00:00 | version=event_exhaustive_yes_v2_esports events_seen=269 event_details=269 baskets_checked=210 actionable_qty1=0 min_net_edge=0.010 | series=14 page_limits=[200] | counts=KXATPCHALLENGERMATCH=20, KXITFMATCH=60, KXITFWMATCH=38, KXLOLGAME=9, KXLOLMAP=18, KXMLBGAME=44, KXNBAGAME=0, KXNHLGAME=0 | reasons=exhaustive_basket_checked=210, two_way_sports_shape_mismatch=54, event_not_mutually_exclusive=2, not_all_active_yes_tradable=2, two_way_no_tie_match_shape_mismatch=1
- nearest_baskets: KXITFWMATCH-26JUL03RADSTA two_way_no_tie_sports_match contracts=2 sum_asks=1.000 fees=0.020 net=-0.020 depth=94 actionable=0 ; KXITFMATCH-26JUL03BOUYAZ two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=158 actionable=0 ; KXITFWMATCH-26JUL03ANDSAH two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=127 actionable=0 ; KXWTAMATCH-26JUL03PEGBOU two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=2554 actionable=0 ; KXWTAMATCH-26JUL03MUCSAW two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=43 actionable=0
...
- reasons: wilson 86.1% < 90.0%; open_filled_trades=7; source reconciliation checked 189/136; source reconciliation mismatches 40; native taker NO ask <10c evidence absent
- resolved: 136/50 | 125W-11L | pnl=+118.74 | wilson=86.1%
...
- fresh_non04z_review: status=NOT_READY | ready=false | reason=fresh gate status NOT_READY; wilson 86.1% < 90.0%; open_filled_trades=7; source reconciliation checked 177/136; source reconciliation mismatches 40; native taker NO ask <10c evidence absent | resolved=136/50 | 125W-11L | pnl=+118.74 | wilson=86.1% | pending=0 | shadow_live_actionable=0 | native_taker_actionable=0 | native_taker_blocked=0 | expired_unresolved=0 | next_backfill_after=unknown | source_reconciliation=177/177 mismatches=40 | native_taker_ask_lt10c=0/172
...
- status: NO_LIVE_READY | ready=false | cells=9 | ready_cells=0 | min_resolved=30 | edge_buffer=+2.0pp | pending=23 active=23 stale=0 unknown=0 | next_pending=crypto_last_hour_longshot_no:KXBTCD-26JUL0302-T61599.99 status=active due=2026-07-03T05:59:59.105844+00:00
- best: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=316 resolved=314 pending=2 active=2 stale=0 unknown=0 | 283W-31L | pnl=-2.41 | Wilson 86.3% vs BE 90.9% | gap=-4.5pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=296 | next_pending=KXBTCD-26JUL0302-T61599.99 status=active due=2026-07-03T05:59:59.105844+00:00 ask=0.81
- rank 1: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=316 resolved=314 pending=2 active=2 stale=0 unknown=0 | 283W-31L | pnl=-2.41 | Wilson 86.3% vs BE 90.9% | gap=-4.5pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=296 | next_pending=KXBTCD-26JUL0302-T61599.99 status=active due=2026-07-03T05:59:59.105844+00:00 ask=0.81
...
- status: NO_NATIVE_CUT_READY | ready=false | observations=14205 | cuts=2271 | display_cuts=471 | candidate_cuts=0 | ready_cuts=0 | min_resolved=30 | min_display_resolved=10 | edge_buffer=+2.0pp | scope=posthoc_native_executable_cut_discovery_requires_predeclared_forward_gate
...
- rank 2: crypto_last_hour_longshot_no|minutes_to_expiry_band=20-40m|native_ask_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=55 resolved=55 pending=0 active=0 stale=0 unknown=0 | 52W-3L | pnl=+$5.92 | Wilson 85.1% vs target 85.8% (BE 83.8%) | gap=-0.6pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=3
...
- rank 4: crypto_last_hour_longshot_no|native_ask_band=85-90 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=177 resolved=176 pending=1 active=1 stale=0 unknown=0 | 160W-16L | pnl=+$4.49 | Wilson 85.7% vs target 90.4% (BE 88.4%) | gap=-4.6pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=88 | next_pending=KXSOLD-26JUL0302-T80.9999 status=active due=2026-07-03T05:59:59.416433+00:00 ask=0.89
- rank 5: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=41 resolved=41 pending=0 active=0 stale=0 unknown=0 | 39W-2L | pnl=+$3.47 | Wilson 83.9% vs target 88.7% (BE 86.7%) | gap=-4.8pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=20
- rank 6: crypto_last_hour_longshot_no|minutes_to_expiry_band=40-60m|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=196 resolved=195 pending=1 active=1 stale=0 unknown=0 | 184W-11L | pnl=+$2.42 | Wilson 90.2% vs target 95.1% (BE 93.1%) | gap=-4.9pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=202 | next_pending=KXSOLD-26JUL0302-T80.9999 status=active due=2026-07-03T05:59:59.416433+00:00 ask=0.90
- rank 7: crypto_last_hour_longshot_no|shadow_spread_band=<=1c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=223 resolved=221 pending=2 active=2 stale=0 unknown=0 | 205W-16L | pnl=+$2.63 | Wilson 88.6% vs target 93.5% (BE 91.5%) | gap=-5.0pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=175 | next_pending=KXBTCD-26JUL0302-T61599.99 status=active due=2026-07-03T05:59:59.105844+00:00 ask=0.81
- rank 8: crypto_last_hour_longshot_no|asset=BTC|signal_tier=moderate | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=39 resolved=38 pending=1 active=1 stale=0 unknown=0 | 37W-1L | pnl=+$2.89 | Wilson 86.5% vs target 91.6% (BE 89.6%) | gap=-5.1pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=26 | next_pending=KXBTCD-26JUL0302-T61599.99 status=active due=2026-07-03T05:59:59.105844+00:00 ask=0.81
...
- best: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=51 resolved=51 pending=0 active=0 stale=0 unknown=0 | 43W-8L | pnl=$-3.59 | Wilson 72.0% vs target 93.4% (BE 91.4%) | gap=-21.4pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=182 | excluded_post_start_actionables=222 (native_spread_band=<=5c=74, native_spread_band=<=2c=59, native_depth_band=1000+=53, native_depth_band=10-99=23) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=131 (not_actionable=131) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 1: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=51 resolved=51 pending=0 active=0 stale=0 unknown=0 | 43W-8L | pnl=$-3.59 | Wilson 72.0% vs target 93.4% (BE 91.4%) | gap=-21.4pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=182 | excluded_post_start_actionables=222 (native_spread_band=<=5c=74, native_spread_band=<=2c=59, native_depth_band=1000+=53, native_depth_band=10-99=23) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=131 (not_actionable=131) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 2: native_watch|crypto_strong_no_90_95 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=39 resolved=38 pending=1 active=1 stale=0 unknown=0 | 31W-7L | pnl=$-4.46 | Wilson 66.6% vs target 95.3% (BE 93.3%) | gap=-28.7pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=266 | next_pending=KXSOLD-26JUL0302-T80.9999 status=active due=2026-07-03T05:59:59.416433+00:00 ask=0.90 | excluded_post_start_actionables=232 (signal_tier=weak=86, signal_tier=moderate=82, native_ask_band=85-90=30, native_ask_band=95-98=22) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89 | target_window_misses=499 (not_actionable_native_ask_band=missing=141, not_actionable_native_ask_band=<80=90, not_actionable_native_ask_band=95-98=78, not_actionable_native_ask_band=98-99=65) | target_window_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89
- rank 3: native_watch|crypto_20_40m_no_80_85 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-29T11:05:00+00:00 | observations=25 resolved=25 pending=0 active=0 stale=0 unknown=0 | 23W-2L | pnl=$+2.04 | Wilson 75.0% vs target 85.8% (BE 83.8%) | gap=-10.8pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=23 | excluded_post_start_actionables=740 (minutes_band=40-60m=404, native_ask_band=90-95=130, native_ask_band=85-90=70, minutes_band=10-20m=67) | excluded_sample=KXBTCD-26JUN2908-T60299.99 minutes_band=40-60m ask=0.95 | target_window_misses=1058 (not_actionable_native_ask_band=98-99=198, not_actionable_native_ask_band=missing=173, not_actionable_native_ask_band=99+=162, not_actionable_native_ask_band=95-98=155) | target_window_sample=KXBTCD-26JUN2908-T60299.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 4: native_watch|crypto_btc_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-30T07:13:19+00:00 | observations=24 resolved=24 pending=0 active=0 stale=0 unknown=0 | 17W-7L | pnl=$-4.28 | Wilson 50.8% vs target 90.7% (BE 88.7%) | gap=-39.8pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=126 | excluded_post_start_actionables=532 (asset=SOL=202, asset=ETH=171, native_ask_band=90-95=107, native_ask_band=95-98=40) | excluded_sample=KXBTCD-26JUN3005-T59699.99 native_ask_band=90-95 ask=0.94 | target_window_misses=897 (not_actionable_native_ask_band=missing=357, not_actionable_native_ask_band=98-99=116, native_ask_band=90-95=107, not_actionable_native_ask_band=95-98=101) | target_window_sample=KXBTCD-26JUN3004-T59799.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 5: native_watch|crypto_spread_le1_depth_10_99 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T07:10:00+00:00 | observations=21 resolved=21 pending=0 active=0 stale=0 unknown=0 | 17W-4L | pnl=$-2.07 | Wilson 60.0% vs target 92.8% (BE 90.8%) | gap=-32.8pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=118 | excluded_post_start_actionables=320 (native_depth_band=100-999=116, native_spread_band=<=5c=76, native_spread_band=<=2c=61, native_depth_band=1000+=54) | excluded_sample=KXBTCD-26JUL0104-T58899.99 native_depth_band=100-999 ask=0.93 | target_window_misses=29 (not_actionable=29) | target_window_sample=KXSOLD-26JUL0107-T75.9999 not_actionable ask=0.99
- rank 6: native_watch|crypto_sol_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T13:00:00+00:00 | observations=16 resolved=15 pending=1 active=1 stale=0 unknown=0 | 15W-0L | pnl=$+1.71 | Wilson 79.6% vs target 90.6% (BE 88.6%) | gap=-11.0pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=23 | next_pending=KXSOLD-26JUL0302-T80.9999 status=active due=2026-07-03T05:59:59.416433+00:00 ask=0.89 | excluded_post_start_actionables=266 (asset=BTC=105, asset=ETH=84, native_ask_band=90-95=47, native_ask_band=80-85=20) | excluded_sample=KXBTCD-26JUL0110-T59199.99 asset=BTC ask=0.93 | target_window_misses=250 (not_actionable_native_ask_band=missing=50, native_ask_band=90-95=47, not_actionable_native_ask_band=99+=36, not_actionable_native_ask_band=<80=34) | target_window_sample=KXSOLD-26JUL0111-T79.9999 not_actionable_native_ask_band=missing
- rank 7: native_watch|crypto_btc_strong_no_90_95_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T14:00:00+00:00 | observations=10 resolved=10 pending=0 active=0 stale=0 unknown=0 | 9W-1L | pnl=$-0.38 | Wilson 59.6% vs target 95.8% (BE 93.8%) | gap=-36.2pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=121 | excluded_post_start_actionables=270 (asset=SOL=109, asset=ETH=84, native_depth_band=1000+=34, signal_tier=moderate=13) | excluded_sample=KXETHD-26JUL0111-T1609.99 asset=ETH ask=0.90 | target_window_misses=63 (not_actionable_native_ask_band=95-98=19, not_actionable_native_ask_band=99+=14, not_actionable_native_ask_band=<80=9, native_ask_band=85-90=8) | target_window_sample=KXBTCD-26JUL0112-T60099.99 native_ask_band=85-90 ask=0.89
- rank 8: native_watch|crypto_tue_no_any_ask | gate=FORWARD_WATCH_WAITING | start=2026-07-01T07:10:00+00:00 | observations=0 resolved=0 pending=0 active=0 stale=0 unknown=0 | 0W-0L | pnl=$+0.00 | Wilson 0.0% vs target 2.0% (BE 0.0%) | gap=-2.0pp | blockers=no_forward_observations;resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=>5000_or_target_impossible | excluded_post_start_actionables=344 (captured_weekday=Thu=165, captured_weekday=Wed=133, captured_weekday=Fri=46) | excluded_sample=KXBTCD-26JUL0104-T58899.99 captured_weekday=Wed ask=0.93

## Kalshi Native Preflight Walk-Forward Validation
- command: `python3 scripts/kalshi_native_preflight_walkforward.py --limit 8`
- status: NO_WALKFORWARD_NATIVE_CUT | ready=false | observations=14205 | cuts=2271 | display_cuts=210 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-29T13:08:30+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_walkforward_native_cut_validation_requires_predeclared_forward_gate
...
- rank 4: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=WALKFORWARD_REJECT | type=single | train=18 resolved 16W-2L +$0.37 Wilson 67.2% vs target 88.8% gap=-21.6pp | validation=23 resolved 23W-0L +$3.10 Wilson 85.7% vs target 88.5% gap=-2.8pp | blockers=train_resolved<30;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 5: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=WALKFORWARD_REJECT | type=pair | train=37 resolved 36W-1L +$1.61 Wilson 86.2% vs target 94.9% gap=-8.8pp | validation=39 resolved 39W-0L +$2.85 Wilson 91.0% vs target 94.7% gap=-3.7pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 6: crypto_last_hour_longshot_no|asset=SOL|native_ask_band=85-90 | gate=WALKFORWARD_REJECT | type=pair | train=23 resolved 20W-3L -$0.35 Wilson 67.9% vs target 90.5% gap=-22.6pp | validation=34 resolved 33W-1L +$2.92 Wilson 85.1% vs target 90.5% gap=-5.4pp | blockers=train_resolved<30;train_pnl<=0;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXSOLD-26JUL0302-T80.9999 status=active due=2026-07-03T05:59:59.416433+00:00 ask=0.89
- rank 7: crypto_last_hour_longshot_no|signal_tier=moderate | gate=WALKFORWARD_REJECT | type=single | train=46 resolved 42W-4L +$0.95 Wilson 79.7% vs target 91.2% gap=-11.6pp | validation=46 resolved 44W-2L +$2.57 Wilson 85.5% vs target 91.9% gap=-6.4pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0302-T61599.99 status=active due=2026-07-03T05:59:59.105844+00:00 ask=0.81
- rank 8: crypto_last_hour_longshot_no|shadow_spread_band=<=1c | gate=WALKFORWARD_REJECT | type=single | train=104 resolved 96W-8L +$1.56 Wilson 85.6% vs target 92.8% gap=-7.3pp | validation=117 resolved 109W-8L +$1.07 Wilson 87.1% vs target 94.2% gap=-7.1pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0302-T61599.99 status=active due=2026-07-03T05:59:59.105844+00:00 ask=0.81
...
- best: crypto_last_hour_native_subcell:moderate:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=60 resolved=59 pending=1 active=1 stale=0 unknown=0 | 57W-2L | pnl=+4.58 | Wilson 88.5% vs BE 88.8% | gap=-0.3pp | blockers=wilson<BE+2pp | perfect_wins_needed=16 | next_pending=KXBTCD-26JUL0302-T61599.99 status=active due=2026-07-03T05:59:59.105844+00:00 ask=0.81
- rank 1: crypto_last_hour_native_subcell:moderate:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=60 resolved=59 pending=1 active=1 stale=0 unknown=0 | 57W-2L | pnl=+4.58 | Wilson 88.5% vs BE 88.8% | gap=-0.3pp | blockers=wilson<BE+2pp | perfect_wins_needed=16 | next_pending=KXBTCD-26JUL0302-T61599.99 status=active due=2026-07-03T05:59:59.105844+00:00 ask=0.81
- rank 2: crypto_last_hour_native_subcell:strong:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=151 resolved=150 pending=1 active=1 stale=0 unknown=0 | 136W-14L | pnl=-3.90 | Wilson 84.9% vs BE 93.2% | gap=-8.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=339 | next_pending=KXSOLD-26JUL0302-T80.9999 status=active due=2026-07-03T05:59:59.416433+00:00 ask=0.89
- rank 3: crypto_last_hour_native_subcell:weak:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=72 resolved=72 pending=0 active=0 stale=0 unknown=0 | 61W-11L | pnl=-2.03 | Wilson 74.7% vs BE 87.5% | gap=-12.9pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=111
- rank 4: crypto_last_hour_native_subcell:native_ask:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=135 resolved=133 pending=2 active=2 stale=0 unknown=0 | 117W-16L | pnl=+1.41 | Wilson 81.4% vs BE 86.9% | gap=-5.6pp | blockers=wilson<BE+2pp | perfect_wins_needed=95 | next_pending=KXBTCD-26JUL0302-T61599.99 status=active due=2026-07-03T05:59:59.105844+00:00 ask=0.81
- rank 5: crypto_last_hour_native_subcell:native_ask:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=139 resolved=139 pending=0 active=0 stale=0 unknown=0 | 128W-11L | pnl=-1.50 | Wilson 86.4% vs BE 93.2% | gap=-6.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=263
...
- status: NO_ENTRY_TIMING_CANDIDATE | ready=false | posthoc_candidates=0 | source_actionable_rows=1413 | selected_observations=793 | cuts=375 | min_resolved=30 | edge_buffer=+2.0pp
- best: crypto_last_hour_entry_timing:first_actionable|asset=SOL|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=34 resolved=33 pending=1 | 33W-0L | pnl=+$3.81 | Wilson 89.6% vs target 90.5% (BE 88.5%) | gap=-0.9pp | blockers=wilson<BE+2pp
- rank 1: crypto_last_hour_entry_timing:first_actionable|asset=SOL|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=34 resolved=33 pending=1 | 33W-0L | pnl=+$3.81 | Wilson 89.6% vs target 90.5% (BE 88.5%) | gap=-0.9pp | blockers=wilson<BE+2pp
- rank 2: crypto_last_hour_entry_timing:latest_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=169 resolved=168 pending=1 | 162W-6L | pnl=+$4.79 | Wilson 92.4% vs target 95.6% (BE 93.6%) | gap=-3.1pp | blockers=wilson<BE+2pp
- rank 3: crypto_last_hour_entry_timing:first_actionable|signal_tier=weak|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=36 resolved=36 pending=0 | 35W-1L | pnl=+$3.41 | Wilson 85.8% vs target 89.8% (BE 87.8%) | gap=-3.9pp | blockers=wilson<BE+2pp
- rank 4: crypto_last_hour_entry_timing:first_actionable|native_depth_band=1000+ | gate=ENTRY_TIMING_ACCUMULATING | observations=81 resolved=80 pending=1 | 77W-3L | pnl=+$3.23 | Wilson 89.5% vs target 94.1% (BE 92.1%) | gap=-4.6pp | blockers=wilson<BE+2pp
- rank 5: crypto_last_hour_entry_timing:first_actionable|signal_tier=moderate | gate=ENTRY_TIMING_ACCUMULATING | observations=93 resolved=92 pending=1 | 86W-6L | pnl=+$3.52 | Wilson 86.5% vs target 91.6% (BE 89.6%) | gap=-5.1pp | blockers=wilson<BE+2pp
- rank 6: crypto_last_hour_entry_timing:latest_actionable|signal_tier=moderate|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=53 resolved=53 pending=0 | 52W-1L | pnl=+$2.52 | Wilson 90.1% vs target 95.4% (BE 93.4%) | gap=-5.3pp | blockers=wilson<BE+2pp
- rank 7: crypto_last_hour_entry_timing:first_actionable|native_spread_band=<=1c | gate=ENTRY_TIMING_ACCUMULATING | observations=220 resolved=219 pending=1 | 202W-17L | pnl=+$1.87 | Wilson 87.9% vs target 93.3% (BE 91.3%) | gap=-5.4pp | blockers=wilson<BE+2pp
- rank 8: crypto_last_hour_entry_timing:first_actionable|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=91 resolved=90 pending=1 | 83W-7L | pnl=+$3.40 | Wilson 84.8% vs target 90.5% (BE 88.5%) | gap=-5.7pp | blockers=wilson<BE+2pp

## Kalshi Crypto Ladder Dislocation Preflight
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_preflight.py --json`
- latest_run: captured_at=2026-07-03T05:07:26+00:00 | lookahead=75m | events=5 rows_per_event=40 | candidates=104 checked=104 dislocation_qty1=0 | min_source_edge=0.03 max_source_age=300s | top_reasons=missing_native_no_ask=101, nonpositive_qty1_win:0.0000=2, source_edge_below_min:0.0200=1
- latest_rows: KXSOLD-26JUL0302-T80.9999 SOL/strong source_no=0.92 native_no_ask=0.90 edge=0.02 age=192s spread=0.02 depth=300 win=0.09 due=2026-07-03T05:59:59.416433+00:00 reason=source_edge_below_min:0.0200 ; KXBTCD-26JUL0302-T62099.99 BTC/extreme source_no=0.99 native_no_ask=0.99 edge=0.00 age=193s spread=0.01 depth=42 win=0.00 due=2026-07-03T05:59:59.131953+00:00 reason=nonpositive_qty1_win:0.0000 ; KXETHD-26JUL0302-T1719.99 ETH/extreme source_no=0.98 native_no_ask=0.99 edge=-0.01 age=192s spread=0.01 depth=1580 win=0.00 due=2026-07-03T05:59:59.866548+00:00 reason=nonpositive_qty1_win:0.0000 ; KXBTCD-26JUL0302-T62199.99 BTC/extreme source_no=0.99 native_no_ask=missing edge=missing age=193s spread=missing depth=0 win=missing due=2026-07-03T05:59:59.137702+00:00 reason=missing_native_no_ask ; KXBTCD-26JUL0302-T62299.99 BTC/extreme source_no=0.99 native_no_ask=missing edge=missing age=193s spread=missing depth=0 win=missing due=2026-07-03T05:59:59.143028+00:00 reason=missing_native_no_ask ; KXBTCD-26JUL0302-T62399.99 BTC/extreme source_no=0.99 native_no_ask=missing edge=missing age=193s spread=missing depth=0 win=missing due=2026-07-03T05:59:59.148832+00:00 reason=missing_native_no_ask

## Kalshi Crypto Ladder Dislocation Forward Audit
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_audit.py --limit 8`
- status: NO_LIVE_READY | ready=false | cells=6 | ready_cells=0 | observations=92 | min_resolved=30 | edge_buffer=+2.0pp | scope=source-vs-native ladder gaps only; not riskless structural arbitrage
- best: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=58 resolved=58 pending=0 active=0 stale=0 | 40W-18L pnl_qty1=-$7.73 | Wilson 56.2% vs target 84.3% gap=-28.1pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=117
- rank 1: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=58 resolved=58 pending=0 active=0 stale=0 | 40W-18L pnl_qty1=-$7.73 | Wilson 56.2% vs target 84.3% gap=-28.1pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=117
- rank 2: ticker_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=61 resolved=61 pending=0 active=0 stale=0 | 42W-19L pnl_qty1=-$8.56 | Wilson 56.4% vs target 84.9% gap=-28.5pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=129
- rank 3: all_rows | gate=LADDER_DISLOCATION_ACCUMULATING | observations=92 resolved=92 pending=0 active=0 stale=0 | 59W-33L pnl_qty1=-$14.05 | Wilson 53.9% vs target 81.4% gap=-27.5pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=150
...
- rank 6: asset_sol | gate=LADDER_DISLOCATION_ACCUMULATING | observations=44 resolved=44 pending=0 active=0 stale=0 | 29W-15L pnl_qty1=-$5.32 | Wilson 51.1% vs target 80.0% gap=-28.9pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=74
...
- latest_run: captured_at=2026-07-03T05:07:53+00:00 | markets_checked=24 parsed=24 source_observations=50 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXTEMPNYCH dates=2026-07-03 | state_keys=2 observations_raw=50 source=weathercom_kalshi_metar_primary source_errors=0 | counts=KXTEMPNYCH=24 | reasons=hourly_temp_observation_missing_or_future=24
...
- latest_run: captured_at=2026-07-03T05:11:10+00:00 | markets_checked=924 parsed=910 espn_games=12 locked_rows=102 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXMLBKS,KXMLBOUTS,KXMLBHIT,KXMLBHRR,KXMLBHR,KXMLBTB,KXMLBRBI,KXMLBSB dates=2026-07-03,2026-07-02 | state_games=12 | reasons=mlb_boxscore_not_current=598, player_stat_waiting_for_threshold_or_final=129, mlb_player_stat_already_reached=102, player_stat_missing_after_final=51, player_stat_missing_before_final=30
- locked_rows: KXMLBHIT-26JUL022210SDLAD-LADAPAGES44-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL022210SDLAD-LADDRUSHING68-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:4/1 game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL022210SDLAD-LADDRUSHING68-2 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:4/2 game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL022210SDLAD-LADDRUSHING68-3 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:4/3 game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL022210SDLAD-LADFFREEMAN5-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL022210SDLAD-LADKTUCKER23-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:4/1 game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL022210SDLAD-LADKTUCKER23-2 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:4/2 game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL022210SDLAD-LADKTUCKER23-3 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:4/3 game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0
...
- latest_run: captured_at=2026-07-03T04:05:10+00:00 | markets_checked=40000 with_legs=40000 component_events=200/359 fetched=200 component_markets=2812 resolved=441 locked_rows=75 actionable_qty1=0 | max_target_ask=0.98 min_depth=1 | series=KXMVESPORTSMULTIGAMEEXTENDED,KXMVECROSSCATEGORY counts=KXMVECROSSCATEGORY=20000, KXMVESPORTSMULTIGAMEEXTENDED=20000 | page_cap=KXMVECROSSCATEGORY,KXMVESPORTSMULTIGAMEEXTENDED rate_limited=none component_cap=true component_rate_limited=false | reasons=not_locked_by_component_results=39925, component_market_resolved=441, component_event_cap_reached=159, component_false_locks_mve_no=60, all_components_true_locks_mve_yes=15
- latest_rows: KXMVECROSSCATEGORY-S202602618F9682A-BC6F3A7CAC5 YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=2/2 decisive=KXSOLD-26JUL0300-T79.9999:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S2026083DF55ADEA-021E6BD26A2 YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=2/2 decisive=KXSOL15M-26JUL030000-00:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S202619A9BE3D0C9-72B8E555572 YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=2/2 decisive=KXDOGE15M-26JUL030000-00:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S20261DD02E0C95F-A22049D550F YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=3/3 decisive=KXSOL15M-26JUL030000-00:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S2026354BBAFA327-637ABFB57E4 YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=2/2 decisive=KXETH15M-26JUL030000-00:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S2026370B78185E8-41414209E0F YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=2/2 decisive=KXSOL15M-26JUL030000-00:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S20263A933269539-1E5DBAA808A YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=2/2 decisive=KXSOL15M-26JUL030000-00:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S20265E8D06F13EF-9FD7DAD25AC YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=3/3 decisive=KXSOLD-26JUL0300-T79.9999:YES->YES reason=all_components_true_locks_mve_yes actionable=0
...
- latest_run: captured_at=2026-07-03T05:11:21+00:00 | markets_checked=543 parsed=513 espn_games=29 locked_rows=12 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXMLBRFI,KXMLBF3,KXMLBF5,KXMLBF5SPREAD,KXMLBF5TOTAL,KXMLBF7,KXMLBTEAMTOTAL,KXMLBEXTRAS dates=2026-07-03,2026-07-02,2026-07-04 | state_games=29 | counts=KXMLBEXTRAS=44, KXMLBF3=39, KXMLBF5=39, KXMLBF5SPREAD=52, KXMLBF5TOTAL=91, KXMLBF7=39, KXMLBRFI=43, KXMLBTEAMTOTAL=196 | reasons=mlb_teamtotal_game_not_final=184, mlb_f5total_window_not_complete=91, mlb_f5spread_window_not_complete=52, mlb_f3_window_not_complete=39, mlb_f5_window_not_complete=39, mlb_f7_window_not_complete=39, mlb_extras_game_not_final=29, mlb_rfi_first_inning_not_complete=28
- locked_rows: KXMLBTEAMTOTAL-26JUL022210SDLAD-LAD2 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=LAD threshold=1.50 margin=missing total=None game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL022210SDLAD-LAD3 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=LAD threshold=2.50 margin=missing total=None game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL022210SDLAD-LAD4 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=LAD threshold=3.50 margin=missing total=None game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL022210SDLAD-LAD5 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=LAD threshold=4.50 margin=missing total=None game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL022210SDLAD-LAD6 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=LAD threshold=5.50 margin=missing total=None game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL022210SDLAD-LAD7 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=LAD threshold=6.50 margin=missing total=None game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL022210SDLAD-LAD8 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=LAD threshold=7.50 margin=missing total=None game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL022210SDLAD-SD2 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=SD threshold=1.50 margin=missing total=None game=SD@LAD 6-12 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0
...
- latest_run: captured_at=2026-07-03T04:37:40+00:00 | markets_checked=47 parsed=45 espn_games=3 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWNBAGAME,KXWNBASPREAD,KXWNBATOTAL,KXWNBAOT,KXWNBA1QWINNER,KXWNBA2QWINNER,KXWNBA3QWINNER,KXWNBA4QWINNER,KXWNBA1HWINNER,KXWNBA2HWINNER,KXWNBA1QSPREAD,KXWNBA2QSPREAD,KXWNBA3QSPREAD,KXWNBA4QSPREAD,KXWNBA1HSPREAD,KXWNBA2HSPREAD,KXWNBA1QTOTAL,KXWNBA2QTOTAL,KXWNBA3QTOTAL,KXWNBA4QTOTAL,KXWNBA1HTOTAL,KXWNBA2HTOTAL dates=2026-07-03,2026-07-04 | state_games=3 | counts=KXWNBA1HSPREAD=0, KXWNBA1HTOTAL=0, KXWNBA1HWINNER=0, KXWNBA1QSPREAD=0, KXWNBA1QTOTAL=0, KXWNBA1QWINNER=0, KXWNBA2HSPREAD=0, KXWNBA2HTOTAL=0, KXWNBA2HWINNER=0, KXWNBA2QSPREAD=0, KXWNBA2QTOTAL=0, KXWNBA2QWINNER=0, KXWNBA3QSPREAD=0, KXWNBA3QTOTAL=0, KXWNBA3QWINNER=0, KXWNBA4QSPREAD=0, KXWNBA4QTOTAL=0, KXWNBA4QWINNER=0, KXWNBAGAME=8, KXWNBAOT=0, KXWNBASPREAD=21, KXWNBATOTAL=18 | reasons=wnba_spread_game_not_final=21, wnba_total_game_not_final=18, wnba_game_not_final=6
...
- latest_run: captured_at=2026-07-03T05:10:24+00:00 | markets_checked=0 parsed=0 espn_games=0 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXWNBAPTS,KXWNBAREB,KXWNBAAST,KXWNBA3PT dates= | state_games=0 titles=0 title_failures=0 summary_fetches=0 | counts=KXWNBA3PT=0, KXWNBAAST=0, KXWNBAPTS=0, KXWNBAREB=0 | reasons=none
...
- latest_run: captured_at=2026-07-03T03:44:53+00:00 | markets_checked=16 parsed=16 espn_games=8 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXAFLGAME dates=2026-07-03,2026-07-04,2026-07-05,2026-07-06 | state_games=8 | counts=KXAFLGAME=16 | reasons=afl_game_not_final=16
...
- latest_run: captured_at=2026-07-03T03:43:40+00:00 | markets_checked=10 parsed=10 official_games=93 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXCFLGAME dates=2026-07-02,2026-07-03,2026-07-04,2026-07-05,2026-07-09 | state_games=5 rounds_raw=27 tournaments_raw=93 supported_games=93 | counts=KXCFLGAME=10 | source_errors=0 | reasons=cfl_game_not_final=10
...
- latest_run: captured_at=2026-07-03T03:47:41+00:00 | markets_checked=8 parsed=8 official_games=32 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXBIG3GAME dates=2026-07-05 | state_games=4 events_raw=32 supported_games=32 | counts=KXBIG3GAME=8 | source_errors=0 | reasons=big3_game_not_final=8
...
- latest_run: captured_at=2026-07-03T03:44:53+00:00 | markets_checked=68 parsed=68 official_games=34 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXKBOGAME,KXNPBGAME dates=2026-07-01,2026-07-03,2026-07-04,2026-07-05 | state_games=34 | counts=KXKBOGAME=30, KXNPBGAME=38 | source_errors=0 | reasons=npb_game_not_final=36, kbo_game_not_final=30, npb_game_canceled_or_postponed=2
...
- latest_run: captured_at=2026-07-03T03:44:53+00:00 | markets_checked=76 parsed=76 official_games=40 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXLMBGAME dates=2026-07-02,2026-07-03,2026-07-04,2026-07-05 | state_games=38 schedule_games=40 teams=20 | counts=KXLMBGAME=76 | source_errors=0 | reasons=lmb_game_not_final=62, no_matching_official_lmb_game_state=10, lmb_game_postponed_or_canceled=4
...
- latest_run: captured_at=2026-07-03T03:43:57+00:00 | markets_checked=24 parsed=24 official_games=44 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXR6GAME dates=2026-07-03,2026-07-04,2026-07-06 | state_games=20 calendar=2026-7 matches_raw=92 supported_games=44 | counts=KXR6GAME=24 | source_errors=0 | reasons=r6_game_not_final=24
...
- latest_run: captured_at=2026-07-03T05:00:41+00:00 | markets_checked=28 parsed=28 official_games=80 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXVALORANTGAME dates=2026-07-03,2026-07-04 | state_games=26 events_raw=80 supported_games=80 | counts=KXVALORANTGAME=28 | source_errors=0 | reasons=valorant_game_not_final=26, no_matching_official_valorant_game_state=2
...
- latest_run: captured_at=2026-07-03T05:00:41+00:00 | markets_checked=19 parsed=19 official_games=80 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXLOLGAME dates=2026-07-03,2026-07-02,2026-07-04 | state_games=22 events_raw=80 supported_games=80 | counts=KXLOLGAME=19 | source_errors=0 | reasons=lol_game_not_final=12, no_matching_official_lol_game_state=4, lol_game_final_no_unique_winner=2, lol_game_target_not_in_game=1
...
- latest_run: captured_at=2026-07-03T04:58:22+00:00 | markets_checked=46 groups=23 hltv_results=148 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXCS2GAME counts=KXCS2GAME=46 | hltv_index_pairs=139 fetches=2 raw_results=148 | reasons=no_hltv_match_pair=23
...
- latest_run: captured_at=2026-07-03T04:58:23+00:00 | markets_checked=19 parsed=19 hltv_results=148 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXCS2TOTALMAPS counts=KXCS2TOTALMAPS=19 | hltv_index_pairs=139 fetches=2 raw_results=148 | reasons=no_hltv_match_pair=19
...
- latest_run: captured_at=2026-07-03T04:59:28+00:00 | kalshi_markets=134 groups=67 espn_matches=573 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXATPMATCH,KXWTAMATCH,KXATPDOUBLES,KXWTADOUBLES counts=KXATPDOUBLES=32, KXATPMATCH=32, KXWTADOUBLES=38, KXWTAMATCH=32 | espn_events=atp=1, wta=1 competitions=atp=288, wta=285 status_fetches=573 | reasons=espn_match_not_unique_completed=56, no_espn_match_pair=11
...
- latest_run: captured_at=2026-07-03T04:58:50+00:00 | kalshi_markets=196 groups=98 flashscore_tournaments=26 flashscore_matches=738 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXITFMATCH,KXITFWMATCH counts=KXITFMATCH=120, KXITFWMATCH=76 | category_tournaments=KXITFMATCH=17, KXITFWMATCH=13 matched_tournaments=26 tournament_match_failures=0 | reasons=flashscore_match_not_unique_completed=83, no_flashscore_match_pair=15
...
- latest_run: captured_at=2026-07-03T05:00:22+00:00 | kalshi_markets=256 groups=96 espn_matches=573 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXATPSETWINNER,KXWTASETWINNER,KXATPEXACTMATCH,KXWTAEXACTMATCH counts=KXATPEXACTMATCH=96, KXATPSETWINNER=96, KXWTAEXACTMATCH=0, KXWTASETWINNER=64 | espn_events=atp=1, wta=1 competitions=atp=288, wta=285 status_fetches=573 linescore_fetches=1146 | reasons=espn_match_not_unique_completed=96
...
- latest_run: captured_at=2026-07-03T05:00:41+00:00 | markets_checked=92 parsed=92 official_games=160 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXVALORANTMAP,KXLOLMAP dates=2026-07-03,2026-07-02,2026-07-04 | state_games=65 events_raw=160 supported_games=160 | counts=KXLOLMAP=36, KXVALORANTMAP=56 | source_errors=0 | proof=completed_clean_sweep_only | reasons=valorant_match_not_final=52, lol_match_not_final=28, no_matching_official_lol_map_sweep_state=8, no_matching_official_valorant_map_sweep_state=4
...
- latest_run: captured_at=2026-07-03T03:47:27+00:00 | markets_checked=128 parsed=128 official_games=53 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXFIBAGAME dates=2026-06-30,2026-07-02,2026-07-03,2026-07-04,2026-07-05,2026-07-06 | state_games=106 matched_markets=106 raw_games=210 supported_games=88 | counts=KXFIBAGAME=128 | source_errors=0 | reasons=fiba_game_not_final=106, no_matching_official_fiba_game_state=22
...
- latest_run: captured_at=2026-07-03T03:47:27+00:00 | markets_checked=8 parsed=8 official_games=27 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXNZNBLGAME dates=2026-07-03,2026-07-04,2026-07-05 | state_games=4 widget_rows=54 supported_games=27 | counts=KXNZNBLGAME=8 | source_errors=0 | reasons=nznbl_game_not_final=8
...
- latest_run: captured_at=2026-07-03T03:47:27+00:00 | markets_checked=6 parsed=6 official_games=16 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXVBAGAME dates=2026-07-03,2026-07-04,2026-07-05 | state_games=3 widget_rows=16 supported_games=16 | counts=KXVBAGAME=6 | source_errors=0 | reasons=vba_game_not_final=6
...
- latest_run: captured_at=2026-07-03T03:43:40+00:00 | markets_checked=20 parsed=20 espn_games=10 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXNBASUMMERGAME dates=2026-07-03,2026-07-04,2026-07-05 | state_games=10 | counts=KXNBASUMMERGAME=20 | leagues=nba-summer-california=8, nba-summer-utah=2 | reasons=nba_summer_game_not_final=20
...
- latest_run: captured_at=2026-07-03T03:43:40+00:00 | markets_checked=66 parsed=60 espn_games=20 locked_rows=0 actionable_qty1=0 | max_ask=0.98 min_depth=1 | series=KXCHNSLGAME,KXALLSVENSKANGAME,KXBRASILEIROBGAME,KXBRASILEIROCGAME,KXUSLGAME,KXECULPGAME dates=2026-07-02,2026-07-01,2026-07-03,2026-07-04,2026-07-05,2026-07-06,2026-07-07,2026-07-08 | state_games=20 | counts=KXALLSVENSKANGAME=3, KXBRASILEIROBGAME=15, KXBRASILEIROCGAME=21, KXCHNSLGAME=3, KXECULPGAME=21, KXUSLGAME=3 | reasons=soccer_game_not_final=60
...
- rank 2: shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=590 | 546W-44L | pnl=+2496.77 | Wilson 90.1% vs target 89.5% (avg_price 87.5%) | target_gap=+0.6pp | blockers=none
- rank 3: shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=832 | 727W-105L | pnl=+2977.48 | Wilson 85.0% vs target 84.8% (avg_price 82.8%) | target_gap=+0.1pp | blockers=none

## Kalshi Shadow Longshot Stability Audit
- command: `python3 scripts/kalshi_shadow_longshot_stability_audit.py --limit 8`
- status: NO_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=6878 | eligible_cells=25 | base_candidate_cells=3 | stable_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
...
- 2. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=590ev 546W-44L +2496.77 Wilson 90.1% vs target 89.5% gap +0.6pp | train=413ev 384W-29L +1904.99 Wilson 90.1% vs target 89.6% gap +0.5pp | validation=177ev 162W-15L +591.78 Wilson 86.5% vs target 89.4% gap -2.9pp | worst_asset=KXSOLD 111ev 103W-8L +498.77 Wilson 86.4% vs target 89.5% gap -3.1pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 3. shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=832ev 727W-105L +2977.48 Wilson 85.0% vs target 84.8% gap +0.1pp | train=582ev 520W-62L +3346.79 Wilson 86.6% vs target 84.6% gap +2.0pp | validation=250ev 207W-43L -369.31 Wilson 77.6% vs target 85.3% gap -7.7pp | worst_asset=KXBTCD 441ev 376W-65L +687.67 Wilson 81.6% vs target 84.7% gap -3.1pp | worst_hour=13Z 35ev 25W-10L -449.18 Wilson 54.9% vs target 85.3% gap -30.3pp | blockers=validation_pnl<=0;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXBTCD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
...
- status: NO_FILTERED_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=6878 | base_candidate_cells=3 | filtered_cells=74 | filtered_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=02Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=02Z | excluded=34 | aggregate=556ev 517W-39L +2581.84 Wilson 90.6% vs target 89.6% gap +1.0pp | train=389ev 362W-27L +1811.14 Wilson 90.1% vs target 89.6% gap +0.4pp | validation=167ev 155W-12L +770.70 Wilson 87.9% vs target 89.4% gap -1.6pp | worst_asset=KXSOLD 102ev 95W-7L +484.20 Wilson 86.5% vs target 89.6% gap -3.1pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 2. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=13Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=13Z | excluded=22 | aggregate=568ev 528W-40L +2639.64 Wilson 90.6% vs target 89.5% gap +1.0pp | train=397ev 370W-27L +1916.35 Wilson 90.3% vs target 89.6% gap +0.7pp | validation=171ev 158W-13L +723.29 Wilson 87.4% vs target 89.4% gap -2.0pp | worst_asset=KXETHD 90ev 84W-6L +467.90 Wilson 86.2% vs target 89.4% gap -3.2pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 3. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=15Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=15Z | excluded=21 | aggregate=569ev 530W-39L +2751.87 Wilson 90.8% vs target 89.5% gap +1.2pp | train=398ev 372W-26L +2032.36 Wilson 90.6% vs target 89.6% gap +1.0pp | validation=171ev 158W-13L +719.51 Wilson 87.4% vs target 89.4% gap -2.0pp | worst_asset=KXETHD 89ev 83W-6L +459.48 Wilson 86.1% vs target 89.3% gap -3.3pp | worst_hour=13Z 22ev 18W-4L -142.87 Wilson 61.5% vs target 89.5% gap -28.1pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
- 4. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_asset=KXETHD | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_asset=KXETHD | excluded=91 | aggregate=499ev 461W-38L +2015.72 Wilson 89.7% vs target 89.6% gap +0.1pp | train=349ev 322W-27L +1349.65 Wilson 89.0% vs target 89.6% gap -0.7pp | validation=150ev 139W-11L +666.07 Wilson 87.3% vs target 89.5% gap -2.1pp | worst_asset=KXSOLD 111ev 103W-8L +498.77 Wilson 86.4% vs target 89.5% gap -3.1pp | worst_hour=13Z 21ev 17W-4L -156.02 Wilson 60.0% vs target 89.6% gap -29.6pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
- 5. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=01Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=01Z | excluded=38 | aggregate=552ev 511W-41L +2362.40 Wilson 90.1% vs target 89.5% gap +0.6pp | train=386ev 358W-28L +1700.11 Wilson 89.7% vs target 89.6% gap +0.1pp | validation=166ev 153W-13L +662.29 Wilson 87.1% vs target 89.4% gap -2.3pp | worst_asset=KXSOLD 101ev 93W-8L +385.26 Wilson 85.1% vs target 89.5% gap -4.4pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 6. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=19Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=19Z | excluded=21 | aggregate=569ev 527W-42L +2455.65 Wilson 90.2% vs target 89.5% gap +0.6pp | train=398ev 370W-28L +1835.19 Wilson 90.0% vs target 89.6% gap +0.4pp | validation=171ev 157W-14L +620.46 Wilson 86.7% vs target 89.4% gap -2.7pp | worst_asset=KXETHD 88ev 82W-6L +447.28 Wilson 85.9% vs target 89.3% gap -3.4pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 7. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=09Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=09Z | excluded=22 | aggregate=568ev 525W-43L +2340.61 Wilson 90.0% vs target 89.5% gap +0.4pp | train=397ev 368W-29L +1720.15 Wilson 89.7% vs target 89.6% gap +0.1pp | validation=171ev 157W-14L +620.46 Wilson 86.7% vs target 89.4% gap -2.7pp | worst_asset=KXETHD 87ev 81W-6L +433.19 Wilson 85.8% vs target 89.4% gap -3.6pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 8. shadow_longshot_fading:other:NO:weak:80-90:4-24h|exclude_hour=15Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=15Z | excluded=1 | aggregate=54ev 53W-1L +755.82 Wilson 90.2% vs target 85.3% gap +4.9pp | train=37ev 36W-1L +469.82 Wilson 86.2% vs target 85.8% gap +0.4pp | validation=17ev 17W-0L +286.00 Wilson 81.6% vs target 84.3% gap -2.7pp | worst_asset=none>=min_slice | worst_hour=none>=min_slice | blockers=validation_wilson<avg_price+buffer
...
- best: moderate_favorites:CRYPTO:ETH:YES:80-90:0-1H:liq1:spread1 | gate=LEGACY_SHADOW_FORWARD_REQUIRED | execution=legacy_taker_like_shadow | events=65 | 62W-3L | pnl=+$817.00 | Wilson 87.3% vs target 84.7% (BE 82.7%, avg_price 82.8%) | gap=+2.6pp | blockers=none | promotion_blockers=requires_native_or_maker_forward_gate
- rank 1: moderate_favorites:CRYPTO:ETH:YES:80-90:0-1H:liq1:spread1 | gate=LEGACY_SHADOW_FORWARD_REQUIRED | execution=legacy_taker_like_shadow | events=65 | 62W-3L | pnl=+$817.00 | Wilson 87.3% vs target 84.7% (BE 82.7%, avg_price 82.8%) | gap=+2.6pp | blockers=none | promotion_blockers=requires_native_or_maker_forward_gate
...
- latest_run: captured_at=2026-07-03T05:08:35+00:00 | cohort=yes_90_93_above_live_threshold_v1 | start=2026-06-25T11:45:00+00:00 | include_pre_cutoff_live=true | candidates=3 checked=3 actionable_qty1=0 | top_reasons=yes_90_93_above_live_threshold_v1:missing_native_yes_ask=2, yes_90_93_above_live_threshold_v1:native_yes_ask_below_band_watch:0.0100=1
- latest_rows: KXHIGHTNOLA-26JUL02-B89.5 city=NOLA yes_ask=missing no_depth=0 reason=missing_native_yes_ask ; KXHIGHTMIN-26JUL02-T87 city=MIN yes_ask=missing no_depth=0 reason=missing_native_yes_ask ; KXLOWTCHI-26JUL02-B77.5 city=CHI yes_ask=0.01 no_depth=56333 reason=native_yes_ask_below_band_watch:0.0100
...
- latest_run: captured_at=2026-07-03T05:06:49+00:00 | start=2026-06-25T07:05:00+00:00 | include_pre_cutoff_live=true | candidates=13 checked=13 actionable_qty1=2 | top_reasons=no_95_98_zero_loss_cities_v1:missing_native_no_ask=6, no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive=2, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9900=2, no_90_95_min_probe_v1:missing_native_no_ask=1, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9100=1, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9400=1
- latest_rows: KXLOWTAUS-26JUL03-B70.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=0.98 no_ask_depth=28 qty1=+0.01/-0.99 reason=actionable_qty1_fee_positive due=2026-07-04T19:00:00+00:00 ; KXLOWTMIA-26JUL03-T81 cohort=no_95_98_zero_loss_cities_v1 city=MIA no_ask=0.97 no_ask_depth=100 qty1=+0.02/-0.98 reason=actionable_qty1_fee_positive due=2026-07-04T19:00:00+00:00 ; KXHIGHTMIN-26JUL02-B93.5 cohort=no_90_95_min_probe_v1 city=MIN no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-03T19:00:00+00:00 ; KXLOWTAUS-26JUL02-B69.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-03T19:00:00+00:00 ; KXHIGHTDAL-26JUL02-B100.5 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-03T19:00:00+00:00 ; KXHIGHTDAL-26JUL03-B101.5 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=0.99 no_ask_depth=214 qty1=+0.00/-1.00 reason=native_no_ask_out_of_band:0.9900 due=2026-07-04T19:00:00+00:00 ; KXHIGHTLV-26JUL02-B102.5 cohort=no_95_98_zero_loss_cities_v1 city=LV no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-03T19:00:00+00:00 ; KXHIGHTLV-26JUL03-B105.5 cohort=no_95_98_zero_loss_cities_v1 city=LV no_ask=0.99 no_ask_depth=633 qty1=+0.00/-1.00 reason=native_no_ask_out_of_band:0.9900 due=2026-07-04T19:00:00+00:00
...
- latest_run: captured_at=2026-07-03T05:08:34+00:00 | cohort=all | start=2026-06-25T20:00:00+00:00 | include_pre_cutoff_live=true | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- status: NO_LIVE_READY | ready=false | cells=15 | ready_cells=0 | review_min=50 | fills=1784 pending_units=478 active=469 stale=9 unknown=0 overall_resolved_indep=1306 toxic=428 | next_pending=cell_weather_no:KXHIGHCHI-26JUL02-B95.5 status=active close=2026-07-03T05:59:00+00:00
- best: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=388/50 max_if_pending_resolve=671 new_needed_after_pending=0 | 304W-84L | pnl=-353.93 | Wilson 74.0% vs BE 87.5% | gap=-13.5pp | fills=671/2336 fill_rate=28.7% pending_units=283 active=283 stale=0 unknown=0 toxic=84 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUN301835CWSBAL-BAL3 status=active close=2026-07-03T22:35:00+00:00 price=0.81
- rank 1: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=388/50 max_if_pending_resolve=671 new_needed_after_pending=0 | 304W-84L | pnl=-353.93 | Wilson 74.0% vs BE 87.5% | gap=-13.5pp | fills=671/2336 fill_rate=28.7% pending_units=283 active=283 stale=0 unknown=0 toxic=84 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUN301835CWSBAL-BAL3 status=active close=2026-07-03T22:35:00+00:00 price=0.81
- rank 2: cell_crypto_yes | gate=NO_GO_REVIEW | resolved_indep=297/50 max_if_pending_resolve=316 new_needed_after_pending=0 | 170W-127L | pnl=-870.07 | Wilson 51.6% vs BE 86.5% | gap=-35.0pp | fills=316/1124 fill_rate=28.1% pending_units=19 active=19 stale=0 unknown=0 toxic=127 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXETHD-26JUL0317-T1429.99 status=active close=2026-07-03T21:00:00+00:00 price=0.88
- rank 3: cell_crypto_no | gate=NO_GO_REVIEW | resolved_indep=274/50 max_if_pending_resolve=287 new_needed_after_pending=0 | 158W-116L | pnl=-804.81 | Wilson 51.7% vs BE 87.0% | gap=-35.3pp | fills=287/984 fill_rate=29.2% pending_units=13 active=13 stale=0 unknown=0 toxic=116 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXETHD-26JUL0317-T1669.99 status=active close=2026-07-03T21:00:00+00:00 price=0.80
...
- rank 5: cell_sports_yes | gate=NO_GO_REVIEW | resolved_indep=113/50 max_if_pending_resolve=247 new_needed_after_pending=0 | 43W-70L | pnl=-555.10 | Wilson 29.6% vs BE 87.2% | gap=-57.5pp | fills=247/391 fill_rate=63.2% pending_units=134 active=134 stale=0 unknown=0 toxic=70 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUN301835CWSBAL-CWS11 status=active close=2026-07-03T22:35:00+00:00 price=0.83
- rank 6: watch_crypto_bid_90_95 | gate=NO_GO_REVIEW | resolved_indep=101/50 max_if_pending_resolve=101 new_needed_after_pending=0 | 93W-8L | pnl=-15.52 | Wilson 85.1% vs BE 93.6% | gap=-8.5pp | fills=101/464 fill_rate=21.8% pending_units=0 active=0 stale=0 unknown=0 toxic=8 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000
- rank 7: cell_weather_no | gate=NO_GO_REVIEW | resolved_indep=98/50 max_if_pending_resolve=124 new_needed_after_pending=0 | 81W-17L | pnl=-69.45 | Wilson 74.0% vs BE 89.7% | gap=-15.8pp | fills=124/259 fill_rate=47.9% pending_units=26 active=19 stale=7 unknown=0 toxic=17 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXHIGHCHI-26JUL02-B95.5 status=active close=2026-07-03T05:59:00+00:00 price=0.90
...
- rank 5: crypto YES maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=93/50 | 83W-10L | pnl=-36.16 | Wilson 81.3% vs BE 93.1% | gap=-11.8pp | candidates=357 fills=93 fill_rate=26.1% pending_units=0 toxic=10 | blockers=pnl<=0; wilson<=BE; toxic>0
...
- rank 7: sports NO maker_band=<85 | gate=NO_GO_REVIEW | resolved_indep=147/50 | 110W-37L | pnl=-110.84 | Wilson 67.2% vs BE 82.4% | gap=-15.1pp | candidates=1197 fills=251 fill_rate=21.0% pending_units=104 toxic=37 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 8: sports NO maker_band=85-90 | gate=NO_GO_REVIEW | resolved_indep=101/50 | 82W-19L | pnl=-66.83 | Wilson 72.5% vs BE 87.8% | gap=-15.3pp | candidates=626 fills=199 fill_rate=31.8% pending_units=98 toxic=19 | blockers=pnl<=0; wilson<=BE; toxic>0

## Kalshi Maker Walk-Forward Validation
- command: `python3 scripts/kalshi_maker_walkforward.py --limit 8`
- status: NO_MAKER_WALKFORWARD_CUT | ready=false | observations=1784 | cuts=187 | display_cuts=119 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-28T14:27:57+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_maker_cut_walkforward_requires_predeclared_live_spec
- best: maker_all_fills|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=single | train=168 resolved 139W-29L -$95.27 toxic=29 Wilson 76.3% vs target 90.4% gap=-14.1pp | validation=162 resolved 148W-14L +$32.09 toxic=14 Wilson 86.0% vs target 91.4% gap=-5.3pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHLAX-26JUL02-B72.5 status=active due=2026-07-03T07:59:00+00:00 price=0.83
- rank 1: maker_all_fills|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=single | train=168 resolved 139W-29L -$95.27 toxic=29 Wilson 76.3% vs target 90.4% gap=-14.1pp | validation=162 resolved 148W-14L +$32.09 toxic=14 Wilson 86.0% vs target 91.4% gap=-5.3pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHLAX-26JUL02-B72.5 status=active due=2026-07-03T07:59:00+00:00 price=0.83
- rank 2: maker_all_fills|category=crypto|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=52 resolved 45W-7L -$9.36 toxic=7 Wilson 74.7% vs target 90.3% gap=-15.6pp | validation=105 resolved 97W-8L +$33.48 toxic=8 Wilson 85.7% vs target 91.2% gap=-5.5pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none
- rank 3: maker_all_fills|due_hour=04Z | gate=MAKER_WALKFORWARD_REJECT | type=single | train=39 resolved 30W-9L -$48.35 toxic=9 Wilson 61.7% vs target 91.3% gap=-29.7pp | validation=27 resolved 26W-1L +$20.82 toxic=1 Wilson 81.7% vs target 90.6% gap=-8.9pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHMIA-26JUL03-B88.5 status=active due=2026-07-04T04:59:00+00:00 price=0.94
- rank 4: maker_all_fills|category=sports|side=NO | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=287 resolved 215W-72L -$359.77 toxic=72 Wilson 69.6% vs target 89.4% gap=-19.9pp | validation=101 resolved 89W-12L +$5.84 toxic=12 Wilson 80.4% vs target 89.5% gap=-9.2pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUN301835CWSBAL-BAL3 status=active due=2026-07-03T22:35:00+00:00 price=0.81
- rank 5: maker_all_fills|side_ask_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=79 resolved 55W-24L -$162.62 toxic=24 Wilson 58.8% vs target 92.2% gap=-33.4pp | validation=48 resolved 44W-4L +$7.00 toxic=4 Wilson 80.4% vs target 92.2% gap=-11.7pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHCHI-26JUL02-B95.5 status=active due=2026-07-03T05:59:00+00:00 price=0.90
- rank 6: maker_all_fills|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=39 resolved 35W-4L -$12.46 toxic=4 Wilson 76.4% vs target 94.9% gap=-18.5pp | validation=47 resolved 44W-3L +$3.57 toxic=3 Wilson 82.8% vs target 94.8% gap=-12.0pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUN301840PITPHI-PHI7 status=active due=2026-07-03T22:40:00+00:00 price=0.91
- rank 7: maker_all_fills|category=crypto|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=15 resolved 12W-3L -$19.32 toxic=3 Wilson 54.8% vs target 94.9% gap=-40.1pp | validation=29 resolved 28W-1L +$10.62 toxic=1 Wilson 82.8% vs target 94.9% gap=-12.1pp | blockers=train_resolved<30;train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none
- rank 8: maker_all_fills|category=weather | gate=MAKER_WALKFORWARD_REJECT | type=single | train=72 resolved 58W-14L -$62.73 toxic=14 Wilson 70.0% vs target 91.3% gap=-21.3pp | validation=49 resolved 44W-5L +$5.83 toxic=5 Wilson 78.2% vs target 90.6% gap=-12.4pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHCHI-26JUL02-B95.5 status=active due=2026-07-03T05:59:00+00:00 price=0.90
...
- status: native=NO_LIVE_READY pending=23 active=23 stale=0 unknown=0 | maker=NO_LIVE_READY pending_units=478 active=469 stale=9 unknown=0 | queued=18
- 1. maker_stale:weather_no | ticker=KXHIGHMIA-26JUL02-B89.5 | status=stale | time=2026-07-03T04:59:00+00:00 | closed_unfinalized expiration=2026-07-09T14:00:00+00:00 price=0.93
- 2. maker_stale:weather_no | ticker=KXHIGHMIA-26JUL02-B93.5 | status=stale | time=2026-07-03T04:59:00+00:00 | closed_unfinalized expiration=2026-07-09T14:00:00+00:00 price=0.92
- 3. maker_stale:weather_no | ticker=KXHIGHNY-26JUL02-B103.5 | status=stale | time=2026-07-03T04:59:00+00:00 | closed_unfinalized expiration=2026-07-09T14:00:00+00:00 price=0.93
- 4. maker_stale:weather_no | ticker=KXHIGHNY-26JUL02-B99.5 | status=stale | time=2026-07-03T04:59:00+00:00 | closed_unfinalized expiration=2026-07-09T14:00:00+00:00 price=0.94
- 5. maker_stale:weather_no | ticker=KXHIGHNY-26JUL02-T99 | status=stale | time=2026-07-03T04:59:00+00:00 | closed_unfinalized expiration=2026-07-09T14:00:00+00:00 price=0.89
- 6. maker:cell_weather_no | ticker=KXHIGHCHI-26JUL02-B95.5 | status=active | time=2026-07-03T05:59:00+00:00 | resolved_indep=98 pending_units=26
- 7. maker:watch_weather_no_ge88 | ticker=KXHIGHCHI-26JUL02-B97.5 | status=active | time=2026-07-03T05:59:00+00:00 | resolved_indep=27 pending_units=7
- 8. native:crypto_last_hour_longshot_no | ticker=KXBTCD-26JUL0302-T61599.99 | status=active | time=2026-07-03T05:59:59.105844+00:00 | resolved=314 pending=2
- 9. maker:cell_weather_yes | ticker=KXHIGHLAX-26JUL02-B72.5 | status=active | time=2026-07-03T07:59:00+00:00 | resolved_indep=23 pending_units=3
- 10. native:weather_high_ask_no | ticker=KXHIGHCHI-26JUL02-B99.5 | status=active | time=2026-07-03T14:00:00+00:00 | resolved=42 pending=3

## Kalshi Academic-Prior Aligned Queue
- command: `python3 scripts/kalshi_academic_prior_queue.py --report --per-family 2`
- KALSHI ACADEMIC-PRIOR ALIGNED QUEUE
- generated_at=2026-07-03T05:11:57.776777+00:00 db=/home/eric-king/kalshi_favorites_bot/trades.db
- Lower rank_score means closer to review, not approval.
- 1. high_price_native_taker:crypto_last_hour_longshot_no | status=NATIVE_FORWARD_ACCUMULATING rank=0.0654 | 314 resolved 283W-31L -$2.41 | Wilson 86.3% vs target 92.9% | next=KXBTCD-26JUL0302-T61599.99 active due=2026-07-03T05:59:59.105844+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
...
- 5. maker_adverse_selection:cell_sports_no | status=NO_GO_REVIEW rank=0.6349 | 388 independent resolved 304W-84L -$353.93 | Wilson 74.0% vs BE 87.5% | toxic=84 fill_rate=28.7% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
- 6. maker_adverse_selection:cell_crypto_yes | status=NO_GO_REVIEW rank=0.8498 | 297 independent resolved 170W-127L -$870.07 | Wilson 51.6% vs BE 86.5% | toxic=127 fill_rate=28.1% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
- 7. structural_arbitrage:same_strike_last_24h | status=WATCH_ONLY rank=1.0000 | 62072 observations | fresh_pairs=61734 execution_ready_tier=5206 gross_positive=1 execution_ready_gross_positive=0 qty10_positive=1 execution_ready_qty10_positive=0 best_gross_edge=0.02 | blockers=no_execution_ready_gross_positive, no_execution_ready_fee_net_qty10_positive | next=continue simultaneous quote scans; only trade fee-net positive executable dislocations
...
- recent_36h_backlog: unresolved=1800 | expired_after_60s_grace=1526 | oldest_expired=2026-07-02 13:59:59 | oldest_expected=2026-07-02 13:59:59
- recent_36h_crypto_backlog: unresolved=1515 | expired_after_60s_grace=1373 | oldest_expired=2026-07-03 04:59:59 | oldest_expected=2026-07-03 04:59:59
- native_gate_stale_unresolved=0
- resolved_last_30m=779
- all_expired_backlog: unresolved=7960 | crypto=7544 | other=352 | weather=64 | oldest_expired=2026-04-15 21:59:59 | newest_expired=2026-07-03 05:00:17
- legacy_pre36h_expired_backlog: unresolved=6434 | crypto=6171 | other=260 | weather=3 | oldest_expired=2026-04-15 21:59:59 | newest_expired=2026-07-01 13:59:59
...
- recent_72h_backlog: unresolved=330 | expired_after_60s_grace=78 | oldest_expired=2026-07-03 04:58:59 | oldest_expected=2026-07-03 04:58:59
...
-   5-10c: candidates=59655 fill=0.3% resolved=31 benign/toxic=9/22 net=$-13.96 benign=$+7.48 Wilson=70.1% BE=0.0% margin=+70.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   10-20c: candidates=57636 fill=0.4% resolved=47 benign/toxic=15/32 net=$-16.67 benign=$+44.57 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   20-35c: candidates=58229 fill=0.6% resolved=59 benign/toxic=21/38 net=$-17.84 benign=$+64.14 Wilson=84.5% BE=0.0% margin=+84.5pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   35-50c: candidates=35742 fill=0.6% resolved=41 benign/toxic=15/26 net=$+22.03 benign=$+65.98 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   50-65c: candidates=35624 fill=0.8% resolved=41 benign/toxic=12/29 net=$-42.10 benign=$+50.56 Wilson=75.7% BE=0.0% margin=+75.7pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   65-80c: candidates=30882 fill=0.7% resolved=51 benign/toxic=15/36 net=$-6.55 benign=$+68.80 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   80-90c: candidates=28916 fill=0.7% resolved=58 benign/toxic=15/43 net=$+13.69 benign=$+35.81 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   90-95c: candidates=16915 fill=0.5% resolved=36 benign/toxic=11/25 net=$-16.37 benign=$+10.53 Wilson=74.1% BE=0.0% margin=+74.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   95-99c: candidates=35558 fill=0.2% resolved=40 benign/toxic=7/33 net=$+0.30 benign=$+2.55 Wilson=64.6% BE=0.0% margin=+64.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT

## Timers
```
NEXT                                  LEFT LAST                                   PASSED UNIT                                                   ACTIVATES
Fri 2026-07-03 00:12:14 CDT            13s Fri 2026-07-03 00:11:12 CDT           48s ago kalshi-worldcup-final-state-live-pilot.timer           kalshi-worldcup-final-state-live-pilot.service
Fri 2026-07-03 00:12:17 CDT            17s Fri 2026-07-03 00:11:32 CDT           28s ago kalshi-worldcup-score-state-live-pilot.timer           kalshi-worldcup-score-state-live-pilot.service
Fri 2026-07-03 00:12:26 CDT            25s Fri 2026-07-03 00:07:26 CDT      4min 34s ago kalshi-crypto-ladder-dislocation-preflight.timer       kalshi-crypto-ladder-dislocation-preflight.service
Fri 2026-07-03 00:12:30 CDT            29s Fri 2026-07-03 00:12:00 CDT         591ms ago gemini-cushion-ds-scanner.timer                        gemini-cushion-ds-scanner.service
Fri 2026-07-03 00:12:34 CDT            33s Fri 2026-07-03 00:07:33 CDT      4min 26s ago kalshi-shadow-deterministic-settlement-backfill.timer  kalshi-shadow-deterministic-settlement-backfill.service
Fri 2026-07-03 00:12:50 CDT            49s Fri 2026-07-03 00:11:50 CDT           10s ago gateway-watchdog.timer                                 gateway-watchdog.service
Fri 2026-07-03 00:13:04 CDT        1min 3s Fri 2026-07-03 00:11:04 CDT           56s ago gemini-ds-index-micro-parity.timer                     gemini-ds-index-micro-parity.service
Fri 2026-07-03 00:13:10 CDT       1min 10s Fri 2026-07-03 00:08:10 CDT      3min 49s ago kalshi-side-equivalence-scanner.timer                  kalshi-side-equivalence-scanner.service
Fri 2026-07-03 00:13:28 CDT       1min 27s Fri 2026-07-03 00:08:20 CDT      3min 40s ago kalshi-crypto-favorite-taker-preflight.timer           kalshi-crypto-favorite-taker-preflight.service
Fri 2026-07-03 00:13:36 CDT       1min 36s Fri 2026-07-03 00:08:35 CDT      3min 25s ago kalshi-weather-yes-90-93-preflight.timer               kalshi-weather-yes-90-93-preflight.service
Fri 2026-07-03 00:13:37 CDT       1min 36s Fri 2026-07-03 00:08:34 CDT      3min 26s ago kalshi-other-longshot-no-80-90-preflight.timer         kalshi-other-longshot-no-80-90-preflight.service
Fri 2026-07-03 00:14:15 CDT       2min 14s Fri 2026-07-03 00:09:15 CDT      2min 45s ago btc-moderate-v2-shadow-scanner.timer                   btc-moderate-v2-shadow-scanner.service
Fri 2026-07-03 00:14:15 CDT       2min 14s Fri 2026-07-03 00:09:15 CDT      2min 45s ago gemini-fp-orderbook-capture.timer                      gemini-fp-orderbook-capture.service
Fri 2026-07-03 00:14:15 CDT       2min 14s Fri 2026-07-03 00:09:15 CDT      2min 45s ago kalshi-shadow-forecast-accuracy-backfill.timer         kalshi-shadow-forecast-accuracy-backfill.service
Fri 2026-07-03 00:15:00 CDT       2min 59s Fri 2026-07-03 00:00:00 CDT         12min ago cushion-ds-multi-series-resolver.timer                 cushion-ds-multi-series-resolver.service
Fri 2026-07-03 00:15:00 CDT       2min 59s Fri 2026-07-03 00:00:00 CDT         12min ago gemini-cushion-ds-resolver.timer                       gemini-cushion-ds-resolver.service
Fri 2026-07-03 00:15:08 CDT        3min 8s Fri 2026-07-03 00:10:01 CDT      1min 59s ago kalshi-shadow-longshot-fading-backfill.timer           kalshi-shadow-longshot-fading-backfill.service
Fri 2026-07-03 00:15:23 CDT       3min 23s Fri 2026-07-03 00:10:23 CDT      1min 36s ago gemini-maker-fill-simulator.timer                      gemini-maker-fill-simulator.service
Fri 2026-07-03 00:15:34 CDT       3min 34s Fri 2026-07-03 00:10:33 CDT      1min 27s ago kalshi-crypto-last-hour-longshot-no-preflight.timer    kalshi-crypto-last-hour-longshot-no-preflight.service
Fri 2026-07-03 00:15:44 CDT       3min 44s Fri 2026-07-03 00:05:35 CDT          6min ago ds-shadow-continuous-archive.timer                     ds-shadow-continuous-archive.service
Fri 2026-07-03 00:16:08 CDT        4min 7s Fri 2026-07-03 00:11:08 CDT           52s ago gemini-reward-post-only-safety.timer                   gemini-reward-post-only-safety.service
Fri 2026-07-03 00:16:31 CDT       4min 30s Fri 2026-07-03 00:01:31 CDT         10min ago gemini-ds-source-parity.timer                          gemini-ds-source-parity.service
Fri 2026-07-03 00:16:40 CDT       4min 39s Thu 2026-07-02 23:46:40 CDT         25min ago ds-storage-monitor.timer                               ds-storage-monitor.service
Fri 2026-07-03 00:16:50 CDT       4min 49s Fri 2026-07-03 00:11:50 CDT           10s ago kalshi-weather-no-candidate-preflight.timer            kalshi-weather-no-candidate-preflight.service
Fri 2026-07-03 00:16:50 CDT       4min 50s Fri 2026-07-03 00:11:46 CDT           14s ago kalshi-weather-high-ask-no-preflight.timer             kalshi-weather-high-ask-no-preflight.service
Fri 2026-07-03 00:17:25 CDT           5min Fri 2026-07-03 00:02:25 CDT          9min ago ds-storage-pressure-monitor.timer                      ds-storage-pressure-monitor.service
Fri 2026-07-03 00:18:45 CDT           6min Fri 2026-07-03 00:03:45 CDT          8min ago kalshi-side-equivalence-resolver.timer                 kalshi-side-equivalence-resolver.service
Fri 2026-07-03 00:19:31 CDT           7min Fri 2026-07-03 00:04:31 CDT          7min ago btc-moderate-v2-shadow-resolver.timer                  btc-moderate-v2-shadow-resolver.service
Fri 2026-07-03 00:19:31 CDT           7min Fri 2026-07-03 00:04:31 CDT          7min ago gemini-categorical-scanner.timer                       gemini-categorical-scanner.service
Fri 2026-07-03 00:20:00 CDT           7min Thu 2026-07-02 23:20:00 CDT         52min ago gemini-db-retention.timer                              gemini-db-retention.service
Fri 2026-07-03 00:21:31 CDT           9min Thu 2026-07-02 23:51:31 CDT         20min ago eth-ds-fg-filter-blocks-resolver.timer                 eth-ds-fg-filter-blocks-resolver.service
Fri 2026-07-03 00:24:32 CDT          12min Fri 2026-07-03 00:09:32 CDT      2min 28s ago gemini-categorical-resolver.timer                      gemini-categorical-resolver.service
Fri 2026-07-03 00:26:22 CDT          14min Thu 2026-07-02 23:56:22 CDT         15min ago gemini-db-size-monitor.timer                           gemini-db-size-monitor.service
Fri 2026-07-03 00:28:11 CDT          16min Thu 2026-07-02 23:27:12 CDT         44min ago macro-release-resolver.timer                           macro-release-resolver.service
Fri 2026-07-03 00:29:11 CDT          17min Thu 2026-07-02 23:27:44 CDT         44min ago ladder-coherence-two-leg-resolver.timer                ladder-coherence-two-leg-resolver.service
Fri 2026-07-03 00:30:00 CDT          17min Thu 2026-07-02 23:30:00 CDT         41min ago gemini-direct-index-ds-first-resolution-verifier.timer gemini-direct-index-ds-first-resolution-verifier.service
Fri 2026-07-03 01:17:00 CDT        1h 4min Thu 2026-07-02 19:17:00 CDT      4h 55min ago ds-shadow-retention-engine.timer                       ds-shadow-retention-engine.service
Fri 2026-07-03 02:19:02 CDT        2h 7min Thu 2026-07-02 23:19:02 CDT         52min ago db-auto-vacuum.timer                                   db-auto-vacuum.service
Fri 2026-07-03 03:10:37 CDT       2h 58min Thu 2026-07-02 21:10:37 CDT       3h 1min ago ds-shadow-db-maintenance.timer                         ds-shadow-db-maintenance.service
Fri 2026-07-03 03:15:00 CDT        3h 2min Thu 2026-07-02 03:15:00 CDT           20h ago shadow-verification.timer                              shadow-verification.service
Fri 2026-07-03 03:24:20 CDT       3h 12min Thu 2026-07-02 21:24:20 CDT      2h 47min ago ds-shadow-archive.timer                                ds-shadow-archive.service
Fri 2026-07-03 03:30:00 CDT       3h 17min Thu 2026-07-02 03:30:00 CDT           20h ago ibkr-independent-verification.timer                    ibkr-independent-verification.service
Fri 2026-07-03 04:30:00 CDT       4h 17min Thu 2026-07-02 04:30:00 CDT           19h ago tax-ledger-ingest.timer                                tax-ledger-ingest.service
Fri 2026-07-03 04:46:49 CDT       4h 34min Thu 2026-07-02 04:45:15 CDT           19h ago ds-archive-tier-rotation.timer                         ds-archive-tier-rotation.service
Fri 2026-07-03 05:20:00 CDT        5h 7min Thu 2026-07-02 05:20:00 CDT           18h ago logrotate-user.timer                                   logrotate-user.service
Fri 2026-07-03 05:30:00 CDT       5h 17min Thu 2026-07-02 05:30:01 CDT           18h ago disk-hygiene-audit.timer                               disk-hygiene-audit.service
Fri 2026-07-03 05:30:00 CDT       5h 17min Thu 2026-07-02 05:30:01 CDT           18h ago full-picture-daily-save.timer                          full-picture-daily-save.service
Fri 2026-07-03 05:40:00 CDT       5h 27min Thu 2026-07-02 05:40:00 CDT           18h ago database-autonomous-maintenance.timer                  database-autonomous-maintenance.service
Fri 2026-07-03 06:40:00 CDT             6h Thu 2026-07-02 08:05:01 CDT           16h ago ibkr-deterministic-fx-poc.timer                        ibkr-deterministic-fx-poc.service
Fri 2026-07-03 20:13:54 CDT            20h Thu 2026-07-02 20:13:54 CDT      3h 58min ago launchpadlib-cache-clean.timer                         launchpadlib-cache-clean.service
Fri 2026-07-03 20:18:37 CDT            20h Thu 2026-07-02 20:18:37 CDT      3h 53min ago gemini-fp-retention.timer                              gemini-fp-retention.service
...
Mon 2026-07-06 20:16:34 CDT         3 days Mon 2026-06-29 20:16:34 CDT        3 days ago ubuntu-insights-upload.timer                           ubuntu-insights-upload.service
Thu 2026-07-23 06:43:39 CDT 2 weeks 6 days Mon 2026-06-22 20:13:39 CDT 1 week 3 days ago ubuntu-insights-collect.timer                          ubuntu-insights-collect.service
-                                        - Fri 2026-07-03 00:10:01 CDT      1min 59s ago claude-chat-sync.timer                                 claude-chat-sync.service
-                                        - Fri 2026-07-03 00:12:00 CDT         592ms ago cushion-ds-multi-series-scanner.timer                  cushion-ds-multi-series-scanner.service
-                                        - Fri 2026-07-03 00:10:01 CDT      1min 59s ago full-picture-latest-refresh.timer                      full-picture-latest-refresh.service
-                                        - Fri 2026-07-03 00:12:00 CDT         573ms ago gemini-ds-index-parity.timer                           gemini-ds-index-parity.service
-                                        - Fri 2026-07-03 00:11:49 CDT           11s ago gemini-liquidity-rewards-scanner.timer                 gemini-liquidity-rewards-scanner.service
-                                        - Thu 2026-07-02 07:27:13 CDT           16h ago gemini-reward-account-monitor.timer                    gemini-reward-account-monitor.service
-                                        - Thu 2026-07-02 07:23:13 CDT           16h ago gemini-reward-inventory-exit.timer                     gemini-reward-inventory-exit.service
-                                        - Thu 2026-07-02 07:25:01 CDT           16h ago gemini-reward-live-readiness.timer                     gemini-reward-live-readiness.service
-                                        - Thu 2026-07-02 07:22:48 CDT           16h ago gemini-reward-quote-pilot.timer                        gemini-reward-quote-pilot.service
-                                        - Fri 2026-07-03 00:08:01 CDT      3min 59s ago gemini-trade-print-capture.timer                       gemini-trade-print-capture.service
-                                        - Fri 2026-07-03 00:11:22 CDT           37s ago kalshi-mve-component-result-live-pilot.timer           kalshi-mve-component-result-live-pilot.service
-                                        - Fri 2026-07-03 00:09:32 CDT      2min 28s ago kalshi-sports-final-state-live-pilot.timer             kalshi-sports-final-state-live-pilot.service
-                                        - Wed 2026-07-01 09:00:00 CDT     1 day 15h ago snap.firmware-updater.firmware-notifier.timer          snap.firmware-updater.firmware-notifier.service
...
- operations-knowledge: head=2848d44 branch=master in_sync=true remote=https://github.com/PhotonRahm/operations-knowledge.git dirty=yes
