...
last_updated_utc: 2026-07-03T10:43:24+00:00
...
- Generated for Claude-in-chat startup at 2026-07-03T05:43:24-05:00; missing artifacts render UNAVAILABLE instead of breaking sync.
- Full-picture artifact: FULL PICTURE - 2026-07-03 05:30 AM
...
- Kalshi: ✓ Kalshi: lifetime -$1,242.55 / 3210 realized rows; bucket sum -$1,242.55 / 3210 rows
- Kalshi reconciliation: UNAVAILABLE
- IBKR: NLV: $1,949.48
- IBKR state: Status: ⚠️ Flex sync 205h stale | ❌ Gateway DOWN | ❌ KILL switch active
...
- • Combined true P&L: **$-16331.68**
- • True lifetime P&L (bots − one-time − recurring): **$-19195.41**
...
-   Disk: 182.89 GiB used / 936.79 GiB total (19.5%), 706.24 GiB free
-   Envelope: TARGET 50.0%, WARN 65.0%, CRITICAL 75.0%, HARD_LIMIT 85.0%
-   DS storage: active 1.17 GiB (state TARGET), hot 30.77 GiB, warm 0.02 GiB, cold 0.00 GiB, archive_state TARGET_EXCEEDED, total 31.97 GiB (3.4% of disk)
-   Archive sidecars: OK
...
-   Tier rotation: last=2026-07-03T09:46:50+00:00 status=OK actions=0
...
- reasons: wilson 76.2% < 90.0%; open_filled_trades=7; source reconciliation checked 189/77; source reconciliation mismatches 40; native taker NO ask <10c evidence absent
- resolved: 77/50 | 66W-11L | pnl=+62.29 | wilson=76.2%
...
- fresh_non04z_review: status=NOT_READY | ready=false | reason=fresh gate status NOT_READY; wilson 76.2% < 90.0%; open_filled_trades=7; source reconciliation checked 177/77; source reconciliation mismatches 40; native taker NO ask <10c evidence absent | resolved=77/50 | 66W-11L | pnl=+62.29 | wilson=76.2% | pending=0 | shadow_live_actionable=0 | native_taker_actionable=0 | native_taker_blocked=0 | expired_unresolved=0 | next_backfill_after=unknown | source_reconciliation=177/177 mismatches=40 | native_taker_ask_lt10c=0/172
...
- status: NO_LIVE_READY | ready=false | cells=9 | ready_cells=0 | min_resolved=30 | edge_buffer=+2.0pp | pending=30 active=29 stale=1 unknown=0 | next_pending=weather_high_ask_no:KXHIGHCHI-26JUL02-B99.5 status=active due=2026-07-03T14:00:00+00:00
- best: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=317 resolved=316 pending=1 active=0 stale=1 unknown=0 | 283W-33L | pnl=-4.14 | Wilson 85.7% vs BE 90.8% | gap=-5.2pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=325 | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.84
- rank 1: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=317 resolved=316 pending=1 active=0 stale=1 unknown=0 | 283W-33L | pnl=-4.14 | Wilson 85.7% vs BE 90.8% | gap=-5.2pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=325 | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.84
- rank 2: weather_no_candidate:no_95_98_zero_loss_cities_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=65 resolved=50 pending=15 active=15 stale=0 unknown=0 | 48W-2L | pnl=-0.75 | Wilson 86.5% vs BE 97.5% | gap=-11.0pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=1476 | next_pending=KXHIGHMIA-26JUL02-B87.5 status=active due=2026-07-03T14:00:00+00:00 ask=0.96
- rank 3: weather_high_ask_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=47 resolved=42 pending=5 active=5 stale=0 unknown=0 | 41W-1L | pnl=-0.58 | Wilson 87.7% vs BE 99.0% | gap=-11.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=>5000_or_target_impossible | next_pending=KXHIGHCHI-26JUL02-B99.5 status=active due=2026-07-03T14:00:00+00:00 ask=0.98
- rank 4: crypto_favorite_taker:crypto_near_certain_95_99_12_24h | gate=NATIVE_FORWARD_ACCUMULATING | native_events=39 resolved=37 pending=2 active=2 stale=0 unknown=0 | 36W-1L | pnl=-0.12 | Wilson 86.2% vs BE 97.6% | gap=-11.5pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=1538 | next_pending=KXSOLD-26JUL0317-T76.9999 status=active due=2026-07-03T20:59:59.685416+00:00 ask=0.97
...
- status: NO_NATIVE_CUT_READY | ready=false | observations=14303 | cuts=2272 | display_cuts=473 | candidate_cuts=0 | ready_cuts=0 | min_resolved=30 | min_display_resolved=10 | edge_buffer=+2.0pp | scope=posthoc_native_executable_cut_discovery_requires_predeclared_forward_gate
...
- rank 4: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=41 resolved=41 pending=0 active=0 stale=0 unknown=0 | 39W-2L | pnl=+$3.47 | Wilson 83.9% vs target 88.7% (BE 86.7%) | gap=-4.8pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=20
...
- rank 6: crypto_last_hour_longshot_no|minutes_to_expiry_band=40-60m|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=197 resolved=196 pending=1 active=0 stale=1 unknown=0 | 184W-12L | pnl=+$1.51 | Wilson 89.6% vs target 95.1% (BE 93.1%) | gap=-5.5pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=228 | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.93
- rank 7: crypto_last_hour_longshot_no|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=272 resolved=271 pending=1 active=0 stale=1 unknown=0 | 252W-19L | pnl=-$0.15 | Wilson 89.3% vs target 95.0% (BE 93.0%) | gap=-5.7pp | blockers=pnl<=0;wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=322 | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.93
- rank 8: crypto_last_hour_longshot_no|shadow_spread_band=<=1c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=224 resolved=223 pending=1 active=0 stale=1 unknown=0 | 205W-18L | pnl=+$0.90 | Wilson 87.6% vs target 93.5% (BE 91.5%) | gap=-5.9pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=209 | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.84
...
- best: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=53 resolved=52 pending=1 active=0 stale=1 unknown=0 | 43W-9L | pnl=$-4.43 | Wilson 70.3% vs target 93.2% (BE 91.2%) | gap=-22.9pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=195 | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.95 | excluded_post_start_actionables=233 (native_spread_band=<=5c=79, native_spread_band=<=2c=61, native_depth_band=1000+=56, native_depth_band=10-99=24) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=133 (not_actionable=133) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 1: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=53 resolved=52 pending=1 active=0 stale=1 unknown=0 | 43W-9L | pnl=$-4.43 | Wilson 70.3% vs target 93.2% (BE 91.2%) | gap=-22.9pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=195 | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.95 | excluded_post_start_actionables=233 (native_spread_band=<=5c=79, native_spread_band=<=2c=61, native_depth_band=1000+=56, native_depth_band=10-99=24) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=133 (not_actionable=133) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 2: native_watch|crypto_strong_no_90_95 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=40 resolved=39 pending=1 active=0 stale=1 unknown=0 | 31W-8L | pnl=$-5.37 | Wilson 64.5% vs target 95.3% (BE 93.3%) | gap=-30.8pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=289 | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.93 | excluded_post_start_actionables=243 (signal_tier=moderate=87, signal_tier=weak=86, native_ask_band=85-90=34, native_ask_band=95-98=23) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89 | target_window_misses=523 (not_actionable_native_ask_band=missing=148, not_actionable_native_ask_band=<80=100, not_actionable_native_ask_band=95-98=78, not_actionable_native_ask_band=98-99=65) | target_window_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89
- rank 3: native_watch|crypto_20_40m_no_80_85 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-29T11:05:00+00:00 | observations=25 resolved=25 pending=0 active=0 stale=0 unknown=0 | 23W-2L | pnl=$+2.04 | Wilson 75.0% vs target 85.8% (BE 83.8%) | gap=-10.8pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=23 | excluded_post_start_actionables=756 (minutes_band=40-60m=417, native_ask_band=90-95=130, native_ask_band=85-90=72, minutes_band=10-20m=67) | excluded_sample=KXBTCD-26JUN2908-T60299.99 minutes_band=40-60m ask=0.95 | target_window_misses=1074 (not_actionable_native_ask_band=98-99=198, not_actionable_native_ask_band=missing=176, not_actionable_native_ask_band=99+=162, not_actionable_native_ask_band=95-98=155) | target_window_sample=KXBTCD-26JUN2908-T60299.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 4: native_watch|crypto_btc_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-30T07:13:19+00:00 | observations=24 resolved=24 pending=0 active=0 stale=0 unknown=0 | 17W-7L | pnl=$-4.28 | Wilson 50.8% vs target 90.7% (BE 88.7%) | gap=-39.8pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=126 | excluded_post_start_actionables=548 (asset=SOL=210, asset=ETH=171, native_ask_band=90-95=108, native_ask_band=95-98=41) | excluded_sample=KXBTCD-26JUN3005-T59699.99 native_ask_band=90-95 ask=0.94 | target_window_misses=926 (not_actionable_native_ask_band=missing=364, not_actionable_native_ask_band=98-99=116, native_ask_band=90-95=108, not_actionable_native_ask_band=95-98=101) | target_window_sample=KXBTCD-26JUN3004-T59799.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 5: native_watch|crypto_spread_le1_depth_10_99 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T07:10:00+00:00 | observations=22 resolved=22 pending=0 active=0 stale=0 unknown=0 | 17W-5L | pnl=$-2.96 | Wilson 56.6% vs target 92.7% (BE 90.7%) | gap=-36.2pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=135 | excluded_post_start_actionables=335 (native_depth_band=100-999=121, native_spread_band=<=5c=81, native_spread_band=<=2c=63, native_depth_band=1000+=57) | excluded_sample=KXBTCD-26JUL0104-T58899.99 native_depth_band=100-999 ask=0.93 | target_window_misses=36 (not_actionable=36) | target_window_sample=KXSOLD-26JUL0107-T75.9999 not_actionable ask=0.99
- rank 6: native_watch|crypto_sol_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T13:00:00+00:00 | observations=16 resolved=16 pending=0 active=0 stale=0 unknown=0 | 15W-1L | pnl=$+0.81 | Wilson 71.7% vs target 90.7% (BE 88.7%) | gap=-19.0pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=41 | excluded_post_start_actionables=278 (asset=BTC=113, asset=ETH=84, native_ask_band=90-95=51, native_ask_band=80-85=20) | excluded_sample=KXBTCD-26JUL0110-T59199.99 asset=BTC ask=0.93 | target_window_misses=263 (native_ask_band=90-95=51, not_actionable_native_ask_band=missing=50, not_actionable_native_ask_band=<80=42, not_actionable_native_ask_band=99+=36) | target_window_sample=KXSOLD-26JUL0111-T79.9999 not_actionable_native_ask_band=missing
- rank 7: native_watch|crypto_btc_strong_no_90_95_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T14:00:00+00:00 | observations=10 resolved=10 pending=0 active=0 stale=0 unknown=0 | 9W-1L | pnl=$-0.38 | Wilson 59.6% vs target 95.8% (BE 93.8%) | gap=-36.2pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=121 | excluded_post_start_actionables=286 (asset=SOL=117, asset=ETH=84, native_depth_band=1000+=36, signal_tier=moderate=18) | excluded_sample=KXETHD-26JUL0111-T1609.99 asset=ETH ask=0.90 | target_window_misses=64 (not_actionable_native_ask_band=95-98=19, not_actionable_native_ask_band=99+=14, not_actionable_native_ask_band=<80=9, native_ask_band=85-90=8) | target_window_sample=KXBTCD-26JUL0112-T60099.99 native_ask_band=85-90 ask=0.89
- rank 8: native_watch|crypto_tue_no_any_ask | gate=FORWARD_WATCH_WAITING | start=2026-07-01T07:10:00+00:00 | observations=0 resolved=0 pending=0 active=0 stale=0 unknown=0 | 0W-0L | pnl=$+0.00 | Wilson 0.0% vs target 2.0% (BE 0.0%) | gap=-2.0pp | blockers=no_forward_observations;resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=>5000_or_target_impossible | excluded_post_start_actionables=360 (captured_weekday=Thu=165, captured_weekday=Wed=133, captured_weekday=Fri=62) | excluded_sample=KXBTCD-26JUL0104-T58899.99 captured_weekday=Wed ask=0.93

## Kalshi Native Preflight Walk-Forward Validation
- command: `python3 scripts/kalshi_native_preflight_walkforward.py --limit 8`
- status: NO_WALKFORWARD_NATIVE_CUT | ready=false | observations=14303 | cuts=2272 | display_cuts=210 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-29T13:15:02+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_walkforward_native_cut_validation_requires_predeclared_forward_gate
...
- rank 4: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=WALKFORWARD_REJECT | type=single | train=19 resolved 17W-2L +$0.55 Wilson 68.6% vs target 88.6% gap=-20.0pp | validation=22 resolved 22W-0L +$2.92 Wilson 85.1% vs target 88.7% gap=-3.6pp | blockers=train_resolved<30;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
...
- rank 6: crypto_last_hour_longshot_no|signal_tier=weak|native_ask_band=85-90 | gate=WALKFORWARD_REJECT | type=pair | train=26 resolved 23W-3L +$0.18 Wilson 71.0% vs target 89.8% gap=-18.7pp | validation=27 resolved 26W-1L +$2.20 Wilson 81.7% vs target 90.1% gap=-8.4pp | blockers=train_resolved<30;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 7: crypto_last_hour_longshot_no|native_ask_band=90-95 | gate=WALKFORWARD_REJECT | type=single | train=125 resolved 118W-7L +$1.66 Wilson 88.9% vs target 95.1% gap=-6.2pp | validation=146 resolved 134W-12L -$1.81 Wilson 86.2% vs target 95.0% gap=-8.8pp | blockers=train_wilson<BE+buffer;validation_pnl<=0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.93
- rank 8: crypto_last_hour_longshot_no|shadow_spread_band=<=1c | gate=WALKFORWARD_REJECT | type=single | train=105 resolved 97W-8L +$1.74 Wilson 85.7% vs target 92.7% gap=-7.0pp | validation=118 resolved 108W-10L -$0.84 Wilson 85.1% vs target 94.2% gap=-9.1pp | blockers=train_wilson<BE+buffer;validation_pnl<=0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.84
...
- rank 2: crypto_last_hour_native_subcell:strong:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=152 resolved=151 pending=1 active=0 stale=1 unknown=0 | 136W-15L | pnl=-4.80 | Wilson 84.3% vs BE 93.2% | gap=-8.9pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=358 | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.84
...
- rank 5: crypto_last_hour_native_subcell:native_ask:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=136 resolved=135 pending=1 active=0 stale=1 unknown=0 | 117W-18L | pnl=-0.32 | Wilson 79.9% vs BE 86.9% | gap=-7.0pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=115 | next_pending=KXBTCD-26JUL0303-T61899.99 status=stale due=2026-07-03T06:59:59.313588+00:00 ask=0.84
...
- status: NO_ENTRY_TIMING_CANDIDATE | ready=false | posthoc_candidates=0 | source_actionable_rows=1429 | selected_observations=795 | cuts=375 | min_resolved=30 | edge_buffer=+2.0pp
...
- rank 5: crypto_last_hour_entry_timing:first_actionable|native_spread_band=<=1c | gate=ENTRY_TIMING_ACCUMULATING | observations=221 resolved=220 pending=1 | 202W-18L | pnl=+$1.04 | Wilson 87.4% vs target 93.3% (BE 91.3%) | gap=-5.9pp | blockers=wilson<BE+2pp
- rank 6: crypto_last_hour_entry_timing:first_actionable|native_depth_band=1000+ | gate=ENTRY_TIMING_ACCUMULATING | observations=82 resolved=81 pending=1 | 77W-4L | pnl=+$2.40 | Wilson 88.0% vs target 94.0% (BE 92.0%) | gap=-6.0pp | blockers=wilson<BE+2pp
...
- rank 8: crypto_last_hour_entry_timing:first_actionable|signal_tier=moderate | gate=ENTRY_TIMING_ACCUMULATING | observations=93 resolved=93 pending=0 | 86W-7L | pnl=+$2.69 | Wilson 85.3% vs target 91.6% (BE 89.6%) | gap=-6.3pp | blockers=wilson<BE+2pp

## Kalshi Crypto Ladder Dislocation Preflight
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_preflight.py --json`
- latest_run: captured_at=2026-07-03T10:43:02+00:00 | lookahead=75m | events=5 rows_per_event=40 | candidates=0 checked=0 dislocation_qty1=0 | min_source_edge=0.03 max_source_age=300s | top_reasons=none
...
- rank 3: shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=833 | 728W-105L | pnl=+2994.44 | Wilson 85.0% vs target 84.8% (avg_price 82.8%) | target_gap=+0.2pp | blockers=none

## Kalshi Shadow Longshot Stability Audit
- command: `python3 scripts/kalshi_shadow_longshot_stability_audit.py --limit 8`
- status: NO_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=6890 | eligible_cells=25 | base_candidate_cells=3 | stable_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
...
- 3. shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=833ev 728W-105L +2994.44 Wilson 85.0% vs target 84.8% gap +0.2pp | train=583ev 520W-63L +3261.84 Wilson 86.4% vs target 84.6% gap +1.8pp | validation=250ev 208W-42L -267.40 Wilson 78.1% vs target 85.3% gap -7.2pp | worst_asset=KXBTCD 442ev 377W-65L +704.63 Wilson 81.7% vs target 84.7% gap -3.0pp | worst_hour=13Z 35ev 25W-10L -449.18 Wilson 54.9% vs target 85.3% gap -30.3pp | blockers=validation_pnl<=0;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXBTCD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
...
- status: NO_FILTERED_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=6890 | base_candidate_cells=3 | filtered_cells=74 | filtered_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
...
- latest_run: captured_at=2026-07-03T10:43:55+00:00 | cohort=yes_90_93_above_live_threshold_v1 | start=2026-06-25T11:45:00+00:00 | include_pre_cutoff_live=true | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- latest_run: captured_at=2026-07-03T10:36:53+00:00 | start=2026-06-25T07:05:00+00:00 | include_pre_cutoff_live=true | candidates=8 checked=8 actionable_qty1=0 | top_reasons=no_90_95_min_probe_v1:fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHTMIN-26JUL03-B87.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=44=1, no_95_98_zero_loss_cities_v1:fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHMIA-26JUL03-B88.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=443=1, no_95_98_zero_loss_cities_v1:fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHTDAL-26JUL03-B101.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=4=1, no_95_98_zero_loss_cities_v1:fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHTLV-26JUL03-B105.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=44=1, no_95_98_zero_loss_cities_v1:fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHTMIN-26JUL03-B87.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=44=1, no_95_98_zero_loss_cities_v1:fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHTOKC-26JUL03-B99.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=44=1
- latest_rows: KXHIGHTMIN-26JUL03-B87.5 cohort=no_90_95_min_probe_v1 city=MIN no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHTMIN-26JUL03-B87.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=44 due=2026-07-04T05:59:59.243523+00:00 ; KXLOWTAUS-26JUL03-B70.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXLOWTAUS-26JUL03-B70.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=443 due=2026-07-04T05:59:59.525604+00:00 ; KXHIGHTDAL-26JUL03-B101.5 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHTDAL-26JUL03-B101.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=4 due=2026-07-04T05:59:59.625787+00:00 ; KXHIGHTLV-26JUL03-B105.5 cohort=no_95_98_zero_loss_cities_v1 city=LV no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHTLV-26JUL03-B105.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=44 due=2026-07-04T07:59:59.585044+00:00 ; KXHIGHMIA-26JUL03-B88.5 cohort=no_95_98_zero_loss_cities_v1 city=MIA no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHMIA-26JUL03-B88.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=443 due=2026-07-04T04:58:59.567604+00:00 ; KXLOWTMIA-26JUL03-T81 cohort=no_95_98_zero_loss_cities_v1 city=MIA no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXLOWTMIA-26JUL03-T81/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=443): due=2026-07-04T04:59:59.967106+00:00 ; KXHIGHTMIN-26JUL03-B87.5 cohort=no_95_98_zero_loss_cities_v1 city=MIN no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHTMIN-26JUL03-B87.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=44 due=2026-07-04T05:59:59.528664+00:00 ; KXHIGHTOKC-26JUL03-B99.5 cohort=no_95_98_zero_loss_cities_v1 city=OKC no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=fetch_error:HTTPSConnectionPool(host='api.elections.kalshi.com', port=443): Max retries exceeded with url: /trade-api/v2/markets/KXHIGHTOKC-26JUL03-B99.5/orderbook (Caused by NameResolutionError("HTTPSConnection(host='api.elections.kalshi.com', port=44 due=2026-07-04T05:59:59.490247+00:00
...
- latest_run: captured_at=2026-07-03T10:44:23+00:00 | cohort=all | start=2026-06-25T20:00:00+00:00 | include_pre_cutoff_live=true | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- status: NO_LIVE_READY | ready=false | cells=15 | ready_cells=0 | review_min=50 | fills=1787 pending_units=479 active=464 stale=15 unknown=0 overall_resolved_indep=1308 toxic=429 | next_pending=cell_crypto_yes:KXETHD-26JUL0317-T1429.99 status=active close=2026-07-03T21:00:00+00:00
...
- rank 2: cell_crypto_yes | gate=NO_GO_REVIEW | resolved_indep=297/50 max_if_pending_resolve=316 new_needed_after_pending=0 | 170W-127L | pnl=-870.07 | Wilson 51.6% vs BE 86.5% | gap=-35.0pp | fills=316/1125 fill_rate=28.1% pending_units=19 active=19 stale=0 unknown=0 toxic=127 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXETHD-26JUL0317-T1429.99 status=active close=2026-07-03T21:00:00+00:00 price=0.88
- rank 3: cell_crypto_no | gate=NO_GO_REVIEW | resolved_indep=276/50 max_if_pending_resolve=289 new_needed_after_pending=0 | 159W-117L | pnl=-813.04 | Wilson 51.7% vs BE 87.1% | gap=-35.4pp | fills=289/989 fill_rate=29.2% pending_units=13 active=13 stale=0 unknown=0 toxic=117 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXETHD-26JUL0317-T1669.99 status=active close=2026-07-03T21:00:00+00:00 price=0.80
...
- rank 6: watch_crypto_bid_90_95 | gate=NO_GO_REVIEW | resolved_indep=102/50 max_if_pending_resolve=102 new_needed_after_pending=0 | 94W-8L | pnl=-14.87 | Wilson 85.3% vs BE 93.6% | gap=-8.3pp | fills=102/465 fill_rate=21.9% pending_units=0 active=0 stale=0 unknown=0 toxic=8 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000
- rank 7: cell_weather_no | gate=NO_GO_REVIEW | resolved_indep=98/50 max_if_pending_resolve=124 new_needed_after_pending=0 | 81W-17L | pnl=-69.45 | Wilson 74.0% vs BE 89.7% | gap=-15.8pp | fills=124/259 fill_rate=47.9% pending_units=26 active=14 stale=12 unknown=0 toxic=17 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXHIGHMIA-26JUL03-B88.5 status=active close=2026-07-04T04:59:00+00:00 price=0.94
...
- rank 7: sports NO maker_band=<85 | gate=NO_GO_REVIEW | resolved_indep=147/50 | 110W-37L | pnl=-110.84 | Wilson 67.2% vs BE 82.4% | gap=-15.1pp | candidates=1205 fills=251 fill_rate=20.8% pending_units=104 toxic=37 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 8: sports NO maker_band=85-90 | gate=NO_GO_REVIEW | resolved_indep=101/50 | 82W-19L | pnl=-66.83 | Wilson 72.5% vs BE 87.8% | gap=-15.3pp | candidates=629 fills=199 fill_rate=31.6% pending_units=98 toxic=19 | blockers=pnl<=0; wilson<=BE; toxic>0

## Kalshi Maker Walk-Forward Validation
- command: `python3 scripts/kalshi_maker_walkforward.py --limit 8`
- status: NO_MAKER_WALKFORWARD_CUT | ready=false | observations=1787 | cuts=187 | display_cuts=119 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-28T14:27:57+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_maker_cut_walkforward_requires_predeclared_live_spec
- best: maker_all_fills|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=single | train=168 resolved 139W-29L -$95.27 toxic=29 Wilson 76.3% vs target 90.4% gap=-14.1pp | validation=163 resolved 149W-14L +$32.74 toxic=14 Wilson 86.1% vs target 91.4% gap=-5.3pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUN301840PITPHI-PHI7 status=active due=2026-07-03T22:40:00+00:00 price=0.91
...
- rank 5: maker_all_fills|side_ask_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=79 resolved 55W-24L -$162.62 toxic=24 Wilson 58.8% vs target 92.2% gap=-33.4pp | validation=48 resolved 44W-4L +$7.00 toxic=4 Wilson 80.4% vs target 92.2% gap=-11.7pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXETHD-26JUL0317-T1709.99 status=active due=2026-07-03T21:00:00+00:00 price=0.89
...
- rank 8: maker_all_fills|category=weather | gate=MAKER_WALKFORWARD_REJECT | type=single | train=72 resolved 58W-14L -$62.73 toxic=14 Wilson 70.0% vs target 91.3% gap=-21.3pp | validation=49 resolved 44W-5L +$5.83 toxic=5 Wilson 78.2% vs target 90.6% gap=-12.4pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHMIA-26JUL03-B88.5 status=active due=2026-07-04T04:59:00+00:00 price=0.94
...
- status: native=NO_LIVE_READY pending=30 active=29 stale=1 unknown=0 | maker=NO_LIVE_READY pending_units=479 active=464 stale=15 unknown=0 | queued=20
- 1. maker:cell_weather_yes | ticker=KXHIGHNY-26JUL02-B101.5 | status=stale | time=2026-07-03T04:59:00+00:00 | resolved_indep=23 pending_units=3
- 2. maker_stale:weather_no | ticker=KXHIGHMIA-26JUL02-B89.5 | status=stale | time=2026-07-03T04:59:00+00:00 | closed_unfinalized expiration=2026-07-09T14:00:00+00:00 price=0.93
- 3. maker_stale:weather_no | ticker=KXHIGHMIA-26JUL02-B93.5 | status=stale | time=2026-07-03T04:59:00+00:00 | closed_unfinalized expiration=2026-07-09T14:00:00+00:00 price=0.92
- 4. maker_stale:weather_no | ticker=KXHIGHNY-26JUL02-B103.5 | status=stale | time=2026-07-03T04:59:00+00:00 | closed_unfinalized expiration=2026-07-09T14:00:00+00:00 price=0.93
- 5. maker_stale:weather_no | ticker=KXHIGHNY-26JUL02-B99.5 | status=stale | time=2026-07-03T04:59:00+00:00 | closed_unfinalized expiration=2026-07-09T14:00:00+00:00 price=0.94
- 6. maker_stale:weather_no | ticker=KXHIGHNY-26JUL02-T99 | status=stale | time=2026-07-03T04:59:00+00:00 | closed_unfinalized expiration=2026-07-09T14:00:00+00:00 price=0.89
- 7. native:crypto_last_hour_longshot_no | ticker=KXBTCD-26JUL0303-T61899.99 | status=stale | time=2026-07-03T06:59:59.313588+00:00 | resolved=316 pending=1
- 8. native:weather_high_ask_no | ticker=KXHIGHCHI-26JUL02-B99.5 | status=active | time=2026-07-03T14:00:00+00:00 | resolved=42 pending=5
- 9. native:weather_no_candidate:no_95_98_zero_loss_cities_v1 | ticker=KXHIGHMIA-26JUL02-B87.5 | status=active | time=2026-07-03T14:00:00+00:00 | resolved=50 pending=15
- 10. native:weather_no_candidate:no_90_95_min_probe_v1 | ticker=KXHIGHTMIN-26JUL02-B93.5 | status=active | time=2026-07-03T19:00:00+00:00 | resolved=7 pending=2

## Kalshi Academic-Prior Aligned Queue
- command: `python3 scripts/kalshi_academic_prior_queue.py --report --per-family 2`
- KALSHI ACADEMIC-PRIOR ALIGNED QUEUE
- generated_at=2026-07-03T10:46:36.232469+00:00 db=/home/eric-king/kalshi_favorites_bot/trades.db
- Lower rank_score means closer to review, not approval.
- 1. high_price_native_taker:crypto_last_hour_longshot_no | status=NATIVE_FORWARD_ACCUMULATING rank=0.0715 | 316 resolved 283W-33L -$4.14 | Wilson 85.7% vs target 92.8% | next=KXBTCD-26JUL0303-T61899.99 stale due=2026-07-03T06:59:59.313588+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
- 2. high_price_native_taker:weather_no_candidate:no_95_98_zero_loss_cities_v1 | status=NATIVE_FORWARD_ACCUMULATING rank=0.1298 | 50 resolved 48W-2L -$0.75 | Wilson 86.5% vs target 99.5% | next=KXHIGHMIA-26JUL02-B87.5 active due=2026-07-03T14:00:00+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
...
- 7. structural_arbitrage:same_strike_last_24h | status=WATCH_ONLY rank=1.0000 | 53170 observations | fresh_pairs=52832 execution_ready_tier=4833 gross_positive=1 execution_ready_gross_positive=0 qty10_positive=1 execution_ready_qty10_positive=0 best_gross_edge=0.02 | blockers=no_execution_ready_gross_positive, no_execution_ready_fee_net_qty10_positive | next=continue simultaneous quote scans; only trade fee-net positive executable dislocations
...
- recent_36h_backlog: unresolved=447 | expired_after_60s_grace=395 | oldest_expired=2026-07-02 13:59:59 | oldest_expected=2026-07-02 13:59:59
- recent_36h_crypto_backlog: unresolved=138 | expired_after_60s_grace=138 | oldest_expired=2026-07-03 06:59:59 | oldest_expected=2026-07-03 06:59:59
- native_gate_stale_unresolved=1
- resolved_last_30m=0
- all_expired_backlog: unresolved=6831 | crypto=6309 | other=352 | weather=170 | oldest_expired=2026-04-15 21:59:59 | newest_expired=2026-07-03 07:59:59
- legacy_pre36h_expired_backlog: unresolved=6436 | crypto=6171 | other=262 | weather=3 | oldest_expired=2026-04-15 21:59:59 | newest_expired=2026-07-02 13:59:59
...
- recent_72h_backlog: unresolved=506 | expired_after_60s_grace=332 | oldest_expired=2026-07-03 04:58:59 | oldest_expected=2026-07-03 04:58:59
...
-   5-10c: candidates=59994 fill=0.3% resolved=31 benign/toxic=9/22 net=$-13.96 benign=$+7.48 Wilson=70.1% BE=0.0% margin=+70.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   10-20c: candidates