...
last_updated_utc: 2026-07-02T23:10:01+00:00
pipeline_heartbeat_utc: 2026-07-02T23:10:01+00:00
generator: Codex generate_current_state.py
workspace_head: 0710930

## Chat Startup Critical Summary
- Generated for Claude-in-chat startup at 2026-07-02T18:10:01-05:00; missing artifacts render UNAVAILABLE instead of breaking sync.
- Full-picture artifact: FULL PICTURE - 2026-07-02 06:00 PM

### Reconciliation and Cash
- Gemini: Cash balance: $22.85
- Gemini reconciliation: Reconciliation: resolved_pnl=$-12871.19 open_cost=$0.80 open_fees=$0.07 recon_adj=$-2139.96 expected_cash=$22.85 cash_gap=$+0.00 unrealized=-$0.70 [MATCH]
- Kalshi: Cash balance: $1,189.55
- Kalshi reconciliation: Reconciliation: resolved_pnl=$-1498.89 open_cost=$1.33 open_fees=$0.04 recon_adj=$189.81 expected_cash=$1189.55 cash_gap=$+0.00 unrealized=$-0.69 [MATCH]
- IBKR: NLV: $1,949.48
- IBKR state: Status: ⚠️ Flex sync 193h stale | ❌ Gateway DOWN | ❌ KILL switch active
...
- Gemini reward quote pilot: ✓ Reward Quote Pilot: -$0.20 | 0W-2L | open: 7 | live reward quote pilot armed; governed by readiness and quote-manager gates
...
### Cost / Runway
- • MTD (through 2026-07-02): **$19.43**
- • Projected monthly total: **$301.15/mo**
- • API-realized net after external costs: **$-17078.09**
- • Gemini open positions: 7 trades, $9.50 at cost, $0.06 at mark
- • Combined true P&L: **$-16330.49**
- • True lifetime P&L (bots − one-time − recurring): **$-19184.51**
...
- pid: 5129
- nrestarts: 0
- active_enter: Mon 2026-06-22 20:08:51 CDT
- reconciliation:
  - • [Gemini] API Settlement/Cashout Reconciliation Adjustment: -$104.78 | 0W-1L | realized rows: 0 | fees: $0.00 | Gemini settled-positions API netProfit plus cashOuts wins over reconstructed DB sell/cost-basis P&L.
  - Reconciliation: resolved_pnl=$-12871.19 open_cost=$0.80 open_fees=$0.07 recon_adj=$-2139.96 expected_cash=$22.85 cash_gap=$+0.00 unrealized=-$0.70 [MATCH]
  - ✓ HARD CHECK PASSED — gap $0.00
  - Reconciliation adjustment: $-2139.96 (auto-computed from exchange balance)
  - Expected cash: $22.85
...
- strategy/cohort excerpts:
  - Live/tracked resolved P&L: -$0.20 across 2 resolved trades
  - API-verified full P&L (all historical strategies): -$12,975.97 across 2353 DB resolved rows (DB reconstruction -$12,871.19)
  - 24h P&L: +$0.00 (0W-0L resolved, 4 placed)
  - Today's P&L: +$0.00
  ...
  - • [Gemini] API Settlement/Cashout Reconciliation Adjustment: -$104.78 | 0W-1L | realized rows: 0 | fees: $0.00 | Gemini settled-positions API netProfit plus cashOuts wins over reconstructed DB sell/cost-basis P&L.
  - ✓ Gemini: lifetime -$12,975.97 / 2353 realized rows; bucket sum -$12,975.97 / 2353 rows
  - Next decision gate: 2026-07-03T00:30:00+00:00 - direct-index DS next resolution (156 rows/6 events unresolved | current qty5: 104 rows/6 events unresolved | micro qty1: 52 rows/6 events unresolved) resolution checks; no live expansion before event-collapsed results
...
- pid: 893461
- nrestarts: 0
- active_enter: Wed 2026-06-24 21:54:23 CDT
- reconciliation:
  - Reconciliation: resolved_pnl=$-1498.89 open_cost=$1.33 open_fees=$0.04 recon_adj=$189.81 expected_cash=$1189.55 cash_gap=$+0.00 unrealized=$-0.69 [MATCH]
  - ✓ HARD CHECK PASSED — gap $0.00
  - Reconciliation adjustment: $189.81 (auto-computed from exchange balance)
  - Expected cash: $1189.55
  - Actual cash (API): $1189.55
- selected env:
...
- strategy/cohort excerpts:
  - Lifetime P&L: -$1,242.55 across 3208 resolved trades
  - 24h P&L: -$0.14 (0W-3L resolved, 5 placed)
  - Historical realized buckets (13; sum must equal lifetime):
  - ✓ Kalshi: lifetime -$1,242.55 / 3208 realized rows; bucket sum -$1,242.55 / 3208 rows
  ...
  - Live-matched v2 (full filter stack): 337W-12L (96.6%) | maker +$1,336.00  -> taker +$621.81
  - Live-matched v2 first-ticker: 218W-12L (94.8%) | taker -$69.16 | Wilson 91.1% vs BE 95.1% | 7d -$242.73 | gate=NOT_LIVE_DEPLOYABLE
  - v1→v2 drops: tier=4951, volume=2785, excluded=1149, category=168, spread=55, nws=52, hours=36
  - [2.5] Moderate Favorites Pilot ($0.80-$0.85 only)
  - Validation vs shadow: shadow WR 82.5% / -$335.00 (spread<=0.05 + allowed assets, matches pilot) | live WR 82.8% | shadow P&L negative; no revival
  ...
  - Mean reversion shadow freshness: last_row=2026-04-22T03:02:54Z age=71.8d live_match_last=2026-04-21T02:43:31Z post_kill_shadow_rows=0 post_kill_live_placements=0 | gate=STALE_NO_FORWARD_EVIDENCE
  - Forecast accuracy (live-matched 0.85-0.90): 175W-22L (88.8%) | -$567.27
  - Forecast accuracy first-ticker live-match: 171W-20L (89.5%) | -$281.59 | Wilson 84.4% vs BE 90.3% | gate=CONTINUE_SHADOW
  - Forecast accuracy YES 90-93 above-live-threshold: event-first 115W-1L n=116 | +$1,652.43 avg_ask=0.915 | Wilson 95.3% vs BE 92.6% margin=+2.7pp | recent 35W-0L n=35 Wilson 90.1% vs BE 92.7% | pending=4 stale_pending=0 | gate=THIN_MARGIN_RECENT_UNDERPOWERED_FORWARD_ONLY | next_pending=KXLOWTCHI-26JUL02-B77.5 city=CHI due=2026-07-03T05:59:59.945606+00:00 ask=0.92 reason=ask_above_max(0.92>0.90)
  - Forecast accuracy high-ask NO event-first: ask>=0.98 all 926W-4L n=930 | +$1,686.86 avg_ask=0.986 | Wilson 98.9% vs BE 98.8%
  - Forecast accuracy high-ask NO ex-LAX: 850W-1L n=851 | +$2,076.68 avg_ask=0.986 | Wilson 99.3% vs BE 98.8% | unresolved_live_est_events=40 | gate=FORWARD_WATCH_ONLY
  - Forecast accuracy high-ask NO native preflight: rows=44706 events=176 actionable_qty1=828 latest=2026-07-02T23:05:31+00:00 | reasons: missing_native_no_ask=39758, nonpositive_qty1_win:0.0000=3019, actionable_qty1_fee_positive=828, native_no_ask_out_of_band:0.9700=238 | latest_run=2026-07-02T23:05:31+00:00 candidates=20 checked=20 actionable=1 run_reasons={"actionable_qty1_fee_positive": 1, "missing_native_no_ask": 19}
  - Forecast accuracy high-ask NO latest actionables: captured=2026-07-02T23:05:31+00:00 events=20 actionable_events=1 best=KXLOWTCHI-26JUL02-T73 city=CHI event=KXLOWTCHI-26JUL02 due=2026-07-03T19:00:00+00:00 no_ask=0.98 depth=4.00 win1=+$0.01 loss1=-$0.99
  - Forecast accuracy high-ask NO native gate: native_events=45 resolved=42 pending=3 41W-1L native_pnl=-$0.58 Wilson 87.7% vs BE 99.0% next_pending=KXHIGHCHI-26JUL02-B99.5 city=CHI event=KXHIGHCHI-26JUL02 due=2026-07-03T14:00:00+00:00 ttl=32.0h no_ask=0.98 depth=1.00 win1=+$0.01 loss1=-$0.99
  - Forecast accuracy NO candidate-cell preflight: rows=28965 cohorts=2 events=67 actionable_qty1=8242 latest=2026-07-02T23:06:21+00:00 | latest_run=2026-07-02T23:06:21+00:00 candidates=15 checked=15 actionable=3 run_reasons={"no_90_95_min_probe_v1:missing_native_no_ask": 1, "no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive": 3, "no_95_98_zero_loss_cities_v1:missing_native_no_ask": 8, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9300": 1, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9900": 2}
  - Forecast accuracy NO candidate-cell cohorts: no_95_98_zero_loss_cities_v1 rows=26204 events=67 actionable=7539; no_90_95_min_probe_v1 rows=2761 events=8 actionable=703
  - Forecast accuracy NO candidate-cell latest cohort actionables: no_90_95_min_probe_v1 captured=2026-07-02T23:06:21+00:00 events=1 actionable_events=0 top_reason=missing_native_no_ask; no_95_98_zero_loss_cities_v1 captured=2026-07-02T23:06:21+00:00 events=14 actionable_events=3 best=KXHIGHTDAL-26JUL03-B101.5 city=DAL event=KXHIGHTDAL-26JUL03 due=2026-07-04T19:00:00+00:00 no_ask=0.96 depth=40.99 win1=+$0.03 loss1=-$0.97
  - Forecast accuracy NO candidate-cell historical control: all-city 95-98 884W-25L n=909 Wilson 96.0% vs BE 96.7%; selected-cities 302W-2L n=304 Wilson 97.6% vs BE 96.8%; weakest_city=AUS 39W-1L n=40 Wilson 87.1% vs BE 96.8% | selected-city filter is in-sample; no live order
  - Forecast accuracy NO candidate-cell forward gate: no_90_95_min_probe_v1 native_events=8 resolved=7 pending=1 6W-1L native_pnl=-$0.63 Wilson 48.7% vs BE 94.8% next_pending=KXHIGHTMIN-26JUL02-B93.5 city=MIN event=KXHIGHTMIN-26JUL02 due=2026-07-03T19:00:00+00:00 ttl=37.8h no_ask=0.94 depth=3.00 win1=+$0.05 loss1=-$0.95; no_95_98_zero_loss_cities_v1 native_events=64 resolved=50 pending=14 48W-2L native_pnl=-$0.75 Wilson 86.5% vs BE 97.5% next_pending=KXHIGHMIA-26JUL02-B87.5 city=MIA event=KXHIGHMIA-26JUL02 due=2026-07-03T14:00:00+00:00 ttl=47.7h no_ask=0.96 depth=13.00 win1=+$0.03 loss1=-$0.97
  ...
  - Legacy weather-city NO shadow: bid>=0.88 first-ticker-side 5326W-255L n=5581 | +$10,103.14 | avg_bid=0.932 | Wilson 94.9% vs modeled BE 93.6% margin=+1.2pp | pending=212 | gate=LEGACY_MAKER_FORWARD_REQUIRED
  - Legacy weather-city NO recency: since_2026-06-17 1914W-76L n=1990 +$3,787.47 pending=210 Wilson 95.2% vs modeled BE 94.3% | forward_since_2026-06-25T09:35Z resolved=847 pending=210 | blocked 1527W-85L +$1,848.43, unblocked 3799W-170L +$8,254.71 | best=KXLOWTNYC 219W-5L +$1,041.65; worst=KXLOWTDEN 220W-19L -$380.38 | next_pending=KXHIGHMIA-26JUL02-B93.5 city=MIA due_est=2026-07-03T04:58:59.011499+00:00 ttl_at_capture=37.9h bid=0.92 overdue_pending=2 | bid-side/maker-priced shadow, not taker-executable
  - Legacy weather-city NO event collapse: event-side 1063W-17L n=1080 +$3,748.41 pending=48 Wilson 97.5% vs modeled BE 95.0% margin=+2.5pp | recent_event_side 376W-8L n=384 Wilson 95.9% vs BE 95.6% | forward_event_side resolved=168 pending=48 | gate=EVENT_MAKER_FORWARD_REQUIRED
  - Legacy weather-city NO maker/cancel proxy: v2 side_bid>=0.88 candidates=107 markets=53 fills=34 pending_fills=7 resolved_indep=27/50 27W-0L pnl=+$17.51 Wilson 87.5% vs modeled BE 93.5% | cancels=73 late_cross_ttl=15 open=0 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range bid-side shadow: side-aware ticker+side first rows 597W-0L n=597 | +$3,684.42 | Wilson 99.4% vs modeled BE 93.8% | pending=0 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range bid-side recency: since_2026-06-17 119W-0L n=119 +$719.98 pending=0 | forward_since_2026-06-25T07:30Z resolved=72 pending=0 | YES 59W-0L pending=0, NO 43W-0L pending=0 | bid-side shadow, not taker-executable
  - Crypto price-range bid-side event collapse: event-side 102W-0L n=102 +$621.96 pending=0 Wilson 96.4% vs BE 93.9% margin=+2.5pp | event_only 69W-0L n=69 Wilson 94.7% vs BE 93.9% margin=+0.8pp | recent_event_side 30W-0L n=30 Wilson 88.6% vs BE 93.9% | forward_event_side resolved=18 pending=0 | gate=RECENT_EVENT_UNDERPOWERED_MAKER_FORWARD_REQUIRED
  - Crypto long-expiry bid-side shadow: 24-72h bid=0.90-0.95 event-side 61W-0L n=61 | +$450.69 | avg_bid=0.921 | Wilson 94.1% vs modeled BE 92.6% margin=+1.5pp | pending=14 | gate=NO_GO_EVENT_ONLY_COLLAPSE
  - Crypto long-expiry bid-side collapse: event_only 34W-0L n=34 +$240.24 Wilson 89.8% vs BE 92.9% | ticker-side_raw 382W-2L n=384 +$2,766.75 pending=119 | YES 33W-0L pending=7, NO 28W-0L pending=7
  - Crypto long-expiry bid-side recency: since_2026-06-17 event-side 16W-0L n=16 +$115.94 pending=10 Wilson 80.6% vs modeled BE 92.8% | forward_since_2026-06-25T09:50Z resolved=1 pending=6 | next_pending=KXSOLD-26JUL0317-T64.9999 side=YES due_est=2026-07-03T20:59:59.105673+00:00 ttl_at_capture=71.7h bid=0.94 overdue_pending=8 | bid-side/maker-priced shadow, not taker-executable
  - Crypto long-expiry maker/cancel proxy: v2 crypto side_bid=0.90-0.95 candidates=452 markets=241 fills=97 pending_fills=0 resolved_indep=97/50 89W-8L pnl=-$18.13 Wilson 84.6% vs modeled BE 93.6% | 24hplus_candidates=93 24hplus_fills=9 24hplus_pending_fills=0 | cancels=336 late_cross_ttl=40 open=19 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel shadow: v2 side_bid=0.92-0.94 candidates=237 markets=137 fills=54 filled_units=54 pending_fills=0 resolved_indep=54/50 50W-4L pnl=-$8.59 Wilson 82.4% vs modeled BE 94.2% | cancels=174 late_cross_ttl=21 open=9 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel sides: NO rows=124 markets=64 fills=20 pending=0 resolved_rows=20; YES rows=113 markets=73 fills=34 pending=0 resolved_rows=34 | source=kalshi_high_price_maker_cancel_shadow | no live orders
  - Crypto legacy taker NO shadow: ask=0.90-0.95 12-24h first-ticker-side 243W-14L n=257 | +$648.32 | avg_ask=0.915 | Wilson 91.1% vs modeled BE 92.0% margin=-1.0pp | pending=0 | gate=NO_GO
  - Crypto favorite taker native preflight: rows=9176 cohorts=2 contracts=50 actionable_obs=1935 latest=2026-07-02T20:55:22+00:00 | latest_run=2026-07-02T23:07:22+00:00 candidates=0 checked=0 actionable=0 reasons={} | no order path
  - Crypto favorite taker native cohorts: crypto_near_certain_95_99_12_24h rows=7399 contracts=40 actionable_obs=1549; crypto_favorite_no_90_95_12_24h rows=1777 contracts=10 actionable_obs=386
  - Crypto favorite taker latest cohort actionables: crypto_favorite_no_90_95_12_24h captured=2026-07-02T20:55:22+00:00 contracts=2 actionable_contracts=1 best=KXSOLD-26JUL0217-T80.9999 side=NO asset=SOL event=KXSOLD-26JUL0217 due=2026-07-02T20:59:59.449538+00:00 ask=0.91 depth=100.44 win1=+$0.08 loss1=-$0.92; crypto_near_certain_95_99_12_24h captured=2026-07-02T20:55:22+00:00 contracts=6 actionable_contracts=0
  - Crypto favorite taker native gate: crypto_favorite_no_90_95_12_24h first_actionable_contracts=8 resolved=8 pending=0 7W-1L native_pnl=-$0.36 Wilson 52.9% vs BE 92.0% gate=NATIVE_FORWARD_ACCUMULATING; crypto_near_certain_95_99_12_24h first_actionable_contracts=37 resolved=37 pending=0 36W-1L native_pnl=-$0.12 Wilson 86.2% vs BE 97.6% gate=NATIVE_FORWARD_ACCUMULATING
  ...
  - Crypto contrarian NO recency: since_2026-06-17 13W-14L n=27 +$638.16 pending=0 Wilson 30.7% vs modeled BE 24.5% | forward_since_2026-06-25T10:40Z resolved=9 pending=0 | 2026-04 8W-27L -$37.12, 2026-06 13W-11L +$711.92 | BTC 8W-18L +$167.58 pending=0, ETH 9W-9L +$477.11 pending=0, SOL 4W-14L -$43.65 pending=1 | next_pending=KXSOLD-26APR2417-T83.9999 event=KXSOLD-26APR2417 due_est=2026-04-24T20:59:59.002927+00:00 ttl=-1658.2h ask=0.22 spread=0.09 active_pending=0 stale_pending=1 unknown_pending=0 | exploratory ask-priced shadow; no live orders
  - Crypto last-hour longshot NO shadow: event-first 1167W-74L n=1241 | +$6,318.85 avg_ask=0.882 | Wilson 92.6% vs modeled BE 89.0% | recent 746W-60L +$2,485.03 | gate=LIQUIDITY_PROXY_FAIL_FORWARD_ONLY
  - Crypto last-hour longshot liquidity: volume=0 595W-8L +$6,810.50; volume>=500/spread<=5c 371W-40L -$202.50 Wilson 87.0% vs BE 90.8%; 80-85c volume-backed 32W-5L +$100.88 Wilson 72.0% vs BE 83.8%; 90-95c volume-backed 246W-20L -$88.28 Wilson 88.7% vs BE 92.8%; 95-99c volume-backed 560W-22L -$530.60 Wilson 94.3% vs BE 97.1%; forward_since_2026-06-25T11:20Z 370W-36L +$499.25 Wilson 88.0% vs BE 89.9% resolved=406 pending=3 | no live orders
  - Crypto last-hour longshot native preflight: rows=5216 events=408 actionable_qty1=1362 latest=2026-07-02T23:08:41+00:00 | latest_run=2026-07-02T23:08:41+00:00 candidates=3 checked=3 actionable=1 reasons={"actionable_qty1_fee_positive": 1, "missing_native_no_ask": 1, "native_no_ask_out_of_band:0.9900": 1} | no order path
  - Crypto last-hour longshot latest actionables: captured=2026-07-02T23:08:41+00:00 events=3 contracts=3 actionable_contracts=1 best=KXSOLD-26JUL0220-T80.9999 asset=SOL event=KXSOLD-26JUL0220 due=2026-07-02T23:59:59.120549+00:00 no_ask=0.92 depth=500.00 win1=+$0.07 loss1=-$0.93
  - Crypto last-hour longshot native gate: native_events=305 resolved=304 pending=1 active_pending=1 stale_pending=0 unknown_pending=0 273W-31L native_pnl=-$3.21 Wilson 85.9% vs BE 90.9% next_pending=KXSOLD-26JUL0220-T80.9999 asset=SOL event=KXSOLD-26JUL0220 due=2026-07-02T23:59:59.120549+00:00 no_ask=0.88 depth=200.00 win1=+$0.11 loss1=-$0.89 | gate=NATIVE_FORWARD_ACCUMULATING
  ...
  - Weather near-expiry favorite shadow: 1-4h ask>=0.90 event-first 46W-0L n=46 +$261.00 avg_ask=0.943 Wilson 92.3% vs modeled BE 94.7% pending=0 overdue_pending=0 | gate=UNDERPOWERED_BELOW_BREAKEVEN
  - Weather near-expiry favorite recency: since_2026-06-17 31W-0L n=31 +$185.00 pending=0 Wilson 89.0% vs modeled BE 94.4% | best_event_price_cell=2-4h/p90_95 28W-0L n=28 +$212.00 pending=0 | next_pending=none | ask-priced near-expiry shadow; no live orders
  - Commodity WTI high-bid blocked shadow: NO first-market 174W-5L n=179 +$854.40; event-side 22W-1L n=23 +$60.78 Wilson 79.0% vs BE 93.0% | YES first-market 112W-6L n=118 +$249.96; event-side 21W-3L n=24 -$126.06 Wilson 69.0% vs BE 92.8% | gate=EVENT_FORWARD_N50_REQUIRED
  - Commodity WTI blocked recency: since_2026-06-17 event-side NO 6W-0L n=6 +$35.48 pending=0, YES 3W-1L n=4 -$75.72 pending=1 | blocked-category diagnostic; no live orders
  - Commodity WTI contrarian NO longshot: event-side 5W-14L n=19 +$218.01 Wilson 11.8% vs BE 14.8% pending_events=1 | first-market 12W-54L n=66 +$421.90 | gate=EVENT_FORWARD_N50_REQUIRED
  - Commodity WTI contrarian recency: since_2026-06-17 event-side 2W-7L n=9 +$66.40 pending=1 | ask-priced live_match; high-variance longshot; no live orders
  ...
  - Summary: rows=6936 open=187 fills=1732 markets=1562 cancels=5017 late_cross_ttl=430 resolved=1238 markets=1152 pnl=-2585.17 last=2026-07-02T23:01:35+00:00
  - Pending fills: unresolved=494 markets=410 next=KXMLBSPREAD-26JUN291910WSHBOS-WSH3 sports NO close=2026-07-02T23:10:00+00:00 expiration=2026-07-02T23:10:00+00:00 | units=494 active=487 stale=7 unknown=0
  - Overall independent fills: resolved=1238 827W-411L pnl=-2585.17 wilson_low=64.1% breakeven=87.7% toxic=411 status=NO_GO_REVIEW
  - Review progress: best_cell=sports NO resolved_independent=342/50 indep=262W-80L pnl=-371.32 wilson_low=71.8% breakeven=87.5% toxic=80 pending_markets=296 filled_markets=638 next_close=2026-07-02T23:10:00+00:00 status=NO_GO_REVIEW
  - Cell scan: resolved_cells=7 edge_positive_cells=0 leader=sports NO resolved_indep=342 best_edge_positive=none best_alternate=crypto YES resolved_indep=293 167W-126L pnl=-864.29 wilson_low=51.3% breakeven=86.5% toxic=126 status=NO_GO_REVIEW
  - KALSHI CRYPTO LOW-PRICE NO CELL AUDIT
  - Status: SHADOW_ONLY | broad low-price NO kill=present | standard DS kill=present
  - NO <10c first-market: n=141 125W-16L wr=88.7% wilson_low=82.4% breakeven=4.6% pnl=+118.95 avg=+0.8436
  - NO <10c first-eligible: n=203 186W-17L wr=91.6% wilson_low=87.0% breakeven=4.9% pnl=+176.70 avg=+0.8704
  - NO <10c concentration: underliers=3 top=BTC n=149 share=73.4% pnl=+130.30 worst=SOL n=27 pnl=+21.61
  - NO <10c day stability: days=3 positive=3 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - NO <10c UTC-hour stability: hours=19 positive=18 losing=1 worst=19Z n=2 pnl=-0.06
  - Post-kill NO <10c first-market: n=141 125W-16L wr=88.7% wilson_low=82.4% breakeven=4.6% pnl=+118.95 avg=+0.8436
  - Post-kill NO <10c first-eligible: n=203 186W-17L wr=91.6% wilson_low=87.0% breakeven=4.9% pnl=+176.70 avg=+0.8704
  - Review: post-kill NO <10c first-eligible progress 203/50 status=NOT_READY reason=native taker NO ask <10c evidence absent
  - Post-kill NO <10c first-eligible concentration: underliers=3 top=BTC n=149 share=73.4% pnl=+130.30 worst=SOL n=27 pnl=+21.61
  - Post-kill NO <10c first-eligible day stability: days=3 positive=3 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - Post-kill NO <10c first-eligible UTC-hour stability: hours=19 positive=18 losing=1 worst=19Z n=2 pnl=-0.06
  - Post-kill NO <10c first-eligible loss cluster: losses=17 loss_hours=5 top_hour=03Z top_hour_losses=6/17 share=35.3% top_underlier=BTC 4/6 | excluding_top_loss_hour=POST_HOC_FORWARD_ONLY n=193 182W-11L pnl=+173.13 Wilson 90.1% vs modeled BE 4.9%
  - Post-kill NO <10c first-eligible source provenance: rows=203 sources=1 top=kalshi.shadow_deterministic_settlement n=203 distinct_source_row_ids=203 missing_source_row_ids=0
  - Post-kill NO <10c first-eligible native source check: source_ids=203 checked=198 native_taker_ask_lt10c=0/198 min=0.6900 avg=0.9628 max=0.9900
  - Fresh non-04Z NO <10c first-eligible: n=191 174W-17L wr=91.1% wilson_low=86.2% breakeven=4.9% pnl=+165.28 avg=+0.8653
  - Forward gate: fresh non-04Z NO <10c first-eligible start=2026-06-25T08:30:00+00:00 excluded_hour=04Z progress 191/50 pending_markets=0 status=NOT_READY reason=wilson 86.2% < 90.0%; native taker NO ask <10c evidence absent
  - Fresh non-04Z NO <10c first-eligible pending horizon: resolved=191/50 pending_markets=0 max_if_all_pending_resolve=50/50 need_new_after_pending=0 next_due=unknown last_due=unknown next_backfill_after=unknown last_backfill_after=unknown
  - Fresh 04Z excluded-control NO <10c first-eligible: n=13 13W-0L wr=100.0% wilson_low=77.2% breakeven=5.2% pnl=+12.37 avg=+0.9515
  - Fresh non-04Z NO <10c first-eligible source provenance: rows=191 sources=1 top=kalshi.shadow_deterministic_settlement n=191 distinct_source_row_ids=191 missing_source_row_ids=0
  - Fresh non-04Z NO <10c first-eligible native source check: source_ids=191 checked=186 native_taker_ask_lt10c=0/186 min=0.6900 avg=0.9627 max=0.9900
  - Fresh non-04Z NO <10c first-eligible concentration: underliers=3 top=BTC n=140 share=73.3% pnl=+121.74 worst=SOL n=26 pnl=+20.66
  - Fresh non-04Z NO <10c first-eligible day stability: days=3 positive=3 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - Fresh non-04Z NO <10c first-eligible UTC-hour stability: hours=18 positive=17 losing=1 worst=19Z n=2 pnl=-0.06
  ...
  - Post-kill NO <10c first-eligible pending horizon: resolved=203/50 pending_markets=0 max_if_all_pending_resolve=50/50 need_new_after_pending=0 next_due=unknown last_due=unknown next_backfill_after=unknown last_backfill_after=unknown
  - Post-kill NO <10c first-eligible live pending preview: pending_first_eligible=0 live_actionable=0 settlement_pending_or_ineligible=0 now=2026-07-02T23:10:17+00:00 | no order path
  - Pilot readiness: NOT_READY | proposed_strategy=kalshi_crypto_no_lt10c_first_eligible_pilot | new identity required; do not revive ds_low_price_no | reason=wilson 87.0% < 90.0%; native taker NO ask <10c evidence absent
  ...
  - FX first-symbol: 9W-124L n=133 | P&L -$1,051.29 | Wilson 3.6% vs BE 23.5% | native_NO 100.0% | side_match 100.0% | live YES/NO 126/7
  - INDEX first-symbol: 20W-351L n=371 | P&L -$397.89 | Wilson 3.5% vs BE 7.6% | native_NO 100.0% | side_match 100.0% | live YES/NO 371/0
  - Raw predicate: 38W-9L n=47 | P&L -$68.43 | Wilson 67.5% vs BE 86.7%
  - First-symbol: 34W-8L n=42 | P&L -$59.41 | Wilson 66.7% vs BE 86.6%
  - Pending predicate rows: 5
  - Review: first-30 progress 47/30 status=FAILED
  - KALSHI INDEX/FX SIDE-EQUIVALENCE FS SHADOW
  - Status: REJECTED_NATIVE_CONTROL | no live pilot
  - Pending native-actionable rows: FX=339, INDEX=1717
  - Gate: failed; native executable rows disprove Index/FX favorite-tracking salvage

## Storage State
- DATABASE STORAGE HEALTH
-   Overall status: GREEN / TARGET
-   Disk: 165.01 GiB used / 936.79 GiB total (17.6%), 724.12 GiB free
-   Envelope: TARGET 50.0%, WARN 65.0%, CRITICAL 75.0%, HARD_LIMIT 85.0%
-   DS storage: active 1.17 GiB (state TARGET), hot 30.09 GiB, warm 0.02 GiB, cold 0.00 GiB, archive_state TARGET_EXCEEDED, total 31.30 GiB (3.3% of disk)
-   Archive sidecars: OK
...
-   Tier rotation: last=2026-07-02T18:18:25+00:00 status=DRY_RUN actions=1
-   Autonomous maintenance: last=2026-07-02T10:46:46+00:00 status=OK backups=4/5 integrity_failures=1 drift_flags=0
...
- latest_run: id=13 captured_at=2026-07-02T22:40:40+00:00 | markets_seen=120000 post_expiration_open_unresolved=56 candidate_count=0 | direct_market_recheck=True pages=120 page_cap=True rate_limited=False | trigger_fields={"expected_expiration_time": 56} | top_series=KXMVESPORTSMULTIGAMEEXTENDED=56
...
- latest_run: id=14 captured_at=2026-07-02T23:04:10+00:00 | mode=series_tickers series=50 offset=450 max_series=50 discovered_to_window_end=500 regex=1 prefix=0 markets_seen=441 grouped_markets=441 duplicate_groups=0 candidate_count=0 | pages=50 page_cap=false rate_limited=false | top_series=KXPGATOP20=283, KXTNPRIMARY=51, KXCS2MAP=48, KXTAYLORSWIFTWEDDING=17, KXWTAGRANDSLAM=15
...
- latest_run: id=11 captured_at=2026-07-02T23:05:45+00:00 | mode=series_tickers series=50 offset=450 max_series=50 discovered_to_window_end=500 regex=1 prefix=0 markets=232 parsed=0 groups=0 relations=0 candidates=0 | pages=50 page_cap=false rate_limited=false | top_series=KXNCAAFPLAYOFF=50, KXNCAAFSF=50, KXTOPALBUM=44, KXACQANNOUNCEANNUAL=23, KXNCAAFACC=17 | parse_rejects=not_strict_binary_labels=232
...
- latest_run: captured_at=2026-07-02T18:46:19+00:00 | mode=series_mode series=102 regex=1 prefix=0 markets_seen=160 parsed_markets=125 parsed_events=41 groups=21 orderbooks=88 candidates=0 best_edge=none | pages=102 page_cap=false rate_limited=false | top_series=KXALBUMRELEASEDATE=12, KXPOPEVISIT=12, KXGPT=10, KXSPOTIFYWRAPPEDRELEASE=9, KXLUCEDELIVERY=8
...
- latest_run: id=29 captured_at=2026-07-02T23:08:51+00:00 | mode=series_tickers series=50 offset=550 max_series=50 discovered_to_window_end=600 regex=1 prefix=0 markets=567 parsed=132 families=27 multi_row=27 relations=156 candidates=0 top_net=-22.0pp | pages=50 page_cap=false rate_limited=false
- nearest_relations: KXKBOTOTAL KXKBOTOTAL-26JUL030530SAMSSG above loose=KXKBOTOTAL-26JUL030530SAMSSG-10(9.5)@0.53 strict=KXKBOTOTAL-26JUL030530SAMSSG-12(11.5)@0.65 net=-22.0pp ; KXKBOTOTAL KXKBOTOTAL-26JUL030530DOOKIW above loose=KXKBOTOTAL-26JUL030530DOOKIW-6(5.5)@0.68 strict=KXKBOTOTAL-26JUL030530DOOKIW-8(7.5)@0.51 net=-23.0pp ; KXWNBAPTS KXWNBAPTS-26JUL02SEAPHX at_least loose=KXWNBAPTS-26JUL02SEAPHX-SEAEMAGBEGOR13-10(10.0)@0.21 strict=KXWNBAPTS-26JUL02SEAPHX-SEAEMAGBEGOR13-15(15.0)@0.99 net=-23.0pp ; KXKBOTOTAL KXKBOTOTAL-26JUL030530HANLG above loose=KXKBOTOTAL-26JUL030530HANLG-8(7.5)@0.61 strict=KXKBOTOTAL-26JUL030530HANLG-10(9.5)@0.60 net=-25.0pp ; KXWNBAPTS KXWNBAPTS-26JUL02ATLWSH at_least loose=KXWNBAPTS-26JUL02ATLWSH-ATLJCANADA3-15(15.0)@0.29 strict=KXWNBAPTS-26JUL02ATLWSH-ATLJCANADA3-20(20.0)@0.94 net=-26.0pp
...
- latest_run: id=13 captured_at=2026-07-02T23:06:34+00:00 | mode=series_tickers series=50 offset=500 max_series=50 discovered_to_window_end=550 regex=1 prefix=0 markets=322 parsed=40 groups=11 partitions=0/6 candidates=0 | pages=50 page_cap=false rate_limited=false | top_series=KXNCAAFTOPAPRANK=170, KXWCSOA=95, KXLOWTPHIL=12, KXLOWTBOS=12, KXCANOREOY=8 | non_partition=gap_between_intervals=4, missing_lower_tail=2
...
- latest_run: id=15 captured_at=2026-07-02T23:07:56+00:00 | mode=series_tickers series=50 offset=550 max_series=50 discovered_to_window_end=600 regex=1 prefix=0 markets=614 parsed=178 groups=27 relations=26 candidates=0 | pages=50 page_cap=false rate_limited=false | top_series=KXLOVEISLANDUSARANK=427, KXWCTOTAL=60, KXWNBATOTAL=45, KXCFLSPREAD=40, KXH100MON=20 | parse_rejects=not_interval_title=436
...
- latest_run: id=16 captured_at=2026-07-02T23:07:18+00:00 | mode=series_tickers series=50 offset=500 max_series=50 discovered_to_window_end=550 regex=1 prefix=0 markets=215 parsed=180 groups=24 relations=5 candidates=0 | pages=50 page_cap=false rate_limited=false | top_series=KXFED=98, KXWNBASPREAD=52, KXAAAGASMAX=13, KXHIGHMIA=12, KXHIGHTLV=12 | parse_rejects=not_single_threshold_title=35
...
- latest_run: id=11 captured_at=2026-07-02T22:40:40+00:00 | markets_seen=120000 post_close_open_unresolved=0 candidates=0 min_age_min=1.00 max_ask=0.25 max_spread=0.15 min_depth=1 | pages=120 page_cap=true rate_limited=false | categories=none | top_series=unknown
...
- latest_run: id=13 captured_at=2026-07-02T22:40:40+00:00 | markets_seen=120000 public_result_active=0 candidates=0 max_ask=0.25 max_spread=0.15 min_depth=1 | pages=120 page_cap=true rate_limited=false | results=none | categories=none | top_series=unknown
...
- latest_run: id=10 captured_at=2026-07-02T20:30:15+00:00 | version=event_result_propagation_v1 events_seen=7000 events_examined=3165 mutex_events=1001 details=1000/1000 detail_cap=true markets=6747 locked=0 actionable_qty1=0 max_ask=0.25 min_depth=1 | pages=35 page_cap=true rate_limited=false | reasons=event_not_mutually_exclusive_summary=2164, no_exhaustive_proof=1000, detail_cap_reached=1
...
- latest_run: id=15 captured_at=2026-07-02T22:52:11+00:00 | events_seen=6994 mutex_events=3005 details=1200/1200 markets=9667 tradable_no=4849 candidates=0 top_net=-1.0pp | pages=35 page_cap=false rate_limited=false | categories=Sports=1487, Elections=1084, Entertainment=159, Climate and Weather=88, Economics=74, Politics=41 | detail_errors=none
- nearest_no_bundles: KXHOUSERACE-CO04-26 KXHOUSERACE k=2 floor=1.00 cost=0.97 fees=0.04 net=-1.0pp tickers=KXHOUSERACE-CO04-26-R,KXHOUSERACE-CO04-26-D ; SENATESC-26 SENATESC k=2 floor=1.00 cost=0.99 fees=0.02 net=-1.0pp tickers=SENATESC-26-R,SENATESC-26-D ; KXHOUSERACE-SC04-26 KXHOUSERACE k=2 floor=1.00 cost=0.99 fees=0.02 net=-1.2pp tickers=KXHOUSERACE-SC04-26-R,KXHOUSERACE-SC04-26-D ; GOVPARTYNY-26 GOVPARTYNY k=2 floor=1.00 cost=1.00 fees=0.02 net=-1.6pp tickers=GOVPARTYNY-26-D,GOVPARTYNY-26-R ; KXNCAAFCONF-26 KXNCAAFCONF k=5 floor=4.00 cost=3.95 fees=0.07 net=-2.0pp tickers=KXNCAAFCONF-26-B10,KXNCAAFCONF-26-SEC,KXNCAAFCONF-26-OTHER
- unsafe_all_yes_positive_requires_exhaustive_validation: count=21 best_net=+72.7pp
...
- latest_run: id=8 captured_at=2026-07-02T16:38:46+00:00 | version=event_exhaustive_yes_v2_esports events_seen=241 event_details=241 baskets_checked=183 actionable_qty1=0 min_net_edge=0.010 | series=14 page_limits=[200] | counts=KXATPCHALLENGERMATCH=3, KXITFMATCH=36, KXITFWMATCH=30, KXLOLGAME=14, KXLOLMAP=20, KXMLBGAME=37, KXNBAGAME=0, KXNHLGAME=0 | reasons=exhaustive_basket_checked=183, two_way_sports_shape_mismatch=48, not_all_active_yes_tradable=6, event_not_mutually_exclusive=2, two_way_no_tie_match_shape_mismatch=2
- nearest_baskets: KXITFMATCH-26JUL02ZAMROD two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=3 actionable=0 ; KXITFMATCH-26JUL02TAIADD two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=4715 actionable=0 ; KXITFMATCH-26JUL02KHODEL two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=947 actionable=0 ; KXWTAMATCH-26JUL03MUCSAW two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=201 actionable=0 ; KXWTAMATCH-26JUL03LIUGAU two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=1039 actionable=0
...
- reasons: wilson 87.0% < 90.0%; open_filled_trades=7; source reconciliation checked 399/203; source reconciliation mismatches 40; native taker NO ask <10c evidence absent
- resolved: 203/50 | 186W-17L | pnl=+176.70 | wilson=87.0%
- pending: 0 markets | max_if_pending=50/50 | need_new_after_pending=0
- risk: open_filled=7 | sports_open=0 | live_maker_open_like=0
- source_reconciliation: checked=399/399 | mismatches=40 | native_taker_ask_lt10c=0/394
...
- fresh_non04z_review: status=NOT_READY | ready=false | reason=fresh gate status NOT_READY; wilson 86.2% < 90.0%; open_filled_trades=7; source reconciliation checked 350/191; source reconciliation mismatches 40; native taker NO ask <10c evidence absent | resolved=191/50 | 174W-17L | pnl=+165.28 | wilson=86.2% | pending=0 | shadow_live_actionable=0 | native_taker_actionable=0 | native_taker_blocked=0 | expired_unresolved=0 | next_backfill_after=unknown | source_reconciliation=350/350 mismatches=40 | native_taker_ask_lt10c=0/345
...
- status: NO_LIVE_READY | ready=false | cells=9 | ready_cells=0 | min_resolved=30 | edge_buffer=+2.0pp | pending=22 active=22 stale=0 unknown=0 | next_pending=crypto_last_hour_longshot_no:KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00
- best: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=305 resolved=304 pending=1 active=1 stale=0 unknown=0 | 273W-31L | pnl=-3.21 | Wilson 85.9% vs BE 90.9% | gap=-5.0pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=304 | next_pending=KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00 ask=0.88
- rank 1: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=305 resolved=304 pending=1 active=1 stale=0 unknown=0 | 273W-31L | pnl=-3.21 | Wilson 85.9% vs BE 90.9% | gap=-5.0pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=304 | next_pending=KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00 ask=0.88
- rank 2: weather_no_candidate:no_95_98_zero_loss_cities_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=64 resolved=50 pending=14 active=14 stale=0 unknown=0 | 48W-2L | pnl=-0.75 | Wilson 86.5% vs BE 97.5% | gap=-11.0pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=1502 | next_pending=KXHIGHMIA-26JUL02-B87.5 status=active due=2026-07-03T14:00:00+00:00 ask=0.96
- rank 3: weather_high_ask_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=45 resolved=42 pending=3 active=3 stale=0 unknown=0 | 41W-1L | pnl=-0.58 | Wilson 87.7% vs BE 99.0% | gap=-11.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=>5000_or_target_impossible | next_pending=KXHIGHCHI-26JUL02-B99.5 status=active due=2026-07-03T14:00:00+00:00 ask=0.98
- rank 4: crypto_favorite_taker:crypto_near_certain_95_99_12_24h | gate=NATIVE_FORWARD_ACCUMULATING | native_events=37 resolved=37 pending=0 active=0 stale=0 unknown=0 | 36W-1L | pnl=-0.12 | Wilson 86.2% vs BE 97.6% | gap=-11.4pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=1457
- rank 5: weather_yes_90_93:yes_90_93_above_live_threshold_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=19 resolved=16 pending=3 active=3 stale=0 unknown=0 | 16W-0L | pnl=+1.19 | Wilson 80.6% vs BE 92.5% | gap=-11.9pp | blockers=resolved<30; wilson<BE+2pp | perfect_wins_needed=51 | next_pending=KXLOWTCHI-26JUL02-B77.5 status=active due=2026-07-03T19:00:00+00:00 ask=0.91
...
- status: NO_NATIVE_CUT_READY | ready=false | observations=13898 | cuts=2261 | display_cuts=465 | candidate_cuts=0 | ready_cuts=0 | min_resolved=30 | min_display_resolved=10 | edge_buffer=+2.0pp | scope=posthoc_native_executable_cut_discovery_requires_predeclared_forward_gate
...
- rank 2: crypto_last_hour_longshot_no|minutes_to_expiry_band=20-40m|native_ask_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=52 resolved=52 pending=0 active=0 stale=0 unknown=0 | 49W-3L | pnl=+$5.42 | Wilson 84.4% vs target 85.8% (BE 83.8%) | gap=-1.5pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=6
- rank 3: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=74 resolved=73 pending=1 active=1 stale=0 unknown=0 | 72W-1L | pnl=+$4.21 | Wilson 92.6% vs target 94.9% (BE 92.9%) | gap=-2.2pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=34 | next_pending=KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00 ask=0.92
- rank 4: crypto_last_hour_longshot_no|native_ask_band=85-90 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=173 resolved=172 pending=1 active=1 stale=0 unknown=0 | 156W-16L | pnl=+$4.01 | Wilson 85.4% vs target 90.4% (BE 88.4%) | gap=-4.9pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=92 | next_pending=KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00 ask=0.88
- rank 5: crypto_last_hour_longshot_no|shadow_spread_band=<=1c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=215 resolved=215 pending=0 active=0 stale=0 unknown=0 | 199W-16L | pnl=+$2.20 | Wilson 88.3% vs target 93.5% (BE 91.5%) | gap=-5.3pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=181
- rank 6: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=39 resolved=39 pending=0 active=0 stale=0 unknown=0 | 37W-2L | pnl=+$3.27 | Wilson 83.1% vs target 88.5% (BE 86.5%) | gap=-5.4pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=21
- rank 7: crypto_last_hour_longshot_no|minutes_to_expiry_band=40-60m|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=187 resolved=186 pending=1 active=1 stale=0 unknown=0 | 175W-11L | pnl=+$1.78 | Wilson 89.7% vs target 95.1% (BE 93.1%) | gap=-5.4pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=213 | next_pending=KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00 ask=0.92
- rank 8: crypto_last_hour_longshot_no|asset=BTC|signal_tier=moderate | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=37 resolved=37 pending=0 active=0 stale=0 unknown=0 | 36W-1L | pnl=+$2.80 | Wilson 86.2% vs target 91.7% (BE 89.7%) | gap=-5.6pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=28
...
- best: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=43 resolved=43 pending=0 active=0 stale=0 unknown=0 | 35W-8L | pnl=$-4.17 | Wilson 67.4% vs target 93.1% (BE 91.1%) | gap=-25.7pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=181 | excluded_post_start_actionables=181 (native_spread_band=<=5c=55, native_spread_band=<=2c=51, native_depth_band=1000+=44, native_depth_band=10-99=22) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=102 (not_actionable=102) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 1: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=43 resolved=43 pending=0 active=0 stale=0 unknown=0 | 35W-8L | pnl=$-4.17 | Wilson 67.4% vs target 93.1% (BE 91.1%) | gap=-25.7pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=181 | excluded_post_start_actionables=181 (native_spread_band=<=5c=55, native_spread_band=<=2c=51, native_depth_band=1000+=44, native_depth_band=10-99=22) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=102 (not_actionable=102) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 2: native_watch|crypto_strong_no_90_95 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=34 resolved=34 pending=0 active=0 stale=0 unknown=0 | 27W-7L | pnl=$-4.70 | Wilson 63.2% vs target 95.2% (BE 93.2%) | gap=-32.0pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=265 | excluded_post_start_actionables=189 (signal_tier=moderate=68, signal_tier=weak=63, native_ask_band=85-90=28, native_ask_band=95-98=19) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89 | target_window_misses=421 (not_actionable_native_ask_band=missing=115, not_actionable_native_ask_band=<80=78, not_actionable_native_ask_band=95-98=63, not_actionable_native_ask_band=98-99=58) | target_window_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89
- rank 3: native_watch|crypto_btc_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-30T07:13:19+00:00 | observations=23 resolved=23 pending=0 active=0 stale=0 unknown=0 | 16W-7L | pnl=$-4.40 | Wilson 49.1% vs target 90.7% (BE 88.7%) | gap=-41.6pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=128 | excluded_post_start_actionables=482 (asset=SOL=169, asset=ETH=163, native_ask_band=90-95=102, native_ask_band=95-98=38) | excluded_sample=KXBTCD-26JUN3005-T59699.99 native_ask_band=90-95 ask=0.94 | target_window_misses=822 (not_actionable_native_ask_band=missing=329, not_actionable_native_ask_band=98-99=111, native_ask_band=90-95=102, not_actionable_native_ask_band=95-98=91) | target_window_sample=KXBTCD-26JUN3004-T59799.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 4: native_watch|crypto_20_40m_no_80_85 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-29T11:05:00+00:00 | observations=22 resolved=22 pending=0 active=0 stale=0 unknown=0 | 20W-2L | pnl=$+1.54 | Wilson 72.2% vs target 85.9% (BE 83.9%) | gap=-13.7pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=26 | excluded_post_start_actionables=693 (minutes_band=40-60m=372, native_ask_band=90-95=120, native_ask_band=85-90=68, minutes_band=10-20m=65) | excluded_sample=KXBTCD-26JUN2908-T60299.99 minutes_band=40-60m ask=0.95 | target_window_misses=998 (not_actionable_native_ask_band=98-99=190, not_actionable_native_ask_band=missing=167, not_actionable_native_ask_band=99+=149, not_actionable_native_ask_band=95-98=144) | target_window_sample=KXBTCD-26JUN2908-T60299.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 5: native_watch|crypto_spread_le1_depth_10_99 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T07:10:00+00:00 | observations=20 resolved=20 pending=0 active=0 stale=0 unknown=0 | 16W-4L | pnl=$-2.15 | Wilson 58.4% vs target 92.8% (BE 90.8%) | gap=-34.4pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=118 | excluded_post_start_actionables=270 (native_depth_band=100-999=106, native_spread_band=<=5c=57, native_spread_band=<=2c=53, native_depth_band=1000+=45) | excluded_sample=KXBTCD-26JUL0104-T58899.99 native_depth_band=100-999 ask=0.93 | target_window_misses=26 (not_actionable=26) | target_window_sample=KXSOLD-26JUL0107-T75.9999 not_actionable ask=0.99
- rank 6: native_watch|crypto_sol_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T13:00:00+00:00 | observations=13 resolved=12 pending=1 active=1 stale=0 unknown=0 | 12W-0L | pnl=$+1.35 | Wilson 75.7% vs target 90.8% (BE 88.8%) | gap=-15.0pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=26 | next_pending=KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00 ask=0.88 | excluded_post_start_actionables=223 (asset=BTC=95, asset=ETH=76, native_ask_band=90-95=27, native_ask_band=80-85=18) | excluded_sample=KXBTCD-26JUL0110-T59199.99 asset=BTC ask=0.93 | target_window_misses=194 (not_actionable_native_ask_band=missing=39, not_actionable_native_ask_band=<80=32, not_actionable_native_ask_band=99+=29, native_ask_band=90-95=27) | target_window_sample=KXSOLD-26JUL0111-T79.9999 not_actionable_native_ask_band=missing
- rank 7: native_watch|crypto_btc_strong_no_90_95_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T14:00:00+00:00 | observations=9 resolved=9 pending=0 active=0 stale=0 unknown=0 | 8W-1L | pnl=$-0.44 | Wilson 56.5% vs target 95.8% (BE 93.8%) | gap=-39.3pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=122 | excluded_post_start_actionables=220 (asset=ETH=76, asset=SOL=76, native_depth_band=1000+=30, native_depth_band=10-99=10) | excluded_sample=KXETHD-26JUL0111-T1609.99 asset=ETH ask=0.90 | target_window_misses=50 (not_actionable_native_ask_band=95-98=15, not_actionable_native_ask_band=99+=10, native_ask_band=85-90=8, not_actionable_native_ask_band=<80=7) | target_window_sample=KXBTCD-26JUL0112-T60099.99 native_ask_band=85-90 ask=0.89
- rank 8: native_watch|crypto_tue_no_any_ask | gate=FORWARD_WATCH_WAITING | start=2026-07-01T07:10:00+00:00 | observations=0 resolved=0 pending=0 active=0 stale=0 unknown=0 | 0W-0L | pnl=$+0.00 | Wilson 0.0% vs target 2.0% (BE 0.0%) | gap=-2.0pp | blockers=no_forward_observations;resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=>5000_or_target_impossible | excluded_post_start_actionables=293 (captured_weekday=Thu=160, captured_weekday=Wed=133) | excluded_sample=KXBTCD-26JUL0104-T58899.99 captured_weekday=Wed ask=0.93

## Kalshi Native Preflight Walk-Forward Validation
- command: `python3 scripts/kalshi_native_preflight_walkforward.py --limit 8`
- status: NO_WALKFORWARD_NATIVE_CUT | ready=false | observations=13898 | cuts=2261 | display_cuts=204 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-29T12:43:02+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_walkforward_native_cut_validation_requires_predeclared_forward_gate
...
- rank 4: crypto_last_hour_longshot_no|captured_weekday=Fri | gate=WALKFORWARD_REJECT | type=single | train=31 resolved 27W-4L -$1.14 Wilson 71.1% vs target 92.8% gap=-21.6pp | validation=0 resolved 0W-0L +$0.00 Wilson 0.0% vs target 2.0% gap=-2.0pp | blockers=train_pnl<=0;train_wilson<BE+buffer;validation_resolved<15;validation_pnl<=0;validation_wilson<BE+buffer | promotion_blockers=none
- rank 5: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=WALKFORWARD_REJECT | type=single | train=18 resolved 16W-2L +$0.37 Wilson 67.2% vs target 88.8% gap=-21.6pp | validation=21 resolved 21W-0L +$2.90 Wilson 84.5% vs target 88.2% gap=-3.7pp | blockers=train_resolved<30;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 6: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=WALKFORWARD_REJECT | type=pair | train=37 resolved 36W-1L +$1.61 Wilson 86.2% vs target 94.9% gap=-8.8pp | validation=36 resolved 36W-0L +$2.60 Wilson 90.4% vs target 94.8% gap=-4.4pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00 ask=0.92
- rank 7: crypto_last_hour_longshot_no|asset=SOL|native_ask_band=85-90 | gate=WALKFORWARD_REJECT | type=pair | train=22 resolved 19W-3L -$0.45 Wilson 66.7% vs target 90.4% gap=-23.7pp | validation=32 resolved 31W-1L +$2.66 Wilson 84.3% vs target 90.6% gap=-6.3pp | blockers=train_resolved<30;train_pnl<=0;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00 ask=0.88
- rank 8: crypto_last_hour_longshot_no|signal_tier=moderate | gate=WALKFORWARD_REJECT | type=single | train=46 resolved 42W-4L +$0.95 Wilson 79.7% vs target 91.2% gap=-11.6pp | validation=43 resolved 41W-2L +$2.28 Wilson 84.5% vs target 92.0% gap=-7.5pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00 ask=0.88
...
- best: crypto_last_hour_native_subcell:moderate:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=58 resolved=58 pending=0 active=0 stale=0 unknown=0 | 56W-2L | pnl=+4.49 | Wilson 88.3% vs BE 88.8% | gap=-0.5pp | blockers=wilson<BE+2pp | perfect_wins_needed=18
- rank 1: crypto_last_hour_native_subcell:moderate:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=58 resolved=58 pending=0 active=0 stale=0 unknown=0 | 56W-2L | pnl=+4.49 | Wilson 88.3% vs BE 88.8% | gap=-0.5pp | blockers=wilson<BE+2pp | perfect_wins_needed=18
- rank 2: crypto_last_hour_native_subcell:strong:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=146 resolved=146 pending=0 active=0 stale=0 unknown=0 | 132W-14L | pnl=-4.08 | Wilson 84.5% vs BE 93.2% | gap=-8.7pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=339
- rank 3: crypto_last_hour_native_subcell:weak:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=69 resolved=69 pending=0 active=0 stale=0 unknown=0 | 58W-11L | pnl=-2.36 | Wilson 73.7% vs BE 87.5% | gap=-13.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=113
- rank 4: crypto_last_hour_native_subcell:native_ask:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=131 resolved=130 pending=1 active=1 stale=0 unknown=0 | 114W-16L | pnl=+1.05 | Wilson 80.9% vs BE 86.9% | gap=-6.0pp | blockers=wilson<BE+2pp | perfect_wins_needed=98 | next_pending=KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00 ask=0.88
- rank 5: crypto_last_hour_native_subcell:native_ask:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=134 resolved=134 pending=0 active=0 stale=0 unknown=0 | 123W-11L | pnl=-1.86 | Wilson 85.9% vs BE 93.2% | gap=-7.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=270
- rank 6: crypto_last_hour_native_subcell:moderate:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=32 resolved=31 pending=1 active=1 stale=0 unknown=0 | 27W-4L | pnl=-1.26 | Wilson 71.1% vs BE 91.1% | gap=-19.9pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=114 | next_pending=KXSOLD-26JUL0220-T80.9999 status=active due=2026-07-02T23:59:59.120549+00:00 ask=0.88

## Kalshi Crypto Last-Hour Entry Timing Audit
- command: `python3 scripts/kalshi_crypto_last_hour_entry_timing_audit.py --limit 8`
- status: NO_ENTRY_TIMING_CANDIDATE | ready=false | posthoc_candidates=0 | source_actionable_rows=1362 | selected_observations=768 | cuts=374 | min_resolved=30 | edge_buffer=+2.0pp
- best: crypto_last_hour_entry_timing:first_actionable|asset=SOL|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=31 resolved=30 pending=1 | 30W-0L | pnl=+$3.45 | Wilson 88.6% vs target 90.5% (BE 88.5%) | gap=-1.9pp | blockers=wilson<BE+2pp
- rank 1: crypto_last_hour_entry_timing:first_actionable|asset=SOL|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=31 resolved=30 pending=1 | 30W-0L | pnl=+$3.45 | Wilson 88.6% vs target 90.5% (BE 88.5%) | gap=-1.9pp | blockers=wilson<BE+2pp
- rank 2: crypto_last_hour_entry_timing:latest_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=162 resolved=161 pending=1 | 155W-6L | pnl=+$4.33 | Wilson 92.1% vs target 95.6% (BE 93.6%) | gap=-3.5pp | blockers=wilson<BE+2pp
- rank 3: crypto_last_hour_entry_timing:first_actionable|signal_tier=weak|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=34 resolved=34 pending=0 | 33W-1L | pnl=+$3.16 | Wilson 85.1% vs target 89.8% (BE 87.8%) | gap=-4.7pp | blockers=wilson<BE+2pp
- rank 4: crypto_last_hour_entry_timing:first_actionable|native_depth_band=1000+ | gate=ENTRY_TIMING_ACCUMULATING | observations=76 resolved=76 pending=0 | 73W-3L | pnl=+$2.93 | Wilson 89.0% vs target 94.2% (BE 92.2%) | gap=-5.2pp | blockers=wilson<BE+2pp
- rank 5: crypto_last_hour_entry_timing:first_actionable|signal_tier=moderate | gate=ENTRY_TIMING_ACCUMULATING | observations=90 resolved=89 pending=1 | 83W-6L | pnl=+$3.23 | Wilson 86.1% vs target 91.6% (BE 89.6%) | gap=-5.6pp | blockers=wilson<BE+2pp
- rank 6: crypto_last_hour_entry_timing:latest_actionable|signal_tier=moderate|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=52 resolved=51 pending=1 | 50W-1L | pnl=+$2.39 | Wilson 89.7% vs target 95.3% (BE 93.3%) | gap=-5.7pp | blockers=wilson<BE+2pp
- rank 7: crypto_last_hour_entry_timing:first_actionable|native_spread_band=<=1c | gate=ENTRY_TIMING_ACCUMULATING | observations=214 resolved=214 pending=0 | 197W-17L | pnl=+$1.51 | Wilson 87.6% vs target 93.4% (BE 91.4%) | gap=-5.7pp | blockers=wilson<BE+2pp
- rank 8: crypto_last_hour_entry_timing:first_actionable|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=88 resolved=87 pending=1 | 80W-7L | pnl=+$3.04 | Wilson 84.3% vs target 90.5% (BE 88.5%) | gap=-6.2pp | blockers=wilson<BE+2pp

## Kalshi Crypto Ladder Dislocation Preflight
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_preflight.py --json`
- latest_run: captured_at=2026-07-02T23:11:02+00:00 | lookahead=75m | events=5 rows_per_event=40 | candidates=102 checked=102 dislocation_qty1=0 | min_source_edge=0.03 max_source_age=300s | top_reasons=missing_native_no_ask=98, source_age_too_old:639s=3, source_age_too_old:476s=1
- latest_rows: KXBTCD-26JUL0220-T61899.99 BTC/extreme source_no=0.99 native_no_ask=0.99 edge=0.00 age=639s spread=0.01 depth=602 win=0.00 due=2026-07-02T23:59:59.611099+00:00 reason=source_age_too_old:639s ; KXBTCD-26JUL0220-T61799.99 BTC/extreme source_no=0.98 native_no_ask=0.99 edge=-0.01 age=639s spread=0.01 depth=2375 win=0.00 due=2026-07-02T23:59:59.607320+00:00 reason=source_age_too_old:639s ; KXSOLD-26JUL0220-T80.9999 SOL/moderate source_no=0.88 native_no_ask=0.89 edge=-0.01 age=476s spread=0.01 depth=12 win=0.10 due=2026-07-02T23:59:59.120549+00:00 reason=source_age_too_old:476s ; KXETHD-26JUL0220-T1709.99 ETH/strong source_no=0.94 native_no_ask=0.99 edge=-0.05 age=639s spread=0.01 depth=904 win=0.00 due=2026-07-02T23:59:59.382745+00:00 reason=source_age_too_old:639s ; KXBTCD-26JUL0220-T61999.99 BTC/extreme source_no=0.99 native_no_ask=missing edge=missing age=639s spread=missing depth=0 win=missing due=2026-07-02T23:59:59.614723+00:00 reason=missing_native_no_ask ; KXBTCD-26JUL0220-T62099.99 BTC/extreme source_no=0.99 native_no_ask=missing edge=missing age=639s spread=missing depth=0 win=missing due=2026-07-02T23:59:59.618366+00:00 reason=missing_native_no_ask

## Kalshi Crypto Ladder Dislocation Forward Audit
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_audit.py --limit 8`
- status: NO_LIVE_READY | ready=false | cells=6 | ready_cells=0 | observations=87 | min_resolved=30 | edge_buffer=+2.0pp | scope=source-vs-native ladder gaps only; not riskless structural arbitrage
- best: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=53 resolved=53 pending=0 active=0 stale=0 | 36W-17L pnl_qty1=-$7.70 | Wilson 54.5% vs target 84.5% gap=-29.9pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=116
- rank 1: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=53 resolved=53 pending=0 active=0 stale=0 | 36W-17L pnl_qty1=-$7.70 | Wilson 54.5% vs target 84.5% gap=-29.9pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=116
- rank 2: ticker_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=56 resolved=56 pending=0 active=0 stale=0 | 38W-18L pnl_qty1=-$8.53 | Wilson 54.8% vs target 85.1% gap=-30.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=129
- rank 3: all_rows | gate=LADDER_DISLOCATION_ACCUMULATING | observations=87 resolved=87 pending=0 active=0 stale=0 | 55W-32L pnl_qty1=-$14.02 | Wilson 52.7% vs target 81.3% gap=-28.6pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=148
- rank 4: asset_btc | gate=LADDER_DISLOCATION_ACCUMULATING | observations=6 resolved=6 pending=0 active=0 stale=0 | 4W-2L pnl_qty1=-$1.66 | Wilson 30.0% vs target 96.3% gap=-66.3pp | blockers=resolved<30; pnl<=0; wilson<BE+2pp | perfect_wins_needed=189
- rank 5: asset_eth | gate=LADDER_DISLOCATION_ACCUMULATING | observations=40 resolved=40 pending=0 active=0 stale=0 | 25W-15L pnl_qty1=-$6.47 | Wilson 47.0% vs target 80.7% gap=-33.6pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=82
- rank 6: asset_sol | gate=LADDER_DISLOCATION_ACCUMULATING | observations=41 resolved=41 pending=0 active=0 stale=0 | 26W-15L pnl_qty1=-$5.89 | Wilson 48.1% vs target 79.8% gap=-31.7pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=76
...
- latest_run: captured_at=2026-07-02T16:50:11+00:00 | markets_checked=24 parsed=24 source_observations=61 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXTEMPNYCH dates=2026-07-02 | state_keys=13 observations_raw=61 source=weathercom_kalshi_metar_primary source_errors=0 | counts=KXTEMPNYCH=24 | reasons=hourly_temp_observation_missing_or_future=24
...
- latest_run: captured_at=2026-07-02T23:00:59+00:00 | markets_checked=1141 parsed=1141 espn_games=6 locked_rows=6 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXMLBKS,KXMLBOUTS,KXMLBHIT,KXMLBHRR,KXMLBHR,KXMLBTB,KXMLBRBI,KXMLBSB dates=2026-07-02 | state_games=6 | reasons=mlb_boxscore_not_current=821, player_stat_waiting_for_threshold_or_final=228, player_stat_missing_after_final=71, player_stat_missing_before_final=15, mlb_player_stat_already_reached=6
- locked_rows: KXMLBHIT-26JUL021840CWSCLE-CLECDELAUTER24-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=CWS@CLE 0-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL021840CWSCLE-CLETBAZZANA37-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=CWS@CLE 0-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL021840CWSCLE-CWSSANTONACCI17-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=CWS@CLE 0-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHRR-26JUL021840CWSCLE-CLECDELAUTER24-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits_runs_rbi:1/1 game=CWS@CLE 0-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHRR-26JUL021840CWSCLE-CLETBAZZANA37-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits_runs_rbi:1/1 game=CWS@CLE 0-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHRR-26JUL021840CWSCLE-CWSSANTONACCI17-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits_runs_rbi:1/1 game=CWS@CLE 0-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0
...
- latest_run: captured_at=2026-07-02T22:36:35+00:00 | markets_checked=80000 with_legs=80000 component_events=347/347 fetched=347 component_markets=4143 resolved=692 locked_rows=87 actionable_qty1=0 | max_target_ask=0.25 min_depth=1 | series=KXMVESPORTSMULTIGAMEEXTENDED,KXMVECROSSCATEGORY counts=KXMVECROSSCATEGORY=40000, KXMVESPORTSMULTIGAMEEXTENDED=40000 | page_cap=KXMVECROSSCATEGORY,KXMVESPORTSMULTIGAMEEXTENDED rate_limited=none component_cap=false component_rate_limited=false | reasons=not_locked_by_component_results=79913, component_market_resolved=692, component_false_locks_mve_no=85, all_components_true_locks_mve_yes=2
- latest_rows: KXMVESPORTSMULTIGAMEEXTENDED-S202600071791866-ECDB03F4491 YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVESPORTSMULTIGAMEEXTENDED legs=3/3 decisive=KXETH15M-26JUL021830-30:NO->NO reason=all_components_true_locks_mve_yes actionable=0 ; KXMVESPORTSMULTIGAMEEXTENDED-S2026ECE75895549-54860535ACF YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVESPORTSMULTIGAMEEXTENDED legs=2/2 decisive=KXDOGE15M-26JUL021830-30:NO->NO reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S20261E92691A15C-235BC30114B NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVECROSSCATEGORY legs=2/6 decisive=KXETH15M-26JUL021830-30:YES->NO reason=component_false_locks_mve_no actionable=0 ; KXMVECROSSCATEGORY-S20262040E365917-8C40838D215 NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVECROSSCATEGORY legs=2/2 decisive=KXXRP15M-26JUL021830-30:NO->YES reason=component_false_locks_mve_no actionable=0 ; KXMVECROSSCATEGORY-S20264F6E1FF7AAB-D616EED4BE8 NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVECROSSCATEGORY legs=4/6 decisive=KXETH15M-26JUL021830-30:YES->NO reason=component_false_locks_mve_no actionable=0 ; KXMVECROSSCATEGORY-S202661BEFE50EC9-DD175E57B70 NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVECROSSCATEGORY legs=2/3 decisive=KXETH15M-26JUL021830-30:YES->NO reason=component_false_locks_mve_no actionable=0 ; KXMVECROSSCATEGORY-S2026692C9029768-391A11390C8 NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVECROSSCATEGORY legs=5/5 decisive=KXETH15M-26JUL021830-30:YES->NO reason=component_false_locks_mve_no actionable=0 ; KXMVECROSSCATEGORY-S2026692C9029768-7B42D73DCA4 NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVECROSSCATEGORY legs=5/5 decisive=KXDOGE15M-26JUL021830-30:YES->NO reason=component_false_locks_mve_no actionable=0
...
- status: live_rows=1 dry_runs=1 live_today=1 open_orders=0 open_risk=$0.00 rows_with_fills=0 filled_unresolved=0 filled_unresolved_cost=$0.00 realized_pnl=+0.00
...
- status: live_rows=1 dry_runs=0 filled_rows=1 cancelled_rows=0 | strategy_open=1 strategy_open_cost=$0.82 | all_live_pilot_open=7 all_live_pilot_cost=$1.37
- latest_rows: id=1 live=true status=PLACED_FILLED ticker=KXLOWTCHI-26JUL02-B77.5 side=YES qty=1 limit=0.81 bid=0.80 ask=0.81 depth=205 spread=0.01 trade_id=7105 order=059f7bf4 fill_confirmed=1 cost=$0.81 fee=$0.01 observed_min_f=78.08 forecast_min_f=83.00 resolution=unresolved pnl=unknown reason=none
...
- status: live_rows=1 dry_runs=0 filled_rows=1 cancelled_rows=0 | strategy_open=1 strategy_open_cost=$0.05 | all_live_pilot_open=7 all_live_pilot_cost=$1.37
- latest_rows: id=1 live=true status=PLACED_FILLED ticker=KXNETFLIXTOPVIEWSMOVIE-26JUL06-25 side=NO qty=1 limit=0.05 bid=0.04 ask=0.05 depth=10 spread=0.01 trade_id=7106 order=077c96d6 fill_confirmed=1 cost=$0.05 fee=$0.00 target_week=2026-07-05 latest_week=2026-06-28 latest_views_m=31.00 primary_no=13/23 primary_wilson=0.37 recent_no=5/15 pred_p=0.57 edge=0.51 resolution=unresolved pnl=unknown reason=none
...
- latest_run: captured_at=2026-07-02T22:10:40+00:00 | markets_checked=12 events=2 timelines=2 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXIMFTWEETS,KXWEFTWEETS counts=KXIMFTWEETS=6, KXWEFTWEETS=6 | events_summary=KXIMFTWEETS-26JUL09:handle=IMFNews visible=1 complete=true after_close=false window=2026-07-02T16:00:00+00:00->2026-07-09T16:00:00+00:00 ; KXWEFTWEETS-26JUL09:handle=wef visible=0 complete=true after_close=false window=2026-07-02T16:00:00+00:00->2026-07-09T16:00:00+00:00 | reasons=range_not_irreversible=8, over_not_irreversible=2, under_not_irreversible=2
...
- latest_run: captured_at=2026-07-02T23:00:59+00:00 | markets_checked=570 parsed=570 espn_games=47 locked_rows=1 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXMLBRFI,KXMLBF3,KXMLBF5,KXMLBF5SPREAD,KXMLBF5TOTAL,KXMLBF7,KXMLBTEAMTOTAL,KXMLBEXTRAS dates=2026-07-02,2026-07-03,2026-07-04,2026-07-05 | state_games=47 | counts=KXMLBEXTRAS=47, KXMLBF3=42, KXMLBF5=42, KXMLBF5SPREAD=56, KXMLBF5TOTAL=98, KXMLBF7=42, KXMLBRFI=47, KXMLBTEAMTOTAL=196 | reasons=mlb_teamtotal_game_not_final=196, mlb_f5total_window_not_complete=98, mlb_f5spread_window_not_complete=56, mlb_extras_game_not_final=47, mlb_rfi_first_inning_not_complete=46, mlb_f3_window_not_complete=42, mlb_f5_window_not_complete=42, mlb_f7_window_not_complete=42
- locked_rows: KXMLBRFI-26JUL021840CWSCLE NO ask=1.00 depth=0 bid=0.99 win=0.00 type=rfi window=1 target=None threshold=missing margin=missing total=0 game=CWS@CLE 0-0 STATUS_IN_PROGRESS reason=mlb_rfi_first_inning_complete_scoreless actionable=0
...
- latest_run: captured_at=2026-07-02T23:00:59+00:00 | markets_checked=391 parsed=391 espn_games=6 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWNBAGAME,KXWNBASPREAD,KXWNBATOTAL,KXWNBAOT,KXWNBA1QWINNER,KXWNBA2QWINNER,KXWNBA3QWINNER,KXWNBA4QWINNER,KXWNBA1HWINNER,KXWNBA2HWINNER,KXWNBA1QSPREAD,KXWNBA2QSPREAD,KXWNBA3QSPREAD,KXWNBA4QSPREAD,KXWNBA1HSPREAD,KXWNBA2HSPREAD,KXWNBA1QTOTAL,KXWNBA2QTOTAL,KXWNBA3QTOTAL,KXWNBA4QTOTAL,KXWNBA1HTOTAL,KXWNBA2HTOTAL dates=2026-07-02,2026-07-03,2026-07-04 | state_games=6 | counts=KXWNBA1HSPREAD=9, KXWNBA1HTOTAL=3, KXWNBA1HWINNER=9, KXWNBA1QSPREAD=21, KXWNBA1QTOTAL=21, KXWNBA1QWINNER=9, KXWNBA2HSPREAD=21, KXWNBA2HTOTAL=21, KXWNBA2HWINNER=9, KXWNBA2QSPREAD=21, KXWNBA2QTOTAL=21, KXWNBA2QWINNER=9, KXWNBA3QSPREAD=21, KXWNBA3QTOTAL=21, KXWNBA3QWINNER=9, KXWNBA4QSPREAD=21, KXWNBA4QTOTAL=21, KXWNBA4QWINNER=9, KXWNBAGAME=12, KXWNBAOT=6, KXWNBASPREAD=52, KXWNBATOTAL=45 | reasons=wnba_spread_game_not_final=52, wnba_total_game_not_final=45, wnba_1q_spread_not_complete=21, wnba_1q_total_not_complete=21, wnba_2h_spread_not_complete=21, wnba_2h_total_not_complete=21, wnba_2q_spread_not_complete=21, wnba_2q_total_not_complete=21
...
- latest_run: captured_at=2026-07-02T23:00:59+00:00 | markets_checked=165 parsed=165 espn_games=3 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWNBAPTS,KXWNBAREB,KXWNBAAST,KXWNBA3PT dates=2026-07-02 | state_games=3 titles=165 title_failures=0 summary_fetches=3 | counts=KXWNBA3PT=24, KXWNBAAST=15, KXWNBAPTS=72, KXWNBAREB=54 | reasons=wnba_player_boxscore_not_current=165
...
- latest_run: captured_at=2026-07-02T08:00:11+00:00 | markets_checked=18 parsed=18 espn_games=9 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXAFLGAME dates=2026-07-02,2026-07-03,2026-07-04,2026-07-05,2026-07-06 | state_games=9 | counts=KXAFLGAME=18 | reasons=afl_game_not_final=18
...
- latest_run: captured_at=2026-07-02T09:00:08+00:00 | markets_checked=8 parsed=8 official_games=93 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXCFLGAME dates=2026-07-02,2026-07-03,2026-07-04,2026-07-05 | state_games=4 rounds_raw=27 tournaments_raw=93 supported_games=93 | counts=KXCFLGAME=8 | source_errors=0 | reasons=cfl_game_not_final=8
...
- latest_run: captured_at=2026-07-02T09:28:08+00:00 | markets_checked=8 parsed=8 official_games=32 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXBIG3GAME dates=2026-07-05 | state_games=4 events_raw=32 supported_games=32 | counts=KXBIG3GAME=8 | source_errors=0 | reasons=big3_game_not_final=8
...
- latest_run: captured_at=2026-07-02T08:24:06+00:00 | markets_checked=88 parsed=88 official_games=43 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXKBOGAME,KXNPBGAME dates=2026-06-30,2026-07-01,2026-07-02,2026-07-03,2026-07-04,2026-07-05 | state_games=43 | counts=KXKBOGAME=42, KXNPBGAME=46 | source_errors=0 | reasons=npb_game_not_final=44, kbo_game_not_final=40, no_matching_official_kbo_game_state=2, npb_game_canceled_or_postponed=2
...
- latest_run: captured_at=2026-07-02T09:39:12+00:00 | markets_checked=82 parsed=82 official_games=60 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXLMBGAME dates=2026-07-02,2026-07-03,2026-06-30,2026-07-04,2026-07-05 | state_games=57 schedule_games=60 teams=20 | counts=KXLMBGAME=82 | source_errors=0 | reasons=lmb_game_not_final=78, no_matching_official_lmb_game_state=4
...
- latest_run: captured_at=2026-07-02T09:56:04+00:00 | markets_checked=20 parsed=20 official_games=44 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXR6GAME dates=2026-07-02,2026-07-04 | state_games=13 calendar=2026-7 matches_raw=92 supported_games=44 | counts=KXR6GAME=20 | source_errors=0 | reasons=r6_game_not_final=20
...
- latest_run: captured_at=2026-07-02T21:42:36+00:00 | markets_checked=40 parsed=40 official_games=80 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXVALORANTGAME dates=2026-07-02,2026-07-03,2026-07-04 | state_games=45 events_raw=80 supported_games=80 | counts=KXVALORANTGAME=40 | source_errors=0 | reasons=valorant_game_not_final=34, no_matching_official_valorant_game_state=6
...
- latest_run: captured_at=2026-07-02T21:42:42+00:00 | markets_checked=17 parsed=17 official_games=80 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXLOLGAME dates=2026-07-02,2026-07-03,2026-07-04 | state_games=22 events_raw=80 supported_games=80 | counts=KXLOLGAME=17 | source_errors=0 | reasons=lol_game_not_final=10, no_matching_official_lol_game_state=4, lol_game_final_no_unique_winner=2, lol_game_target_not_in_game=1
...
- latest_run: captured_at=2026-07-02T11:16:44+00:00 | markets_checked=42 groups=21 hltv_results=154 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXCS2GAME counts=KXCS2GAME=42 | hltv_index_pairs=146 fetches=2 raw_results=154 | reasons=no_hltv_match_pair=21
...
- latest_run: captured_at=2026-07-02T11:59:19+00:00 | markets_checked=15 parsed=15 hltv_results=153 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXCS2TOTALMAPS counts=KXCS2TOTALMAPS=15 | hltv_index_pairs=145 fetches=2 raw_results=153 | reasons=no_hltv_match_pair=15
...
- latest_run: captured_at=2026-07-02T21:57:18+00:00 | kalshi_markets=134 groups=67 espn_matches=573 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXATPMATCH,KXWTAMATCH,KXATPDOUBLES,KXWTADOUBLES counts=KXATPDOUBLES=32, KXATPMATCH=32, KXWTADOUBLES=38, KXWTAMATCH=32 | espn_events=atp=1, wta=1 competitions=atp=288, wta=285 status_fetches=573 | reasons=espn_match_not_unique_completed=56, no_espn_match_pair=11
...
- latest_run: captured_at=2026-07-02T16:50:53+00:00 | kalshi_markets=128 groups=64 flashscore_tournaments=21 flashscore_matches=553 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXITFMATCH,KXITFWMATCH counts=KXITFMATCH=70, KXITFWMATCH=58 | category_tournaments=KXITFMATCH=17, KXITFWMATCH=13 matched_tournaments=21 tournament_match_failures=2 | reasons=flashscore_match_not_unique_completed=49, no_flashscore_match_pair=15
...
- latest_run: captured_at=2026-07-02T21:59:02+00:00 | kalshi_markets=256 groups=96 espn_matches=573 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXATPSETWINNER,KXWTASETWINNER,KXATPEXACTMATCH,KXWTAEXACTMATCH counts=KXATPEXACTMATCH=96, KXATPSETWINNER=96, KXWTAEXACTMATCH=0, KXWTASETWINNER=64 | espn_events=atp=1, wta=1 competitions=atp=288, wta=285 status_fetches=573 linescore_fetches=1146 | reasons=espn_match_not_unique_completed=96
...
- latest_run: captured_at=2026-07-02T21:42:48+00:00 | markets_checked=108 parsed=108 official_games=160 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXVALORANTMAP,KXLOLMAP dates=2026-07-02,2026-07-03,2026-07-04 | state_games=67 events_raw=160 supported_games=160 | counts=KXLOLMAP=34, KXVALORANTMAP=74 | source_errors=0 | proof=completed_clean_sweep_only | reasons=valorant_match_not_final=68, lol_match_not_final=24, no_matching_official_lol_map_sweep_state=10, no_matching_official_valorant_map_sweep_state=6
...
- latest_run: captured_at=2026-07-02T08:36:48+00:00 | markets_checked=136 parsed=136 official_games=60 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXFIBAGAME dates=2026-06-30,2026-07-02,2026-07-03,2026-07-04,2026-07-05 | state_games=120 matched_markets=120 raw_games=180 supported_games=68 | counts=KXFIBAGAME=136 | source_errors=0 | reasons=fiba_game_not_final=120, no_matching_official_fiba_game_state=16
...
- latest_run: captured_at=2026-07-02T08:51:51+00:00 | markets_checked=8 parsed=8 official_games=28 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXNZNBLGAME dates=2026-07-03,2026-07-04,2026-07-05 | state_games=4 widget_rows=56 supported_games=28 | counts=KXNZNBLGAME=8 | source_errors=0 | reasons=nznbl_game_not_final=8
...
- latest_run: captured_at=2026-07-02T09:12:23+00:00 | markets_checked=8 parsed=8 official_games=16 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXVBAGAME dates=2026-07-02,2026-07-03,2026-07-04,2026-07-05 | state_games=4 widget_rows=16 supported_games=16 | counts=KXVBAGAME=8 | source_errors=0 | reasons=vba_game_not_final=8
...
- latest_run: captured_at=2026-07-02T21:43:37+00:00 | markets_checked=110 parsed=110 espn_games=10 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWCCORNERS,KXWCTCORNERS dates=2026-07-02,2026-07-03,2026-07-04,2026-07-05,2026-07-06 | state_games=10 needed_events=10 | counts=KXWCCORNERS=50, KXWCTCORNERS=60 | reasons=team_corner_state_unknown=60, corner_state_unknown=50
...
- latest_run: captured_at=2026-07-02T21:43:31+00:00 | markets_checked=371 parsed=367 espn_games=10 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWCGOAL,KXWCAST,KXWCSOA dates=2026-07-02,2026-07-03,2026-07-04,2026-07-05,2026-07-06 | state_games=10 needed_events=10 | counts=KXWCAST=123, KXWCGOAL=162, KXWCSOA=86 | reasons=wc_player_goal_waiting_for_threshold_or_final=160, wc_player_assist_waiting_for_threshold_or_final=122, wc_player_score_or_assist_waiting_for_threshold_or_final=85, unparsed_market=4
...
- latest_run: captured_at=2026-07-02T17:40:07+00:00 | markets_checked=254 parsed=254 espn_games=5 locked_rows=0 actionable_qty1=0 | max_ask=0.15 min_depth=1 | series=KXWCSTART dates=2026-07-02,2026-07-03 | state_games=5 needed_events=5 | counts=KXWCSTART=254 | reasons=wc_start_lineup_not_available=254
...
- latest_run: captured_at=2026-07-02T07:51:09+00:00 | markets_checked=69 parsed=69 espn_games=23 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXCHNSLGAME,KXALLSVENSKANGAME,KXBRASILEIROBGAME,KXBRASILEIROCGAME,KXUSLGAME,KXECULPGAME dates=2026-07-02,2026-07-01,2026-07-03,2026-07-04,2026-07-05,2026-07-06,2026-07-07,2026-07-08 | state_games=23 | counts=KXALLSVENSKANGAME=3, KXBRASILEIROBGAME=18, KXBRASILEIROCGAME=18, KXCHNSLGAME=3, KXECULPGAME=21, KXUSLGAME=6 | reasons=soccer_game_not_final=69

## Kalshi Broad Event-First Shadow Audit
- command: `python3 scripts/kalshi_shadow_event_first_audit.py --json`
- status: SHADOW_EVENT_FIRST_CANDIDATES | ready=false | eligible_cells=167 | candidate_cells=3 | ready_cells=0 | min_events=30 | edge_buffer=+2.0pp | scope=event-first shadow only; native execution still requires a separate forward gate
...
- rank 2: shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=582 | 538W-44L | pnl=+2404.82 | Wilson 90.0% vs target 89.5% (avg_price 87.5%) | target_gap=+0.5pp | blockers=none
- rank 3: shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=823 | 719W-104L | pnl=+2944.86 | Wilson 84.9% vs target 84.8% (avg_price 82.8%) | target_gap=+0.1pp | blockers=none

## Kalshi Shadow Longshot Stability Audit
- command: `python3 scripts/kalshi_shadow_longshot_stability_audit.py --limit 8`
- status: NO_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=6815 | eligible_cells=25 | base_candidate_cells=3 | stable_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:other:NO:weak:80-90:4-24h | gate=SHADOW_STABILITY_REJECT | aggregate=55ev 54W-1L +771.83 Wilson 90.4% vs target 85.3% gap +5.1pp | train=38ev 37W-1L +487.74 Wilson 86.5% vs target 85.7% gap +0.8pp | validation=17ev 17W-0L +284.09 Wilson 81.6% vs target 84.4% gap -2.8pp | worst_asset=none>=min_slice | worst_hour=none>=min_slice | blockers=validation_wilson<avg_price+buffer
- 2. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=582ev 538W-44L +2404.82 Wilson 90.0% vs target 89.5% gap +0.5pp | train=407ev 378W-29L +1834.61 Wilson 90.0% vs target 89.6% gap +0.3pp | validation=175ev 160W-15L +570.21 Wilson 86.3% vs target 89.4% gap -3.1pp | worst_asset=KXSOLD 109ev 101W-8L +477.20 Wilson 86.2% vs target 89.5% gap -3.3pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 3. shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=823ev 719W-104L +2944.86 Wilson 84.9% vs target 84.8% gap +0.1pp | train=576ev 516W-60L +3456.46 Wilson 86.8% vs target 84.6% gap +2.2pp | validation=247ev 203W-44L -511.60 Wilson 76.9% vs target 85.3% gap -8.3pp | worst_asset=KXBTCD 436ev 372W-64L +711.45 Wilson 81.7% vs target 84.7% gap -3.0pp | worst_hour=13Z 35ev 25W-10L -449.18 Wilson 54.9% vs target 85.3% gap -30.3pp | blockers=validation_pnl<=0;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXBTCD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
...
- status: NO_FILTERED_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=6815 | base_candidate_cells=3 | filtered_cells=74 | filtered_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=02Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=02Z | excluded=33 | aggregate=549ev 510W-39L +2500.20 Wilson 90.4% vs target 89.6% gap +0.9pp | train=384ev 357W-27L +1749.18 Wilson 90.0% vs target 89.7% gap +0.3pp | validation=165ev 153W-12L +751.02 Wilson 87.7% vs target 89.4% gap -1.7pp | worst_asset=KXSOLD 100ev 93W-7L +462.63 Wilson 86.3% vs target 89.6% gap -3.4pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 2. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=15Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=15Z | excluded=21 | aggregate=561ev 522W-39L +2659.92 Wilson 90.6% vs target 89.5% gap +1.1pp | train=392ev 366W-26L +1961.98 Wilson 90.5% vs target 89.6% gap +0.9pp | validation=169ev 156W-13L +697.94 Wilson 87.3% vs target 89.4% gap -2.1pp | worst_asset=KXETHD 88ev 82W-6L +446.33 Wilson 85.9% vs target 89.3% gap -3.4pp | worst_hour=13Z 22ev 18W-4L -142.87 Wilson 61.5% vs target 89.5% gap -28.1pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
- 3. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=13Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=13Z | excluded=22 | aggregate=560ev 520W-40L +2547.69 Wilson 90.4% vs target 89.5% gap +0.9pp | train=392ev 365W-27L +1859.12 Wilson 90.2% vs target 89.6% gap +0.6pp | validation=168ev 155W-13L +688.57 Wilson 87.2% vs target 89.4% gap -2.2pp | worst_asset=KXETHD 89ev 83W-6L +454.75 Wilson 86.1% vs target 89.4% gap -3.3pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 4. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=01Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=01Z | excluded=37 | aggregate=545ev 504W-41L +2280.76 Wilson 90.0% vs target 89.5% gap +0.4pp | train=381ev 353W-28L +1640.99 Wilson 89.6% vs target 89.6% gap +0.0pp | validation=164ev 151W-13L +639.77 Wilson 86.9% vs target 89.4% gap -2.5pp | worst_asset=KXSOLD 99ev 91W-8L +363.69 Wilson 84.9% vs target 89.5% gap -4.6pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 5. shadow_longshot_fading:other:NO:weak:80-90:4-24h|exclude_hour=15Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=15Z | excluded=1 | aggregate=54ev 53W-1L +755.82 Wilson 90.2% vs target 85.3% gap +4.9pp | train=37ev 36W-1L +469.82 Wilson 86.2% vs target 85.8% gap +0.4pp | validation=17ev 17W-0L +286.00 Wilson 81.6% vs target 84.3% gap -2.7pp | worst_asset=none>=min_slice | worst_hour=none>=min_slice | blockers=validation_wilson<avg_price+buffer
- 6. shadow_longshot_fading:other:NO:weak:80-90:4-24h|exclude_hour=21Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=21Z | excluded=1 | aggregate=54ev 54W-0L +858.26 Wilson 93.4% vs target 85.3% gap +8.1pp | train=37ev 37W-0L +574.17 Wilson 90.6% vs target 85.7% gap +4.9pp | validation=17ev 17W-0L +284.09 Wilson 81.6% vs target 84.4% gap -2.8pp | worst_asset=none>=min_slice | worst_hour=none>=min_slice | blockers=validation_wilson<avg_price+buffer
- 7. shadow_longshot_fading:other:NO:weak:80-90:4-24h|exclude_hour=03Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=03Z | excluded=1 | aggregate=54ev 53W-1L +757.73 Wilson 90.2% vs target 85.3% gap +4.9pp | train=37ev 36W-1L +473.64 Wilson 86.2% vs target 85.7% gap +0.5pp | validation=17ev 17W-0L +284.09 Wilson 81.6% vs target 84.4% gap -2.8pp | worst_asset=none>=min_slice | worst_hour=none>=min_slice | blockers=validation_wilson<avg_price+buffer
- 8. shadow_longshot_fading:other:NO:weak:80-90:4-24h|exclude_hour=09Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=09Z | excluded=1 | aggregate=54ev 53W-1L +754.87 Wilson 90.2% vs target 85.4% gap +4.9pp | train=37ev 36W-1L +470.78 Wilson 86.2% vs target 85.8% gap +0.4pp | validation=17ev 17W-0L +284.09 Wilson 81.6% vs target 84.4% gap -2.8pp | worst_asset=none>=min_slice | worst_hour=none>=min_slice | blockers=validation_wilson<avg_price+buffer

## Kalshi Legacy Shadow Surface Audit
- command: `python3 scripts/kalshi_legacy_shadow_surface_audit.py --limit 8`
- status: LEGACY_SHADOW_FORWARD_REQUIRED | ready=false | eligible_cells=137 | candidate_cells=1 | ready_cells=0 | min_events=30 | edge_buffer=+2.0pp | scope=legacy_shadow_only_requires_native_or_maker_forward_gate
- best: moderate_favorites:CRYPTO:ETH:YES:80-90:0-1H:liq1:spread1 | gate=LEGACY_SHADOW_FORWARD_REQUIRED | execution=legacy_taker_like_shadow | events=62 | 59W-3L | pnl=+$772.00 | Wilson 86.7% vs target 84.6% (BE 82.6%, avg_price 82.7%) | gap=+2.1pp | blockers=none | promotion_blockers=requires_native_or_maker_forward_gate
- rank 1: moderate_favorites:CRYPTO:ETH:YES:80-90:0-1H:liq1:spread1 | gate=LEGACY_SHADOW_FORWARD_REQUIRED | execution=legacy_taker_like_shadow | events=62 | 59W-3L | pnl=+$772.00 | Wilson 86.7% vs target 84.6% (BE 82.6%, avg_price 82.7%) | gap=+2.1pp | blockers=none | promotion_blockers=requires_native_or_maker_forward_gate
...
- rank 3: weather_city_bid_side:KXHIGHTSEA:NO:90-95:unblocked | gate=LEGACY_SHADOW_REJECT | execution=legacy_bid_side_maker | events=44 | 44W-0L | pnl=+$316.02 | Wilson 92.0% vs target 94.8% (BE 92.8%, avg_price 92.3%) | gap=-2.8pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=26
- rank 4: weather_city_bid_side:KXHIGHTPHX:NO:90-95:unblocked | gate=LEGACY_SHADOW_REJECT | execution=legacy_bid_side_maker | events=42 | 42W-0L | pnl=+$314.24 | Wilson 91.6% vs target 94.5% (BE 92.5%, avg_price 92.0%) | gap=-2.9pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=24
- rank 5: weather_city_bid_side:KXHIGHTMIN:NO:90-95:unblocked | gate=LEGACY_SHADOW_REJECT | execution=legacy_bid_side_maker | events=43 | 43W-0L | pnl=+$300.06 | Wilson 91.8% vs target 95.0% (BE 93.0%, avg_price 92.5%) | gap=-3.2pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=30
...
- rank 7: sell_inverse:WEATHER:NO:95+:4-24h | gate=LEGACY_SHADOW_REJECT | execution=legacy_inverse_shadow | events=692 | 6W-686L | pnl=-$668.02 | Wilson 0.4% vs target 3.9% (BE 1.9%, avg_price 98.3%) | gap=-3.5pp | blockers=pnl<=0;wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=33
- rank 8: price_range_bid_side:CRYPTO:YES:90-95:4-24h | gate=LEGACY_SHADOW_REJECT | execution=legacy_bid_side_maker | events=46 | 46W-0L | pnl=+$281.10 | Wilson 92.3% vs target 95.9% (BE 93.9%, avg_price 93.5%) | gap=-3.6pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=44
...
- latest_run: captured_at=2026-07-02T23:06:47+00:00 | cohort=yes_90_93_above_live_threshold_v1 | start=2026-06-25T11:45:00+00:00 | include_pre_cutoff_live=true | candidates=4 checked=4 actionable_qty1=0 | top_reasons=yes_90_93_above_live_threshold_v1:native_yes_ask_out_of_band:0.9900=2, yes_90_93_above_live_threshold_v1:missing_native_yes_ask=1, yes_90_93_above_live_threshold_v1:native_yes_ask_below_band_watch:0.6300=1
- latest_rows: KXHIGHTDC-26JUL02-B102.5 city=DC yes_ask=missing no_depth=0 reason=missing_native_yes_ask ; KXHIGHTNOLA-26JUL02-B89.5 city=NOLA yes_ask=0.99 no_depth=106 reason=native_yes_ask_out_of_band:0.9900 ; KXHIGHTMIN-26JUL02-T87 city=MIN yes_ask=0.99 no_depth=3 reason=native_yes_ask_out_of_band:0.9900 ; KXLOWTCHI-26JUL02-B77.5 city=CHI yes_ask=0.63 no_depth=3 reason=native_yes_ask_below_band_watch:0.6300
...
- latest_run: captured_at=2026-07-02T23:11:21+00:00 | start=2026-06-25T07:05:00+00:00 | include_pre_cutoff_live=true | candidates=15 checked=15 actionable_qty1=3 | top_reasons=no_95_98_zero_loss_cities_v1:missing_native_no_ask=8, no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive=3, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9900=2, no_90_95_min_probe_v1:missing_native_no_ask=1, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9300=1
- latest_rows: KXLOWTAUS-26JUL03-B70.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=0.98 no_ask_depth=40 qty1=+0.01/-0.99 reason=actionable_qty1_fee_positive due=2026-07-04T19:00:00+00:00 ; KXHIGHTDAL-26JUL03-B101.5 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=0.96 no_ask_depth=41 qty1=+0.03/-0.97 reason=actionable_qty1_fee_positive due=2026-07-04T19:00:00+00:00 ; KXLOWTMIA-26JUL03-T81 cohort=no_95_98_zero_loss_cities_v1 city=MIA no_ask=0.98 no_ask_depth=10 qty1=+0.01/-0.99 reason=actionable_qty1_fee_positive due=2026-07-04T19:00:00+00:00 ; KXHIGHTMIN-26JUL02-B93.5 cohort=no_90_95_min_probe_v1 city=MIN no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-03T19:00:00+00:00 ; KXLOWTAUS-26JUL02-B69.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-03T19:00:00+00:00 ; KXHIGHTDAL-26JUL02-B100.5 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-03T19:00:00+00:00 ; KXHIGHTLV-26JUL02-B102.5 cohort=no_95_98_zero_loss_cities_v1 city=LV no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-03T19:00:00+00:00 ; KXHIGHTLV-26JUL03-B105.5 cohort=no_95_98_zero_loss_cities_v1 city=LV no_ask=0.99 no_ask_depth=1270 qty1=+0.00/-1.00 reason=native_no_ask_out_of_band:0.9900 due=2026-07-04T19:00:00+00:00
...
- latest_run: captured_at=2026-07-02T23:11:46+00:00 | cohort=all | start=2026-06-25T20:00:00+00:00 | include_pre_cutoff_live=true | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- latest_run: captured_at=2026-07-02T03:34:41+00:00 | start=2026-06-26T17:10:00+00:00 | include_pre_cutoff_live=false | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none

## Kalshi Maker Forward Proxy Leaderboard
- command: `python3 scripts/kalshi_maker_forward_leaderboard.py --json`
- status: NO_LIVE_READY | ready=false | cells=15 | ready_cells=0 | review_min=50 | fills=1732 pending_units=494 active=487 stale=7 unknown=0 overall_resolved_indep=1238 toxic=411 | next_pending=cell_sports_yes:KXMLBSPREAD-26JUN291940CINMIL-CIN2 status=active close=2026-07-02T23:40:00+00:00
- best: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=342/50 max_if_pending_resolve=638 new_needed_after_pending=0 | 262W-80L | pnl=-371.32 | Wilson 71.8% vs BE 87.5% | gap=-15.6pp | fills=638/2226 fill_rate=28.7% pending_units=296 active=289 stale=7 unknown=0 toxic=80 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUN291940CINMIL-CIN3 status=active close=2026-07-02T23:40:00+00:00 price=0.79
- rank 1: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=342/50 max_if_pending_resolve=638 new_needed_after_pending=0 | 262W-80L | pnl=-371.32 | Wilson 71.8% vs BE 87.5% | gap=-15.6pp | fills=638/2226 fill_rate=28.7% pending_units=296 active=289 stale=7 unknown=0 toxic=80 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUN291940CINMIL-CIN3 status=active close=2026-07-02T23:40:00+00:00 price=0.79
- rank 2: cell_crypto_yes | gate=NO_GO_REVIEW | resolved_indep=293/50 max_if_pending_resolve=312 new_needed_after_pending=0 | 167W-126L | pnl=-864.29 | Wilson 51.3% vs BE 86.5% | gap=-35.2pp | fills=312/1109 fill_rate=28.1% pending_units=19 active=19 stale=0 unknown=0 toxic=126 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXETHD-26JUL0317-T1429.99 status=active close=2026-07-03T21:00:00+00:00 price=0.88
- rank 3: cell_crypto_no | gate=NO_GO_REVIEW | resolved_indep=269/50 max_if_pending_resolve=282 new_needed_after_pending=0 | 153W-116L | pnl=-809.77 | Wilson 50.9% vs BE 87.0% | gap=-36.1pp | fills=282/968 fill_rate=29.1% pending_units=13 active=13 stale=0 unknown=0 toxic=116 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXETHD-26JUL0317-T1669.99 status=active close=2026-07-03T21:00:00+00:00 price=0.80
- rank 4: cell_index_no | gate=NO_GO_REVIEW | resolved_indep=113/50 max_if_pending_resolve=113 new_needed_after_pending=0 | 101W-12L | pnl=-29.57 | Wilson 82.4% vs BE 91.9% | gap=-9.6pp | fills=113/1944 fill_rate=5.8% pending_units=0 active=0 stale=0 unknown=0 toxic=12 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000
- rank 5: cell_sports_yes | gate=NO_GO_REVIEW | resolved_indep=100/50 max_if_pending_resolve=238 new_needed_after_pending=0 | 42W-58L | pnl=-453.32 | Wilson 32.8% vs BE 87.3% | gap=-54.5pp | fills=238/374 fill_rate=63.6% pending_units=138 active=138 stale=0 unknown=0 toxic=58 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUN291940CINMIL-CIN2 status=active close=2026-07-02T23:40:00+00:00 price=0.94
- rank 6: cell_weather_no | gate=NO_GO_REVIEW | resolved_indep=98/50 max_if_pending_resolve=123 new_needed_after_pending=0 | 81W-17L | pnl=-69.45 | Wilson 74.0% vs BE 89.7% | gap=-15.8pp | fills=123/258 fill_rate=47.7% pending_units=25 active=25 stale=0 unknown=0 toxic=17 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXHIGHMIA-26JUL02-B87.5 status=active close=2026-07-03T04:59:00+00:00 price=0.91
- rank 7: watch_crypto_bid_90_95 | gate=NO_GO_REVIEW | resolved_indep=97/50 max_if_pending_resolve=97 new_needed_after_pending=0 | 89W-8L | pnl=-18.13 | Wilson 84.6% vs BE 93.6% | gap=-9.1pp | fills=97/452 fill_rate=21.5% pending_units=0 active=0 stale=0 unknown=0 toxic=8 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000
- rank 8: watch_crypto_no_4_24h | gate=NO_GO_REVIEW | resolved_indep=58/50 max_if_pending_resolve=58 new_needed_after_pending=0 | 42W-16L | pnl=-87.69 | Wilson 59.8% vs BE 87.5% | gap=-27.7pp | fills=58/232 fill_rate=25.0% pending_units=0 active=0 stale=0 unknown=0 toxic=16 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000
...
- rank 2: weather YES maker_band=<85 | gate=ACCUMULATING | resolved_indep=11/50 | 10W-1L | pnl=+9.56 | Wilson 62.3% vs BE 82.2% | gap=-20.0pp | candidates=24 fills=14 fill_rate=58.3% pending_units=3 toxic=1 | blockers=resolved<50; wilson<=BE; toxic>0
- rank 3: weather YES maker_band=85-90 | gate=ACCUMULATING | resolved_indep=9/50 | 8W-1L | pnl=+0.48 | Wilson 56.5% vs BE 88.4% | gap=-31.9pp | candidates=16 fills=9 fill_rate=56.2% pending_units=0 toxic=1 | blockers=resolved<50; wilson<=BE; toxic>0
- rank 4: weather NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=52/50 | 48W-4L | pnl=-6.49 | Wilson 81.8% vs BE 93.6% | gap=-11.7pp | candidates=160 fills=66 fill_rate=41.2% pending_units=14 toxic=4 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 5: crypto YES maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=92/50 | 82W-10L | pnl=-36.72 | Wilson 81.1% vs BE 93.1% | gap=-12.0pp | candidates=349 fills=92 fill_rate=26.4% pending_units=0 toxic=10 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 6: index NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=94/50 | 83W-11L | pnl=-44.59 | Wilson 80.2% vs BE 93.0% | gap=-12.7pp | candidates=1709 fills=94 fill_rate=5.5% pending_units=0 toxic=11 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 7: sports NO maker_band=85-90 | gate=NO_GO_REVIEW | resolved_indep=89/50 | 72W-17L | pnl=-61.46 | Wilson 71.5% vs BE 87.8% | gap=-16.3pp | candidates=599 fills=190 fill_rate=31.7% pending_units=101 toxic=17 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 8: sports NO maker_band=<85 | gate=NO_GO_REVIEW | resolved_indep=131/50 | 94W-37L | pnl=-138.98 | Wilson 63.5% vs BE 82.4% | gap=-18.9pp | candidates=1148 fills=234 fill_rate=20.4% pending_units=103 toxic=37 | blockers=pnl<=0; wilson<=BE; toxic>0

## Kalshi Maker Walk-Forward Validation
- command: `python3 scripts/kalshi_maker_walkforward.py --limit 8`
- status: NO_MAKER_WALKFORWARD_CUT | ready=false | observations=1732 | cuts=187 | display_cuts=115 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-28T04:07:53+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_maker_cut_walkforward_requires_predeclared_live_spec
- best: maker_all_fills|category=crypto|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=45 resolved 38W-7L -$16.00 toxic=7 Wilson 71.2% vs target 90.0% gap=-18.8pp | validation=106 resolved 98W-8L +$34.88 toxic=8 Wilson 85.8% vs target 91.2% gap=-5.4pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none
- rank 1: maker_all_fills|category=crypto|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=45 resolved 38W-7L -$16.00 toxic=7 Wilson 71.2% vs target 90.0% gap=-18.8pp | validation=106 resolved 98W-8L +$34.88 toxic=8 Wilson 85.8% vs target 91.2% gap=-5.4pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none
- rank 2: maker_all_fills|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=single | train=158 resolved 129W-29L -$104.89 toxic=29 Wilson 74.9% vs target 90.3% gap=-15.4pp | validation=162 resolved 148W-14L +$30.17 toxic=14 Wilson 86.0% vs target 91.5% gap=-5.5pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUN291940CINMIL-CIN3 status=active due=2026-07-02T23:40:00+00:00 price=0.79
- rank 3: maker_all_fills|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=36 resolved 32W-4L -$14.68 toxic=4 Wilson 74.7% vs target 95.0% gap=-20.3pp | validation=49 resolved 46W-3L +$4.95 toxic=3 Wilson 83.5% vs target 94.8% gap=-11.3pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHMIA-26JUL02-B87.5 status=active due=2026-07-03T04:59:00+00:00 price=0.91
- rank 4: maker_all_fills|category=crypto|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=13 resolved 10W-3L -$20.80 toxic=3 Wilson 49.7% vs target 94.9% gap=-45.2pp | validation=30 resolved 29W-1L +$11.26 toxic=1 Wilson 83.3% vs target 94.9% gap=-11.6pp | blockers=train_resolved<30;train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none
- rank 5: maker_all_fills|side=YES|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=4 resolved 3W-1L -$6.93 toxic=1 Wilson 30.1% vs target 94.3% gap=-64.3pp | validation=18 resolved 18W-0L +$13.09 toxic=0 Wilson 82.4% vs target 94.7% gap=-12.3pp | blockers=train_resolved<30;train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUL011235CWSBAL-BAL2 status=active due=2026-07-04T16:35:00+00:00 price=0.91
- rank 6: maker_all_fills|side=YES|side_bid_band=80-85 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=24 resolved 21W-3L +$4.28 toxic=3 Wilson 69.0% vs target 87.7% gap=-18.7pp | validation=42 resolved 37W-5L +$11.12 toxic=5 Wilson 75.0% vs target 87.4% gap=-12.4pp | blockers=train_resolved<30;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHNY-26JUL02-B99.5 status=active due=2026-07-03T04:59:00+00:00 price=0.81
- rank 7: maker_all_fills|due_hour=04Z | gate=MAKER_WALKFORWARD_REJECT | type=single | train=34 resolved 26W-8L -$41.70 toxic=8 Wilson 60.0% vs target 90.7% gap=-30.7pp | validation=30 resolved 28W-2L +$12.20 toxic=2 Wilson 78.7% vs target 91.3% gap=-12.6pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHMIA-26JUL02-B87.5 status=active due=2026-07-03T04:59:00+00:00 price=0.91
- rank 8: maker_all_fills|side_bid_band=85-90 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=81 resolved 64W-17L -$91.98 toxic=17 Wilson 68.9% vs target 92.4% gap=-23.4pp | validation=89 resolved 78W-11L -$22.83 toxic=11 Wilson 79.2% vs target 92.2% gap=-13.0pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_pnl<=0;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUN292040MIACOL-COL6 status=active due=2026-07-03T00:40:00+00:00 price=0.92
...
- status: native=NO_LIVE_READY pending=22 active=22 stale=0 unknown=0 | maker=NO_LIVE_READY pending_units=494 active=487 stale=7 unknown=0 | queued=18
- 1. maker_stale:sports_no | ticker=KXMLBSPREAD-26JUN291910TEXCLE-CLE4 | status=stale | time=2026-07-02T23:10:00+00:00 | closed_unfinalized expiration=2026-07-02T23:10:00+00:00 price=0.82
- 2. maker_stale:sports_no | ticker=KXMLBSPREAD-26JUN291910TEXCLE-TEX4 | status=stale | time=2026-07-02T23:10:00+00:00 | closed_unfinalized expiration=2026-07-02T23:10:00+00:00 price=0.93
- 3. maker_stale:sports_no | ticker=KXMLBSPREAD-26JUN291910WSHBOS-BOS8 | status=stale | time=2026-07-02T23:10:00+00:00 | closed_unfinalized expiration=2026-07-02T23:10:00+00:00 price=0.83
- 4. maker_stale:sports_no | ticker=KXMLBSPREAD-26JUN291910WSHBOS-WSH3 | status=stale | time=2026-07-02T23:10:00+00:00 | closed_unfinalized expiration=2026-07-02T23:10:00+00:00 price=0.84
- 5. maker_stale:sports_no | ticker=KXMLBSPREAD-26JUN291910WSHBOS-WSH4 | status=stale | time=2026-07-02T23:10:00+00:00 | closed_unfinalized expiration=2026-07-02T23:10:00+00:00 price=0.87
- 6. maker:cell_sports_no | ticker=KXMLBSPREAD-26JUN291940CINMIL-CIN3 | status=active | time=2026-07-02T23:40:00+00:00 | resolved_indep=342 pending_units=296
- 7. maker:cell_sports_yes | ticker=KXMLBSPREAD-26JUN291940CINMIL-CIN2 | status=active | time=2026-07-02T23:40:00+00:00 | resolved_indep=100 pending_units=138
- 8. native:crypto_last_hour_longshot_no | ticker=KXSOLD-26JUL0220-T80.9999 | status=active | time=2026-07-02T23:59:59.120549+00:00 | resolved=304 pending=1
- 9. maker:cell_weather_no | ticker=KXHIGHMIA-26JUL02-B87.5 | status=active | time=2026-07-03T04:59:00+00:00 | resolved_indep=98 pending_units=25
- 10. maker:cell_weather_yes | ticker=KXHIGHNY-26JUL02-B101.5 | status=active | time=2026-07-03T04:59:00+00:00 | resolved_indep=23 pending_units=3

## Kalshi Academic-Prior Aligned Queue
- command: `python3 scripts/kalshi_academic_prior_queue.py --report --per-family 2`
- KALSHI ACADEMIC-PRIOR ALIGNED QUEUE
- generated_at=2026-07-02T23:11:59.495764+00:00 db=/home/eric-king/kalshi_favorites_bot/trades.db
- Lower rank_score means closer to review, not approval.
- 1. high_price_native_taker:crypto_last_hour_longshot_no | status=NATIVE_FORWARD_ACCUMULATING rank=0.0696 | 304 resolved 273W-31L -$3.21 | Wilson 85.9% vs target 92.9% | next=KXSOLD-26JUL0220-T80.9999 active due=2026-07-02T23:59:59.120549+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
- 2. high_price_native_taker:weather_no_candidate:no_95_98_zero_loss_cities_v1 | status=NATIVE_FORWARD_ACCUMULATING rank=0.1299 | 50 resolved 48W-2L -$0.75 | Wilson 86.5% vs target 99.5% | next=KXHIGHMIA-26JUL02-B87.5 active due=2026-07-03T14:00:00+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
- 3. source_shadow_requires_native:shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | status=SHADOW_STABILITY_REJECT rank=0.2500 | 582 events 538W-44L +$2404.82 | Wilson 90.0% vs target 89.5% | stability_validation=175ev 160W-15L +$570.21 Wilson 86.3% vs target 89.4% | blockers=source_only_requires_native_forward_gate, shadow_stability_reject, validation_wilson<avg_price+buffer, asset_slice_wilson<avg_price:KXSOLD, utc_hour_slice_pnl<=0:15Z, utc_hour_slice_wilson<avg_price:15Z | next=only promote if a matching native first-actionable gate clears after fees and depth
...
- 5. maker_adverse_selection:cell_sports_no | status=NO_GO_REVIEW rank=0.6562 | 342 independent resolved 262W-80L -$371.32 | Wilson 71.8% vs BE 87.5% | toxic=80 fill_rate=28.7% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
- 6. maker_adverse_selection:cell_crypto_yes | status=NO_GO_REVIEW rank=0.8522 | 293 independent resolved 167W-126L -$864.29 | Wilson 51.3% vs BE 86.5% | toxic=126 fill_rate=28.1% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
- 7. structural_arbitrage:same_strike_last_24h | status=WATCH_ONLY rank=1.0000 | 58517 observations | fresh_pairs=58517 execution_ready_tier=4979 gross_positive=1 execution_ready_gross_positive=0 qty10_positive=1 execution_ready_qty10_positive=0 best_gross_edge=0.02 | blockers=no_execution_ready_gross_positive, no_execution_ready_fee_net_qty10_positive | next=continue simultaneous quote scans; only trade fee-net positive executable dislocations
...
- recent_36h_backlog: unresolved=312 | expired_after_60s_grace=94 | oldest_expired=2026-07-01 13:59:59 | oldest_expected=2026-07-01 13:59:59
- recent_36h_crypto_backlog: unresolved=126 | expired_after_60s_grace=0 | oldest_expired=none | oldest_expected=2026-07-02 23:59:59
- native_gate_stale_unresolved=0
- resolved_last_30m=1385
...
- legacy_pre36h_expired_backlog: unresolved=6432 | crypto=6171 | other=258 | weather=3 | oldest_expired=2026-04-15 21:59:59 | newest_expired=2026-07-01 13:59:59
...
- recent_72h_backlog: unresolved=319 | expired_after_60s_grace=0 | oldest_expired=none | oldest_expected=2026-07-03 04:58:59
- native_weather_gate_stale_unresolved=0 | next_due=2026-07-03T14:00:00+00:00
...
-   5-10c: candidates=58388 fill=0.3% resolved=31 benign/toxic=9/22 net=$-13.96 benign=$+7.48 Wilson=70.1% BE=0.0% margin=+70.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   10-20c: candidates=56884 fill=0.4% resolved=47 benign/toxic=15/32 net=$-16.67 benign=$+44.57 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   20-35c: candidates=57645 fill=0.6% resolved=59 benign/toxic=21/38 net=$-17.84 benign=$+64.14 Wilson=84.5% BE=0.0% margin=+84.5pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   35-50c: candidates=35264 fill=0.6% resolved=41 benign/toxic=15/26 net=$+22.03 benign=$+65.98 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   50-65c: candidates=35385 fill=0.8% resolved=41 benign/toxic=12/29 net=$-42.10 benign=$+50.56 Wilson=75.7% BE=0.0% margin=+75.7pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   65-80c: candidates=30546 fill=0.7% resolved=51 benign/toxic=15/36 net=$-6.55 benign=$+68.80 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   80-90c: candidates=28690 fill=0.7% resolved=58 benign/toxic=15/43 net=$+13.69 benign=$+35.81 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   90-95c: candidates=16678 fill=0.5% resolved=36 benign/toxic=11/25 net=$-16.37 benign=$+10.53 Wilson=74.1% BE=0.0% margin=+74.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   95-99c: candidates=35300 fill=0.2% resolved=40 benign/toxic=7/33 net=$+0.30 benign=$+2.55 Wilson=64.6% BE=0.0% margin=+64.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT

## Timers
```
NEXT                                  LEFT LAST                                   PASSED UNIT                                                   ACTIVATES
Thu 2026-07-02 18:12:09 CDT             6s Thu 2026-07-02 18:11:09 CDT           53s ago gemini-ds-index-parity.timer                           gemini-ds-index-parity.service
Thu 2026-07-02 18:12:28 CDT            26s Thu 2026-07-02 18:07:22 CDT      4min 40s ago kalshi-crypto-favorite-taker-preflight.timer           kalshi-crypto-favorite-taker-preflight.service
Thu 2026-07-02 18:12:30 CDT            27s Thu 2026-07-02 18:12:00 CDT            1s ago gemini-cushion-ds-scanner.timer                        gemini-cushion-ds-scanner.service
Thu 2026-07-02 18:12:30 CDT            28s Thu 2026-07-02 18:11:57 CDT            5s ago kalshi-worldcup-score-state-live-pilot.timer           kalshi-worldcup-score-state-live-pilot.service
Thu 2026-07-02 18:12:39 CDT            37s Thu 2026-07-02 18:11:39 CDT           22s ago gateway-watchdog.timer                                 gateway-watchdog.service
Thu 2026-07-02 18:12:43 CDT            41s Thu 2026-07-02 18:07:43 CDT      4min 18s ago kalshi-side-equivalence-scanner.timer                  kalshi-side-equivalence-scanner.service
Thu 2026-07-02 18:12:45 CDT            43s Thu 2026-07-02 18:11:42 CDT           20s ago kalshi-worldcup-final-state-live-pilot.timer           kalshi-worldcup-final-state-live-pilot.service
Thu 2026-07-02 18:13:46 CDT       1min 44s Thu 2026-07-02 18:08:41 CDT      3min 20s ago kalshi-crypto-last-hour-longshot-no-preflight.timer    kalshi-crypto-last-hour-longshot-no-preflight.service
Thu 2026-07-02 18:13:49 CDT       1min 46s Thu 2026-07-02 18:08:49 CDT      3min 13s ago btc-moderate-v2-shadow-scanner.timer                   btc-moderate-v2-shadow-scanner.service
Thu 2026-07-02 18:13:49 CDT       1min 46s Thu 2026-07-02 18:08:49 CDT      3min 13s ago gemini-fp-orderbook-capture.timer                      gemini-fp-orderbook-capture.service
Thu 2026-07-02 18:13:49 CDT       1min 46s Thu 2026-07-02 18:08:49 CDT      3min 13s ago kalshi-shadow-forecast-accuracy-backfill.timer         kalshi-shadow-forecast-accuracy-backfill.service
Thu 2026-07-02 18:13:59 CDT       1min 57s Thu 2026-07-02 18:03:50 CDT          8min ago ds-shadow-continuous-archive.timer                     ds-shadow-continuous-archive.service
Thu 2026-07-02 18:14:08 CDT        2min 6s Thu 2026-07-02 18:08:58 CDT       3min 3s ago kalshi-shadow-longshot-fading-backfill.timer           kalshi-shadow-longshot-fading-backfill.service
Thu 2026-07-02 18:14:19 CDT       2min 17s Thu 2026-07-02 18:07:39 CDT      4min 22s ago kalshi-sports-final-state-live-pilot.timer             kalshi-sports-final-state-live-pilot.service
Thu 2026-07-02 18:14:55 CDT       2min 53s Thu 2026-07-02 18:09:55 CDT       2min 6s ago gemini-maker-fill-simulator.timer                      gemini-maker-fill-simulator.service
Thu 2026-07-02 18:15:00 CDT       2min 57s Thu 2026-07-02 18:00:00 CDT         12min ago cushion-ds-multi-series-resolver.timer                 cushion-ds-multi-series-resolver.service
Thu 2026-07-02 18:15:00 CDT       2min 57s Thu 2026-07-02 18:00:00 CDT         12min ago gemini-cushion-ds-resolver.timer                       gemini-cushion-ds-resolver.service
Thu 2026-07-02 18:15:38 CDT       3min 36s Thu 2026-07-02 18:10:38 CDT      1min 23s ago gemini-reward-post-only-safety.timer                   gemini-reward-post-only-safety.service
Thu 2026-07-02 18:15:38 CDT       3min 36s Thu 2026-07-02 18:10:38 CDT      1min 23s ago kalshi-weather-high-ask-no-preflight.timer             kalshi-weather-high-ask-no-preflight.service
Thu 2026-07-02 18:16:01 CDT       3min 59s Thu 2026-07-02 18:10:56 CDT       1min 5s ago kalshi-shadow-deterministic-settlement-backfill.timer  kalshi-shadow-deterministic-settlement-backfill.service
Thu 2026-07-02 18:16:10 CDT        4min 8s Thu 2026-07-02 18:11:02 CDT           59s ago kalshi-crypto-ladder-dislocation-preflight.timer       kalshi-crypto-ladder-dislocation-preflight.service
Thu 2026-07-02 18:16:21 CDT       4min 19s Thu 2026-07-02 18:11:21 CDT           40s ago kalshi-weather-no-candidate-preflight.timer            kalshi-weather-no-candidate-preflight.service
Thu 2026-07-02 18:16:23 CDT       4min 21s Thu 2026-07-02 18:01:23 CDT         10min ago gemini-ds-source-parity.timer                          gemini-ds-source-parity.service
Thu 2026-07-02 18:16:35 CDT       4min 33s Thu 2026-07-02 17:46:35 CDT         25min ago ds-storage-monitor.timer                               ds-storage-monitor.service
Thu 2026-07-02 18:16:52 CDT       4min 50s Thu 2026-07-02 18:11:46 CDT           15s ago kalshi-other-longshot-no-80-90-preflight.timer         kalshi-other-longshot-no-80-90-preflight.service
Thu 2026-07-02 18:17:00 CDT       4min 58s Thu 2026-07-02 18:11:57 CDT            5s ago kalshi-weather-yes-90-93-preflight.timer               kalshi-weather-yes-90-93-preflight.service
Thu 2026-07-02 18:17:16 CDT           5min Thu 2026-07-02 18:02:16 CDT          9min ago ds-storage-pressure-monitor.timer                      ds-storage-pressure-monitor.service
Thu 2026-07-02 18:18:36 CDT           6min Thu 2026-07-02 18:03:36 CDT          8min ago kalshi-side-equivalence-resolver.timer                 kalshi-side-equivalence-resolver.service
Thu 2026-07-02 18:19:23 CDT           7min Thu 2026-07-02 18:04:23 CDT          7min ago btc-moderate-v2-shadow-resolver.timer                  btc-moderate-v2-shadow-resolver.service
Thu 2026-07-02 18:19:23 CDT           7min Thu 2026-07-02 18:04:23 CDT          7min ago gemini-categorical-scanner.timer                       gemini-categorical-scanner.service
Thu 2026-07-02 18:19:58 CDT           7min Thu 2026-07-02 17:19:58 CDT         52min ago gemini-db-retention.timer                              gemini-db-retention.service
Thu 2026-07-02 18:21:26 CDT           9min Thu 2026-07-02 17:51:26 CDT         20min ago eth-ds-fg-filter-blocks-resolver.timer                 eth-ds-fg-filter-blocks-resolver.service
Thu 2026-07-02 18:23:12 CDT          11min Thu 2026-07-02 17:21:20 CDT         50min ago macro-release-resolver.timer                           macro-release-resolver.service
Thu 2026-07-02 18:24:21 CDT          12min Thu 2026-07-02 17:22:34 CDT         49min ago ladder-coherence-two-leg-resolver.timer                ladder-coherence-two-leg-resolver.service
Thu 2026-07-02 18:24:24 CDT          12min Thu 2026-07-02 18:09:24 CDT      2min 37s ago gemini-categorical-resolver.timer                      gemini-categorical-resolver.service
Thu 2026-07-02 18:26:18 CDT          14min Thu 2026-07-02 17:56:18 CDT         15min ago gemini-db-size-monitor.timer                           gemini-db-size-monitor.service
Thu 2026-07-02 18:30:00 CDT          17min Thu 2026-07-02 17:30:00 CDT         42min ago gemini-direct-index-ds-first-resolution-verifier.timer gemini-direct-index-ds-first-resolution-verifier.service
Thu 2026-07-02 19:17:00 CDT        1h 4min Thu 2026-07-02 13:17:01 CDT      4h 55min ago ds-shadow-retention-engine.timer                       ds-shadow-retention-engine.service
Thu 2026-07-02 20:13:54 CDT        2h 1min Wed 2026-07-01 20:13:54 CDT           21h ago launchpadlib-cache-clean.timer                         launchpadlib-cache-clean.service
Thu 2026-07-02 20:18:36 CDT        2h 6min Wed 2026-07-01 20:18:36 CDT           21h ago gemini-fp-retention.timer                              gemini-fp-retention.service
Thu 2026-07-02 20:19:02 CDT        2h 7min Thu 2026-07-02 17:19:02 CDT         52min ago db-auto-vacuum.timer                                   db-auto-vacuum.service
Thu 2026-07-02 21:10:37 CDT       2h 58min Thu 2026-07-02 15:10:37 CDT       3h 1min ago ds-shadow-db-maintenance.timer                         ds-shadow-db-maintenance.service
Thu 2026-07-02 21:24:20 CDT       3h 12min Thu 2026-07-02 15:24:20 CDT      2h 47min ago ds-shadow-archive.timer                                ds-shadow-archive.service
Fri 2026-07-03 03:15:00 CDT             9h Thu 2026-07-02 03:15:00 CDT           14h ago shadow-verification.timer                              shadow-verification.service
Fri 2026-07-03 03:30:00 CDT             9h Thu 2026-07-02 03:30:00 CDT           14h ago ibkr-independent-verification.timer                    ibkr-independent-verification.service
Fri 2026-07-03 04:30:00 CDT            10h Thu 2026-07-02 04:30:00 CDT           13h ago tax-ledger-ingest.timer                                tax-ledger-ingest.service
Fri 2026-07-03 04:46:49 CDT            10h Thu 2026-07-02 04:45:15 CDT           13h ago ds-archive-tier-rotation.timer                         ds-archive-tier-rotation.service
Fri 2026-07-03 05:20:00 CDT            11h Thu 2026-07-02 05:20:00 CDT           12h ago logrotate-user.timer                                   logrotate-user.service
Fri 2026-07-03 05:30:00 CDT            11h Thu 2026-07-02 05:30:01 CDT           12h ago disk-hygiene-audit.timer                               disk-hygiene-audit.service
Fri 2026-07-03 05:30:00 CDT            11h Thu 2026-07-02 05:30:01 CDT           12h ago full-picture-daily-save.timer                          full-picture-daily-save.service
Fri 2026-07-03 05:40:00 CDT            11h Thu 2026-07-02 05:40:00 CDT           12h ago database-autonomous-maintenance.timer                  database-autonomous-maintenance.service
Fri 2026-07-03 06:40:00 CDT            12h Thu 2026-07-02 08:05:01 CDT           10h ago ibkr-deterministic-fx-poc.timer                        ibkr-deterministic-fx-poc.service
Sun 2026-07-05 02:00:00 CDT         2 days Sun 2026-06-28 02:00:00 CDT        4 days ago gemini-archive-compression.timer                       gemini-archive-compression.service
Mon 2026-07-06 20:16:34 CDT         4 days Mon 2026-06-29 20:16:34 CDT        2 days ago ubuntu-insights-upload.timer                           ubuntu-insights-upload.service
Thu 2026-07-23 06:43:39 CDT 2 weeks 6 days Mon 2026-06-22 20:13:39 CDT 1 week 2 days ago ubuntu-insights-collect.timer                          ubuntu-insights-collect.service
-                                        - Thu 2026-07-02 18:10:01 CDT       2min 1s ago claude-chat-sync.timer                                 claude-chat-sync.service
-                                        - Thu 2026-07-02 18:12:00 CDT            1s ago cushion-ds-multi-series-scanner.timer                  cushion-ds-multi-series-scanner.service
-                                        - Thu 2026-07-02 18:10:01 CDT       2min 1s ago full-picture-latest-refresh.timer                      full-picture-latest-refresh.service
-                                        - Thu 2026-07-02 18:11:57 CDT            5s ago gemini-ds-index-micro-parity.timer                     gemini-ds-index-micro-parity.service
-                                        - Thu 2026-07-02 18:10:35 CDT      1min 26s ago gemini-liquidity-rewards-scanner.timer                 gemini-liquidity-rewards-scanner.service
-                                        - Thu 2026-07-02 07:27:13 CDT           10h ago gemini-reward-account-monitor.timer                    gemini-reward-account-monitor.service
-                                        - Thu 2026-07-02 07:23:13 CDT           10h ago gemini-reward-inventory-exit.timer                     gemini-reward-inventory-exit.service
-                                        - Thu 2026-07-02 07:25:01 CDT           10h ago gemini-reward-live-readiness.timer                     gemini-reward-live-readiness.service
-                                        - Thu 2026-07-02 07:22:48 CDT           10h ago gemini-reward-quote-pilot.timer                        gemini-reward-quote-pilot.service
-                                        - Thu 2026-07-02 18:07:33 CDT      4min 29s ago gemini-trade-print-capture.timer                       gemini-trade-print-capture.service
-                                        - Thu 2026-07-02 18:09:46 CDT      2min 15s ago kalshi-mve-component-result-live-pilot.timer           kalshi-mve-component-result-live-pilot.service
-                                        - Wed 2026-07-01 09:00:00 CDT      1 day 9h ago snap.firmware-updater.firmware-notifier.timer          snap.firmware-updater.firmware-notifier.service
...
- operations-knowledge: head=5c6d5ce branch=master in_sync=true remote=https://github.com/PhotonRahm/operations-knowledge.git dirty=yes
...
## Today's Research Files (2026-07-02 America/Chicago)
- research/2026-07-02-fx-gj-kalshi-esports-structural-audit.md
- research/2026-07-02-fx-gk-kalshi-mutex-no-refresh.md
- research/2026-07-02-fx-gl-kalshi-kxmve-cross-event-refresh.md
- research/2026-07-02-fx-gm-kalshi-worldcup-mlb-final-state-refresh.md
- research/2026-07-02-fx-gn-kalshi-cross-platform-native-forward-refresh.md
- research/2026-07-02-fx-go-kalshi-catalog-ladder-discovery-refresh.md
- research/2026-07-02-fx-gp-kalshi-academic-maker-exhaustiveness-refresh.md
- research/2026-07-02-fx-gq-kalshi-direct-mlb-player-prop-state-audit.md
- research/2026-07-02-fx-gr-kalshi-mlb-player-prop-outs-total-bases-expansion.md
- research/2026-07-02-fx-gs-kalshi-mlb-player-prop-rbi-expansion.md
- research/2026-07-02-fx-gt-kalshi-mlb-partial-game-state-audit.md
- research/2026-07-02-fx-gu-kalshi-wnba-game-state-audit.md
- research/2026-07-02-fx-gv-kalshi-soccer-game-state-audit.md
- research/2026-07-02-fx-gw-kalshi-direct-game-surface-and-soccer-expansion.md
- research/2026-07-02-fx-gx-kalshi-usl-brazil-serie-c-soccer-expansion.md
- research/2026-07-02-fx-gy-kalshi-ecuador-ligapro-soccer-window.md
- research/2026-07-02-fx-gz-kalshi-afl-game-state-audit.md
- research/2026-07-02-fx-ha-kalshi-nba-summer-game-state-audit.md
- research/2026-07-02-fx-hb-kalshi-asia-baseball-game-state-audit.md
- research/2026-07-02-fx-hc-kalshi-fiba-game-state-audit.md
- research/2026-07-02-fx-hd-kalshi-nznbl-game-state-audit.md
- research/2026-07-02-fx-he-kalshi-cfl-game-state-audit.md
- research/2026-07-02-fx-hf-kalshi-vba-game-state-audit.md
- research/2026-07-02-fx-hg-kalshi-big3-game-state-audit.md
- research/2026-07-02-fx-hh-kalshi-lmb-game-state-audit.md
- research/2026-07-02-fx-hi-kalshi-r6-game-state-audit.md
- research/2026-07-02-fx-hj-kalshi-valorant-game-state-audit.md
- research/2026-07-02-fx-hk-kalshi-lol-game-state-audit.md
- research/2026-07-02-fx-hl-kalshi-esports-map-sweep-audit.md
- research/2026-07-02-fx-hm-kalshi-hourly-temp-state-audit.md
- research/2026-07-02-fx-hn-kalshi-mlb-stolen-base-prop-expansion.md
- research/2026-07-02-fx-ho-kalshi-cs2-hltv-game-state-audit.md
- research/2026-07-02-fx-hp-kalshi-worldcup-player-contribution-state-audit.md
- research/2026-07-02-fx-hq-kalshi-tennis-doubles-final-state-expansion.md
- research/2026-07-02-fx-hr-kalshi-wnba-player-prop-state-audit.md
- research/2026-07-02-fx-hs-kalshi-cs2-total-maps-state-audit.md
- research/2026-07-02-fx-ht-kalshi-tennis-wnba-hourly-live-refresh.md
- research/2026-07-02-fx-hu-kalshi-mve-component-result-refresh.md
- research/2026-07-02-fx-hv-kalshi-maker-native-whole-universe-gate-refresh.md
- research/2026-07-02-fx-hw-kalshi-live-lag-source-refresh.md
- research/2026-07-02-fx-hx-kalshi-worldcup-starting-lineup-state-audit.md
- research/2026-07-02-fx-hy-kalshi-wnba-period-state-audit.md
- research/2026-07-02-fx-hz-kalshi-worldcup-corner-state-audit.md
- research/2026-07-02-fx-ia-kalshi-itf-flashscore-match-state-audit.md
- research/2026-07-02-fx-ib-kalshi-broad-live-refresh-and-event-scan-fix.md
- research/2026-07-02-fx-ic-kalshi-structural-post-expiration-and-native-refresh.md
- research/2026-07-02-fx-id-kalshi-resolution-lag-official-source-refresh.md
- research/2026-07-02-fx-ie-kalshi-broad-live-refresh-no-pilot.md
- research/2026-07-02-fx-if-kalshi-netflix-top10-rank-audit.md
- research/2026-07-02-fx-ig-kalshi-x-post-count-audit.md
- research/2026-07-02-fx-ih-kalshi-tennis-walkover-guard-refresh.md
- research/2026-07-02-fx-ii-kalshi-broad-live-source-and-native-refresh.md
- research/2026-07-02-fx-ij-kalshi-tennis-throttle-and-indexu-refresh.md
- research/2026-07-02-fx-ik-kalshi-structural-source-and-native-refresh.md
- research/2026-07-02-fx-il-kalshi-resolution-source-and-structural-refresh.md
- research/2026-07-02-fx-im-kalshi-state-lock-passive-maker-refresh.md
- research/2026-07-02-fx-in-kalshi-locked-mve-passive-maker-live-pilot.md
- research/2026-07-02-fx-io-kalshi-date-threshold-and-live-pilot-closeout.md
- research/2026-07-02-fx-ip-kalshi-date-threshold-whole-universe-scanner.md
- research/2026-07-02-fx-iq-kalshi-date-threshold-catalog-scan.md
- research/2026-07-02-fx-ir-kalshi-catalog-interval-threshold-chunks.md
- research/2026-07-02-fx-is-kalshi-duplicate-proposition-catalog-chunks.md
- research/2026-07-02-fx-it-kalshi-binary-complement-catalog-chunks.md
- research/2026-07-02-fx-iu-kalshi-interval-relation-catalog-scan.md
- research/2026-07-02-fx-iv-kalshi-series-ladder-catalog-windows.md
- research/2026-07-02-fx-iw-kalshi-event-mutex-current-state-refresh.md
- research/2026-07-02-fx-ix-kalshi-event-result-propagation-current-state.md
- research/2026-07-02-fx-iy-kalshi-public-result-active-current-state.md
- research/2026-07-02-fx-iz-kalshi-post-close-active-current-state.md
- research/2026-07-02-fx-ja-kalshi-weather-chi-low-live-pilot.md
- research/2026-07-02-fx-jb-kalshi-structural-catalog-window-advance.md
- research/2026-07-02-fx-jc-kalshi-broad-source-refresh-and-universe-check.md
- research/2026-07-02-fx-jd-kalshi-structural-catalog-window-advance-2.md
- research/2026-07-02-fx-je-kalshi-live-source-and-catalog-refresh.md
- research/2026-07-02-fx-jf-kalshi-netflix-views-live-pilot.md
- research/2026-07-02-fx-jg-kalshi-broad-refresh-mention-and-structural-no-go.md
