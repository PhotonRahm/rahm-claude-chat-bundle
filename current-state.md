...
last_updated_utc: 2026-07-06T23:10:00+00:00
pipeline_heartbeat_utc: 2026-07-06T23:10:00+00:00
generator: Codex generate_current_state.py
workspace_head: 0710930

## Chat Startup Critical Summary
- Generated for Claude-in-chat startup at 2026-07-06T18:10:00-05:00; missing artifacts render UNAVAILABLE instead of breaking sync.
- Full-picture artifact: FULL PICTURE - 2026-07-06 06:00 PM
...
- Kalshi reconciliation: Reconciliation: resolved_pnl=$-1500.38 open_cost=$0.47 open_fees=$0.03 recon_adj=$189.84 expected_cash=$1188.96 cash_gap=$+0.00 unrealized=$-0.44 [MATCH]
- IBKR: NLV: $1,949.48
- IBKR state: Status: ⚠️ Flex sync 289h stale | ❌ Gateway DOWN | ❌ KILL switch active
...
- • Combined true P&L: **$-16331.66**
- • True lifetime P&L (bots − one-time − recurring): **$-19224.53**
...
- strategy/cohort excerpts:
  ...
  - Next decision gate: 2026-07-07T00:30:00+00:00 - direct-index DS next resolution (178 rows/6 events unresolved | current qty5: 122 rows/6 events unresolved | micro qty1: 56 rows/6 events unresolved) resolution checks; no live expansion before event-collapsed results
...
- active_enter: Fri 2026-07-03 09:09:17 CDT
- reconciliation:
  - Reconciliation: resolved_pnl=$-1500.38 open_cost=$0.47 open_fees=$0.03 recon_adj=$189.84 expected_cash=$1188.96 cash_gap=$+0.00 unrealized=$-0.44 [MATCH]
  - ✓ HARD CHECK PASSED — gap $0.00
...
- strategy/cohort excerpts:
  ...
  - Live-matched v2 (full filter stack): 375W-15L (96.2%) | maker +$1,328.00  -> taker +$530.91
  - Live-matched v2 first-ticker: 255W-15L (94.4%) | taker -$166.60 | Wilson 91.0% vs BE 95.1% | 7d -$95.81 | gate=NOT_LIVE_DEPLOYABLE
  - v1→v2 drops: tier=5087, volume=2824, excluded=1159, category=185, spread=58, nws=52, hours=36
  - [2.5] Moderate Favorites Pilot ($0.80-$0.85 only)
  - Validation vs shadow: shadow WR 83.5% / +$170.00 (spread<=0.05 + allowed assets, matches pilot) | live WR 82.8% | ✓ matches shadow
  ...
  - Mean reversion shadow freshness: last_row=2026-04-22T03:02:54Z age=75.8d live_match_last=2026-04-21T02:43:31Z post_kill_shadow_rows=0 post_kill_live_placements=0 | gate=STALE_NO_FORWARD_EVIDENCE
  ...
  - Forecast accuracy YES 90-93 above-live-threshold: event-first 132W-4L n=136 | +$1,376.20 avg_ask=0.914 | Wilson 92.7% vs BE 92.5% margin=+0.1pp | recent 52W-3L n=55 Wilson 85.1% vs BE 92.6% | pending=0 stale_pending=0 | gate=THIN_MARGIN_RECENT_UNDERPOWERED_FORWARD_ONLY
  - Forecast accuracy high-ask NO event-first: ask>=0.98 all 1013W-8L n=1021 | +$1,162.14 avg_ask=0.985 | Wilson 98.5% vs BE 98.7%
  - Forecast accuracy high-ask NO ex-LAX: 929W-5L n=934 | +$1,527.78 avg_ask=0.985 | Wilson 98.8% vs BE 98.7% | unresolved_live_est_events=21 | gate=FORWARD_WATCH_ONLY
  - Forecast accuracy high-ask NO native preflight: rows=61923 events=258 actionable_qty1=1750 latest=2026-07-06T23:06:21+00:00 | reasons: missing_native_no_ask=52751, nonpositive_qty1_win:0.0000=4477, actionable_qty1_fee_positive=1750, native_no_ask_out_of_band:0.0100=467 | latest_run=2026-07-06T23:06:21+00:00 candidates=20 checked=20 actionable=0 run_reasons={"missing_native_no_ask": 20}
  - Forecast accuracy high-ask NO latest actionables: captured=2026-07-06T23:06:21+00:00 events=20 actionable_events=0 top_reason=missing_native_no_ask
  - Forecast accuracy high-ask NO native gate: native_events=77 resolved=65 pending=12 62W-3L native_pnl=-$2.35 Wilson 87.3% vs BE 99.0% next_pending=KXHIGHMIA-26JUL06-T87 city=MIA event=KXHIGHMIA-26JUL06 due=2026-07-07T14:00:00+00:00 ttl=47.8h no_ask=0.98 depth=101.00 win1=+$0.01 loss1=-$0.99
  - Forecast accuracy NO candidate-cell preflight: rows=43479 cohorts=2 events=91 actionable_qty1=11692 latest=2026-07-06T23:07:47+00:00 | latest_run=2026-07-06T23:07:47+00:00 candidates=8 checked=8 actionable=0 run_reasons={"no_90_95_min_probe_v1:missing_native_no_ask": 1, "no_95_98_zero_loss_cities_v1:missing_native_no_ask": 6, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.8100": 1}
  - Forecast accuracy NO candidate-cell cohorts: no_95_98_zero_loss_cities_v1 rows=38965 events=89 actionable=10813; no_90_95_min_probe_v1 rows=4514 events=12 actionable=879
  - Forecast accuracy NO candidate-cell latest cohort actionables: no_90_95_min_probe_v1 captured=2026-07-06T23:07:47+00:00 events=1 actionable_events=0 top_reason=missing_native_no_ask; no_95_98_zero_loss_cities_v1 captured=2026-07-06T23:07:47+00:00 events=7 actionable_events=0 top_reason=missing_native_no_ask
  - Forecast accuracy NO candidate-cell historical control: all-city 95-98 963W-31L n=994 Wilson 95.6% vs BE 96.7%; selected-cities 331W-2L n=333 Wilson 97.8% vs BE 96.8%; weakest_city=AUS 43W-1L n=44 Wilson 88.2% vs BE 96.9% | selected-city filter is in-sample; no live order
  - Forecast accuracy NO candidate-cell forward gate: no_90_95_min_probe_v1 native_events=12 resolved=11 pending=1 10W-1L native_pnl=-$0.40 Wilson 62.3% vs BE 94.5% next_pending=KXHIGHTMIN-26JUL06-B85.5 city=MIN event=KXHIGHTMIN-26JUL06 due=2026-07-07T19:00:00+00:00 ttl=52.9h no_ask=0.93 depth=24.00 win1=+$0.06 loss1=-$0.94; no_95_98_zero_loss_cities_v1 native_events=85 resolved=78 pending=7 76W-2L native_pnl=-$0.07 Wilson 91.1% vs BE 97.5% next_pending=KXHIGHMIA-26JUL06-T94 city=MIA event=KXHIGHMIA-26JUL06 due=2026-07-07T14:00:00+00:00 ttl=47.0h no_ask=0.97 depth=118.00 win1=+$0.02 loss1=-$0.98 best_pending=KXHIGHTDAL-26JUL06-B101.5 city=DAL event=KXHIGHTDAL-26JUL06 due=2026-07-07T19:00:00+00:00 no_ask=0.96 depth=43.00 win1=+$0.03 loss1=-$0.97
  ...
  - Legacy untapped FX/Index NO maker/cancel proxy: v2 side_bid=0.85-0.90 candidates=600 markets=39 fills=27 pending_fills=1 resolved_indep=26/50 23W-3L pnl=-$5.00 Wilson 71.0% vs modeled BE 90.3% | cancels=571 late_cross_ttl=8 open=2 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Legacy weather-city NO shadow: bid>=0.88 first-ticker-side 5801W-287L n=6088 | +$10,086.05 | avg_bid=0.932 | Wilson 94.7% vs modeled BE 93.6% margin=+1.1pp | pending=87 | gate=LEGACY_MAKER_FORWARD_REQUIRED
  - Legacy weather-city NO recency: since_2026-06-17 2389W-108L n=2497 +$3,770.38 pending=85 Wilson 94.8% vs modeled BE 94.2% | forward_since_2026-06-25T09:35Z resolved=1354 pending=85 | blocked 1667W-93L +$2,021.33, unblocked 4134W-194L +$8,064.72 | best=KXHIGHTDAL 232W-7L +$920.92; worst=KXLOWTDEN 240W-21L -$451.32 | next_pending=KXHIGHMIA-26JUL06-T87 city=MIA due_est=2026-07-07T04:58:59.142001+00:00 ttl_at_capture=38.9h bid=0.97 overdue_pending=2 | bid-side/maker-priced shadow, not taker-executable
  - Legacy weather-city NO event collapse: event-side 1154W-22L n=1176 +$3,778.07 pending=24 Wilson 97.2% vs modeled BE 94.9% margin=+2.3pp | recent_event_side 467W-13L n=480 Wilson 95.4% vs BE 95.4% | forward_event_side resolved=264 pending=24 | gate=EVENT_MAKER_FORWARD_REQUIRED
  - Legacy weather-city NO maker/cancel proxy: v2 side_bid>=0.88 candidates=146 markets=74 fills=47 pending_fills=4 resolved_indep=43/50 42W-1L pnl=+$18.04 Wilson 87.9% vs modeled BE 93.5% | cancels=98 late_cross_ttl=16 open=1 | gate=MAKER_FILL_FORWARD_REQUIRED
  ...
  - Crypto long-expiry maker/cancel proxy: v2 crypto side_bid=0.90-0.95 candidates=594 markets=334 fills=137 pending_fills=1 resolved_indep=136/50 127W-9L pnl=-$4.28 Wilson 87.9% vs modeled BE 93.7% | 24hplus_candidates=122 24hplus_fills=20 24hplus_pending_fills=1 | cancels=425 late_cross_ttl=50 open=32 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel shadow: v2 side_bid=0.92-0.94 candidates=319 markets=196 fills=82 filled_units=82 pending_fills=0 resolved_indep=82/50 78W-4L pnl=+$7.63 Wilson 88.1% vs modeled BE 94.2% | cancels=222 late_cross_ttl=25 open=15 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel sides: NO rows=170 markets=99 fills=39 pending=0 resolved_rows=39; YES rows=149 markets=97 fills=43 pending=0 resolved_rows=43 | source=kalshi_high_price_maker_cancel_shadow | no live orders
  - Crypto legacy taker NO shadow: ask=0.90-0.95 12-24h first-ticker-side 250W-16L n=266 | +$520.34 | avg_ask=0.915 | Wilson 90.5% vs modeled BE 92.0% margin=-1.6pp | pending=0 | gate=NO_GO
  - Crypto favorite taker native preflight: rows=12264 cohorts=2 contracts=63 actionable_obs=3039 latest=2026-07-05T20:57:57+00:00 | latest_run=2026-07-06T23:09:41+00:00 candidates=0 checked=0 actionable=0 reasons={} | no order path
  ...
  - Crypto contrarian NO underdog shadow: ask=0.20-0.25 18-24h event-first 21W-44L n=65 +$534.53 avg_ask=0.228 Wilson 22.2% vs modeled BE 24.1% pending=1 active_pending=0 stale_pending=1 old_live_match_events=6/66 | gate=ALL_PERIOD_BELOW_BREAKEVEN_POSTHOC
  - Crypto contrarian NO recency: since_2026-06-17 13W-17L n=30 +$571.65 pending=0 Wilson 27.4% vs modeled BE 24.3% | forward_since_2026-06-25T10:40Z resolved=12 pending=0 | 2026-04 8W-27L -$37.12, 2026-06 13W-11L +$711.92 | BTC 8W-19L +$144.37 pending=0, ETH 9W-10L +$455.98 pending=0, SOL 4W-15L -$65.82 pending=1 | next_pending=KXSOLD-26APR2417-T83.9999 event=KXSOLD-26APR2417 due_est=2026-04-24T20:59:59.002927+00:00 ttl=-1754.2h ask=0.22 spread=0.09 active_pending=0 stale_pending=1 unknown_pending=0 | exploratory ask-priced shadow; no live orders
  - Crypto last-hour longshot NO shadow: event-first 1296W-84L n=1380 | +$6,848.08 avg_ask=0.882 | Wilson 92.5% vs modeled BE 89.0% | recent 875W-70L +$3,014.26 | gate=LIQUIDITY_PROXY_FAIL_FORWARD_ONLY
  - Crypto last-hour longshot liquidity: volume=0 617W-9L +$7,013.27; volume>=500/spread<=5c 459W-47L +$105.41 Wilson 87.9% vs BE 90.5%; 80-85c volume-backed 52W-5L +$419.10 Wilson 81.1% vs BE 83.9%; 90-95c volume-backed 290W-22L +$41.80 Wilson 89.6% vs BE 92.8%; 95-99c volume-backed 661W-27L -$722.35 Wilson 94.4% vs BE 97.1%; forward_since_2026-06-25T11:20Z 499W-46L +$1,028.48 Wilson 88.9% vs BE 89.7% resolved=545 pending=1 | no live orders
  - Crypto last-hour longshot native preflight: rows=7152 events=545 actionable_qty1=2052 latest=2026-07-06T23:07:14+00:00 | latest_run=2026-07-06T23:07:14+00:00 candidates=1 checked=1 actionable=1 reasons={"actionable_qty1_fee_positive": 1} | no order path
  - Crypto last-hour longshot latest actionables: captured=2026-07-06T23:07:14+00:00 events=1 contracts=1 actionable_contracts=1 best=KXBTCD-26JUL0620-T64499.99 asset=BTC event=KXBTCD-26JUL0620 due=2026-07-06T23:59:59.504534+00:00 no_ask=0.88 depth=142.96 win1=+$0.11 loss1=-$0.89
  - Crypto last-hour longshot native gate: native_events=415 resolved=414 pending=1 active_pending=1 stale_pending=0 unknown_pending=0 374W-40L native_pnl=-$0.84 Wilson 87.1% vs BE 90.5% next_pending=KXBTCD-26JUL0620-T64499.99 asset=BTC event=KXBTCD-26JUL0620 due=2026-07-06T23:59:59.504534+00:00 no_ask=0.88 depth=142.96 win1=+$0.11 loss1=-$0.89 | gate=NATIVE_FORWARD_ACCUMULATING
  ...
  - Summary: rows=10040 open=254 fills=2379 markets=2143 cancels=7407 late_cross_ttl=563 resolved=2020 markets=1840 pnl=-4780.98 last=2026-07-06T23:04:29+00:00
  - Pending fills: unresolved=359 markets=303 next=KXMLBSPREAD-26JUL031905MINNYY-NYY4 sports YES close=2026-07-06T23:05:00+00:00 expiration=2026-07-06T23:05:00+00:00 | units=359 active=332 stale=27 unknown=0
  - Overall independent fills: resolved=2020 1284W-736L pnl=-4780.98 wilson_low=61.4% breakeven=87.2% toxic=736 status=NO_GO_REVIEW
  - Review progress: best_cell=sports NO resolved_independent=652/50 indep=469W-183L pnl=-1005.88 wilson_low=68.4% breakeven=87.4% toxic=183 pending_markets=228 filled_markets=880 next_close=2026-07-06T23:05:00+00:00 status=NO_GO_REVIEW
  - Cell scan: resolved_cells=7 edge_positive_cells=0 leader=sports NO resolved_indep=652 best_edge_positive=none best_alternate=crypto NO resolved_indep=425 211W-214L pnl=-1554.87 wilson_low=44.9% breakeven=86.2% toxic=214 status=NO_GO_REVIEW
  ...
  - Post-kill NO <10c first-eligible live pending preview: pending_first_eligible=0 live_actionable=0 settlement_pending_or_ineligible=0 now=2026-07-06T23:10:18+00:00 | no order path
  ...
  - Pending native-actionable rows: FX=12452, INDEX=27066
  - Gate: failed; native executable rows disprove Index/FX favorite-tracking salvage

## Storage State
- DATABASE STORAGE HEALTH
-   Overall status: GREEN / TARGET
-   Disk: 213.61 GiB used / 936.79 GiB total (22.8%), 675.52 GiB free
-   Envelope: TARGET 50.0%, WARN 65.0%, CRITICAL 75.0%, HARD_LIMIT 85.0%
-   DS storage: active 1.18 GiB (state TARGET), hot 15.86 GiB, warm 0.14 GiB, cold 0.00 GiB, archive_state TARGET, total 17.19 GiB (1.8% of disk)
-   Archive sidecars: OK
-   Retention engine: last=2026-07-06T18:17:00+00:00 status=OK dry_run=False rows_selected=0 rows_archived=0 rows_pruned=0
-   Archive compression: status=OK actions=0 warm_days=7 min_file_mb=100
-   Tier rotation: last=2026-07-06T18:17:00+00:00 status=OK actions=0
...
- latest_run: id=66 captured_at=2026-07-05T22:18:24+00:00 | markets_seen=100000 post_expiration_open_unresolved=61 candidate_count=0 | direct_market_recheck=True pages=100 page_cap=True rate_limited=False | trigger_fields={"expected_expiration_time": 61} | top_series=KXMVESPORTSMULTIGAMEEXTENDED=38, KXMVECROSSCATEGORY=23
...
- latest_run: id=54 captured_at=2026-07-05T19:18:41+00:00 | markets_seen=25000 post_close_open_unresolved=0 candidates=0 min_age_min=1.00 max_ask=0.30 max_spread=0.15 min_depth=1 | pages=25 page_cap=true rate_limited=false | categories=none | top_series=unknown
...
- latest_run: id=71 captured_at=2026-07-05T22:18:24+00:00 | markets_seen=100000 public_result_active=0 candidates=0 max_ask=0.30 max_spread=0.15 min_depth=1 | pages=100 page_cap=true rate_limited=false | results=none | categories=none | top_series=unknown
...
- latest_run: id=43 captured_at=2026-07-06T23:09:48+00:00 | version=event_result_propagation_v1 events_seen=2600 events_examined=1648 mutex_events=241 details=240/240 detail_cap=true markets=2338 locked=0 actionable_qty1=0 max_ask=0.25 min_depth=1 | pages=13 page_cap=false rate_limited=true | reasons=event_not_mutually_exclusive_summary=1407, no_exhaustive_proof=240, detail_cap_reached=1
...
- latest_run: id=55 captured_at=2026-07-05T17:41:53+00:00 | events_seen=2000 mutex_events=398 details=398/500 markets=4874 tradable_no=2427 candidates=0 top_net=-2.2pp | pages=10 page_cap=true rate_limited=false | categories=Elections=193, Sports=134, Politics=25, Economics=17, Entertainment=15, Financials=6 | detail_errors=none
- nearest_no_bundles: KXCAGOVPRIMARY1ST-26JUN02-1ST KXCAGOVPRIMARY1ST k=2 floor=1.00 cost=1.00 fees=0.02 net=-2.2pp tickers=KXCAGOVPRIMARY1ST-26JUN02-1ST-XBEC,KXCAGOVPRIMARY1ST-26JUN02-1ST-SHIL ; KXNBAEAST-27 KXNBAEAST k=12 floor=11.00 cost=10.90 fees=0.13 net=-3.0pp tickers=KXNBAEAST-27-NYK,KXNBAEAST-27-PHI,KXNBAEAST-27-BOS ; KXNCAAFCONF-26 KXNCAAFCONF k=5 floor=4.00 cost=3.96 fees=0.07 net=-3.0pp tickers=KXNCAAFCONF-26-SEC,KXNCAAFCONF-26-B10,KXNCAAFCONF-26-OTHER ; GOVPARTYMT-28 GOVPARTYMT k=2 floor=1.00 cost=1.01 fees=0.02 net=-3.0pp tickers=GOVPARTYMT-28-R,GOVPARTYMT-28-D ; KXPRIMARYMOV-COPRIMARY01D26 KXPRIMARYMOV k=2 floor=1.00 cost=1.01 fees=0.02 net=-3.0pp tickers=KXPRIMARYMOV-COPRIMARY01D26-MKIR-P13,KXPRIMARYMOV-COPRIMARY01D26-MKIR-P57
- unsafe_all_yes_positive_requires_exhaustive_validation: count=13 best_net=+73.3pp
...
- latest_run: id=39 captured_at=2026-07-05T17:18:44+00:00 | version=event_exhaustive_yes_v2_esports events_seen=199 event_details=199 baskets_checked=147 actionable_qty1=0 min_net_edge=0.000 | series=14 page_limits=[200] | counts=KXATPCHALLENGERMATCH=36, KXITFMATCH=14, KXITFWMATCH=4, KXLOLGAME=15, KXLOLMAP=12, KXMLBGAME=39, KXNBAGAME=0, KXNHLGAME=0 | reasons=exhaustive_basket_checked=147, two_way_sports_shape_mismatch=46, not_all_active_yes_tradable=4, event_not_mutually_exclusive=2
- nearest_baskets: KXVALORANTMAP-26JUL051100RBNEP-3 two_way_no_tie_sports_match contracts=2 sum_asks=1.000 fees=0.020 net=-0.020 depth=8 actionable=0 ; KXITFMATCH-26JUL05CRIMAR two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=4680 actionable=0 ; KXATPCHALLENGERMATCH-26JUL05URRMEL two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=406 actionable=0 ; KXATPCHALLENGERMATCH-26JUL05MONHUR two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=570 actionable=0 ; KXATPCHALLENGERMATCH-26JUL05GOIAND two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=14337 actionable=0
...
- status: NO_LIVE_READY | ready=false | cells=9 | ready_cells=0 | min_resolved=30 | edge_buffer=+2.0pp | pending=23 active=23 stale=0 unknown=0 | next_pending=crypto_last_hour_longshot_no:KXBTCD-26JUL0620-T64499.99 status=active due=2026-07-06T23:59:59.504534+00:00
- best: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=415 resolved=414 pending=1 active=1 stale=0 unknown=0 | 374W-40L | pnl=-0.84 | Wilson 87.1% vs BE 90.5% | gap=-3.4pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=308 | next_pending=KXBTCD-26JUL0620-T64499.99 status=active due=2026-07-06T23:59:59.504534+00:00 ask=0.88
- rank 1: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=415 resolved=414 pending=1 active=1 stale=0 unknown=0 | 374W-40L | pnl=-0.84 | Wilson 87.1% vs BE 90.5% | gap=-3.4pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=308 | next_pending=KXBTCD-26JUL0620-T64499.99 status=active due=2026-07-06T23:59:59.504534+00:00 ask=0.88
- rank 2: weather_no_candidate:no_95_98_zero_loss_cities_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=85 resolved=78 pending=7 active=7 stale=0 unknown=0 | 76W-2L | pnl=-0.07 | Wilson 91.1% vs BE 97.5% | gap=-6.4pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=1508 | next_pending=KXHIGHMIA-26JUL06-T94 status=active due=2026-07-07T14:00:00+00:00 ask=0.97
...
- rank 4: weather_high_ask_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=77 resolved=65 pending=12 active=12 stale=0 unknown=0 | 62W-3L | pnl=-2.35 | Wilson 87.3% vs BE 99.0% | gap=-11.7pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=>5000_or_target_impossible | next_pending=KXHIGHMIA-26JUL06-T87 status=active due=2026-07-07T14:00:00+00:00 ask=0.98
- rank 5: weather_yes_90_93:yes_90_93_above_live_threshold_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=34 resolved=34 pending=0 active=0 stale=0 unknown=0 | 31W-3L | pnl=-0.39 | Wilson 77.0% vs BE 92.3% | gap=-15.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=118
...
- status: NATIVE_CUT_FORWARD_REQUIRED | ready=false | observations=20359 | cuts=2442 | display_cuts=661 | candidate_cuts=1 | ready_cuts=0 | min_resolved=30 | min_display_resolved=10 | edge_buffer=+2.0pp | scope=posthoc_native_executable_cut_discovery_requires_predeclared_forward_gate
...
- rank 4: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=108 resolved=108 pending=0 active=0 stale=0 unknown=0 | 105W-3L | pnl=+$4.99 | Wilson 92.1% vs target 94.6% (BE 92.6%) | gap=-2.5pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=52
...
- rank 6: crypto_last_hour_longshot_no|native_ask_band=85-90 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=240 resolved=239 pending=1 active=1 stale=0 unknown=0 | 217W-22L | pnl=+$6.05 | Wilson 86.5% vs target 90.3% (BE 88.3%) | gap=-3.8pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=97 | next_pending=KXBTCD-26JUL0620-T64499.99 status=active due=2026-07-06T23:59:59.504534+00:00 ask=0.88
- rank 7: crypto_last_hour_longshot_no|native_spread_band=<=2c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=171 resolved=171 pending=0 active=0 stale=0 unknown=0 | 160W-11L | pnl=+$4.43 | Wilson 88.8% vs target 93.0% (BE 91.0%) | gap=-4.1pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=104
- rank 8: crypto_last_hour_longshot_no|native_spread_band=<=1c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=350 resolved=349 pending=1 active=1 stale=0 unknown=0 | 321W-28L | pnl=+$4.03 | Wilson 88.6% vs target 92.8% (BE 90.8%) | gap=-4.2pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=207 | next_pending=KXBTCD-26JUL0620-T64499.99 status=active due=2026-07-06T23:59:59.504534+00:00 ask=0.88
...
- best: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=114 resolved=113 pending=1 active=1 stale=0 unknown=0 | 100W-13L | pnl=$-2.30 | Wilson 81.3% vs target 92.5% (BE 90.5%) | gap=-11.2pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=179 | next_pending=KXBTCD-26JUL0620-T64499.99 status=active due=2026-07-06T23:59:59.504534+00:00 ask=0.88 | excluded_post_start_actionables=636 (native_spread_band=<=5c=225, native_depth_band=1000+=164, native_spread_band=<=2c=147, native_depth_band=10-99=74) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=271 (not_actionable=271) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 1: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=114 resolved=113 pending=1 active=1 stale=0 unknown=0 | 100W-13L | pnl=$-2.30 | Wilson 81.3% vs target 92.5% (BE 90.5%) | gap=-11.2pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=179 | next_pending=KXBTCD-26JUL0620-T64499.99 status=active due=2026-07-06T23:59:59.504534+00:00 ask=0.88 | excluded_post_start_actionables=636 (native_spread_band=<=5c=225, native_depth_band=1000+=164, native_spread_band=<=2c=147, native_depth_band=10-99=74) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=271 (not_actionable=271) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 2: native_watch|crypto_strong_no_90_95 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=60 resolved=60 pending=0 active=0 stale=0 unknown=0 | 51W-9L | pnl=$-5.08 | Wilson 73.9% vs target 95.5% (BE 93.5%) | gap=-21.6pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=313 | excluded_post_start_actionables=799 (signal_tier=weak=332, signal_tier=moderate=329, native_ask_band=85-90=66, native_ask_band=95-98=43) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89 | target_window_misses=916 (not_actionable_native_ask_band=missing=300, not_actionable_native_ask_band=<80=123, not_actionable_native_ask_band=99+=118, not_actionable_native_ask_band=95-98=117) | target_window_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89
- rank 3: native_watch|crypto_btc_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-30T07:13:19+00:00 | observations=55 resolved=54 pending=1 active=1 stale=0 unknown=0 | 44W-10L | pnl=$-3.65 | Wilson 69.2% vs target 90.2% (BE 88.2%) | gap=-21.1pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=130 | next_pending=KXBTCD-26JUL0620-T64499.99 status=active due=2026-07-06T23:59:59.504534+00:00 ask=0.88 | excluded_post_start_actionables=1082 (asset=SOL=324, asset=ETH=320, native_ask_band=90-95=293, native_ask_band=80-85=73) | excluded_sample=KXBTCD-26JUN3005-T59699.99 native_ask_band=90-95 ask=0.94 | target_window_misses=1758 (not_actionable_native_ask_band=missing=594, native_ask_band=90-95=293, not_actionable_native_ask_band=<80=194, not_actionable_native_ask_band=98-99=192) | target_window_sample=KXBTCD-26JUN3004-T59799.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 4: native_watch|crypto_spread_le1_depth_10_99 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T07:10:00+00:00 | observations=52 resolved=52 pending=0 active=0 stale=0 unknown=0 | 47W-5L | pnl=$+0.16 | Wilson 79.4% vs target 92.1% (BE 90.1%) | gap=-12.7pp | blockers=wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=92 | excluded_post_start_actionables=908 (native_depth_band=100-999=341, native_spread_band=<=5c=227, native_depth_band=1000+=165, native_spread_band=<=2c=149) | excluded_sample=KXBTCD-26JUL0104-T58899.99 native_depth_band=100-999 ask=0.93 | target_window_misses=90 (not_actionable=90) | target_window_sample=KXSOLD-26JUL0107-T75.9999 not_actionable ask=0.99
- rank 5: native_watch|crypto_20_40m_no_80_85 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-29T11:05:00+00:00 | observations=44 resolved=44 pending=0 active=0 stale=0 unknown=0 | 40W-4L | pnl=$+3.03 | Wilson 78.8% vs target 86.0% (BE 84.0%) | gap=-7.2pp | blockers=wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=26 | excluded_post_start_actionables=1357 (minutes_band=40-60m=783, native_ask_band=90-95=234, native_ask_band=85-90=119, minutes_band=10-20m=115) | excluded_sample=KXBTCD-26JUN2908-T60299.99 minutes_band=40-60m ask=0.95 | target_window_misses=1614 (not_actionable_native_ask_band=missing=281, not_actionable_native_ask_band=98-99=253, native_ask_band=90-95=234, not_actionable_native_ask_band=99+=230) | target_window_sample=KXBTCD-26JUN2908-T60299.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 6: native_watch|crypto_sol_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T13:00:00+00:00 | observations=30 resolved=30 pending=0 active=0 stale=0 unknown=0 | 27W-3L | pnl=$+0.49 | Wilson 74.4% vs target 90.4% (BE 88.4%) | gap=-16.0pp | blockers=wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=58 | excluded_post_start_actionables=865 (asset=BTC=473, asset=ETH=233, native_ask_band=90-95=94, native_ask_band=80-85=39) | excluded_sample=KXBTCD-26JUL0110-T59199.99 asset=BTC ask=0.93 | target_window_misses=567 (not_actionable_native_ask_band=missing=117, native_ask_band=90-95=94, not_actionable_native_ask_band=99+=88, not_actionable_native_ask_band=<80=78) | target_window_sample=KXSOLD-26JUL0111-T79.9999 not_actionable_native_ask_band=missing
- rank 7: native_watch|crypto_btc_strong_no_90_95_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T14:00:00+00:00 | observations=21 resolved=21 pending=0 active=0 stale=0 unknown=0 | 19W-2L | pnl=$-0.62 | Wilson 71.1% vs target 95.4% (BE 93.4%) | gap=-24.3pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=135 | excluded_post_start_actionables=880 (asset=ETH=233, asset=SOL=231, signal_tier=moderate=180, signal_tier=weak=95) | excluded_sample=KXETHD-26JUL0111-T1609.99 asset=ETH ask=0.90 | target_window_misses=125 (not_actionable_native_ask_band=95-98=31, native_ask_band=85-90=22, not_actionable_native_ask_band=99+=21, not_actionable_native_ask_band=<80=20) | target_window_sample=KXBTCD-26JUL0112-T60099.99 native_ask_band=85-90 ask=0.89
- rank 8: native_watch|crypto_tue_no_any_ask | gate=FORWARD_WATCH_WAITING | start=2026-07-01T07:10:00+00:00 | observations=0 resolved=0 pending=0 active=0 stale=0 unknown=0 | 0W-0L | pnl=$+0.00 | Wilson 0.0% vs target 2.0% (BE 0.0%) | gap=-2.0pp | blockers=no_forward_observations;resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=>5000_or_target_impossible | excluded_post_start_actionables=983 (captured_weekday=Sat=305, captured_weekday=Sun=197, captured_weekday=Fri=180, captured_weekday=Thu=165) | excluded_sample=KXBTCD-26JUL0104-T58899.99 captured_weekday=Wed ask=0.93

## Kalshi Native Preflight Walk-Forward Validation
- command: `python3 scripts/kalshi_native_preflight_walkforward.py --limit 8`
- status: NO_WALKFORWARD_NATIVE_CUT | ready=false | observations=20359 | cuts=2442 | display_cuts=314 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-07-01T21:39:23+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_walkforward_native_cut_validation_requires_predeclared_forward_gate
- best: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=WALKFORWARD_REJECT | type=single | train=31 resolved 29W-2L +$2.03 Wilson 79.3% vs target 89.0% gap=-9.7pp | validation=29 resolved 29W-0L +$4.02 Wilson 88.3% vs target 88.1% gap=+0.2pp | blockers=train_wilson<BE+buffer | promotion_blockers=none
- rank 1: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=WALKFORWARD_REJECT | type=single | train=31 resolved 29W-2L +$2.03 Wilson 79.3% vs target 89.0% gap=-9.7pp | validation=29 resolved 29W-0L +$4.02 Wilson 88.3% vs target 88.1% gap=+0.2pp | blockers=train_wilson<BE+buffer | promotion_blockers=none
...
- rank 5: crypto_ladder_dislocation|captured_weekday=Wed | gate=WALKFORWARD_REJECT | type=single | train=15 resolved 11W-4L -$1.56 Wilson 48.0% vs target 85.7% gap=-37.7pp | validation=0 resolved 0W-0L +$0.00 Wilson 0.0% vs target 2.0% gap=-2.0pp | blockers=train_resolved<30;train_pnl<=0;train_wilson<BE+buffer;validation_resolved<15;validation_pnl<=0;validation_wilson<BE+buffer | promotion_blockers=none
- rank 6: crypto_last_hour_longshot_no|asset=ETH|native_ask_band=85-90 | gate=WALKFORWARD_REJECT | type=pair | train=37 resolved 33W-4L +$0.33 Wilson 75.3% vs target 90.3% gap=-15.0pp | validation=25 resolved 25W-0L +$3.01 Wilson 86.7% vs target 90.0% gap=-3.3pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 7: crypto_last_hour_longshot_no|minutes_to_expiry_band=10-20m | gate=WALKFORWARD_REJECT | type=single | train=69 resolved 59W-10L -$3.72 Wilson 75.3% vs target 92.9% gap=-17.6pp | validation=41 resolved 40W-1L +$2.76 Wilson 87.4% vs target 92.8% gap=-5.4pp | blockers=train_pnl<=0;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 8: crypto_last_hour_longshot_no|signal_tier=weak|native_ask_band=85-90 | gate=WALKFORWARD_REJECT | type=pair | train=43 resolved 39W-4L +$1.11 Wilson 78.4% vs target 90.1% gap=-11.7pp | validation=36 resolved 34W-2L +$2.55 Wilson 81.9% vs target 89.4% gap=-7.5pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
...
- rank 2: crypto_last_hour_native_subcell:strong:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=179 resolved=178 pending=1 active=1 stale=0 unknown=0 | 162W-16L | pnl=-3.72 | Wilson 85.9% vs BE 93.1% | gap=-7.2pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=344 | next_pending=KXBTCD-26JUL0620-T64499.99 status=active due=2026-07-06T23:59:59.504534+00:00 ask=0.88
- rank 3: crypto_last_hour_native_subcell:weak:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=108 resolved=108 pending=0 active=0 stale=0 unknown=0 | 94W-14L | pnl=-0.48 | Wilson 79.4% vs BE 87.5% | gap=-8.1pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=110
- rank 4: crypto_last_hour_native_subcell:native_ask:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=188 resolved=187 pending=1 active=1 stale=0 unknown=0 | 166W-21L | pnl=+3.86 | Wilson 83.4% vs BE 86.7% | gap=-3.3pp | blockers=wilson<BE+2pp | perfect_wins_needed=91 | next_pending=KXBTCD-26JUL0620-T64499.99 status=active due=2026-07-06T23:59:59.504534+00:00 ask=0.88
- rank 5: crypto_last_hour_native_subcell:native_ask:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=180 resolved=180 pending=0 active=0 stale=0 unknown=0 | 165W-15L | pnl=-2.58 | Wilson 86.7% vs BE 93.1% | gap=-6.4pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=320
...
- status: NO_ENTRY_TIMING_CANDIDATE | ready=false | posthoc_candidates=0 | source_actionable_rows=2052 | selected_observations=1046 | cuts=381 | min_resolved=30 | edge_buffer=+2.0pp
- best: crypto_last_hour_entry_timing:latest_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=222 resolved=222 pending=0 | 215W-7L | pnl=+$7.29 | Wilson 93.6% vs target 95.6% (BE 93.6%) | gap=-1.9pp | blockers=wilson<BE+2pp
- rank 1: crypto_last_hour_entry_timing:latest_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=222 resolved=222 pending=0 | 215W-7L | pnl=+$7.29 | Wilson 93.6% vs target 95.6% (BE 93.6%) | gap=-1.9pp | blockers=wilson<BE+2pp
...
- rank 3: crypto_last_hour_entry_timing:first_actionable|native_depth_band=1000+ | gate=ENTRY_TIMING_ACCUMULATING | observations=101 resolved=101 pending=0 | 97W-4L | pnl=+$4.50 | Wilson 90.3% vs target 93.6% (BE 91.6%) | gap=-3.3pp | blockers=wilson<BE+2pp
- rank 4: crypto_last_hour_entry_timing:first_actionable|signal_tier=weak|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=48 resolved=48 pending=0 | 46W-2L | pnl=+$3.90 | Wilson 86.0% vs target 89.7% (BE 87.7%) | gap=-3.7pp | blockers=wilson<BE+2pp
- rank 5: crypto_last_hour_entry_timing:latest_actionable|asset=BTC|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=102 resolved=102 pending=0 | 99W-3L | pnl=+$3.41 | Wilson 91.7% vs target 95.7% (BE 93.7%) | gap=-4.0pp | blockers=wilson<BE+2pp
- rank 6: crypto_last_hour_entry_timing:first_actionable|native_spread_band=<=1c | gate=ENTRY_TIMING_ACCUMULATING | observations=280 resolved=279 pending=1 | 258W-21L | pnl=+$4.48 | Wilson 88.8% vs target 92.9% (BE 90.9%) | gap=-4.1pp | blockers=wilson<BE+2pp
- rank 7: crypto_last_hour_entry_timing:first_actionable|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=120 resolved=119 pending=1 | 110W-9L | pnl=+$4.80 | Wilson 86.2% vs target 90.4% (BE 88.4%) | gap=-4.2pp | blockers=wilson<BE+2pp
- rank 8: crypto_last_hour_entry_timing:latest_actionable|asset=BTC|native_ask_band=95-98 | gate=ENTRY_TIMING_ACCUMULATING | observations=54 resolved=54 pending=0 | 54W-0L | pnl=+$2.16 | Wilson 93.4% vs target 98.0% (BE 96.0%) | gap=-4.6pp | blockers=wilson<BE+2pp

## Kalshi Crypto Ladder Dislocation Preflight
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_preflight.py --json`
- latest_run: captured_at=2026-07-06T23:10:55+00:00 | lookahead=75m | events=5 rows_per_event=40 | candidates=109 checked=109 dislocation_qty1=0 | min_source_edge=0.03 max_source_age=300s | top_reasons=missing_native_no_ask=107, source_age_too_old:490s=1, source_age_too_old:491s=1
- latest_rows: KXETHD-26JUL0620-T1829.99 ETH/extreme source_no=0.98 native_no_ask=0.99 edge=-0.01 age=491s spread=0.01 depth=1001 win=0.00 due=2026-07-06T23:59:59.198732+00:00 reason=source_age_too_old:491s ; KXSOLD-26JUL0620-T82.9999 SOL/strong source_no=0.93 native_no_ask=0.98 edge=-0.05 age=490s spread=0.03 depth=3213 win=0.01 due=2026-07-06T23:59:59.760233+00:00 reason=source_age_too_old:490s ; KXETHD-26JUL0620-T1849.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=491s spread=missing depth=0 win=missing due=2026-07-06T23:59:59.204197+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0620-T1869.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=491s spread=missing depth=0 win=missing due=2026-07-06T23:59:59.208392+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0620-T1889.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=491s spread=missing depth=0 win=missing due=2026-07-06T23:59:59.212683+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0620-T1909.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=491s spread=missing depth=0 win=missing due=2026-07-06T23:59:59.217635+00:00 reason=missing_native_no_ask

## Kalshi Crypto Ladder Dislocation Forward Audit
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_audit.py --limit 8`
- status: NO_LIVE_READY | ready=false | cells=6 | ready_cells=0 | observations=113 | min_resolved=30 | edge_buffer=+2.0pp | scope=source-vs-native ladder gaps only; not riskless structural arbitrage
- best: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=73 resolved=73 pending=0 active=0 stale=0 | 52W-21L pnl_qty1=-$7.70 | Wilson 60.0% vs target 83.8% gap=-23.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=119
- rank 1: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=73 resolved=73 pending=0 active=0 stale=0 | 52W-21L pnl_qty1=-$7.70 | Wilson 60.0% vs target 83.8% gap=-23.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=119
- rank 2: ticker_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=77 resolved=77 pending=0 active=0 stale=0 | 55W-22L pnl_qty1=-$8.42 | Wilson 60.5% vs target 84.4% gap=-23.9pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=130
- rank 3: all_rows | gate=LADDER_DISLOCATION_ACCUMULATING | observations=113 resolved=113 pending=0 active=0 stale=0 | 75W-38L pnl_qty1=-$14.55 | Wilson 57.2% vs target 81.2% gap=-24.0pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=157
...
- rank 6: asset_sol | gate=LADDER_DISLOCATION_ACCUMULATING | observations=55 resolved=55 pending=0 active=0 stale=0 | 37W-18L pnl_qty1=-$5.95 | Wilson 54.1% vs target 80.1% gap=-26.0pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=82
...
- rank 2: shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=636 | 588W-48L | pnl=+2625.97 | Wilson 90.1% vs target 89.6% (avg_price 87.6%) | target_gap=+0.6pp | blockers=none
- rank 3: shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=913 | 800W-113L | pnl=+3425.55 | Wilson 85.3% vs target 84.9% (avg_price 82.9%) | target_gap=+0.4pp | blockers=none

## Kalshi Shadow Longshot Stability Audit
- command: `python3 scripts/kalshi_shadow_longshot_stability_audit.py --limit 8`
- status: NO_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=7612 | eligible_cells=25 | base_candidate_cells=3 | stable_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
...
- 2. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=636ev 588W-48L +2625.97 Wilson 90.1% vs target 89.6% gap +0.6pp | train=445ev 412W-33L +1886.97 Wilson 89.8% vs target 89.6% gap +0.2pp | validation=191ev 176W-15L +739.00 Wilson 87.4% vs target 89.5% gap -2.1pp | worst_asset=KXETHD 101ev 94W-7L +494.58 Wilson 86.4% vs target 89.4% gap -3.0pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 3. shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=913ev 800W-113L +3425.55 Wilson 85.3% vs target 84.9% gap +0.4pp | train=639ev 570W-69L +3573.58 Wilson 86.6% vs target 84.6% gap +1.9pp | validation=274ev 230W-44L -148.03 Wilson 79.1% vs target 85.5% gap -6.4pp | worst_asset=KXSOLD 170ev 150W-20L +661.85 Wilson 82.5% vs target 85.4% gap -2.8pp | worst_hour=13Z 38ev 27W-11L -504.02 Wilson 55.2% vs target 85.3% gap -30.1pp | blockers=validation_pnl<=0;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
...
- status: NO_FILTERED_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=7612 | base_candidate_cells=3 | filtered_cells=74 | filtered_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=15Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=15Z | excluded=26 | aggregate=610ev 569W-41L +3022.89 Wilson 91.0% vs target 89.6% gap +1.4pp | train=427ev 398W-29L +2078.68 Wilson 90.4% vs target 89.6% gap +0.8pp | validation=183ev 171W-12L +944.21 Wilson 88.9% vs target 89.5% gap -0.6pp | worst_asset=KXETHD 97ev 91W-6L +551.44 Wilson 87.2% vs target 89.4% gap -2.2pp | worst_hour=13Z 23ev 19W-4L -131.61 Wilson 62.9% vs target 89.6% gap -26.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
- 2. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=02Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=02Z | excluded=36 | aggregate=600ev 557W-43L +2688.53 Wilson 90.5% vs target 89.6% gap +0.9pp | train=420ev 389W-31L +1780.92 Wilson 89.7% vs target 89.6% gap +0.1pp | validation=180ev 168W-12L +907.61 Wilson 88.7% vs target 89.5% gap -0.8pp | worst_asset=KXSOLD 107ev 100W-7L +542.38 Wilson 87.1% vs target 89.6% gap -2.5pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 3. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_asset=KXETHD,exclude_hour=15Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_asset=KXETHD,exclude_hour=15Z | excluded=123 | aggregate=513ev 478W-35L +2471.45 Wilson 90.7% vs target 89.6% gap +1.1pp | train=359ev 334W-25L +1665.05 Wilson 89.9% vs target 89.6% gap +0.3pp | validation=154ev 144W-10L +806.40 Wilson 88.5% vs target 89.5% gap -1.0pp | worst_asset=KXSOLD 112ev 105W-7L +610.98 Wilson 87.7% vs target 89.5% gap -1.9pp | worst_hour=13Z 21ev 17W-4L -156.02 Wilson 60.0% vs target 89.6% gap -29.6pp | blockers=validation_wilson<avg_price+buffer;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
- 4. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=01Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=01Z | excluded=40 | aggregate=596ev 551W-45L +2469.08 Wilson 90.0% vs target 89.5% gap +0.5pp | train=417ev 385W-32L +1669.89 Wilson 89.4% vs target 89.6% gap -0.2pp | validation=179ev 166W-13L +799.19 Wilson 88.0% vs target 89.5% gap -1.5pp | worst_asset=KXETHD 95ev 88W-7L +423.26 Wilson 85.6% vs target 89.4% gap -3.8pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 5. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=05Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=05Z | excluded=19 | aggregate=617ev 570W-47L +2495.99 Wilson 90.0% vs target 89.6% gap +0.4pp | train=431ev 398W-33L +1719.90 Wilson 89.4% vs target 89.6% gap -0.1pp | validation=186ev 172W-14L +776.09 Wilson 87.8% vs target 89.5% gap -1.8pp | worst_asset=KXETHD 98ev 91W-7L +456.07 Wilson 86.0% vs target 89.4% gap -3.5pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 6. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=13Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=13Z | excluded=23 | aggregate=613ev 569W-44L +2757.58 Wilson 90.5% vs target 89.6% gap +0.9pp | train=429ev 399W-30L +2001.17 Wilson 90.2% vs target 89.6% gap +0.6pp | validation=184ev 170W-14L +756.41 Wilson 87.6% vs target 89.5% gap -1.9pp | worst_asset=KXETHD 99ev 92W-7L +470.17 Wilson 86.1% vs target 89.4% gap -3.3pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 7. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=09Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=09Z | excluded=23 | aggregate=613ev 566W-47L +2459.50 Wilson 90.0% vs target 89.6% gap +0.4pp | train=429ev 396W-33L +1703.08 Wilson 89.4% vs target 89.6% gap -0.2pp | validation=184ev 170W-14L +756.42 Wilson 87.6% vs target 89.5% gap -1.9pp | worst_asset=KXETHD 97ev 90W-7L +446.72 Wilson 85.8% vs target 89.4% gap -3.6pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 8. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=21Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=21Z | excluded=26 | aggregate=610ev 564W-46L +2526.67 Wilson 90.1% vs target 89.6% gap +0.5pp | train=427ev 395W-32L +1778.67 Wilson 89.6% vs target 89.6% gap +0.0pp | validation=183ev 169W-14L +748.00 Wilson 87.6% vs target 89.5% gap -1.9pp | worst_asset=KXSOLD 113ev 105W-8L +521.29 Wilson 86.6% vs target 89.5% gap -2.9pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
...
- rank 2: weather_city_bid_side:KXHIGHTSEA:NO:90-95:unblocked | gate=LEGACY_SHADOW_REJECT | execution=legacy_bid_side_maker | events=48 | 48W-0L | pnl=+$345.94 | Wilson 92.6% vs target 94.8% (BE 92.8%, avg_price 92.3%) | gap=-2.2pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=22
- rank 3: weather_city_bid_side:KXHIGHTMIN:NO:90-95:unblocked | gate=LEGACY_SHADOW_REJECT | execution=legacy_bid_side_maker | events=47 | 47W-0L | pnl=+$330.93 | Wilson 92.4% vs target 94.9% (BE 92.9%, avg_price 92.5%) | gap=-2.5pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=25
...
- rank 5: weather_city_bid_side:KXHIGHTHOU:NO:90-95:unblocked | gate=LEGACY_SHADOW_REJECT | execution=legacy_bid_side_maker | events=44 | 44W-0L | pnl=+$308.49 | Wilson 92.0% vs target 95.0% (BE 93.0%, avg_price 92.5%) | gap=-3.0pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=29
- rank 6: weather_city_bid_side:KXHIGHMIA:NO:90-95:unblocked | gate=LEGACY_SHADOW_REJECT | execution=legacy_bid_side_maker | events=40 | 40W-0L | pnl=+$304.97 | Wilson 91.2% vs target 94.3% (BE 92.3%, avg_price 91.8%) | gap=-3.1pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=24
- rank 7: sell_inverse:WEATHER:NO:95+:4-24h | gate=LEGACY_SHADOW_REJECT | execution=legacy_inverse_shadow | events=750 | 8W-742L | pnl=-$594.16 | Wilson 0.5% vs target 3.9% (BE 1.9%, avg_price 98.3%) | gap=-3.3pp | blockers=pnl<=0;wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=33
...
- latest_run: captured_at=2026-07-06T23:11:04+00:00 | cohort=moderate_favorites_eth_yes_80_90_0_1h_v1 | start=2026-07-03T16:50:00+00:00 | include_pre_cutoff_live=false | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- latest_run: captured_at=2026-07-06T23:06:57+00:00 | cohort=yes_90_93_above_live_threshold_v1 | start=2026-06-25T11:45:00+00:00 | include_pre_cutoff_live=true | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- latest_run: captured_at=2026-07-06T23:07:47+00:00 | start=2026-06-25T07:05:00+00:00 | include_pre_cutoff_live=true | candidates=8 checked=8 actionable_qty1=0 | top_reasons=no_95_98_zero_loss_cities_v1:missing_native_no_ask=6, no_90_95_min_probe_v1:missing_native_no_ask=1, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.8100=1
- latest_rows: KXHIGHTMIN-26JUL06-B85.5 cohort=no_90_95_min_probe_v1 city=MIN no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-07T19:00:00+00:00 ; KXLOWTAUS-26JUL06-B78.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-07T19:00:00+00:00 ; KXHIGHTDAL-26JUL06-B101.5 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-07T19:00:00+00:00 ; KXHIGHTLV-26JUL06-T111 cohort=no_95_98_zero_loss_cities_v1 city=LV no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-07T19:00:00+00:00 ; KXHIGHMIA-26JUL06-T94 cohort=no_95_98_zero_loss_cities_v1 city=MIA no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-07T14:00:00+00:00 ; KXLOWTMIA-26JUL06-B75.5 cohort=no_95_98_zero_loss_cities_v1 city=MIA no_ask=0.81 no_ask_depth=2 qty1=+0.17/-0.83 reason=native_no_ask_out_of_band:0.8100 due=2026-07-07T19:00:00+00:00 ; KXHIGHTOKC-26JUL06-B97.5 cohort=no_95_98_zero_loss_cities_v1 city=OKC no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-07T19:00:00+00:00 ; KXHIGHTSEA-26JUL06-T79 cohort=no_95_98_zero_loss_cities_v1 city=SEA no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-07T19:00:00+00:00
...
- latest_run: captured_at=2026-07-06T23:09:06+00:00 | cohort=all | start=2026-06-25T23:20:00+00:00 | include_pre_cutoff_live=false | candidates=2 checked=2 actionable_qty1=2 | top_reasons=other_strong_no_90_95_4_24h_v1:actionable_qty1_fee_positive=2
- latest_rows: KXUSDJPY-26JUL0710-B163.125 cohort=other_strong_no_90_95_4_24h_v1 group=FX no_ask=0.92 no_ask_depth=100 spread=0.03 qty1=+0.07/-0.93 reason=actionable_qty1_fee_positive ; KXEURUSD-26JUL0710-B1.147 cohort=other_strong_no_90_95_4_24h_v1 group=FX no_ask=0.94 no_ask_depth=898 spread=0.03 qty1=+0.05/-0.95 reason=actionable_qty1_fee_positive
...
- status: NO_LIVE_READY | ready=false | cells=15 | ready_cells=0 | review_min=50 | fills=2380 pending_units=333 active=333 stale=0 unknown=0 overall_resolved_indep=2047 toxic=747 | next_pending=cell_sports_yes:KXMLBSPREAD-26JUL031915NYMATL-ATL2 status=active close=2026-07-06T23:15:00+00:00
- best: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=668/50 max_if_pending_resolve=881 new_needed_after_pending=0 | 484W-184L | pnl=-995.90 | Wilson 68.9% vs BE 87.4% | gap=-18.4pp | fills=881/3167 fill_rate=27.8% pending_units=213 active=213 stale=0 unknown=0 toxic=184 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUL031915NYMATL-ATL4 status=active close=2026-07-06T23:15:00+00:00 price=0.91
- rank 1: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=668/50 max_if_pending_resolve=881 new_needed_after_pending=0 | 484W-184L | pnl=-995.90 | Wilson 68.9% vs BE 87.4% | gap=-18.4pp | fills=881/3167 fill_rate=27.8% pending_units=213 active=213 stale=0 unknown=0 toxic=184 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUL031915NYMATL-ATL4 status=active close=2026-07-06T23:15:00+00:00 price=0.91
- rank 2: cell_crypto_no | gate=NO_GO_REVIEW | resolved_indep=425/50 max_if_pending_resolve=438 new_needed_after_pending=0 | 211W-214L | pnl=-1554.87 | Wilson 44.9% vs BE 86.2% | gap=-41.3pp | fills=438/1439 fill_rate=30.4% pending_units=13 active=13 stale=0 unknown=0 toxic=214 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0717-T65249.99 status=active close=2026-07-07T21:00:00+00:00 price=0.83
- rank 3: cell_crypto_yes | gate=NO_GO_REVIEW | resolved_indep=392/50 max_if_pending_resolve=409 new_needed_after_pending=0 | 219W-173L | pnl=-1188.65 | Wilson 50.9% vs BE 86.2% | gap=-35.3pp | fills=409/1374 fill_rate=29.8% pending_units=17 active=17 stale=0 unknown=0 toxic=173 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXETHD-26JUL1017-T1579.99 status=active close=2026-07-10T21:00:00+00:00 price=0.94
- rank 4: cell_sports_yes | gate=NO_GO_REVIEW | resolved_indep=245/50 max_if_pending_resolve=322 new_needed_after_pending=0 | 116W-129L | pnl=-972.65 | Wilson 41.2% vs BE 87.0% | gap=-45.9pp | fills=322/518 fill_rate=62.2% pending_units=77 active=77 stale=0 unknown=0 toxic=129 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUL031915NYMATL-ATL2 status=active close=2026-07-06T23:15:00+00:00 price=0.94
- rank 5: cell_weather_no | gate=NO_GO_REVIEW | resolved_indep=153/50 max_if_pending_resolve=164 new_needed_after_pending=0 | 125W-28L | pnl=-115.04 | Wilson 74.8% vs BE 89.2% | gap=-14.4pp | fills=164/353 fill_rate=46.5% pending_units=11 active=11 stale=0 unknown=0 toxic=28 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXHIGHMIA-26JUL06-B89.5 status=active close=2026-07-07T04:59:00+00:00 price=0.91
- rank 6: watch_crypto_bid_90_95 | gate=NO_GO_REVIEW | resolved_indep=136/50 max_if_pending_resolve=137 new_needed_after_pending=0 | 127W-9L | pnl=-4.28 | Wilson 87.9% vs BE 93.7% | gap=-5.8pp | fills=137/594 fill_rate=23.1% pending_units=1 active=1 stale=0 unknown=0 toxic=9 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXETHD-26JUL1017-T1579.99 status=active close=2026-07-10T21:00:00+00:00 price=0.94
- rank 7: cell_index_no | gate=NO_GO_REVIEW | resolved_indep=127/50 max_if_pending_resolve=128 new_needed_after_pending=0 | 113W-14L | pnl=-39.44 | Wilson 82.3% vs BE 92.0% | gap=-9.7pp | fills=128/3120 fill_rate=4.1% pending_units=1 active=1 stale=0 unknown=0 toxic=14 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXINX-26JUL10H1600-B7562 status=active close=2026-07-10T20:00:00+00:00 price=0.91
- rank 8: watch_crypto_bid_92_94 | gate=NO_GO_REVIEW | resolved_indep=82/50 max_if_pending_resolve=82 new_needed_after_pending=0 | 78W-4L | pnl=+7.63 | Wilson 88.1% vs BE 94.2% | gap=-6.1pp | fills=82/319 fill_rate=25.7% pending_units=0 active=0 stale=0 unknown=0 toxic=4 | blockers=wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000
...
- best: index NO maker_band=85-90 | gate=ACCUMULATING | resolved_indep=16/50 | 15W-1L | pnl=+9.64 | Wilson 71.7% vs BE 87.7% | gap=-16.0pp | candidates=400 fills=16 fill_rate=4.0% pending_units=0 toxic=1 | blockers=resolved<50; wilson<=BE; toxic>0
- rank 1: index NO maker_band=85-90 | gate=ACCUMULATING | resolved_indep=16/50 | 15W-1L | pnl=+9.64 | Wilson 71.7% vs BE 87.7% | gap=-16.0pp | candidates=400 fills=16 fill_rate=4.0% pending_units=0 toxic=1 | blockers=resolved<50; wilson<=BE; toxic>0
- rank 2: weather YES maker_band=<85 | gate=ACCUMULATING | resolved_indep=19/50 | 16W-3L | pnl=+3.68 | Wilson 62.4% vs BE 82.3% | gap=-19.8pp | candidates=39 fills=20 fill_rate=51.3% pending_units=1 toxic=3 | blockers=resolved<50; wilson<=BE; toxic>0
- rank 3: weather YES maker_band=90-95 | gate=ACCUMULATING | resolved_indep=5/50 | 5W-0L | pnl=+4.00 | Wilson 56.6% vs BE 92.0% | gap=-35.4pp | candidates=12 fills=5 fill_rate=41.7% pending_units=0 toxic=0 | blockers=resolved<50; wilson<=BE
- rank 4: crypto YES maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=114/50 | 101W-13L | pnl=-52.00 | Wilson 81.5% vs BE 93.2% | gap=-11.7pp | candidates=441 fills=116 fill_rate=26.3% pending_units=2 toxic=13 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 5: index NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=107/50 | 94W-13L | pnl=-55.72 | Wilson 80.3% vs BE 93.0% | gap=-12.7pp | candidates=2666 fills=108 fill_rate=4.1% pending_units=1 toxic=13 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 6: weather NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=76/50 | 67W-9L | pnl=-40.58 | Wilson 79.0% vs BE 93.5% | gap=-14.5pp | candidates=204 fills=83 fill_rate=40.7% pending_units=7 toxic=9 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 7: sports NO maker_band=<85 | gate=NO_GO_REVIEW | resolved_indep=254/50 | 177W-77L | pnl=-324.25 | Wilson 63.8% vs BE 82.5% | gap=-18.7pp | candidates=1688 fills=349 fill_rate=20.7% pending_units=95 toxic=77 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 8: weather NO maker_band=85-90 | gate=NEGATIVE_INTERIM | resolved_indep=32/50 | 27W-5L | pnl=-13.01 | Wilson 68.2% vs BE 88.4% | gap=-20.2pp | candidates=60 fills=33 fill_rate=55.0% pending_units=1 toxic=5 | blockers=resolved<50; pnl<=0; wilson<=BE; toxic>0

## Kalshi Maker Walk-Forward Validation
- command: `python3 scripts/kalshi_maker_walkforward.py --limit 8`
- status: NO_MAKER_WALKFORWARD_CUT | ready=false | observations=2380 | cuts=188 | display_cuts=130 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-30T19:26:56+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_maker_cut_walkforward_requires_predeclared_live_spec
- best: maker_all_fills|category=crypto|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=95 resolved 85W-10L +$12.57 toxic=10 Wilson 81.7% vs target 90.2% gap=-8.5pp | validation=105 resolved 97W-8L +$27.83 toxic=8 Wilson 85.7% vs target 91.7% gap=-6.0pp | blockers=train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0717-T65249.99 status=active due=2026-07-07T21:00:00+00:00 price=0.83
- rank 1: maker_all_fills|category=crypto|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=95 resolved 85W-10L +$12.57 toxic=10 Wilson 81.7% vs target 90.2% gap=-8.5pp | validation=105 resolved 97W-8L +$27.83 toxic=8 Wilson 85.7% vs target 91.7% gap=-6.0pp | blockers=train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0717-T65249.99 status=active due=2026-07-07T21:00:00+00:00 price=0.83
- rank 2: maker_all_fills|side=YES|side_bid_band=80-85 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=52 resolved 44W-8L -$5.74 toxic=8 Wilson 72.5% vs target 87.7% gap=-15.2pp | validation=41 resolved 38W-3L +$29.52 toxic=3 Wilson 80.6% vs target 87.5% gap=-6.9pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUL032010SFCOL-COL9 status=active due=2026-07-07T00:10:00+00:00 price=0.86
- rank 3: maker_all_fills|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=single | train=257 resolved 220W-37L -$74.31 toxic=37 Wilson 80.8% vs target 90.5% gap=-9.7pp | validation=168 resolved 148W-20L -$13.07 toxic=20 Wilson 82.3% vs target 90.9% gap=-8.5pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_pnl<=0;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHNY-26JUL06-B75.5 status=active due=2026-07-07T04:59:00+00:00 price=0.83
- rank 4: maker_all_fills|category=weather|spread_band=<=5c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=25 resolved 21W-4L -$8.48 toxic=4 Wilson 65.3% vs target 89.4% gap=-24.0pp | validation=26 resolved 25W-1L +$19.80 toxic=1 Wilson 81.1% vs target 90.5% gap=-9.4pp | blockers=train_resolved<30;train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHMIA-26JUL06-B89.5 status=active due=2026-07-07T04:59:00+00:00 price=0.91
- rank 5: maker_all_fills|side_bid_band=92-94 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=88 resolved 81W-7L -$18.00 toxic=7 Wilson 84.5% vs target 96.1% gap=-11.6pp | validation=68 resolved 64W-4L -$0.20 toxic=4 Wilson 85.8% vs target 96.1% gap=-10.3pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_pnl<=0;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHLAX-26JUL06-T77 status=active due=2026-07-07T07:59:00+00:00 price=0.94
- rank 6: maker_all_fills|category=crypto|side_bid_band=92-94 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=28 resolved 27W-1L +$6.31 toxic=1 Wilson 82.3% vs target 96.2% gap=-13.9pp | validation=54 resolved 51W-3L +$1.32 toxic=3 Wilson 84.9% vs target 96.2% gap=-11.3pp | blockers=train_resolved<30;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none
- rank 7: maker_all_fills|side=YES|side_bid_band=92-94 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=19 resolved 18W-1L +$1.18 toxic=1 Wilson 75.4% vs target 96.1% gap=-20.8pp | validation=30 resolved 29W-1L +$7.52 toxic=1 Wilson 83.3% vs target 96.2% gap=-12.8pp | blockers=train_resolved<30;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUL051630MIAATH-MIA4 status=active due=2026-07-08T20:30:00+00:00 price=0.93
- rank 8: maker_all_fills|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=68 resolved 62W-6L -$12.02 toxic=6 Wilson 82.1% vs target 94.9% gap=-12.9pp | validation=44 resolved 41W-3L +$1.37 toxic=3 Wilson 81.8% vs target 94.9% gap=-13.1pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUL032010SFCOL-COL7 status=active due=2026-07-07T00:10:00+00:00 price=0.93
...
- status: native=NO_LIVE_READY pending=23 active=23 stale=0 unknown=0 | maker=NO_LIVE_READY pending_units=333 active=333 stale=0 unknown=0 | queued=17
- 1. maker:cell_sports_no | ticker=KXMLBSPREAD-26JUL031915NYMATL-ATL4 | status=active | time=2026-07-06T23:15:00+00:00 | resolved_indep=668 pending_units=213
- 2. maker:cell_sports_yes | ticker=KXMLBSPREAD-26JUL031915NYMATL-ATL2 | status=active | time=2026-07-06T23:15:00+00:00 | resolved_indep=245 pending_units=77
- 3. native:crypto_last_hour_longshot_no | ticker=KXBTCD-26JUL0620-T64499.99 | status=active | time=2026-07-06T23:59:59.504534+00:00 | resolved=414 pending=1
- 4. maker:cell_weather_no | ticker=KXHIGHMIA-26JUL06-B89.5 | status=active | time=2026-07-07T04:59:00+00:00 | resolved_indep=153 pending_units=11
- 5. maker:cell_weather_yes | ticker=KXHIGHNY-26JUL06-T75 | status=active | time=2026-07-07T04:59:00+00:00 | resolved_indep=37 pending_units=1
- 6. maker:watch_weather_no_ge88 | ticker=KXHIGHMIA-26JUL06-B89.5 | status=active | time=2026-07-07T04:59:00+00:00 | resolved_indep=43 pending_units=4
- 7. native:other_longshot_no_80_90:other_strong_no_90_95_4_24h_v1 | ticker=KXUSDJPY-26JUL0710-B163.125 | status=active | time=2026-07-07T13:59:59.267471+00:00 | resolved=9 pending=2
- 8. native:weather_high_ask_no | ticker=KXHIGHMIA-26JUL06-T87 | status=active | time=2026-07-07T14:00:00+00:00 | resolved=65 pending=12
- 9. native:weather_no_candidate:no_95_98_zero_loss_cities_v1 | ticker=KXHIGHMIA-26JUL06-T94 | status=active | time=2026-07-07T14:00:00+00:00 | resolved=78 pending=7
- 10. native:weather_no_candidate:no_90_95_min_probe_v1 | ticker=KXHIGHTMIN-26JUL06-B85.5 | status=active | time=2026-07-07T19:00:00+00:00 | resolved=11 pending=1

## Kalshi Academic-Prior Aligned Queue
- command: `python3 scripts/kalshi_academic_prior_queue.py --report --per-family 2`
- KALSHI ACADEMIC-PRIOR ALIGNED QUEUE
- generated_at=2026-07-06T23:11:51.668490+00:00 db=/home/eric-king/kalshi_favorites_bot/trades.db
- Lower rank_score means closer to review, not approval.
- 1. high_price_native_taker:crypto_last_hour_longshot_no | status=NATIVE_FORWARD_ACCUMULATING rank=0.0543 | 414 resolved 374W-40L -$0.84 | Wilson 87.1% vs target 92.5% | next=KXBTCD-26JUL0620-T64499.99 active due=2026-07-06T23:59:59.504534+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
- 2. high_price_native_taker:weather_no_candidate:no_95_98_zero_loss_cities_v1 | status=NATIVE_FORWARD_ACCUMULATING rank=0.0842 | 78 resolved 76W-2L -$0.07 | Wilson 91.1% vs target 99.5% | next=KXHIGHMIA-26JUL06-T94 active due=2026-07-07T14:00:00+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
- 3. source_shadow_requires_native:shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | status=SHADOW_STABILITY_REJECT rank=0.2500 | 636 events 588W-48L +$2625.97 | Wilson 90.1% vs target 89.6% | stability_validation=191ev 176W-15L +$739.00 Wilson 87.4% vs target 89.5% | blockers=source_only_requires_native_forward_gate, shadow_stability_reject, validation_wilson<avg_price+buffer, asset_slice_wilson<avg_price:KXETHD, utc_hour_slice_pnl<=0:15Z, utc_hour_slice_wilson<avg_price:15Z | next=only promote if a matching native first-actionable gate clears after fees and depth
...
- 5. maker_adverse_selection:cell_sports_no | status=NO_GO_REVIEW rank=0.6842 | 668 independent resolved 484W-184L -$995.90 | Wilson 68.9% vs BE 87.4% | toxic=184 fill_rate=27.8% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
- 6. maker_adverse_selection:cell_crypto_no | status=NO_GO_REVIEW rank=0.9131 | 425 independent resolved 211W-214L -$1554.87 | Wilson 44.9% vs BE 86.2% | toxic=214 fill_rate=30.4% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
- 7. structural_arbitrage:same_strike_last_24h | status=WATCH_ONLY rank=1.0000 | 1212 observations | fresh_pairs=1212 execution_ready_tier=217 gross_positive=0 execution_ready_gross_positive=0 qty10_positive=0 execution_ready_qty10_positive=0 best_gross_edge=-0.01 | blockers=no_gross_positive_same_strike, no_execution_ready_gross_positive, no_execution_ready_fee_net_qty10_positive | next=continue simultaneous quote scans; only trade fee-net positive executable dislocations
...
- recent_36h_backlog: unresolved=256 | expired_after_60s_grace=0 | oldest_expired=none | oldest_expected=2026-07-06 23:59:59
- recent_36h_crypto_backlog: unresolved=144 | expired_after_60s_grace=0 | oldest_expired=none | oldest_expected=2026-07-06 23:59:59
- native_gate_stale_unresolved=0
- resolved_last_30m=471
...
- recent_72h_backlog: unresolved=85 | expired_after_60s_grace=0 | oldest_expired=none | oldest_expected=2026-07-07 04:58:59
- native_weather_gate_stale_unresolved=0 | next_due=2026-07-07T14:00:00+00:00
...
-   5-10c: candidates=73859 fill=0.2% resolved=32 benign/toxic=9/23 net=$-14.87 benign=$+7.48 Wilson=70.1% BE=0.0% margin=+70.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   10-20c: candidates=66661 fill=0.4% resolved=49 benign/toxic=15/34 net=$-33.52 benign=$+44.57 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   20-35c: candidates=64170 fill=0.5% resolved=59 benign/toxic=21/38 net=$-17.84 benign=$+64.14 Wilson=84.5% BE=0.0% margin=+84.5pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   35-50c: candidates=39588 fill=0.5% resolved=43 benign/toxic=15/28 net=$+11.14 benign=$+65.98 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   50-65c: candidates=38919 fill=0.7% resolved=41 benign/toxic=12/29 net=$-42.10 benign=$+50.56 Wilson=75.7% BE=0.0% margin=+75.7pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   65-80c: candidates=33418 fill=0.7% resolved=53 benign/toxic=15/38 net=$-11.42 benign=$+68.80 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   80-90c: candidates=31472 fill=0.6% resolved=58 benign/toxic=15/43 net=$+13.69 benign=$+35.81 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   90-95c: candidates=19060 fill=0.4% resolved=38 benign/toxic=11/27 net=$-17.69 benign=$+10.53 Wilson=74.1% BE=0.0% margin=+74.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   95-99c: candidates=37398 fill=0.2% resolved=42 benign/toxic=8/34 net=$+0.19 benign=$+2.74 Wilson=67.6% BE=0.0% margin=+67.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT

## Timers
```
NEXT                                  LEFT LAST                               PASSED UNIT                                                   ACTIVATES
Mon 2026-07-06 18:12:00 CDT             4s Mon 2026-07-06 18:07:00 CDT  4min 55s ago claude-crossing-no-v3.timer                            claude-crossing-no-v3.service
Mon 2026-07-06 18:12:00 CDT             4s Mon 2026-07-06 18:11:00 CDT       55s ago cushion-ds-multi-series-scanner.timer                  cushion-ds-multi-series-scanner.service
Mon 2026-07-06 18:12:00 CDT             4s Mon 2026-07-06 18:11:30 CDT       25s ago gemini-cushion-ds-scanner.timer                        gemini-cushion-ds-scanner.service
Mon 2026-07-06 18:12:01 CDT             6s Mon 2026-07-06 18:06:59 CDT  4min 55s ago kalshi-other-longshot-no-80-90-preflight.timer         kalshi-other-longshot-no-80-90-preflight.service
Mon 2026-07-06 18:12:05 CDT             9s Mon 2026-07-06 18:11:29 CDT       26s ago kalshi-worldcup-score-state-live-pilot.timer           kalshi-worldcup-score-state-live-pilot.service
Mon 2026-07-06 18:12:05 CDT             9s Mon 2026-07-06 18:06:56 CDT  4min 58s ago kalshi-weather-yes-90-93-preflight.timer               kalshi-weather-yes-90-93-preflight.service
Mon 2026-07-06 18:12:16 CDT            20s Mon 2026-07-06 18:07:14 CDT  4min 41s ago kalshi-crypto-last-hour-longshot-no-preflight.timer    kalshi-crypto-last-hour-longshot-no-preflight.service
Mon 2026-07-06 18:12:19 CDT            23s Mon 2026-07-06 18:11:19 CDT       36s ago gemini-ds-index-parity.timer                           gemini-ds-index-parity.service
Mon 2026-07-06 18:12:20 CDT            24s Mon 2026-07-06 18:11:16 CDT       39s ago kalshi-worldcup-final-state-live-pilot.timer           kalshi-worldcup-final-state-live-pilot.service
Mon 2026-07-06 18:12:21 CDT            25s Mon 2026-07-06 18:07:18 CDT  4min 37s ago kalshi-shadow-deterministic-settlement-backfill.timer  kalshi-shadow-deterministic-settlement-backfill.service
Mon 2026-07-06 18:12:21 CDT            25s Mon 2026-07-06 18:02:20 CDT      9min ago ds-shadow-continuous-archive.timer                     ds-shadow-continuous-archive.service
Mon 2026-07-06 18:12:23 CDT            27s Mon 2026-07-06 18:11:23 CDT       32s ago goal-loop-watchdog.timer                               goal-loop-watchdog.service
Mon 2026-07-06 18:12:26 CDT            30s Mon 2026-07-06 18:11:26 CDT       29s ago gateway-watchdog.timer                                 gateway-watchdog.service
Mon 2026-07-06 18:12:47 CDT            51s Mon 2026-07-06 18:07:47 CDT   4min 8s ago kalshi-weather-no-candidate-preflight.timer            kalshi-weather-no-candidate-preflight.service
Mon 2026-07-06 18:12:59 CDT        1min 4s Mon 2026-07-06 18:09:53 CDT   2min 2s ago kalshi-sports-final-state-live-pilot.timer             kalshi-sports-final-state-live-pilot.service
Mon 2026-07-06 18:13:00 CDT        1min 4s Mon 2026-07-06 18:08:00 CDT  3min 55s ago btc-moderate-v2-shadow-scanner.timer                   btc-moderate-v2-shadow-scanner.service
Mon 2026-07-06 18:13:00 CDT        1min 4s Mon 2026-07-06 18:08:00 CDT  3min 55s ago gemini-fp-orderbook-capture.timer                      gemini-fp-orderbook-capture.service
Mon 2026-07-06 18:13:00 CDT        1min 4s Mon 2026-07-06 18:08:00 CDT  3min 55s ago gemini-reward-post-only-safety.timer                   gemini-reward-post-only-safety.service
Mon 2026-07-06 18:13:09 CDT       1min 13s Mon 2026-07-06 18:11:09 CDT       46s ago gemini-ds-index-micro-parity.timer                     gemini-ds-index-micro-parity.service
Mon 2026-07-06 18:13:32 CDT       1min 36s Mon 2026-07-06 18:08:23 CDT  3min 31s ago kalshi-shadow-longshot-fading-backfill.timer           kalshi-shadow-longshot-fading-backfill.service
Mon 2026-07-06 18:13:48 CDT       1min 53s Mon 2026-07-06 18:08:48 CDT   3min 6s ago gemini-maker-fill-simulator.timer                      gemini-maker-fill-simulator.service
Mon 2026-07-06 18:13:52 CDT       1min 56s Mon 2026-07-06 17:58:52 CDT     13min ago ds-storage-pressure-monitor.timer                      ds-storage-pressure-monitor.service
Mon 2026-07-06 18:14:43 CDT       2min 47s Mon 2026-07-06 18:09:40 CDT  2min 14s ago kalshi-crypto-favorite-taker-preflight.timer           kalshi-crypto-favorite-taker-preflight.service
Mon 2026-07-06 18:14:51 CDT       2min 55s Mon 2026-07-06 18:09:51 CDT   2min 4s ago kalshi-side-equivalence-scanner.timer                  kalshi-side-equivalence-scanner.service
Mon 2026-07-06 18:14:58 CDT        3min 2s Mon 2026-07-06 17:44:58 CDT     26min ago ds-storage-monitor.timer                               ds-storage-monitor.service
Mon 2026-07-06 18:15:00 CDT        3min 4s Mon 2026-07-06 18:00:00 CDT     11min ago cushion-ds-multi-series-resolver.timer                 cushion-ds-multi-series-resolver.service
Mon 2026-07-06 18:15:00 CDT        3min 4s Mon 2026-07-06 18:00:00 CDT     11min ago gemini-cushion-ds-resolver.timer                       gemini-cushion-ds-resolver.service
Mon 2026-07-06 18:16:04 CDT        4min 8s Mon 2026-07-06 18:01:04 CDT     10min ago btc-moderate-v2-shadow-resolver.timer                  btc-moderate-v2-shadow-resolver.service
Mon 2026-07-06 18:16:04 CDT        4min 8s Mon 2026-07-06 18:01:04 CDT     10min ago gemini-categorical-scanner.timer                       gemini-categorical-scanner.service
Mon 2026-07-06 18:16:04 CDT        4min 8s Mon 2026-07-06 18:10:55 CDT   1min 0s ago kalshi-crypto-ladder-dislocation-preflight.timer       kalshi-crypto-ladder-dislocation-preflight.service
Mon 2026-07-06 18:16:11 CDT       4min 15s Mon 2026-07-06 18:11:04 CDT       51s ago kalshi-moderate-favorites-eth-yes-preflight.timer      kalshi-moderate-favorites-eth-yes-preflight.service
Mon 2026-07-06 18:16:28 CDT       4min 32s Mon 2026-07-06 18:11:28 CDT       27s ago kalshi-shadow-forecast-accuracy-backfill.timer         kalshi-shadow-forecast-accuracy-backfill.service
Mon 2026-07-06 18:16:31 CDT       4min 35s Mon 2026-07-06 18:11:22 CDT       33s ago kalshi-weather-high-ask-no-preflight.timer             kalshi-weather-high-ask-no-preflight.service
Mon 2026-07-06 18:19:09 CDT           7min Mon 2026-07-06 15:19:09 CDT  2h 52min ago db-auto-vacuum.timer                                   db-auto-vacuum.service
Mon 2026-07-06 18:19:25 CDT           7min Mon 2026-07-06 17:19:25 CDT     52min ago gemini-db-retention.timer                              gemini-db-retention.service
Mon 2026-07-06 18:19:54 CDT           7min Mon 2026-07-06 17:49:54 CDT     22min ago eth-ds-fg-filter-blocks-resolver.timer                 eth-ds-fg-filter-blocks-resolver.service
Mon 2026-07-06 18:20:56 CDT           9min Mon 2026-07-06 18:05:56 CDT      5min ago gemini-categorical-resolver.timer                      gemini-categorical-resolver.service
Mon 2026-07-06 18:24:52 CDT          12min Mon 2026-07-06 17:54:52 CDT     17min ago gemini-db-size-monitor.timer                           gemini-db-size-monitor.service
Mon 2026-07-06 18:25:51 CDT          13min Mon 2026-07-06 18:10:51 CDT   1min 4s ago gemini-ds-source-parity.timer                          gemini-ds-source-parity.service
Mon 2026-07-06 18:26:02 CDT          14min Mon 2026-07-06 18:11:02 CDT       53s ago kalshi-side-equivalence-resolver.timer                 kalshi-side-equivalence-resolver.service
Mon 2026-07-06 18:30:00 CDT          18min Mon 2026-07-06 17:30:00 CDT     41min ago gemini-direct-index-ds-first-resolution-verifier.timer gemini-direct-index-ds-first-resolution-verifier.service
Mon 2026-07-06 18:53:02 CDT          41min Mon 2026-07-06 17:52:43 CDT     19min ago macro-release-resolver.timer                           macro-release-resolver.service
Mon 2026-07-06 18:54:23 CDT          42min Mon 2026-07-06 17:53:51 CDT     18min ago ladder-coherence-two-leg-resolver.timer                ladder-coherence-two-leg-resolver.service
Mon 2026-07-06 19:07:00 CDT          55min Mon 2026-07-06 18:07:00 CDT  4min 55s ago claude-partition-arb-scan.timer                        claude-partition-arb-scan.service
Mon 2026-07-06 19:17:00 CDT        1h 5min Mon 2026-07-06 13:17:00 CDT  4h 54min ago ds-shadow-retention-engine.timer                       ds-shadow-retention-engine.service
Mon 2026-07-06 21:19:00 CDT        3h 7min Mon 2026-07-06 15:19:00 CDT  2h 52min ago ds-shadow-db-maintenance.timer                         ds-shadow-db-maintenance.service
Mon 2026-07-06 21:24:20 CDT       3h 12min Mon 2026-07-06 15:24:20 CDT  2h 47min ago ds-shadow-archive.timer                                ds-shadow-archive.service
Tue 2026-07-07 03:15:00 CDT             9h Mon 2026-07-06 03:15:00 CDT       14h ago shadow-verification.timer                              shadow-verification.service
Tue 2026-07-07 03:30:00 CDT             9h Mon 2026-07-06 03:30:00 CDT       14h ago ibkr-independent-verification.timer                    ibkr-independent-verification.service
Tue 2026-07-07 04:30:00 CDT            10h Mon 2026-07-06 04:30:00 CDT       13h ago tax-ledger-ingest.timer                                tax-ledger-ingest.service
Tue 2026-07-07 04:37:29 CDT            10h Mon 2026-07-06 04:37:38 CDT       13h ago ds-archive-tier-rotation.timer                         ds-archive-tier-rotation.service
Tue 2026-07-07 05:20:00 CDT            11h Mon 2026-07-06 05:20:00 CDT       12h ago logrotate-user.timer                                   logrotate-user.service
Tue 2026-07-07 05:30:00 CDT            11h Mon 2026-07-06 05:30:00 CDT       12h ago disk-hygiene-audit.timer                               disk-hygiene-audit.service
Tue 2026-07-07 05:30:00 CDT            11h Mon 2026-07-06 05:30:00 CDT       12h ago full-picture-daily-save.timer                          full-picture-daily-save.service
Tue 2026-07-07 05:40:00 CDT            11h Mon 2026-07-06 05:40:00 CDT       12h ago database-autonomous-maintenance.timer                  database-autonomous-maintenance.service
Tue 2026-07-07 06:40:00 CDT            12h Mon 2026-07-06 08:05:00 CDT       10h ago ibkr-deterministic-fx-poc.timer                        ibkr-deterministic-fx-poc.service
Tue 2026-07-07 09:14:13 CDT            15h Mon 2026-07-06 09:14:13 CDT        8h ago launchpadlib-cache-clean.timer                         launchpadlib-cache-clean.service
Tue 2026-07-07 09:18:56 CDT            15h Mon 2026-07-06 09:18:56 CDT        8h ago gemini-fp-retention.timer                              gemini-fp-retention.service
...
Sun 2026-07-12 02:00:00 CDT         5 days Sun 2026-07-05 02:00:00 CDT 1 day 16h ago gemini-archive-compression.timer                       gemini-archive-compression.service
Sun 2026-08-02 19:43:55 CDT 3 weeks 6 days Fri 2026-07-03 09:13:55 CDT    3 days ago ubuntu-insights-collect.timer                          ubuntu-insights-collect.service
-                                        - Mon 2026-07-06 04:13:00 CDT       13h ago claude-calibration-logger.timer                        claude-calibration-logger.service
-                                        - Mon 2026-07-06 18:10:00 CDT  1min 55s ago claude-chat-sync.timer                                 claude-chat-sync.service
-                                        - Mon 2026-07-06 18:10:00 CDT  1min 55s ago full-picture-latest-refresh.timer                      full-picture-latest-refresh.service
-                                        - Mon 2026-07-06 18:11:26 CDT       29s ago gemini-liquidity-rewards-scanner.timer                 gemini-liquidity-rewards-scanner.service
-                                        - Sun 2026-07-05 18:16:01 CDT       23h ago gemini-reward-account-monitor.timer                    gemini-reward-account-monitor.service
-                                        - Sun 2026-07-05 18:12:02 CDT       23h ago gemini-reward-inventory-exit.timer                     gemini-reward-inventory-exit.service
-                                        - Mon 2026-07-06 17:42:55 CDT     29min ago gemini-reward-live-readiness.timer                     gemini-reward-live-readiness.service
-                                        - Mon 2026-07-06 17:40:34 CDT     31min ago gemini-reward-quote-pilot.timer                        gemini-reward-quote-pilot.service
-                                        - Mon 2026-07-06 18:10:45 CDT  1min 10s ago gemini-trade-print-capture.timer                       gemini-trade-print-capture.service
-                                        - Mon 2026-07-06 18:10:56 CDT       59s ago kalshi-mve-component-result-live-pilot.timer           kalshi-mve-component-result-live-pilot.service
...
- operations-knowledge: head=623d1ce branch=master in_sync=false remote=https://github.com/PhotonRahm/operations-knowledge.git dirty=yes
