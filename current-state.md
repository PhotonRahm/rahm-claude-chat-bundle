...
last_updated_utc: 2026-07-05T05:10:00+00:00
pipeline_heartbeat_utc: 2026-07-05T05:10:00+00:00
generator: Codex generate_current_state.py
workspace_head: 0710930

## Chat Startup Critical Summary
- Generated for Claude-in-chat startup at 2026-07-05T00:10:00-05:00; missing artifacts render UNAVAILABLE instead of breaking sync.
- Full-picture artifact: FULL PICTURE - 2026-07-05 12:00 AM
...
- Kalshi reconciliation: Reconciliation: resolved_pnl=$-1500.51 open_cost=$1.30 open_fees=$0.07 recon_adj=$189.84 expected_cash=$1187.96 cash_gap=$+0.00 unrealized=$-0.45 [MATCH]
- IBKR: NLV: $1,949.48
- IBKR state: Status: ⚠️ Flex sync 247h stale | ❌ Gateway DOWN | ❌ KILL switch active
...
- • Combined true P&L: **$-16331.91**
- • True lifetime P&L (bots − one-time − recurring): **$-19215.07**
...
- active_enter: Fri 2026-07-03 09:09:17 CDT
- reconciliation:
  - Reconciliation: resolved_pnl=$-1500.51 open_cost=$1.30 open_fees=$0.07 recon_adj=$189.84 expected_cash=$1187.96 cash_gap=$+0.00 unrealized=$-0.45 [MATCH]
...
- strategy/cohort excerpts:
  ...
  - Live-matched v2 (full filter stack): 358W-14L (96.2%) | maker +$1,290.00  -> taker +$528.17
  - Live-matched v2 first-ticker: 239W-14L (94.5%) | taker -$162.80 | Wilson 90.9% vs BE 95.1% | 7d -$375.57 | gate=NOT_LIVE_DEPLOYABLE
  - v1→v2 drops: tier=5011, volume=2797, excluded=1149, category=179, spread=57, nws=52, hours=36
  - [2.5] Moderate Favorites Pilot ($0.80-$0.85 only)
  - Validation vs shadow: shadow WR 83.3% / +$45.00 (spread<=0.05 + allowed assets, matches pilot) | live WR 82.8% | ✓ matches shadow
  ...
  - Mean reversion shadow freshness: last_row=2026-04-22T03:02:54Z age=74.1d live_match_last=2026-04-21T02:43:31Z post_kill_shadow_rows=0 post_kill_live_placements=0 | gate=STALE_NO_FORWARD_EVIDENCE
  ...
  - Forecast accuracy YES 90-93 above-live-threshold: event-first 122W-2L n=124 | +$1,577.78 avg_ask=0.915 | Wilson 94.3% vs BE 92.6% margin=+1.7pp | recent 42W-1L n=43 Wilson 87.9% vs BE 92.7% | pending=6 stale_pending=1 | gate=THIN_MARGIN_RECENT_UNDERPOWERED_FORWARD_ONLY | next_pending=KXLOWTDEN-26JUL04-B59.5 city=DEN due=2026-07-05T06:59:59.580393+00:00 ask=0.90 reason=weekend_block_active
  - Forecast accuracy high-ask NO event-first: ask>=0.98 all 971W-7L n=978 | +$1,231.94 avg_ask=0.986 | Wilson 98.5% vs BE 98.8%
  - Forecast accuracy high-ask NO ex-LAX: 891W-4L n=895 | +$1,608.74 avg_ask=0.986 | Wilson 98.9% vs BE 98.8% | unresolved_live_est_events=30 | gate=FORWARD_WATCH_ONLY
  - Forecast accuracy high-ask NO native preflight: rows=56537 events=224 actionable_qty1=1079 latest=2026-07-05T05:07:31+00:00 | reasons: missing_native_no_ask=49620, nonpositive_qty1_win:0.0000=3613, actionable_qty1_fee_positive=1079, native_no_ask_out_of_band:0.0100=456 | latest_run=2026-07-05T05:07:31+00:00 candidates=20 checked=20 actionable=1 run_reasons={"actionable_qty1_fee_positive": 1, "missing_native_no_ask": 16, "native_no_ask_out_of_band:0.0100": 1, "nonpositive_qty1_win:0.0000": 2}
  - Forecast accuracy high-ask NO latest actionables: captured=2026-07-05T05:07:31+00:00 events=20 actionable_events=1 best=KXLOWTPHIL-26JUL05-T66 city=PHIL event=KXLOWTPHIL-26JUL05 due=2026-07-06T19:00:00+00:00 no_ask=0.98 depth=75.00 win1=+$0.01 loss1=-$0.99
  - Forecast accuracy high-ask NO native gate: native_events=56 resolved=48 pending=8 45W-3L native_pnl=-$2.52 Wilson 83.2% vs BE 99.0% next_pending=KXHIGHMIA-26JUL04-T95 city=MIA event=KXHIGHMIA-26JUL04 due=2026-07-05T14:00:00+00:00 ttl=33.0h no_ask=0.98 depth=300.11 win1=+$0.01 loss1=-$0.99
  - Forecast accuracy NO candidate-cell preflight: rows=38276 cohorts=2 events=82 actionable_qty1=10494 latest=2026-07-05T05:08:41+00:00 | latest_run=2026-07-05T05:08:41+00:00 candidates=13 checked=13 actionable=4 run_reasons={"no_90_95_min_probe_v1:missing_native_no_ask": 1, "no_90_95_min_probe_v1:native_no_ask_out_of_band:0.9800": 1, "no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive": 4, "no_95_98_zero_loss_cities_v1:missing_native_no_ask": 5, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.8300": 1, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9000": 1}
  - Forecast accuracy NO candidate-cell cohorts: no_95_98_zero_loss_cities_v1 rows=34411 events=81 actionable=9642; no_90_95_min_probe_v1 rows=3865 events=11 actionable=852
  - Forecast accuracy NO candidate-cell latest cohort actionables: no_90_95_min_probe_v1 captured=2026-07-05T05:08:41+00:00 events=2 actionable_events=0 top_reason=native_no_ask_out_of_band:0.9800; no_95_98_zero_loss_cities_v1 captured=2026-07-05T05:08:41+00:00 events=11 actionable_events=4 best=KXLOWTMIA-26JUL05-B74.5 city=MIA event=KXLOWTMIA-26JUL05 due=2026-07-06T19:00:00+00:00 no_ask=0.96 depth=6.00 win1=+$0.03 loss1=-$0.97
  - Forecast accuracy NO candidate-cell historical control: all-city 95-98 925W-27L n=952 Wilson 95.9% vs BE 96.7%; selected-cities 317W-2L n=319 Wilson 97.7% vs BE 96.8%; weakest_city=AUS 41W-1L n=42 Wilson 87.7% vs BE 96.8% | selected-city filter is in-sample; no live order
  - Forecast accuracy NO candidate-cell forward gate: no_90_95_min_probe_v1 native_events=11 resolved=9 pending=2 8W-1L native_pnl=-$0.50 Wilson 56.5% vs BE 94.5% next_pending=KXHIGHTMIN-26JUL04-T78 city=MIN event=KXHIGHTMIN-26JUL04 due=2026-07-05T19:00:00+00:00 ttl=51.1h no_ask=0.95 depth=1.00 win1=+$0.04 loss1=-$0.96 best_pending=KXHIGHTMIN-26JUL05-T82 city=MIN event=KXHIGHTMIN-26JUL05 due=2026-07-06T19:00:00+00:00 no_ask=0.93 depth=15.00 win1=+$0.06 loss1=-$0.94; no_95_98_zero_loss_cities_v1 native_events=77 resolved=65 pending=12 63W-2L native_pnl=-$0.39 Wilson 89.5% vs BE 97.5% next_pending=KXHIGHMIA-26JUL04-T88 city=MIA event=KXHIGHMIA-26JUL04 due=2026-07-05T14:00:00+00:00 ttl=47.0h no_ask=0.97 depth=36.00 win1=+$0.02 loss1=-$0.98 best_pending=KXHIGHTDAL-26JUL05-T97 city=DAL event=KXHIGHTDAL-26JUL05 due=2026-07-06T19:00:00+00:00 no_ask=0.95 depth=30.00 win1=+$0.04 loss1=-$0.96
  ...
  - Legacy untapped FX/Index NO maker/cancel proxy: v2 side_bid=0.85-0.90 candidates=348 markets=38 fills=26 pending_fills=2 resolved_indep=24/50 22W-2L pnl=+$2.78 Wilson 74.2% vs modeled BE 90.4% | cancels=318 late_cross_ttl=8 open=4 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Legacy weather-city NO shadow: bid>=0.88 first-ticker-side 5566W-267L n=5833 | +$10,426.47 | avg_bid=0.932 | Wilson 94.9% vs modeled BE 93.6% margin=+1.2pp | pending=230 | gate=LEGACY_MAKER_FORWARD_REQUIRED
  - Legacy weather-city NO recency: since_2026-06-17 2154W-88L n=2242 +$4,110.80 pending=228 Wilson 95.2% vs modeled BE 94.2% | forward_since_2026-06-25T09:35Z resolved=1099 pending=228 | blocked 1597W-88L +$2,001.11, unblocked 3969W-179L +$8,425.36 | best=KXLOWTNYC 229W-6L +$1,002.36; worst=KXLOWTDEN 230W-20L -$440.23 | next_pending=KXHIGHCHI-26JUL04-T85 city=CHI due_est=2026-07-05T05:58:59.083587+00:00 ttl_at_capture=7.9h bid=0.99 overdue_pending=45 | bid-side/maker-priced shadow, not taker-executable
  - Legacy weather-city NO event collapse: event-side 1108W-20L n=1128 +$3,743.74 pending=48 Wilson 97.3% vs modeled BE 94.9% margin=+2.4pp | recent_event_side 421W-11L n=432 Wilson 95.5% vs BE 95.4% | forward_event_side resolved=216 pending=48 | gate=EVENT_MAKER_FORWARD_REQUIRED
  - Legacy weather-city NO maker/cancel proxy: v2 side_bid>=0.88 candidates=129 markets=65 fills=42 pending_fills=8 resolved_indep=34/50 33W-1L pnl=+$11.98 Wilson 85.1% vs modeled BE 93.5% | cancels=87 late_cross_ttl=16 open=0 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range bid-side shadow: side-aware ticker+side first rows 604W-0L n=604 | +$3,724.56 | Wilson 99.4% vs modeled BE 93.8% | pending=0 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range bid-side recency: since_2026-06-17 126W-0L n=126 +$760.12 pending=0 | forward_since_2026-06-25T07:30Z resolved=79 pending=0 | YES 59W-0L pending=0, NO 46W-0L pending=0 | bid-side shadow, not taker-executable
  - Crypto price-range bid-side event collapse: event-side 105W-0L n=105 +$638.76 pending=0 Wilson 96.5% vs BE 93.9% margin=+2.6pp | event_only 72W-0L n=72 Wilson 94.9% vs BE 93.9% margin=+1.0pp | recent_event_side 33W-0L n=33 Wilson 89.6% vs BE 94.0% | forward_event_side resolved=21 pending=0 | gate=RECENT_EVENT_UNDERPOWERED_MAKER_FORWARD_REQUIRED
  ...
  - Crypto long-expiry maker/cancel proxy: v2 crypto side_bid=0.90-0.95 candidates=554 markets=306 fills=125 pending_fills=8 resolved_indep=117/50 108W-9L pnl=-$15.65 Wilson 86.0% vs modeled BE 93.6% | 24hplus_candidates=114 24hplus_fills=16 24hplus_pending_fills=3 | cancels=402 late_cross_ttl=45 open=27 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel shadow: v2 side_bid=0.92-0.94 candidates=302 markets=181 fills=75 filled_units=75 pending_fills=6 resolved_indep=69/50 65W-4L pnl=+$0.17 Wilson 86.0% vs modeled BE 94.2% | cancels=213 late_cross_ttl=24 open=14 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel sides: NO rows=159 markets=90 fills=34 pending=2 resolved_rows=32; YES rows=143 markets=91 fills=41 pending=4 resolved_rows=37 | source=kalshi_high_price_maker_cancel_shadow | no live orders
  - Crypto legacy taker NO shadow: ask=0.90-0.95 12-24h first-ticker-side 246W-16L n=262 | +$487.60 | avg_ask=0.915 | Wilson 90.3% vs modeled BE 92.0% margin=-1.7pp | pending=3 | gate=NO_GO
  - Crypto favorite taker native preflight: rows=10584 cohorts=2 contracts=59 actionable_obs=2260 latest=2026-07-05T05:07:17+00:00 | latest_run=2026-07-05T05:07:17+00:00 candidates=4 checked=4 actionable=2 reasons={"crypto_favorite_no_90_95_12_24h:native_no_ask_out_of_band:0.8900": 1, "crypto_favorite_no_90_95_12_24h:native_no_ask_out_of_band:0.9600": 1, "crypto_near_certain_95_99_12_24h:actionable_qty1_fee_positive": 2} | no order path
  - Crypto favorite taker native cohorts: crypto_near_certain_95_99_12_24h rows=8346 contracts=46 actionable_obs=1797; crypto_favorite_no_90_95_12_24h rows=2238 contracts=14 actionable_obs=463
  - Crypto favorite taker latest cohort actionables: crypto_favorite_no_90_95_12_24h captured=2026-07-05T05:07:17+00:00 contracts=2 actionable_contracts=0; crypto_near_certain_95_99_12_24h captured=2026-07-05T05:07:17+00:00 contracts=2 actionable_contracts=2 best=KXSOLD-26JUL0517-T82.9999 side=NO asset=SOL event=KXSOLD-26JUL0517 due=2026-07-05T20:59:59.603316+00:00 ask=0.96 depth=5200.00 win1=+$0.03 loss1=-$0.97
  - Crypto favorite taker native gate: crypto_favorite_no_90_95_12_24h first_actionable_contracts=12 resolved=10 pending=2 8W-2L native_pnl=-$1.21 Wilson 49.0% vs BE 92.1% next_pending=KXSOLD-26JUL0517-T82.9999 side=NO asset=SOL event=KXSOLD-26JUL0517 due=2026-07-05T20:59:59.017092+00:00 ask=0.90 depth=1.00 win1=+$0.09 loss1=-$0.91 gate=NATIVE_FORWARD_ACCUMULATING; crypto_near_certain_95_99_12_24h first_actionable_contracts=43 resolved=41 pending=2 40W-1L native_pnl=-$0.04 Wilson 87.4% vs BE 97.6% next_pending=KXBTCD-26JUL0517-T60999.99 side=YES asset=BTC event=KXBTCD-26JUL0517 due=2026-07-05T20:59:59.534667+00:00 ask=0.97 depth=100.00 win1=+$0.02 loss1=-$0.98 gate=NATIVE_FORWARD_ACCUMULATING
  ...
  - Crypto contrarian NO recency: since_2026-06-17 13W-14L n=27 +$638.16 pending=0 Wilson 30.7% vs modeled BE 24.5% | forward_since_2026-06-25T10:40Z resolved=9 pending=0 | 2026-04 8W-27L -$37.12, 2026-06 13W-11L +$711.92 | BTC 8W-18L +$167.58 pending=0, ETH 9W-9L +$477.11 pending=0, SOL 4W-14L -$43.65 pending=1 | next_pending=KXSOLD-26APR2417-T83.9999 event=KXSOLD-26APR2417 due_est=2026-04-24T20:59:59.002927+00:00 ttl=-1712.2h ask=0.22 spread=0.09 active_pending=0 stale_pending=1 unknown_pending=0 | exploratory ask-priced shadow; no live orders
  - Crypto last-hour longshot NO shadow: event-first 1262W-82L n=1344 | +$6,643.43 avg_ask=0.882 | Wilson 92.5% vs modeled BE 89.0% | recent 841W-68L +$2,809.61 | gate=LIQUIDITY_PROXY_FAIL_FORWARD_ONLY
  - Crypto last-hour longshot liquidity: volume=0 612W-9L +$6,937.91; volume>=500/spread<=5c 434W-45L +$20.21 Wilson 87.7% vs BE 90.6%; 80-85c volume-backed 50W-5L +$388.04 Wilson 80.4% vs BE 83.9%; 90-95c volume-backed 278W-22L -$48.95 Wilson 89.1% vs BE 92.8%; 95-99c volume-backed 636W-24L -$510.83 Wilson 94.6% vs BE 97.1%; forward_since_2026-06-25T11:20Z 465W-44L +$823.83 Wilson 88.6% vs BE 89.7% resolved=509 pending=3 | no live orders
  - Crypto last-hour longshot native preflight: rows=6709 events=511 actionable_qty1=1924 latest=2026-07-05T05:08:01+00:00 | latest_run=2026-07-05T05:08:01+00:00 candidates=2 checked=2 actionable=2 reasons={"actionable_qty1_fee_positive": 2} | no order path
  - Crypto last-hour longshot latest actionables: captured=2026-07-05T05:08:01+00:00 events=2 contracts=2 actionable_contracts=2 best=KXETHD-26JUL0502-T1769.99 asset=ETH event=KXETHD-26JUL0502 due=2026-07-05T05:59:59.348987+00:00 no_ask=0.89 depth=70.00 win1=+$0.10 loss1=-$0.90
  - Crypto last-hour longshot native gate: native_events=389 resolved=387 pending=2 active_pending=2 stale_pending=0 unknown_pending=0 349W-38L native_pnl=-$1.69 Wilson 86.8% vs BE 90.6% next_pending=KXETHD-26JUL0502-T1769.99 asset=ETH event=KXETHD-26JUL0502 due=2026-07-05T05:59:59.348987+00:00 no_ask=0.85 depth=1.00 win1=+$0.14 loss1=-$0.86 | gate=NATIVE_FORWARD_ACCUMULATING
  ...
  - Weather near-expiry favorite shadow: 1-4h ask>=0.90 event-first 50W-0L n=50 +$278.00 avg_ask=0.944 Wilson 92.9% vs modeled BE 94.8% pending=2 overdue_pending=2 | gate=UNDERPOWERED_BELOW_BREAKEVEN
  - Weather near-expiry favorite recency: since_2026-06-17 35W-0L n=35 +$202.00 pending=2 Wilson 90.1% vs modeled BE 94.6% | best_event_price_cell=2-4h/p90_95 30W-0L n=30 +$225.00 pending=1 | next_pending=KXLOWTMIA-26JUL04-B80.5 event=KXLOWTMIA-26JUL04 due_est=2026-07-05T05:00:03+00:00 ask=0.92 spread=0.26 | ask-priced near-expiry shadow; no live orders
  ...
  - Summary: rows=8883 open=218 fills=2215 markets=1989 cancels=6450 late_cross_ttl=529 resolved=1707 markets=1553 pnl=-3755.05 last=2026-07-05T05:05:14+00:00
  - Pending fills: unresolved=508 markets=436 next=KXHIGHMIA-26JUL04-B94.5 weather NO close=2026-07-05T04:59:00+00:00 expiration=2026-07-11T14:00:00+00:00 | units=508 active=501 stale=7 unknown=0
  - Overall independent fills: resolved=1707 1119W-588L pnl=-3755.05 wilson_low=63.3% breakeven=87.5% toxic=588 status=NO_GO_REVIEW
  - Review progress: best_cell=sports NO resolved_independent=575/50 indep=422W-153L pnl=-812.90 wilson_low=69.6% breakeven=87.5% toxic=153 pending_markets=260 filled_markets=835 next_close=2026-07-05T16:35:00+00:00 status=NO_GO_REVIEW
  - Cell scan: resolved_cells=7 edge_positive_cells=0 leader=sports NO resolved_indep=575 best_edge_positive=none best_alternate=crypto YES resolved_indep=345 193W-152L pnl=-1047.28 wilson_low=50.7% breakeven=86.3% toxic=152 status=NO_GO_REVIEW
  ...
  - Fresh non-04Z NO <10c first-eligible: n=13 10W-3L wr=76.9% wilson_low=49.7% breakeven=4.0% pnl=+9.51 avg=+0.7315
  - Forward gate: fresh non-04Z NO <10c first-eligible start=2026-06-25T08:30:00+00:00 excluded_hour=04Z progress 13/50 pending_markets=0 status=ACCUMULATING reason=resolved 13/50; needs 37 new markets after pending; native taker NO ask <10c evidence absent
  - Fresh non-04Z NO <10c first-eligible pending horizon: resolved=13/50 pending_markets=0 max_if_all_pending_resolve=13/50 need_new_after_pending=37 next_due=unknown last_due=unknown next_backfill_after=unknown last_backfill_after=unknown
  - Fresh 04Z excluded-control NO <10c first-eligible: n=9 8W-1L wr=88.9% wilson_low=56.5% breakeven=5.9% pnl=+7.50 avg=+0.8333
  - Fresh non-04Z NO <10c first-eligible source provenance: rows=13 sources=1 top=kalshi.shadow_deterministic_settlement n=13 distinct_source_row_ids=13 missing_source_row_ids=0
  - Fresh non-04Z NO <10c first-eligible native source check: source_ids=13 checked=10 native_taker_ask_lt10c=0/10 min=0.7400 avg=0.9140 max=0.9800
  - Fresh non-04Z NO <10c first-eligible concentration: underliers=2 top=BTC n=11 share=84.6% pnl=+7.58 worst=ETH n=2 pnl=+1.93
  - Fresh non-04Z NO <10c first-eligible day stability: days=2 positive=2 losing=0 worst=2026-07-05 n=3 pnl=+0.87
  - Fresh non-04Z NO <10c first-eligible UTC-hour stability: hours=2 positive=2 losing=0 worst=03Z n=5 pnl=+3.81
  ...
  - Post-kill NO <10c first-eligible live pending preview: pending_first_eligible=0 live_actionable=0 settlement_pending_or_ineligible=0 now=2026-07-05T05:10:16+00:00 | no order path
  ...
  - Pending native-actionable rows: FX=12168, INDEX=13445
  - Gate: failed; native executable rows disprove Index/FX favorite-tracking salvage

## Storage State
- DATABASE STORAGE HEALTH
-   Overall status: GREEN / TARGET
-   Disk: 186.99 GiB used / 936.79 GiB total (20.0%), 702.14 GiB free
-   Envelope: TARGET 50.0%, WARN 65.0%, CRITICAL 75.0%, HARD_LIMIT 85.0%
-   DS storage: active 1.14 GiB (state TARGET), hot 18.14 GiB, warm 0.11 GiB, cold 0.00 GiB, archive_state TARGET, total 19.41 GiB (2.1% of disk)
-   Archive sidecars: OK
-   Retention engine: last=2026-07-05T00:18:44+00:00 status=OK dry_run=False rows_selected=133 rows_archived=133 rows_pruned=0
-   Archive compression: status=OK actions=1 warm_days=7 min_file_mb=100
-   Tier rotation: last=2026-07-05T00:18:44+00:00 status=OK actions=1, compression_ratio_avg=0.007
...
- latest_run: id=47 captured_at=2026-07-05T04:16:39+00:00 | markets_seen=20000 post_expiration_open_unresolved=79 candidate_count=0 | direct_market_recheck=True pages=20 page_cap=True rate_limited=False | trigger_fields={"expected_expiration_time": 79} | top_series=KXMVESPORTSMULTIGAMEEXTENDED=40, KXMVECROSSCATEGORY=39
...
- latest_run: id=37 captured_at=2026-07-05T04:16:39+00:00 | mode=global_open_cursor markets_seen=10000 grouped_markets=9950 duplicate_groups=117 candidate_count=0 | pages=10 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=8254, KXMVECROSSCATEGORY=1696
...
- latest_run: id=41 captured_at=2026-07-05T04:24:19+00:00 | mode=global_open_cursor markets=10000 parsed=0 groups=0 relations=0 candidates=0 | pages=10 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=8217, KXMVECROSSCATEGORY=1783 | parse_rejects=not_strict_binary_labels=10000
...
- latest_run: captured_at=2026-07-05T04:09:49+00:00 | mode=series_mode series=120 regex=1 prefix=0 markets_seen=249 parsed_markets=70 parsed_events=22 groups=14 orderbooks=53 candidates=0 best_edge=none | pages=120 page_cap=false rate_limited=false | top_series=KXSONGRELEASE=41, KXMUSKNW=36, KXSTARSHIPSPACE=20, KXEARNINGSMENTIONJPM=18, KXEARNINGSMENTIONBAC=16
...
- latest_run: id=41 captured_at=2026-07-05T04:16:51+00:00 | mode=global_open_cursor markets=10000 parsed=5593 groups=4857 partitions=0/429 candidates=0 | pages=10 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=8288, KXMVECROSSCATEGORY=1712 | non_partition=missing_lower_tail=429
...
- latest_run: id=39 captured_at=2026-07-05T04:24:19+00:00 | mode=global_open_cursor markets=10000 parsed=4990 groups=4387 relations=0 candidates=0 | pages=10 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=8217, KXMVECROSSCATEGORY=1783 | parse_rejects=not_interval_title=5010
...
- latest_run: id=48 captured_at=2026-07-05T04:16:49+00:00 | mode=global_open_cursor markets=10000 parsed=1299 groups=1251 relations=0 candidates=0 | pages=10 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=8288, KXMVECROSSCATEGORY=1712 | parse_rejects=not_single_threshold_title=8701
...
- latest_run: id=44 captured_at=2026-07-05T04:16:39+00:00 | markets_seen=20000 post_close_open_unresolved=0 candidates=0 min_age_min=2.00 max_ask=0.30 max_spread=0.15 min_depth=1 | pages=20 page_cap=true rate_limited=false | categories=none | top_series=unknown
...
- latest_run: id=50 captured_at=2026-07-05T04:16:39+00:00 | markets_seen=20000 public_result_active=0 candidates=0 max_ask=0.30 max_spread=0.15 min_depth=1 | pages=20 page_cap=true rate_limited=false | results=none | categories=none | top_series=unknown
...
- latest_run: id=32 captured_at=2026-07-05T01:25:56+00:00 | version=event_result_propagation_v1 events_seen=1000 events_examined=1000 mutex_events=160 details=160/200 detail_cap=false markets=1519 locked=0 actionable_qty1=0 max_ask=0.25 min_depth=1 | pages=5 page_cap=true rate_limited=false | reasons=event_not_mutually_exclusive_summary=840, no_exhaustive_proof=160
...
- latest_run: id=44 captured_at=2026-07-05T04:24:35+00:00 | events_seen=2000 mutex_events=398 details=80/80 markets=648 tradable_no=517 candidates=0 top_net=-3.0pp | pages=10 page_cap=true rate_limited=false | categories=Elections=193, Sports=134, Politics=25, Economics=17, Entertainment=15, Financials=6 | detail_errors=none
- nearest_no_bundles: KXNEXTUKPM-30 KXNEXTUKPM k=2 floor=1.00 cost=1.01 fees=0.02 net=-3.0pp tickers=KXNEXTUKPM-30-ABUR,KXNEXTUKPM-30-ACAR ; GOVPARTYMO-28 GOVPARTYMO k=2 floor=1.00 cost=1.01 fees=0.02 net=-3.4pp tickers=GOVPARTYMO-28-R,GOVPARTYMO-28-D ; KXG7LEADEROUT-45JAN01 KXG7LEADEROUT k=2 floor=1.00 cost=1.02 fees=0.02 net=-3.6pp tickers=KXG7LEADEROUT-45JAN01-KSTA,KXG7LEADEROUT-45JAN01-EMAC ; KXNEXTUKPM-30 KXNEXTUKPM k=3 floor=2.00 cost=2.01 fees=0.03 net=-3.9pp tickers=KXNEXTUKPM-30-ABUR,KXNEXTUKPM-30-ACAR,KXNEXTUKPM-30-NF ; KXG7LEADEROUT-45JAN01 KXG7LEADEROUT k=3 floor=2.00 cost=2.01 fees=0.03 net=-4.2pp tickers=KXG7LEADEROUT-45JAN01-KSTA,KXG7LEADEROUT-45JAN01-EMAC,KXG7LEADEROUT-45JAN01-FMER
- unsafe_all_yes_positive_requires_exhaustive_validation: count=5 best_net=+73.3pp
...
- latest_run: id=35 captured_at=2026-07-05T03:14:11+00:00 | version=event_exhaustive_yes_v2_esports events_seen=305 event_details=305 baskets_checked=250 actionable_qty1=0 min_net_edge=0.010 | series=14 page_limits=[200] | counts=KXATPCHALLENGERMATCH=77, KXITFMATCH=34, KXITFWMATCH=42, KXLOLGAME=14, KXLOLMAP=12, KXMLBGAME=46, KXNBAGAME=0, KXNHLGAME=0 | reasons=exhaustive_basket_checked=250, two_way_sports_shape_mismatch=53, event_not_mutually_exclusive=2
- nearest_baskets: KXITFMATCH-26JUL05IVAORL two_way_no_tie_sports_match contracts=2 sum_asks=0.990 fees=0.040 net=-0.030 depth=471 actionable=0 ; KXITFMATCH-26JUL04DELSHI two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=193 actionable=0 ; KXATPCHALLENGERMATCH-26JUL05WEHIFI two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=507 actionable=0 ; KXATPCHALLENGERMATCH-26JUL05RAQMAS two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=486 actionable=0 ; KXATPCHALLENGERMATCH-26JUL05MARNVS two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.020 net=-0.030 depth=190 actionable=0
...
- reasons: resolved 20/50; wilson 58.4% < 90.0%; open_filled_trades=7; source reconciliation mismatches 51; native taker NO ask <10c evidence absent
...
- fresh_non04z_review: status=NOT_READY | ready=false | reason=fresh gate status ACCUMULATING; resolved 13/50; wilson 49.7% < 90.0%; open_filled_trades=7; source reconciliation mismatches 35; native taker NO ask <10c evidence absent | resolved=13/50 | 10W-3L | pnl=+9.51 | wilson=49.7% | pending=0 | shadow_live_actionable=0 | native_taker_actionable=0 | native_taker_blocked=0 | expired_unresolved=0 | next_backfill_after=unknown | source_reconciliation=13/13 mismatches=35 | native_taker_ask_lt10c=0/10
...
- status: NO_LIVE_READY | ready=false | cells=9 | ready_cells=0 | min_resolved=30 | edge_buffer=+2.0pp | pending=34 active=34 stale=0 unknown=0 | next_pending=crypto_last_hour_longshot_no:KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00
- best: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=389 resolved=387 pending=2 active=2 stale=0 unknown=0 | 349W-38L | pnl=-1.69 | Wilson 86.8% vs BE 90.6% | gap=-3.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=311 | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
- rank 1: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=389 resolved=387 pending=2 active=2 stale=0 unknown=0 | 349W-38L | pnl=-1.69 | Wilson 86.8% vs BE 90.6% | gap=-3.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=311 | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
- rank 2: weather_no_candidate:no_95_98_zero_loss_cities_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=77 resolved=65 pending=12 active=12 stale=0 unknown=0 | 63W-2L | pnl=-0.39 | Wilson 89.5% vs BE 97.5% | gap=-8.1pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=1491 | next_pending=KXHIGHMIA-26JUL04-T88 status=active due=2026-07-05T14:00:00+00:00 ask=0.97
- rank 3: crypto_favorite_taker:crypto_near_certain_95_99_12_24h | gate=NATIVE_FORWARD_ACCUMULATING | native_events=43 resolved=41 pending=2 active=2 stale=0 unknown=0 | 40W-1L | pnl=-0.04 | Wilson 87.4% vs BE 97.6% | gap=-10.2pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=1478 | next_pending=KXBTCD-26JUL0517-T60999.99 status=active due=2026-07-05T20:59:59.534667+00:00 ask=0.97
- rank 4: weather_yes_90_93:yes_90_93_above_live_threshold_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=29 resolved=23 pending=6 active=6 stale=0 unknown=0 | 22W-1L | pnl=+0.72 | Wilson 79.0% vs BE 92.3% | gap=-13.3pp | blockers=resolved<30; wilson<BE+2pp | perfect_wins_needed=74 | next_pending=KXHIGHCHI-26JUL04-T85 status=active due=2026-07-05T14:00:00+00:00 ask=0.91
- rank 5: weather_high_ask_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=56 resolved=48 pending=8 active=8 stale=0 unknown=0 | 45W-3L | pnl=-2.52 | Wilson 83.2% vs BE 99.0% | gap=-15.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=>5000_or_target_impossible | next_pending=KXHIGHMIA-26JUL04-T95 status=active due=2026-07-05T14:00:00+00:00 ask=0.98
...
- status: NO_NATIVE_CUT_READY | ready=false | observations=17483 | cuts=2369 | display_cuts=540 | candidate_cuts=0 | ready_cuts=0 | min_resolved=30 | min_display_resolved=10 | edge_buffer=+2.0pp | scope=posthoc_native_executable_cut_discovery_requires_predeclared_forward_gate
...
- rank 2: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=59 resolved=58 pending=1 active=1 stale=0 unknown=0 | 56W-2L | pnl=+$5.77 | Wilson 88.3% vs target 88.6% (BE 86.6%) | gap=-0.3pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=2 | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
- rank 3: crypto_last_hour_longshot_no|minutes_to_expiry_band=20-40m|native_ask_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=72 resolved=72 pending=0 active=0 stale=0 unknown=0 | 67W-5L | pnl=+$6.59 | Wilson 84.8% vs target 85.9% (BE 83.9%) | gap=-1.2pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=7
- rank 4: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=97 resolved=96 pending=1 active=1 stale=0 unknown=0 | 94W-2L | pnl=+$5.11 | Wilson 92.7% vs target 94.6% (BE 92.6%) | gap=-1.9pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=35 | next_pending=KXBTCD-26JUL0502-T62899.99 status=active due=2026-07-05T05:59:59.605680+00:00 ask=0.92
- rank 5: crypto_last_hour_longshot_no|native_spread_band=<=1c|native_depth_band=10-99 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=109 resolved=109 pending=0 active=0 stale=0 unknown=0 | 103W-6L | pnl=+$4.66 | Wilson 88.5% vs target 92.2% (BE 90.2%) | gap=-3.7pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=55
- rank 6: crypto_last_hour_longshot_no|native_ask_band=85-90 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=224 resolved=223 pending=1 active=1 stale=0 unknown=0 | 203W-20L | pnl=+$6.11 | Wilson 86.6% vs target 90.3% (BE 88.3%) | gap=-3.7pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=89 | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
- rank 7: crypto_last_hour_longshot_no|native_spread_band=<=1c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=330 resolved=328 pending=2 active=2 stale=0 unknown=0 | 301W-27L | pnl=+$2.64 | Wilson 88.3% vs target 93.0% (BE 91.0%) | gap=-4.7pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=223 | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
- rank 8: crypto_last_hour_longshot_no|shadow_spread_band=<=1c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=263 resolved=261 pending=2 active=2 stale=0 unknown=0 | 241W-20L | pnl=+$2.86 | Wilson 88.5% vs target 93.2% (BE 91.2%) | gap=-4.8pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=189 | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
...
- best: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=94 resolved=93 pending=1 active=1 stale=0 unknown=0 | 81W-12L | pnl=$-3.44 | Wilson 78.8% vs target 92.8% (BE 90.8%) | gap=-14.0pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=193 | next_pending=KXBTCD-26JUL0502-T62899.99 status=active due=2026-07-05T05:59:59.605680+00:00 ask=0.92 | excluded_post_start_actionables=563 (native_spread_band=<=5c=209, native_spread_band=<=2c=136, native_depth_band=1000+=129, native_depth_band=10-99=64) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=232 (not_actionable=232) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 1: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=94 resolved=93 pending=1 active=1 stale=0 unknown=0 | 81W-12L | pnl=$-3.44 | Wilson 78.8% vs target 92.8% (BE 90.8%) | gap=-14.0pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=193 | next_pending=KXBTCD-26JUL0502-T62899.99 status=active due=2026-07-05T05:59:59.605680+00:00 ask=0.92 | excluded_post_start_actionables=563 (native_spread_band=<=5c=209, native_spread_band=<=2c=136, native_depth_band=1000+=129, native_depth_band=10-99=64) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=232 (not_actionable=232) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 2: native_watch|crypto_strong_no_90_95 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=57 resolved=57 pending=0 active=0 stale=0 unknown=0 | 48W-9L | pnl=$-5.24 | Wilson 72.6% vs target 95.4% (BE 93.4%) | gap=-22.8pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=310 | excluded_post_start_actionables=682 (signal_tier=weak=291, signal_tier=moderate=257, native_ask_band=85-90=62, native_ask_band=95-98=43) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89 | target_window_misses=856 (not_actionable_native_ask_band=missing=274, not_actionable_native_ask_band=<80=122, not_actionable_native_ask_band=95-98=115, not_actionable_native_ask_band=99+=108) | target_window_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89
- rank 3: native_watch|crypto_spread_le1_depth_10_99 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T07:10:00+00:00 | observations=46 resolved=46 pending=0 active=0 stale=0 unknown=0 | 41W-5L | pnl=$-0.59 | Wilson 77.0% vs target 92.4% (BE 90.4%) | gap=-15.5pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=104 | excluded_post_start_actionables=790 (native_depth_band=100-999=286, native_spread_band=<=5c=211, native_spread_band=<=2c=138, native_depth_band=1000+=130) | excluded_sample=KXBTCD-26JUL0104-T58899.99 native_depth_band=100-999 ask=0.93 | target_window_misses=78 (not_actionable=78) | target_window_sample=KXSOLD-26JUL0107-T75.9999 not_actionable ask=0.99
- rank 4: native_watch|crypto_btc_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-30T07:13:19+00:00 | observations=45 resolved=45 pending=0 active=0 stale=0 unknown=0 | 36W-9L | pnl=$-3.71 | Wilson 66.2% vs target 90.2% (BE 88.2%) | gap=-24.1pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=125 | excluded_post_start_actionables=977 (asset=SOL=319, asset=ETH=286, native_ask_band=90-95=251, native_ask_band=95-98=65) | excluded_sample=KXBTCD-26JUN3005-T59699.99 native_ask_band=90-95 ask=0.94 | target_window_misses=1503 (not_actionable_native_ask_band=missing=520, native_ask_band=90-95=251, not_actionable_native_ask_band=98-99=159, not_actionable_native_ask_band=<80=159) | target_window_sample=KXBTCD-26JUN3004-T59799.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 5: native_watch|crypto_20_40m_no_80_85 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-29T11:05:00+00:00 | observations=42 resolved=42 pending=0 active=0 stale=0 unknown=0 | 38W-4L | pnl=$+2.71 | Wilson 77.9% vs target 86.0% (BE 84.0%) | gap=-8.1pp | blockers=wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=28 | excluded_post_start_actionables=1231 (minutes_band=40-60m=697, native_ask_band=90-95=218, native_ask_band=85-90=112, minutes_band=10-20m=107) | excluded_sample=KXBTCD-26JUN2908-T60299.99 minutes_band=40-60m ask=0.95 | target_window_misses=1482 (not_actionable_native_ask_band=missing=244, not_actionable_native_ask_band=98-99=236, native_ask_band=90-95=218, not_actionable_native_ask_band=99+=209) | target_window_sample=KXBTCD-26JUN2908-T60299.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 6: native_watch|crypto_sol_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T13:00:00+00:00 | observations=28 resolved=28 pending=0 active=0 stale=0 unknown=0 | 26W-2L | pnl=$+1.27 | Wilson 77.4% vs target 90.3% (BE 88.3%) | gap=-13.0pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=44 | excluded_post_start_actionables=739 (asset=BTC=384, asset=ETH=199, native_ask_band=90-95=91, native_ask_band=80-85=39) | excluded_sample=KXBTCD-26JUL0110-T59199.99 asset=BTC ask=0.93 | target_window_misses=534 (not_actionable_native_ask_band=missing=107, native_ask_band=90-95=91, not_actionable_native_ask_band=99+=80, not_actionable_native_ask_band=<80=73) | target_window_sample=KXSOLD-26JUL0111-T79.9999 not_actionable_native_ask_band=missing
- rank 7: native_watch|crypto_btc_strong_no_90_95_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T14:00:00+00:00 | observations=18 resolved=18 pending=0 active=0 stale=0 unknown=0 | 16W-2L | pnl=$-0.82 | Wilson 67.2% vs target 95.4% (BE 93.4%) | gap=-28.2pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=138 | excluded_post_start_actionables=757 (asset=SOL=226, asset=ETH=199, signal_tier=moderate=119, signal_tier=weak=81) | excluded_sample=KXETHD-26JUL0111-T1609.99 asset=ETH ask=0.90 | target_window_misses=117 (not_actionable_native_ask_band=95-98=30, not_actionable_native_ask_band=99+=21, native_ask_band=85-90=19, not_actionable_native_ask_band=<80=19) | target_window_sample=KXBTCD-26JUL0112-T60099.99 native_ask_band=85-90 ask=0.89
- rank 8: native_watch|crypto_tue_no_any_ask | gate=FORWARD_WATCH_WAITING | start=2026-07-01T07:10:00+00:00 | observations=0 resolved=0 pending=0 active=0 stale=0 unknown=0 | 0W-0L | pnl=$+0.00 | Wilson 0.0% vs target 2.0% (BE 0.0%) | gap=-2.0pp | blockers=no_forward_observations;resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=>5000_or_target_impossible | excluded_post_start_actionables=855 (captured_weekday=Sat=305, captured_weekday=Fri=180, captured_weekday=Thu=165, captured_weekday=Wed=133) | excluded_sample=KXBTCD-26JUL0104-T58899.99 captured_weekday=Wed ask=0.93

## Kalshi Native Preflight Walk-Forward Validation
- command: `python3 scripts/kalshi_native_preflight_walkforward.py --limit 8`
- status: NO_WALKFORWARD_NATIVE_CUT | ready=false | observations=17483 | cuts=2369 | display_cuts=254 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-30T10:30:25+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_walkforward_native_cut_validation_requires_predeclared_forward_gate
- best: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=WALKFORWARD_REJECT | type=single | train=23 resolved 21W-2L +$0.98 Wilson 73.2% vs target 89.0% gap=-15.8pp | validation=35 resolved 35W-0L +$4.79 Wilson 90.1% vs target 88.3% gap=+1.8pp | blockers=train_resolved<30;train_wilson<BE+buffer | promotion_blockers=none | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
- rank 1: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=WALKFORWARD_REJECT | type=single | train=23 resolved 21W-2L +$0.98 Wilson 73.2% vs target 89.0% gap=-15.8pp | validation=35 resolved 35W-0L +$4.79 Wilson 90.1% vs target 88.3% gap=+1.8pp | blockers=train_resolved<30;train_wilson<BE+buffer | promotion_blockers=none | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
...
- rank 4: crypto_last_hour_longshot_no|captured_weekday=Tue | gate=WALKFORWARD_REJECT | type=single | train=21 resolved 21W-0L +$1.75 Wilson 84.5% vs target 93.7% gap=-9.1pp | validation=31 resolved 31W-0L +$2.79 Wilson 89.0% vs target 93.0% gap=-4.0pp | blockers=train_resolved<30;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 5: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=WALKFORWARD_REJECT | type=pair | train=48 resolved 47W-1L +$2.42 Wilson 89.1% vs target 94.9% gap=-5.8pp | validation=48 resolved 47W-1L +$2.69 Wilson 89.1% vs target 94.3% gap=-5.2pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0502-T62899.99 status=active due=2026-07-05T05:59:59.605680+00:00 ask=0.92
- rank 6: crypto_last_hour_longshot_no|asset=ETH|native_ask_band=85-90 | gate=WALKFORWARD_REJECT | type=pair | train=26 resolved 23W-3L +$0.11 Wilson 71.0% vs target 90.0% gap=-19.0pp | validation=31 resolved 30W-1L +$2.57 Wilson 83.8% vs target 90.4% gap=-6.6pp | blockers=train_resolved<30;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
- rank 7: crypto_last_hour_longshot_no|signal_tier=weak|native_ask_band=85-90 | gate=WALKFORWARD_REJECT | type=pair | train=35 resolved 32W-3L +$1.20 Wilson 77.6% vs target 90.0% gap=-12.4pp | validation=37 resolved 35W-2L +$2.56 Wilson 82.3% vs target 89.6% gap=-7.3pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
- rank 8: crypto_last_hour_longshot_no|signal_tier=moderate | gate=WALKFORWARD_REJECT | type=single | train=58 resolved 53W-5L +$1.08 Wilson 81.4% vs target 91.5% gap=-10.2pp | validation=57 resolved 53W-4L +$1.89 Wilson 83.3% vs target 91.7% gap=-8.4pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0502-T62899.99 status=active due=2026-07-05T05:59:59.605680+00:00 ask=0.92
...
- best: crypto_last_hour_native_subcell:moderate:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=71 resolved=71 pending=0 active=0 stale=0 unknown=0 | 67W-4L | pnl=+4.02 | Wilson 86.4% vs BE 88.7% | gap=-2.3pp | blockers=wilson<BE+2pp | perfect_wins_needed=36
- rank 1: crypto_last_hour_native_subcell:moderate:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=71 resolved=71 pending=0 active=0 stale=0 unknown=0 | 67W-4L | pnl=+4.02 | Wilson 86.4% vs BE 88.7% | gap=-2.3pp | blockers=wilson<BE+2pp | perfect_wins_needed=36
- rank 2: crypto_last_hour_native_subcell:strong:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=172 resolved=172 pending=0 active=0 stale=0 unknown=0 | 156W-16L | pnl=-4.23 | Wilson 85.4% vs BE 93.2% | gap=-7.7pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=359
- rank 3: crypto_last_hour_native_subcell:weak:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=101 resolved=100 pending=1 active=1 stale=0 unknown=0 | 87W-13L | pnl=-0.43 | Wilson 79.0% vs BE 87.4% | gap=-8.4pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=105 | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
- rank 4: crypto_last_hour_native_subcell:native_ask:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=173 resolved=172 pending=1 active=1 stale=0 unknown=0 | 151W-21L | pnl=+1.77 | Wilson 82.1% vs BE 86.8% | gap=-4.7pp | blockers=wilson<BE+2pp | perfect_wins_needed=107 | next_pending=KXETHD-26JUL0502-T1769.99 status=active due=2026-07-05T05:59:59.348987+00:00 ask=0.85
- rank 5: crypto_last_hour_native_subcell:native_ask:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=170 resolved=169 pending=1 active=1 stale=0 unknown=0 | 156W-13L | pnl=-1.30 | Wilson 87.3% vs BE 93.1% | gap=-5.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=277 | next_pending=KXBTCD-26JUL0502-T62899.99 status=active due=2026-07-05T05:59:59.605680+00:00 ask=0.92
- rank 6: crypto_last_hour_native_subcell:moderate:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=45 resolved=44 pending=1 active=1 stale=0 unknown=0 | 39W-5L | pnl=-1.05 | Wilson 76.0% vs BE 91.1% | gap=-15.0pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=121 | next_pending=KXBTCD-26JUL0502-T62899.99 status=active due=2026-07-05T05:59:59.605680+00:00 ask=0.92

## Kalshi Crypto Last-Hour Entry Timing Audit
- command: `python3 scripts/kalshi_crypto_last_hour_entry_timing_audit.py --limit 8`
- status: NO_ENTRY_TIMING_CANDIDATE | ready=false | posthoc_candidates=0 | source_actionable_rows=1924 | selected_observations=981 | cuts=377 | min_resolved=30 | edge_buffer=+2.0pp
- best: crypto_last_hour_entry_timing:latest_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=208 resolved=208 pending=0 | 201W-7L | pnl=+$6.40 | Wilson 93.2% vs target 95.6% (BE 93.6%) | gap=-2.3pp | blockers=wilson<BE+2pp
- rank 1: crypto_last_hour_entry_timing:latest_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=208 resolved=208 pending=0 | 201W-7L | pnl=+$6.40 | Wilson 93.2% vs target 95.6% (BE 93.6%) | gap=-2.3pp | blockers=wilson<BE+2pp
- rank 2: crypto_last_hour_entry_timing:latest_actionable|signal_tier=moderate|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=67 resolved=67 pending=0 | 66W-1L | pnl=+$3.47 | Wilson 92.0% vs target 95.3% (BE 93.3%) | gap=-3.3pp | blockers=wilson<BE+2pp
- rank 3: crypto_last_hour_entry_timing:first_actionable|native_depth_band=1000+ | gate=ENTRY_TIMING_ACCUMULATING | observations=94 resolved=94 pending=0 | 90W-4L | pnl=+$3.82 | Wilson 89.6% vs target 93.7% (BE 91.7%) | gap=-4.1pp | blockers=wilson<BE+2pp
- rank 4: crypto_last_hour_entry_timing:first_actionable|native_spread_band=<=1c | gate=ENTRY_TIMING_ACCUMULATING | observations=262 resolved=260 pending=2 | 240W-20L | pnl=+$3.28 | Wilson 88.4% vs target 93.0% (BE 91.0%) | gap=-4.6pp | blockers=wilson<BE+2pp
- rank 5: crypto_last_hour_entry_timing:latest_actionable|asset=BTC|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=92 resolved=92 pending=0 | 89W-3L | pnl=+$2.79 | Wilson 90.8% vs target 95.7% (BE 93.7%) | gap=-4.9pp | blockers=wilson<BE+2pp
- rank 6: crypto_last_hour_entry_timing:first_actionable|signal_tier=weak|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=45 resolved=44 pending=1 | 42W-2L | pnl=+$3.37 | Wilson 84.9% vs target 89.8% (BE 87.8%) | gap=-4.9pp | blockers=wilson<BE+2pp
- rank 7: crypto_last_hour_entry_timing:latest_actionable|asset=BTC|native_ask_band=95-98 | gate=ENTRY_TIMING_ACCUMULATING | observations=52 resolved=51 pending=1 | 51W-0L | pnl=+$2.04 | Wilson 93.0% vs target 98.0% (BE 96.0%) | gap=-5.0pp | blockers=wilson<BE+2pp
- rank 8: crypto_last_hour_entry_timing:latest_actionable|asset=ETH|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=55 resolved=55 pending=0 | 54W-1L | pnl=+$2.51 | Wilson 90.4% vs target 95.6% (BE 93.6%) | gap=-5.2pp | blockers=wilson<BE+2pp

## Kalshi Crypto Ladder Dislocation Preflight
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_preflight.py --json`
- latest_run: captured_at=2026-07-05T05:11:16+00:00 | lookahead=75m | events=5 rows_per_event=40 | candidates=114 checked=114 dislocation_qty1=0 | min_source_edge=0.03 max_source_age=300s | top_reasons=missing_native_no_ask=112, source_age_too_old:534s=1, source_age_too_old:535s=1
- latest_rows: KXSOLD-26JUL0502-T80.9999 SOL/extreme source_no=0.95 native_no_ask=0.97 edge=-0.02 age=534s spread=0.02 depth=8 win=0.02 due=2026-07-05T05:59:59.879889+00:00 reason=source_age_too_old:534s ; KXETHD-26JUL0502-T1769.99 ETH/weak source_no=0.82 native_no_ask=0.87 edge=-0.05 age=535s spread=0.01 depth=62 win=0.12 due=2026-07-05T05:59:59.348987+00:00 reason=source_age_too_old:535s ; KXETHD-26JUL0502-T1789.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=535s spread=missing depth=0 win=missing due=2026-07-05T05:59:59.354233+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0502-T1809.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=535s spread=missing depth=0 win=missing due=2026-07-05T05:59:59.359229+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0502-T1829.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=535s spread=missing depth=0 win=missing due=2026-07-05T05:59:59.364117+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0502-T1849.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=535s spread=missing depth=0 win=missing due=2026-07-05T05:59:59.369088+00:00 reason=missing_native_no_ask

## Kalshi Crypto Ladder Dislocation Forward Audit
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_audit.py --limit 8`
- status: NO_LIVE_READY | ready=false | cells=6 | ready_cells=0 | observations=111 | min_resolved=30 | edge_buffer=+2.0pp | scope=source-vs-native ladder gaps only; not riskless structural arbitrage
- best: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=71 resolved=70 pending=1 active=0 stale=1 | 49W-21L pnl_qty1=-$8.36 | Wilson 58.5% vs target 83.9% gap=-25.5pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=124 | next_pending=KXETHD-26JUL0501-T1769.99 status=stale due=2026-07-05T04:59:59.014370+00:00
- rank 1: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=71 resolved=70 pending=1 active=0 stale=1 | 49W-21L pnl_qty1=-$8.36 | Wilson 58.5% vs target 83.9% gap=-25.5pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=124 | next_pending=KXETHD-26JUL0501-T1769.99 status=stale due=2026-07-05T04:59:59.014370+00:00
- rank 2: ticker_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=75 resolved=74 pending=1 active=0 stale=1 | 52W-22L pnl_qty1=-$9.08 | Wilson 59.1% vs target 84.5% gap=-25.5pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=135 | next_pending=KXETHD-26JUL0501-T1769.99 status=stale due=2026-07-05T04:59:59.014370+00:00
- rank 3: all_rows | gate=LADDER_DISLOCATION_ACCUMULATING | observations=111 resolved=110 pending=1 active=0 stale=1 | 72W-38L pnl_qty1=-$15.21 | Wilson 56.2% vs target 81.3% gap=-25.1pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=161 | next_pending=KXETHD-26JUL0501-T1769.99 status=stale due=2026-07-05T04:59:59.014370+00:00
...
- rank 5: asset_eth | gate=LADDER_DISLOCATION_ACCUMULATING | observations=50 resolved=49 pending=1 active=0 stale=1 | 32W-17L pnl_qty1=-$6.79 | Wilson 51.3% vs target 81.2% gap=-29.9pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=90 | next_pending=KXETHD-26JUL0501-T1769.99 status=stale due=2026-07-05T04:59:59.014370+00:00
- rank 6: asset_sol | gate=LADDER_DISLOCATION_ACCUMULATING | observations=53 resolved=53 pending=0 active=0 stale=0 | 35W-18L pnl_qty1=-$6.25 | Wilson 52.6% vs target 79.8% gap=-27.2pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=82
...
- latest_run: captured_at=2026-07-05T04:23:17+00:00 | markets_checked=24 parsed=24 source_observations=49 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXTEMPNYCH dates=2026-07-05 | state_keys=1 observations_raw=49 source=weathercom_kalshi_metar_primary source_errors=0 | counts=KXTEMPNYCH=24 | reasons=hourly_temp_observation_missing_or_future=24
...
- latest_run: captured_at=2026-07-05T03:22:57+00:00 | markets_checked=2204 parsed=2204 espn_games=12 locked_rows=268 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXMLBKS,KXMLBOUTS,KXMLBHIT,KXMLBHRR,KXMLBHR,KXMLBTB,KXMLBRBI,KXMLBSB dates=2026-07-04,2026-07-05 | state_games=12 | reasons=player_stat_waiting_for_threshold_or_final=1064, player_stat_missing_after_final=403, mlb_boxscore_not_current=370, mlb_player_stat_already_reached=268, player_stat_missing_before_final=99
- locked_rows: KXMLBHIT-26JUL042140MILAZ-MILWCONTRERAS24-2 YES ask=0.99 depth=340 bid=0.83 win=0.00 stat=hits:2/2 game=MIL@AZ 2-3 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHRR-26JUL042140MILAZ-MILWCONTRERAS24-2 YES ask=0.99 depth=769 bid=0.82 win=0.00 stat=hits_runs_rbi:2/2 game=MIL@AZ 2-3 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL042008STLCHC-CHCIHAPP8-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=STL@CHC 2-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL042008STLCHC-CHCMCONFORTO90-1 YES ask=1.00 depth=0 bid=0.98 win=0.00 stat=hits:2/1 game=STL@CHC 2-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL042008STLCHC-CHCMCONFORTO90-2 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:2/2 game=STL@CHC 2-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL042008STLCHC-STLABURLESON41-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=STL@CHC 2-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL042008STLCHC-STLIHERRERA48-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=STL@CHC 2-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL042008STLCHC-STLJFERMN15-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=STL@CHC 2-0 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0
...
- latest_run: captured_at=2026-07-05T04:18:31+00:00 | markets_checked=5000 with_legs=5000 component_events=80/300 fetched=80 component_markets=463 resolved=3 locked_rows=9 actionable_qty1=0 | max_target_ask=0.25 min_depth=1 | series=KXMVESPORTSMULTIGAMEEXTENDED counts=KXMVESPORTSMULTIGAMEEXTENDED=5000 | page_cap=KXMVESPORTSMULTIGAMEEXTENDED rate_limited=none component_cap=true component_rate_limited=false | reasons=not_locked_by_component_results=4991, component_event_cap_reached=220, component_false_locks_mve_no=9, component_market_resolved=3
- latest_rows: KXMVESPORTSMULTIGAMEEXTENDED-S2026071E0401807-AF8F23FA62E NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVESPORTSMULTIGAMEEXTENDED legs=3/6 decisive=KXDOGE15M-26JUL050015-15:YES->NO reason=component_false_locks_mve_no actionable=0 ; KXMVESPORTSMULTIGAMEEXTENDED-S20262B40965BE47-901783758DB NO ask=1.00 depth=0 bid=0.00 win=0.00 series=KXMVESPORTSMULTIGAMEEXTENDED legs=3/13 decisive=KXDOGE15M-26JUL050015-15:YES->NO reason=component_false_locks_mve_no actionable=0 ; KXMVESPORTSMULTIGAMEEXTENDED-S20262E5C0A1BBD1-973253F73EC NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVESPORTSMULTIGAMEEXTENDED legs=3/8 decisive=KXDOGE15M-26JUL050015-15:YES->NO reason=component_false_locks_mve_no actionable=0 ; KXMVESPORTSMULTIGAMEEXTENDED-S20264EECD51E6F3-C4E4C2E5FE5 NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVESPORTSMULTIGAMEEXTENDED legs=2/5 decisive=KXBTC15M-26JUL050015-15:NO->YES reason=component_false_locks_mve_no actionable=0 ; KXMVESPORTSMULTIGAMEEXTENDED-S202659ACA02E27E-A98F9E0254C NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVESPORTSMULTIGAMEEXTENDED legs=1/21 decisive=KXBTC15M-26JUL050015-15:NO->YES reason=component_false_locks_mve_no actionable=0 ; KXMVESPORTSMULTIGAMEEXTENDED-S20265DD9C4B9F29-42182A39ACF NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVESPORTSMULTIGAMEEXTENDED legs=1/4 decisive=KXBTC15M-26JUL050015-15:NO->YES reason=component_false_locks_mve_no actionable=0 ; KXMVESPORTSMULTIGAMEEXTENDED-S20268F7DE5BDFC6-77D0DAE8A6D NO ask=1.00 depth=0 bid=1.00 win=0.00 series=KXMVESPORTSMULTIGAMEEXTENDED legs=1/3 decisive=KXBTC15M-26JUL050015-15:NO->YES reason=component_false_locks_mve_no actionable=0 ; KXMVESPORTSMULTIGAMEEXTENDED-S2026E6E3F17A799-E5DC6026D0E NO ask=1.00 depth=0 bid=0.00 win=0.00 series=KXMVESPORTSMULTIGAMEEXTENDED legs=1/2 decisive=KXDOGE15M-26JUL050015-15:YES->NO reason=component_false_locks_mve_no actionable=0
...
- status: live_rows=1 dry_runs=8 filled_rows=0 cancelled_rows=0 | strategy_open=0 strategy_open_cost=$0.00 | all_live_pilot_open=7 all_live_pilot_cost=$1.37
- latest_rows: id=9 live=false status=DRY_RUN ticker=KXNETFLIXTOPVIEWSMOVIE-26JUL06-25 side=NO qty=1 limit=0.19 bid=0.18 ask=0.19 depth=1 spread=0.01 trade_id=none order=none fill_confirmed=0 cost=$unknown fee=$unknown target_week=2026-07-05 latest_week=2026-06-28 latest_views_m=31.00 primary_no=13/23 primary_wilson=0.37 recent_no=5/15 pred_p=unknown edge=unknown resolution=unresolved pnl=unknown reason=native_no_ask_out_of_guard:0.1900 ; id=8 live=false status=DRY_RUN ticker=KXNETFLIXTOPVIEWSMOVIE-26JUL06-25 side=NO qty=1 limit=0.07 bid=0.05 ask=0.07 depth=1 spread=0.02 trade_id=none order=none fill_confirmed=0 cost=$unknown fee=$unknown target_week=2026-07-05 latest_week=2026-06-28 latest_views_m=31.00 primary_no=13/23 primary_wilson=0.37 recent_no=5/15 pred_p=unknown edge=unknown resolution=unresolved pnl=unknown reason=native_no_ask_out_of_guard:0.0700 ; id=7 live=false status=DRY_RUN ticker=KXNETFLIXTOPVIEWSMOVIE-26JUL06-25 side=NO qty=1 limit=0.08 bid=0.05 ask=0.08 depth=1 spread=0.03 trade_id=none order=none fill_confirmed=0 cost=$unknown fee=$unknown target_week=2026-07-05 latest_week=2026-06-28 latest_views_m=31.00 primary_no=13/23 primary_wilson=0.37 recent_no=5/15 pred_p=unknown edge=unknown resolution=unresolved pnl=unknown reason=native_no_ask_out_of_guard:0.0800 ; id=6 live=false status=DRY_RUN ticker=KXNETFLIXTOPVIEWSMOVIE-26JUL06-25 side=NO qty=1 limit=0.13 bid=0.05 ask=0.13 depth=23 spread=0.08 trade_id=none order=none fill_confirmed=0 cost=$unknown fee=$unknown target_week=2026-07-05 latest_week=2026-06-28 latest_views_m=31.00 primary_no=13/23 primary_wilson=0.37 recent_no=5/15 pred_p=unknown edge=unknown resolution=unresolved pnl=unknown reason=native_no_ask_out_of_guard:0.1300 ; id=5 live=false status=DRY_RUN ticker=KXNETFLIXTOPVIEWSMOVIE-26JUL06-25 side=NO qty=1 limit=0.14 bid=0.05 ask=0.14 depth=10 spread=0.09 trade_id=none order=none fill_confirmed=0 cost=$unknown fee=$unknown target_week=2026-07-05 latest_week=2026-06-28 latest_views_m=31.00 primary_no=13/23 primary_wilson=0.37 recent_no=5/15 pred_p=unknown edge=unknown resolution=unresolved pnl=unknown reason=native_no_ask_out_of_guard:0.1400
...
- latest_run: captured_at=2026-07-05T04:21:30+00:00 | markets_checked=584 parsed=580 espn_games=39 locked_rows=7 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXMLBRFI,KXMLBF3,KXMLBF5,KXMLBF5SPREAD,KXMLBF5TOTAL,KXMLBF7,KXMLBTEAMTOTAL,KXMLBEXTRAS dates=2026-07-05,2026-07-04,2026-07-06,2026-07-07 | state_games=39 | counts=KXMLBEXTRAS=41, KXMLBF3=42, KXMLBF5=42, KXMLBF5SPREAD=56, KXMLBF5TOTAL=98, KXMLBF7=42, KXMLBRFI=39, KXMLBTEAMTOTAL=224 | reasons=mlb_teamtotal_game_not_final=217, mlb_f5total_window_not_complete=98, mlb_f5spread_window_not_complete=56, mlb_f3_window_not_complete=42, mlb_f5_window_not_complete=42, mlb_f7_window_not_complete=42, mlb_extras_game_not_final=39, mlb_rfi_first_inning_not_complete=37
- locked_rows: KXMLBTEAMTOTAL-26JUL042140MIAATH-MIA2 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=MIA threshold=1.50 margin=missing total=None game=MIA@ATH 7-1 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL042140MIAATH-MIA3 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=MIA threshold=2.50 margin=missing total=None game=MIA@ATH 7-1 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL042140MIAATH-MIA4 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=MIA threshold=3.50 margin=missing total=None game=MIA@ATH 7-1 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL042140MIAATH-MIA5 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=MIA threshold=4.50 margin=missing total=None game=MIA@ATH 7-1 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL042140MIAATH-MIA6 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=MIA threshold=5.50 margin=missing total=None game=MIA@ATH 7-1 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL042140MIAATH-MIA7 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=MIA threshold=6.50 margin=missing total=None game=MIA@ATH 7-1 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL042210SDLAD-LAD2 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=LAD threshold=1.50 margin=missing total=None game=SD@LAD 0-2 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0
...
- latest_run: captured_at=2026-07-05T04:21:30+00:00 | markets_checked=114 parsed=114 espn_games=5 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWNBAGAME,KXWNBASPREAD,KXWNBATOTAL,KXWNBAOT,KXWNBA1QWINNER,KXWNBA2QWINNER,KXWNBA3QWINNER,KXWNBA4QWINNER,KXWNBA1HWINNER,KXWNBA2HWINNER,KXWNBA1QSPREAD,KXWNBA2QSPREAD,KXWNBA3QSPREAD,KXWNBA4QSPREAD,KXWNBA1HSPREAD,KXWNBA2HSPREAD,KXWNBA1QTOTAL,KXWNBA2QTOTAL,KXWNBA3QTOTAL,KXWNBA4QTOTAL,KXWNBA1HTOTAL,KXWNBA2HTOTAL dates=2026-07-05,2026-07-06 | state_games=5 | counts=KXWNBA1HSPREAD=0, KXWNBA1HTOTAL=0, KXWNBA1HWINNER=0, KXWNBA1QSPREAD=0, KXWNBA1QTOTAL=0, KXWNBA1QWINNER=0, KXWNBA2HSPREAD=0, KXWNBA2HTOTAL=0, KXWNBA2HWINNER=0, KXWNBA2QSPREAD=0, KXWNBA2QTOTAL=0, KXWNBA2QWINNER=0, KXWNBA3QSPREAD=0, KXWNBA3QTOTAL=0, KXWNBA3QWINNER=0, KXWNBA4QSPREAD=0, KXWNBA4QTOTAL=0, KXWNBA4QWINNER=0, KXWNBAGAME=10, KXWNBAOT=5, KXWNBASPREAD=54, KXWNBATOTAL=45 | reasons=wnba_spread_game_not_final=54, wnba_total_game_not_final=45, wnba_game_not_final=10, wnba_overtime_game_not_final=5
...
- latest_run: captured_at=2026-07-05T03:15:37+00:00 | markets_checked=0 parsed=0 espn_games=0 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWNBAPTS,KXWNBAREB,KXWNBAAST,KXWNBA3PT dates= | state_games=0 titles=0 title_failures=0 summary_fetches=0 | counts=KXWNBA3PT=0, KXWNBAAST=0, KXWNBAPTS=0, KXWNBAREB=0 | reasons=none
...
- status: live_rows=1 dry_runs=2 filled_rows=1 cancelled_rows=0 | strategy_open=0 strategy_open_cost=$0.00 | all_live_pilot_open=7 all_live_pilot_cost=$1.37
...
- latest_run: captured_at=2026-07-05T04:22:28+00:00 | kalshi_markets=68 groups=34 espn_matches=622 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXATPMATCH,KXWTAMATCH,KXATPDOUBLES,KXWTADOUBLES counts=KXATPDOUBLES=16, KXATPMATCH=16, KXWTADOUBLES=20, KXWTAMATCH=16 | espn_events=atp=1, wta=1 competitions=atp=312, wta=310 status_fetches=622 | reasons=espn_match_not_unique_completed=28, no_espn_match_pair=6
...
- latest_run: captured_at=2026-07-05T04:21:30+00:00 | markets_checked=120 parsed=0 espn_games=4 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXCHNSLGAME,KXALLSVENSKANGAME,KXBRASILEIROBGAME,KXBRASILEIROCGAME,KXUSLGAME,KXECULPGAME dates=2026-07-05,2026-07-04,2026-07-06,2026-07-03 | state_games=4 | counts=KXALLSVENSKANGAME=15, KXBRASILEIROBGAME=36, KXBRASILEIROCGAME=36, KXCHNSLGAME=6, KXECULPGAME=15, KXUSLGAME=12 | reasons=none

## Kalshi Broad Event-First Shadow Audit
- command: `python3 scripts/kalshi_shadow_event_first_audit.py --json`
- status: SHADOW_EVENT_FIRST_CANDIDATES | ready=false | eligible_cells=169 | candidate_cells=4 | ready_cells=0 | min_events=30 | edge_buffer=+2.0pp | scope=event-first shadow only; native execution still requires a separate forward gate
...
- rank 2: shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=621 | 574W-47L | pnl=+2551.43 | Wilson 90.1% vs target 89.6% (avg_price 87.6%) | target_gap=+0.5pp | blockers=none
- rank 3: shadow_deterministic_settlement:ETH:YES:50-80:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=88 | 71W-17L | pnl=+1052.70 | Wilson 71.2% vs target 70.7% (avg_price 68.7%) | target_gap=+0.5pp | blockers=none
- rank 4: shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=890 | 780W-110L | pnl=+3363.07 | Wilson 85.3% vs target 84.9% (avg_price 82.9%) | target_gap=+0.4pp | blockers=none

## Kalshi Shadow Longshot Stability Audit
- command: `python3 scripts/kalshi_shadow_longshot_stability_audit.py --limit 8`
- status: NO_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=7332 | eligible_cells=25 | base_candidate_cells=3 | stable_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=621ev 574W-47L +2551.43 Wilson 90.1% vs target 89.6% gap +0.5pp | train=434ev 402W-32L +1858.42 Wilson 89.8% vs target 89.6% gap +0.2pp | validation=187ev 172W-15L +693.01 Wilson 87.2% vs target 89.5% gap -2.3pp | worst_asset=KXETHD 98ev 91W-7L +459.86 Wilson 86.0% vs target 89.4% gap -3.4pp | worst_hour=15Z 25ev 18W-7L -410.07 Wilson 52.4% vs target 89.6% gap -37.2pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
...
- 3. shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=890ev 780W-110L +3363.07 Wilson 85.3% vs target 84.9% gap +0.4pp | train=623ev 556W-67L +3507.90 Wilson 86.6% vs target 84.6% gap +2.0pp | validation=267ev 224W-43L -144.83 Wilson 79.0% vs target 85.5% gap -6.5pp | worst_asset=KXBTCD 471ev 404W-67L +962.18 Wilson 82.3% vs target 84.7% gap -2.4pp | worst_hour=13Z 36ev 26W-10L -432.22 Wilson 56.0% vs target 85.2% gap -29.2pp | blockers=validation_pnl<=0;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXBTCD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
...
- status: NO_FILTERED_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=7332 | base_candidate_cells=3 | filtered_cells=74 | filtered_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_asset=KXETHD,exclude_hour=15Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_asset=KXETHD,exclude_hour=15Z | excluded=119 | aggregate=502ev 468W-34L +2444.78 Wilson 90.7% vs target 89.6% gap +1.1pp | train=351ev 326W-25L +1574.06 Wilson 89.7% vs target 89.6% gap +0.1pp | validation=151ev 142W-9L +870.72 Wilson 89.1% vs target 89.5% gap -0.4pp | worst_asset=KXSOLD 112ev 105W-7L +610.98 Wilson 87.7% vs target 89.5% gap -1.9pp | worst_hour=13Z 21ev 17W-4L -156.02 Wilson 60.0% vs target 89.6% gap -29.6pp | blockers=validation_wilson<avg_price+buffer;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
- 2. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=15Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=15Z | excluded=25 | aggregate=596ev 556W-40L +2961.50 Wilson 91.0% vs target 89.6% gap +1.4pp | train=417ev 389W-28L +2059.49 Wilson 90.5% vs target 89.6% gap +0.9pp | validation=179ev 167W-12L +902.01 Wilson 88.6% vs target 89.5% gap -0.8pp | worst_asset=KXETHD 94ev 88W-6L +516.72 Wilson 86.8% vs target 89.4% gap -2.6pp | worst_hour=13Z 22ev 18W-4L -142.87 Wilson 61.5% vs target 89.5% gap -28.1pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
- 3. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=02Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=02Z | excluded=36 | aggregate=585ev 543W-42L +2613.99 Wilson 90.4% vs target 89.6% gap +0.8pp | train=409ev 379W-30L +1749.53 Wilson 89.7% vs target 89.6% gap +0.1pp | validation=176ev 164W-12L +864.46 Wilson 88.5% vs target 89.5% gap -1.0pp | worst_asset=KXETHD 93ev 87W-6L +499.78 Wilson 86.6% vs target 89.4% gap -2.8pp | worst_hour=15Z 25ev 18W-7L -410.07 Wilson 52.4% vs target 89.6% gap -37.2pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 4. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=09Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=09Z | excluded=22 | aggregate=599ev 553W-46L +2395.27 Wilson 89.9% vs target 89.6% gap +0.4pp | train=419ev 386W-33L +1582.95 Wilson 89.1% vs target 89.6% gap -0.4pp | validation=180ev 167W-13L +812.32 Wilson 88.0% vs target 89.5% gap -1.5pp | worst_asset=KXETHD 94ev 87W-7L +412.00 Wilson 85.4% vs target 89.4% gap -4.0pp | worst_hour=15Z 25ev 18W-7L -410.07 Wilson 52.4% vs target 89.6% gap -37.2pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 5. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_asset=KXETHD | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_asset=KXETHD | excluded=98 | aggregate=523ev 483W-40L +2091.57 Wilson 89.8% vs target 89.6% gap +0.2pp | train=366ev 337W-29L +1349.53 Wilson 88.9% vs target 89.6% gap -0.8pp | validation=157ev 146W-11L +742.04 Wilson 87.9% vs target 89.5% gap -1.6pp | worst_asset=KXSOLD 116ev 108W-8L +556.95 Wilson 87.0% vs target 89.5% gap -2.6pp | worst_hour=15Z 21ev 15W-6L -353.21 Wilson 50.0% vs target 89.5% gap -39.4pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 6. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=01Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=01Z | excluded=40 | aggregate=581ev 537W-44L +2394.54 Wilson 90.0% vs target 89.5% gap +0.4pp | train=406ev 375W-31L +1641.34 Wilson 89.4% vs target 89.6% gap -0.2pp | validation=175ev 162W-13L +753.20 Wilson 87.7% vs target 89.5% gap -1.8pp | worst_asset=KXETHD 92ev 85W-7L +388.54 Wilson 85.1% vs target 89.4% gap -4.3pp | worst_hour=15Z 25ev 18W-7L -410.07 Wilson 52.4% vs target 89.6% gap -37.2pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 7. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=08Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=08Z | excluded=17 | aggregate=604ev 559W-45L +2555.33 Wilson 90.2% vs target 89.6% gap +0.6pp | train=422ev 391W-31L +1818.61 Wilson 89.8% vs target 89.6% gap +0.2pp | validation=182ev 168W-14L +736.72 Wilson 87.5% vs target 89.5% gap -2.0pp | worst_asset=KXETHD 98ev 91W-7L +459.86 Wilson 86.0% vs target 89.4% gap -3.4pp | worst_hour=15Z 25ev 18W-7L -410.07 Wilson 52.4% vs target 89.6% gap -37.2pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 8. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=05Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=05Z | excluded=19 | aggregate=602ev 556W-46L +2421.45 Wilson 90.0% vs target 89.6% gap +0.4pp | train=421ev 389W-32L +1701.66 Wilson 89.5% vs target 89.6% gap -0.1pp | validation=181ev 167W-14L +719.79 Wilson 87.4% vs target 89.5% gap -2.1pp | worst_asset=KXETHD 95ev 88W-7L +421.35 Wilson 85.6% vs target 89.4% gap -3.9pp | worst_hour=15Z 25ev 18W-7L -410.07 Wilson 52.4% vs target 89.6% gap -37.2pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
...
- best: moderate_favorites:CRYPTO:ETH:YES:80-90:0-1H:liq1:spread1 | gate=LEGACY_SHADOW_FORWARD_REQUIRED | execution=legacy_taker_like_shadow | events=72 | 69W-3L | pnl=+$947.00 | Wilson 88.5% vs target 84.5% (BE 82.5%, avg_price 82.7%) | gap=+3.9pp | blockers=none | promotion_blockers=requires_native_or_maker_forward_gate
- rank 1: moderate_favorites:CRYPTO:ETH:YES:80-90:0-1H:liq1:spread1 | gate=LEGACY_SHADOW_FORWARD_REQUIRED | execution=legacy_taker_like_shadow | events=72 | 69W-3L | pnl=+$947.00 | Wilson 88.5% vs target 84.5% (BE 82.5%, avg_price 82.7%) | gap=+3.9pp | blockers=none | promotion_blockers=requires_native_or_maker_forward_gate
...
- rank 7: sell_inverse:WEATHER:NO:95+:4-24h | gate=LEGACY_SHADOW_REJECT | execution=legacy_inverse_shadow | events=726 | 7W-719L | pnl=-$640.70 | Wilson 0.5% vs target 3.9% (BE 1.9%, avg_price 98.3%) | gap=-3.4pp | blockers=pnl<=0;wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=33
...
- latest_run: captured_at=2026-07-05T05:09:02+00:00 | cohort=moderate_favorites_eth_yes_80_90_0_1h_v1 | start=2026-07-03T16:50:00+00:00 | include_pre_cutoff_live=false | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- latest_run: captured_at=2026-07-05T05:07:15+00:00 | cohort=yes_90_93_above_live_threshold_v1 | start=2026-06-25T11:45:00+00:00 | include_pre_cutoff_live=true | candidates=5 checked=5 actionable_qty1=0 | top_reasons=yes_90_93_above_live_threshold_v1:missing_native_yes_ask=2, yes_90_93_above_live_threshold_v1:native_yes_ask_below_band_watch:0.0100=2, yes_90_93_above_live_threshold_v1:native_yes_ask_below_band_watch:0.8900=1
- latest_rows: KXHIGHCHI-26JUL04-T85 city=CHI yes_ask=0.01 no_depth=413358 reason=native_yes_ask_below_band_watch:0.0100 ; KXHIGHTDAL-26JUL04-B98.5 city=DAL yes_ask=missing no_depth=0 reason=missing_native_yes_ask ; KXLOWTDEN-26JUL04-B59.5 city=DEN yes_ask=0.89 no_depth=47 reason=native_yes_ask_below_band_watch:0.8900 ; KXHIGHTSEA-26JUL04-T72 city=SEA yes_ask=0.01 no_depth=144649 reason=native_yes_ask_below_band_watch:0.0100 ; KXHIGHTSFO-26JUL04-B69.5 city=SFO yes_ask=missing no_depth=0 reason=missing_native_yes_ask
...
- latest_run: captured_at=2026-07-05T05:08:41+00:00 | start=2026-06-25T07:05:00+00:00 | include_pre_cutoff_live=true | candidates=13 checked=13 actionable_qty1=4 | top_reasons=no_95_98_zero_loss_cities_v1:missing_native_no_ask=5, no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive=4, no_90_95_min_probe_v1:missing_native_no_ask=1, no_90_95_min_probe_v1:native_no_ask_out_of_band:0.9800=1, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.8300=1, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9000=1
- latest_rows: KXLOWTAUS-26JUL05-B71.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=0.98 no_ask_depth=72 qty1=+0.01/-0.99 reason=actionable_qty1_fee_positive due=2026-07-06T19:00:00+00:00 ; KXHIGHMIA-26JUL05-T94 cohort=no_95_98_zero_loss_cities_v1 city=MIA no_ask=0.98 no_ask_depth=350 qty1=+0.01/-0.99 reason=actionable_qty1_fee_positive due=2026-07-06T14:00:00+00:00 ; KXLOWTMIA-26JUL05-B74.5 cohort=no_95_98_zero_loss_cities_v1 city=MIA no_ask=0.96 no_ask_depth=6 qty1=+0.03/-0.97 reason=actionable_qty1_fee_positive due=2026-07-06T19:00:00+00:00 ; KXHIGHTSEA-26JUL05-T72 cohort=no_95_98_zero_loss_cities_v1 city=SEA no_ask=0.98 no_ask_depth=9 qty1=+0.01/-0.99 reason=actionable_qty1_fee_positive due=2026-07-06T19:00:00+00:00 ; KXHIGHTMIN-26JUL04-T78 cohort=no_90_95_min_probe_v1 city=MIN no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-05T19:00:00+00:00 ; KXHIGHTMIN-26JUL05-T82 cohort=no_90_95_min_probe_v1 city=MIN no_ask=0.98 no_ask_depth=171 qty1=+0.01/-0.99 reason=native_no_ask_out_of_band:0.9800 due=2026-07-06T19:00:00+00:00 ; KXLOWTAUS-26JUL04-B72.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-05T19:00:00+00:00 ; KXHIGHTDAL-26JUL04-T96 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-05T19:00:00+00:00
...
- latest_run: captured_at=2026-07-05T05:11:38+00:00 | cohort=all | start=2026-06-25T20:00:00+00:00 | include_pre_cutoff_live=true | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- latest_run: captured_at=2026-07-05T02:12:53+00:00 | start=2026-06-26T17:10:00+00:00 | include_pre_cutoff_live=false | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none

## Kalshi Maker Forward Proxy Leaderboard
- command: `python3 scripts/kalshi_maker_forward_leaderboard.py --json`
- status: NO_LIVE_READY | ready=false | cells=15 | ready_cells=0 | review_min=50 | fills=2215 pending_units=508 active=501 stale=7 unknown=0 overall_resolved_indep=1707 toxic=588 | next_pending=cell_weather_no:KXHIGHCHI-26JUL04-B85.5 status=active close=2026-07-05T05:59:00+00:00
- best: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=575/50 max_if_pending_resolve=835 new_needed_after_pending=0 | 422W-153L | pnl=-812.90 | Wilson 69.6% vs BE 87.5% | gap=-17.9pp | fills=835/2925 fill_rate=28.5% pending_units=260 active=260 stale=0 unknown=0 toxic=153 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUL021235PITPHI-PHI4 status=active close=2026-07-05T16:35:00+00:00 price=0.80
- rank 1: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=575/50 max_if_pending_resolve=835 new_needed_after_pending=0 | 422W-153L | pnl=-812.90 | Wilson 69.6% vs BE 87.5% | gap=-17.9pp | fills=835/2925 fill_rate=28.5% pending_units=260 active=260 stale=0 unknown=0 toxic=153 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUL021235PITPHI-PHI4 status=active close=2026-07-05T16:35:00+00:00 price=0.80
- rank 2: cell_crypto_yes | gate=NO_GO_REVIEW | resolved_indep=345/50 max_if_pending_resolve=389 new_needed_after_pending=0 | 193W-152L | pnl=-1047.28 | Wilson 50.7% vs BE 86.3% | gap=-35.6pp | fills=389/1297 fill_rate=30.0% pending_units=44 active=44 stale=0 unknown=0 toxic=152 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0517-T61499.99 status=active close=2026-07-05T21:00:00+00:00 price=0.93
- rank 3: cell_crypto_no | gate=NO_GO_REVIEW | resolved_indep=324/50 max_if_pending_resolve=371 new_needed_after_pending=0 | 181W-143L | pnl=-1015.58 | Wilson 50.4% vs BE 87.2% | gap=-36.8pp | fills=371/1225 fill_rate=30.3% pending_units=47 active=47 stale=0 unknown=0 toxic=143 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0517-T53999.99 status=active close=2026-07-05T21:00:00+00:00 price=0.79
- rank 4: cell_sports_yes | gate=NO_GO_REVIEW | resolved_indep=195/50 max_if_pending_resolve=311 new_needed_after_pending=0 | 93W-102L | pnl=-763.72 | Wilson 40.8% vs BE 86.9% | gap=-46.1pp | fills=311/498 fill_rate=62.4% pending_units=116 active=116 stale=0 unknown=0 toxic=102 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUL021410CINMIL-CIN2 status=active close=2026-07-05T18:10:00+00:00 price=0.79
- rank 5: cell_weather_no | gate=NO_GO_REVIEW | resolved_indep=126/50 max_if_pending_resolve=152 new_needed_after_pending=0 | 103W-23L | pnl=-98.15 | Wilson 74.1% vs BE 89.5% | gap=-15.4pp | fills=152/322 fill_rate=47.2% pending_units=26 active=21 stale=5 unknown=0 toxic=23 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXHIGHCHI-26JUL04-B85.5 status=active close=2026-07-05T05:59:00+00:00 price=0.83
- rank 6: watch_crypto_bid_90_95 | gate=NO_GO_REVIEW | resolved_indep=117/50 max_if_pending_resolve=125 new_needed_after_pending=0 | 108W-9L | pnl=-15.65 | Wilson 86.0% vs BE 93.6% | gap=-7.6pp | fills=125/554 fill_rate=22.6% pending_units=8 active=8 stale=0 unknown=0 toxic=9 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0517-T61499.99 status=active close=2026-07-05T21:00:00+00:00 price=0.93
- rank 7: cell_index_no | gate=NO_GO_REVIEW | resolved_indep=113/50 max_if_pending_resolve=124 new_needed_after_pending=0 | 101W-12L | pnl=-29.57 | Wilson 82.4% vs BE 91.9% | gap=-9.6pp | fills=124/2546 fill_rate=4.9% pending_units=11 active=11 stale=0 unknown=0 toxic=12 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXINX-26JUL06H1600-B7437 status=active close=2026-07-06T20:00:00+00:00 price=0.92
- rank 8: watch_crypto_bid_92_94 | gate=NO_GO_REVIEW | resolved_indep=69/50 max_if_pending_resolve=75 new_needed_after_pending=0 | 65W-4L | pnl=+0.17 | Wilson 86.0% vs BE 94.2% | gap=-8.2pp | fills=75/302 fill_rate=24.8% pending_units=6 active=6 stale=0 unknown=0 toxic=4 | blockers=wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0517-T61499.99 status=active close=2026-07-05T21:00:00+00:00 price=0.93
...
- best: index NO maker_band=85-90 | gate=ACCUMULATING | resolved_indep=15/50 | 14W-1L | pnl=+8.38 | Wilson 70.2% vs BE 87.7% | gap=-17.5pp | candidates=255 fills=16 fill_rate=6.3% pending_units=1 toxic=1 | blockers=resolved<50; wilson<=BE; toxic>0
- rank 1: index NO maker_band=85-90 | gate=ACCUMULATING | resolved_indep=15/50 | 14W-1L | pnl=+8.38 | Wilson 70.2% vs BE 87.7% | gap=-17.5pp | candidates=255 fills=16 fill_rate=6.3% pending_units=1 toxic=1 | blockers=resolved<50; wilson<=BE; toxic>0
- rank 2: weather YES maker_band=<85 | gate=ACCUMULATING | resolved_indep=15/50 | 13W-2L | pnl=+6.91 | Wilson 62.1% vs BE 82.1% | gap=-19.9pp | candidates=30 fills=16 fill_rate=53.3% pending_units=1 toxic=2 | blockers=resolved<50; wilson<=BE; toxic>0
...
- rank 5: index NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=94/50 | 83W-11L | pnl=-44.59 | Wilson 80.2% vs BE 93.0% | gap=-12.7pp | candidates=2237 fills=104 fill_rate=4.6% pending_units=10 toxic=11 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 6: crypto YES maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=101/50 | 89W-12L | pnl=-50.66 | Wilson 80.4% vs BE 93.1% | gap=-12.8pp | candidates=412 fills=109 fill_rate=26.5% pending_units=8 toxic=12 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 7: weather NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=66/50 | 58W-8L | pnl=-36.91 | Wilson 77.9% vs BE 93.5% | gap=-15.6pp | candidates=183 fills=76 fill_rate=41.5% pending_units=10 toxic=8 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 8: sports NO maker_band=<85 | gate=NO_GO_REVIEW | resolved_indep=209/50 | 147W-62L | pnl=-252.87 | Wilson 63.8% vs BE 82.4% | gap=-18.6pp | candidates=1572 fills=330 fill_rate=21.0% pending_units=121 toxic=62 | blockers=pnl<=0; wilson<=BE; toxic>0

## Kalshi Maker Walk-Forward Validation
- command: `python3 scripts/kalshi_maker_walkforward.py --limit 8`
- status: NO_MAKER_WALKFORWARD_CUT | ready=false | observations=2215 | cuts=188 | display_cuts=121 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-29T10:20:10+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_maker_cut_walkforward_requires_predeclared_live_spec
- best: maker_all_fills|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=single | train=215 resolved 181W-34L -$90.40 toxic=34 Wilson 78.7% vs target 90.4% gap=-11.7pp | validation=149 resolved 134W-15L +$7.45 toxic=15 Wilson 84.1% vs target 91.4% gap=-7.4pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHCHI-26JUL04-B85.5 status=active due=2026-07-05T05:59:00+00:00 price=0.83
- rank 1: maker_all_fills|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=single | train=215 resolved 181W-34L -$90.40 toxic=34 Wilson 78.7% vs target 90.4% gap=-11.7pp | validation=149 resolved 134W-15L +$7.45 toxic=15 Wilson 84.1% vs target 91.4% gap=-7.4pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHCHI-26JUL04-B85.5 status=active due=2026-07-05T05:59:00+00:00 price=0.83
- rank 2: maker_all_fills|side=YES|side_bid_band=80-85 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=41 resolved 36W-5L +$8.20 toxic=5 Wilson 74.5% vs target 87.8% gap=-13.3pp | validation=38 resolved 35W-3L +$25.78 toxic=3 Wilson 79.2% vs target 87.3% gap=-8.1pp | blockers=train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHLAX-26JUL04-B73.5 status=active due=2026-07-05T07:59:00+00:00 price=0.81
- rank 3: maker_all_fills|category=crypto|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=73 resolved 65W-8L +$5.47 toxic=8 Wilson 79.8% vs target 90.3% gap=-10.5pp | validation=98 resolved 88W-10L +$2.11 toxic=10 Wilson 82.2% vs target 91.6% gap=-9.4pp | blockers=train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0517-T61499.99 status=active due=2026-07-05T21:00:00+00:00 price=0.93
- rank 4: maker_all_fills|side_bid_band=80-85 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=138 resolved 111W-27L -$77.14 toxic=27 Wilson 73.0% vs target 88.0% gap=-15.0pp | validation=99 resolved 86W-13L +$1.44 toxic=13 Wilson 78.8% vs target 88.7% gap=-9.9pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHCHI-26JUL04-B85.5 status=active due=2026-07-05T05:59:00+00:00 price=0.83
- rank 5: maker_all_fills|category=weather|hours_band=4-24h | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=19 resolved 15W-4L -$13.67 toxic=4 Wilson 56.7% vs target 88.1% gap=-31.5pp | validation=19 resolved 18W-1L +$19.33 toxic=1 Wilson 75.4% vs target 86.6% gap=-11.2pp | blockers=train_resolved<30;train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHCHI-26JUL04-T85 status=active due=2026-07-05T05:59:00+00:00 price=0.88
- rank 6: maker_all_fills|side_bid_band=92-94 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=75 resolved 69W-6L -$15.55 toxic=6 Wilson 83.6% vs target 96.1% gap=-12.4pp | validation=61 resolved 57W-4L -$4.36 toxic=4 Wilson 84.3% vs target 96.1% gap=-11.8pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_pnl<=0;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0517-T61499.99 status=active due=2026-07-05T21:00:00+00:00 price=0.93
- rank 7: maker_all_fills|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=54 resolved 48W-6L -$21.82 toxic=6 Wilson 77.8% vs target 94.9% gap=-17.1pp | validation=45 resolved 42W-3L +$2.23 toxic=3 Wilson 82.1% vs target 94.8% gap=-12.7pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUL021410CINMIL-CIN7 status=active due=2026-07-05T18:10:00+00:00 price=0.94
- rank 8: maker_all_fills|category=weather|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=24 resolved 21W-3L -$0.28 toxic=3 Wilson 69.0% vs target 89.6% gap=-20.6pp | validation=21 resolved 20W-1L +$14.48 toxic=1 Wilson 77.3% vs target 90.3% gap=-13.0pp | blockers=train_resolved<30;train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHCHI-26JUL04-B85.5 status=active due=2026-07-05T05:59:00+00:00 price=0.83
...
- status: native=NO_LIVE_READY pending=34 active=34 stale=0 unknown=0 | maker=NO_LIVE_READY pending_units=508 active=501 stale=7 unknown=0 | queued=26
- 1. maker_stale:weather_no | ticker=KXHIGHMIA-26JUL04-B88.5 | status=stale | time=2026-07-05T04:59:00+00:00 | closed_unfinalized expiration=2026-07-11T14:00:00+00:00 price=0.93
- 2. maker_stale:weather_no | ticker=KXHIGHMIA-26JUL04-B90.5 | status=stale | time=2026-07-05T04:59:00+00:00 | closed_unfinalized expiration=2026-07-11T14:00:00+00:00 price=0.84
- 3. maker_stale:weather_no | ticker=KXHIGHMIA-26JUL04-B94.5 | status=stale | time=2026-07-05T04:59:00+00:00 | closed_unfinalized expiration=2026-07-11T14:00:00+00:00 price=0.79
- 4. maker_stale:weather_no | ticker=KXHIGHNY-26JUL04-B100.5 | status=stale | time=2026-07-05T04:59:00+00:00 | closed_unfinalized expiration=2026-07-11T14:00:00+00:00 price=0.94
- 5. maker_stale:weather_no | ticker=KXHIGHNY-26JUL04-B98.5 | status=stale | time=2026-07-05T04:59:00+00:00 | closed_unfinalized expiration=2026-07-11T14:00:00+00:00 price=0.80
- 6. maker:cell_weather_no | ticker=KXHIGHCHI-26JUL04-B85.5 | status=active | time=2026-07-05T05:59:00+00:00 | resolved_indep=126 pending_units=26
- 7. maker:cell_weather_yes | ticker=KXHIGHCHI-26JUL04-T85 | status=active | time=2026-07-05T05:59:00+00:00 | resolved_indep=29 pending_units=4
- 8. native:crypto_last_hour_longshot_no | ticker=KXETHD-26JUL0502-T1769.99 | status=active | time=2026-07-05T05:59:59.348987+00:00 | resolved=387 pending=2
- 9. native:weather_high_ask_no | ticker=KXHIGHMIA-26JUL04-T95 | status=active | time=2026-07-05T14:00:00+00:00 | resolved=48 pending=8
- 10. native:weather_no_candidate:no_95_98_zero_loss_cities_v1 | ticker=KXHIGHMIA-26JUL04-T88 | status=active | time=2026-07-05T14:00:00+00:00 | resolved=65 pending=12

## Kalshi Academic-Prior Aligned Queue
- command: `python3 scripts/kalshi_academic_prior_queue.py --report --per-family 2`
- KALSHI ACADEMIC-PRIOR ALIGNED QUEUE
- generated_at=2026-07-05T05:12:03.902597+00:00 db=/home/eric-king/kalshi_favorites_bot/trades.db
- Lower rank_score means closer to review, not approval.
- 1. high_price_native_taker:crypto_last_hour_longshot_no | status=NATIVE_FORWARD_ACCUMULATING rank=0.0580 | 387 resolved 349W-38L -$1.69 | Wilson 86.8% vs target 92.6% | next=KXETHD-26JUL0502-T1769.99 active due=2026-07-05T05:59:59.348987+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
- 2. high_price_native_taker:weather_no_candidate:no_95_98_zero_loss_cities_v1 | status=NATIVE_FORWARD_ACCUMULATING rank=0.1008 | 65 resolved 63W-2L -$0.39 | Wilson 89.5% vs target 99.5% | next=KXHIGHMIA-26JUL04-T88 active due=2026-07-05T14:00:00+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
- 3. source_shadow_requires_native:shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | status=SHADOW_STABILITY_REJECT rank=0.2500 | 621 events 574W-47L +$2551.43 | Wilson 90.1% vs target 89.6% | stability_validation=187ev 172W-15L +$693.01 Wilson 87.2% vs target 89.5% | blockers=source_only_requires_native_forward_gate, shadow_stability_reject, validation_wilson<avg_price+buffer, asset_slice_wilson<avg_price:KXETHD, utc_hour_slice_pnl<=0:15Z, utc_hour_slice_wilson<avg_price:15Z | next=only promote if a matching native first-actionable gate clears after fees and depth
...
- 5. maker_adverse_selection:cell_sports_no | status=NO_GO_REVIEW rank=0.6790 | 575 independent resolved 422W-153L -$812.90 | Wilson 69.6% vs BE 87.5% | toxic=153 fill_rate=28.5% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
- 6. maker_adverse_selection:cell_crypto_yes | status=NO_GO_REVIEW rank=0.8563 | 345 independent resolved 193W-152L -$1047.28 | Wilson 50.7% vs BE 86.3% | toxic=152 fill_rate=30.0% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
- 7. structural_arbitrage:same_strike_last_24h | status=WATCH_ONLY rank=1.0000 | 55550 observations | fresh_pairs=55550 execution_ready_tier=8756 gross_positive=1 execution_ready_gross_positive=0 qty10_positive=1 execution_ready_qty10_positive=0 best_gross_edge=0.01 | blockers=no_execution_ready_gross_positive, no_execution_ready_fee_net_qty10_positive | next=continue simultaneous quote scans; only trade fee-net positive executable dislocations
...
- recent_36h_backlog: unresolved=2387 | expired_after_60s_grace=2044 | oldest_expired=2026-07-05 04:58:59 | oldest_expected=2026-07-05 04:58:59
- recent_36h_crypto_backlog: unresolved=2113 | expired_after_60s_grace=1949 | oldest_expired=2026-07-05 04:59:59 | oldest_expected=2026-07-05 04:59:59
- native_gate_stale_unresolved=0
- resolved_last_30m=1270
- all_expired_backlog: unresolved=8570 | crypto=8120 | other=352 | weather=98 | oldest_expired=2026-04-15 21:59:59 | newest_expired=2026-07-05 05:00:03
...
- recent_72h_backlog: unresolved=378 | expired_after_60s_grace=85 | oldest_expired=2026-07-05 04:58:59 | oldest_expected=2026-07-05 04:58:59
- native_weather_gate_stale_unresolved=0 | next_due=2026-07-05T14:00:00+00:00
...
-   5-10c: candidates=69817 fill=0.2% resolved=32 benign/toxic=9/23 net=$-14.87 benign=$+7.48 Wilson=70.1% BE=0.0% margin=+70.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   10-20c: candidates=62502 fill=0.4% resolved=47 benign/toxic=15/32 net=$-16.67 benign=$+44.57 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   20-35c: candidates=61445 fill=0.5% resolved=59 benign/toxic=21/38 net=$-17.84 benign=$+64.14 Wilson=84.5% BE=0.0% margin=+84.5pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   35-50c: candidates=37500 fill=0.5% resolved=42 benign/toxic=15/27 net=$+16.88 benign=$+65.98 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   50-65c: candidates=37035 fill=0.8% resolved=41 benign/toxic=12/29 net=$-42.10 benign=$+50.56 Wilson=75.7% BE=0.0% margin=+75.7pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   65-80c: candidates=31853 fill=0.7% resolved=51 benign/toxic=15/36 net=$-6.55 benign=$+68.80 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   80-90c: candidates=30004 fill=0.7% resolved=58 benign/toxic=15/43 net=$+13.69 benign=$+35.81 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   90-95c: candidates=18207 fill=0.5% resolved=37 benign/toxic=11/26 net=$-16.98 benign=$+10.53 Wilson=74.1% BE=0.0% margin=+74.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   95-99c: candidates=36625 fill=0.2% resolved=41 benign/toxic=8/33 net=$+0.49 benign=$+2.74 Wilson=67.6% BE=0.0% margin=+67.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT

## Timers
```
NEXT                                  LEFT LAST                               PASSED UNIT                                                   ACTIVATES
Sun 2026-07-05 00:12:12 CDT             5s Sun 2026-07-05 00:11:12 CDT       54s ago gateway-watchdog.timer                                 gateway-watchdog.service
Sun 2026-07-05 00:12:12 CDT             5s Sun 2026-07-05 00:11:12 CDT       54s ago goal-loop-watchdog.timer                               goal-loop-watchdog.service
Sun 2026-07-05 00:12:16 CDT             9s Sun 2026-07-05 00:04:32 CDT      7min ago gemini-reward-live-readiness.timer                     gemini-reward-live-readiness.service
Sun 2026-07-05 00:12:18 CDT            11s Sun 2026-07-05 00:07:15 CDT  4min 51s ago kalshi-weather-yes-90-93-preflight.timer               kalshi-weather-yes-90-93-preflight.service
Sun 2026-07-05 00:12:22 CDT            15s Sun 2026-07-05 00:11:46 CDT       20s ago kalshi-worldcup-score-state-live-pilot.timer           kalshi-worldcup-score-state-live-pilot.service
Sun 2026-07-05 00:12:23 CDT            16s Sun 2026-07-05 00:07:17 CDT  4min 49s ago kalshi-crypto-favorite-taker-preflight.timer           kalshi-crypto-favorite-taker-preflight.service
Sun 2026-07-05 00:12:30 CDT            22s Sun 2026-07-05 00:12:00 CDT        6s ago gemini-cushion-ds-scanner.timer                        gemini-cushion-ds-scanner.service
Sun 2026-07-05 00:12:34 CDT            27s Sun 2026-07-05 00:07:31 CDT  4min 35s ago kalshi-weather-high-ask-no-preflight.timer             kalshi-weather-high-ask-no-preflight.service
Sun 2026-07-05 00:12:36 CDT            29s Sun 2026-07-05 00:11:36 CDT       30s ago gemini-ds-index-parity.timer                           gemini-ds-index-parity.service
Sun 2026-07-05 00:12:52 CDT            45s Sat 2026-07-04 23:57:52 CDT     14min ago ds-storage-pressure-monitor.timer                      ds-storage-pressure-monitor.service
Sun 2026-07-05 00:12:54 CDT            47s Sun 2026-07-05 00:11:53 CDT       13s ago kalshi-mve-component-result-live-pilot.timer           kalshi-mve-component-result-live-pilot.service
Sun 2026-07-05 00:12:59 CDT            52s Sun 2026-07-05 00:11:58 CDT        8s ago kalshi-worldcup-final-state-live-pilot.timer           kalshi-worldcup-final-state-live-pilot.service
Sun 2026-07-05 00:13:00 CDT            52s Sun 2026-07-05 00:12:00 CDT        6s ago cushion-ds-multi-series-scanner.timer                  cushion-ds-multi-series-scanner.service
Sun 2026-07-05 00:13:06 CDT            59s Sun 2026-07-05 00:08:01 CDT   4min 5s ago kalshi-crypto-last-hour-longshot-no-preflight.timer    kalshi-crypto-last-hour-longshot-no-preflight.service
Sun 2026-07-05 00:13:16 CDT        1min 9s Sun 2026-07-05 00:08:16 CDT  3min 50s ago kalshi-shadow-forecast-accuracy-backfill.timer         kalshi-shadow-forecast-accuracy-backfill.service
Sun 2026-07-05 00:13:24 CDT       1min 17s Sun 2026-07-05 00:10:04 CDT   2min 2s ago kalshi-sports-final-state-live-pilot.timer             kalshi-sports-final-state-live-pilot.service
Sun 2026-07-05 00:13:25 CDT       1min 18s Sun 2026-07-05 00:11:25 CDT       41s ago gemini-ds-index-micro-parity.timer                     gemini-ds-index-micro-parity.service
Sun 2026-07-05 00:13:41 CDT       1min 34s Sun 2026-07-05 00:08:41 CDT  3min 25s ago kalshi-side-equivalence-scanner.timer                  kalshi-side-equivalence-scanner.service
Sun 2026-07-05 00:13:41 CDT       1min 34s Sun 2026-07-05 00:08:41 CDT  3min 25s ago kalshi-weather-no-candidate-preflight.timer            kalshi-weather-no-candidate-preflight.service
Sun 2026-07-05 00:13:59 CDT       1min 52s Sat 2026-07-04 23:58:59 CDT     13min ago kalshi-side-equivalence-resolver.timer                 kalshi-side-equivalence-resolver.service
Sun 2026-07-05 00:14:04 CDT       1min 57s Sun 2026-07-05 00:09:01 CDT   3min 5s ago kalshi-moderate-favorites-eth-yes-preflight.timer      kalshi-moderate-favorites-eth-yes-preflight.service
Sun 2026-07-05 00:14:27 CDT       2min 20s Sat 2026-07-04 23:44:27 CDT     27min ago ds-storage-monitor.timer                               ds-storage-monitor.service
Sun 2026-07-05 00:14:29 CDT       2min 22s Sun 2026-07-05 00:04:28 CDT      7min ago ds-shadow-continuous-archive.timer                     ds-shadow-continuous-archive.service
Sun 2026-07-05 00:14:54 CDT       2min 47s Sat 2026-07-04 23:59:54 CDT     12min ago btc-moderate-v2-shadow-resolver.timer                  btc-moderate-v2-shadow-resolver.service
Sun 2026-07-05 00:14:54 CDT       2min 47s Sat 2026-07-04 23:59:54 CDT     12min ago gemini-categorical-scanner.timer                       gemini-categorical-scanner.service
Sun 2026-07-05 00:14:56 CDT       2min 49s Sun 2026-07-05 00:09:56 CDT  2min 10s ago btc-moderate-v2-shadow-scanner.timer                   btc-moderate-v2-shadow-scanner.service
Sun 2026-07-05 00:14:56 CDT       2min 49s Sun 2026-07-05 00:09:56 CDT  2min 10s ago gemini-fp-orderbook-capture.timer                      gemini-fp-orderbook-capture.service
Sun 2026-07-05 00:14:56 CDT       2min 49s Sun 2026-07-05 00:09:56 CDT  2min 10s ago gemini-reward-post-only-safety.timer                   gemini-reward-post-only-safety.service
Sun 2026-07-05 00:15:00 CDT       2min 52s Sun 2026-07-05 00:00:01 CDT     12min ago cushion-ds-multi-series-resolver.timer                 cushion-ds-multi-series-resolver.service
Sun 2026-07-05 00:15:00 CDT       2min 52s Sun 2026-07-05 00:00:01 CDT     12min ago gemini-cushion-ds-resolver.timer                       gemini-cushion-ds-resolver.service
Sun 2026-07-05 00:15:25 CDT       3min 18s Sun 2026-07-05 00:10:18 CDT  1min 48s ago kalshi-shadow-deterministic-settlement-backfill.timer  kalshi-shadow-deterministic-settlement-backfill.service
Sun 2026-07-05 00:15:50 CDT       3min 43s Sun 2026-07-05 00:10:50 CDT  1min 16s ago gemini-maker-fill-simulator.timer                      gemini-maker-fill-simulator.service
Sun 2026-07-05 00:16:23 CDT       4min 16s Sun 2026-07-05 00:11:16 CDT       50s ago kalshi-crypto-ladder-dislocation-preflight.timer       kalshi-crypto-ladder-dislocation-preflight.service
Sun 2026-07-05 00:16:37 CDT       4min 30s Sun 2026-07-05 00:11:33 CDT       33s ago kalshi-shadow-longshot-fading-backfill.timer           kalshi-shadow-longshot-fading-backfill.service
Sun 2026-07-05 00:16:41 CDT       4min 34s Sun 2026-07-05 00:11:38 CDT       28s ago kalshi-other-longshot-no-80-90-preflight.timer         kalshi-other-longshot-no-80-90-preflight.service
Sun 2026-07-05 00:19:01 CDT           6min Sat 2026-07-04 21:19:01 CDT  2h 53min ago db-auto-vacuum.timer                                   db-auto-vacuum.service
Sun 2026-07-05 00:19:10 CDT           7min Sat 2026-07-04 23:19:10 CDT     52min ago gemini-db-retention.timer                              gemini-db-retention.service
Sun 2026-07-05 00:19:24 CDT           7min Sat 2026-07-04 23:49:24 CDT     22min ago eth-ds-fg-filter-blocks-resolver.timer                 eth-ds-fg-filter-blocks-resolver.service
Sun 2026-07-05 00:19:58 CDT           7min Sun 2026-07-05 00:04:58 CDT      7min ago gemini-categorical-resolver.timer                      gemini-categorical-resolver.service
Sun 2026-07-05 00:24:23 CDT          12min Sat 2026-07-04 23:54:23 CDT     17min ago gemini-db-size-monitor.timer                           gemini-db-size-monitor.service
Sun 2026-07-05 00:30:00 CDT          17min Sat 2026-07-04 23:30:00 CDT     42min ago gemini-direct-index-ds-first-resolution-verifier.timer gemini-direct-index-ds-first-resolution-verifier.service
Sun 2026-07-05 01:05:27 CDT          53min Sun 2026-07-05 00:03:37 CDT      8min ago macro-release-resolver.timer                           macro-release-resolver.service
Sun 2026-07-05 01:07:00 CDT          54min Sun 2026-07-05 00:07:00 CDT      5min ago claude-partition-arb-scan.timer                        claude-partition-arb-scan.service
Sun 2026-07-05 01:09:06 CDT          56min Sun 2026-07-05 00:07:54 CDT  4min 12s ago ladder-coherence-two-leg-resolver.timer                ladder-coherence-two-leg-resolver.service
Sun 2026-07-05 01:17:00 CDT        1h 4min Sat 2026-07-04 19:17:00 CDT  4h 55min ago ds-shadow-retention-engine.timer                       ds-shadow-retention-engine.service
Sun 2026-07-05 02:00:00 CDT       1h 47min Sun 2026-06-28 02:00:00 CDT             - gemini-archive-compression.timer                       gemini-archive-compression.service
Sun 2026-07-05 03:15:00 CDT        3h 2min Sat 2026-07-04 03:15:00 CDT       20h ago shadow-verification.timer                              shadow-verification.service
Sun 2026-07-05 03:18:57 CDT        3h 6min Sat 2026-07-04 21:18:57 CDT  2h 53min ago ds-shadow-db-maintenance.timer                         ds-shadow-db-maintenance.service
Sun 2026-07-05 03:24:20 CDT       3h 12min Sat 2026-07-04 21:24:20 CDT  2h 47min ago ds-shadow-archive.timer                                ds-shadow-archive.service
Sun 2026-07-05 03:30:00 CDT       3h 17min Sat 2026-07-04 03:30:00 CDT       20h ago ibkr-independent-verification.timer                    ibkr-independent-verification.service
Sun 2026-07-05 04:13:00 CDT        4h 0min Sat 2026-07-04 16:13:00 CDT        7h ago claude-calibration-logger.timer                        claude-calibration-logger.service
Sun 2026-07-05 04:30:00 CDT       4h 17min Sat 2026-07-04 04:30:00 CDT       19h ago tax-ledger-ingest.timer                                tax-ledger-ingest.service
Sun 2026-07-05 04:45:50 CDT       4h 33min Sat 2026-07-04 04:48:40 CDT       19h ago ds-archive-tier-rotation.timer                         ds-archive-tier-rotation.service
Sun 2026-07-05 05:20:00 CDT        5h 7min Sat 2026-07-04 05:20:00 CDT       18h ago logrotate-user.timer                                   logrotate-user.service
Sun 2026-07-05 05:30:00 CDT       5h 17min Sat 2026-07-04 05:30:00 CDT       18h ago disk-hygiene-audit.timer                               disk-hygiene-audit.service
Sun 2026-07-05 05:30:00 CDT       5h 17min Sat 2026-07-04 05:30:00 CDT       18h ago full-picture-daily-save.timer                          full-picture-daily-save.service
Sun 2026-07-05 05:40:00 CDT       5h 27min Sat 2026-07-04 05:40:00 CDT       18h ago database-autonomous-maintenance.timer                  database-autonomous-maintenance.service
Sun 2026-07-05 06:40:00 CDT             6h Sat 2026-07-04 08:05:00 CDT       16h ago ibkr-deterministic-fx-poc.timer                        ibkr-deterministic-fx-poc.service
Sun 2026-07-05 09:02:00 CDT             8h Sat 2026-07-04 20:57:00 CDT  3h 15min ago claude-crossing-no-v3.timer                            claude-crossing-no-v3.service
Sun 2026-07-05 09:14:12 CDT             9h Sat 2026-07-04 09:14:12 CDT       14h ago launchpadlib-cache-clean.timer                         launchpadlib-cache-clean.service
Sun 2026-07-05 09:18:56 CDT             9h Sat 2026-07-04 09:18:56 CDT       14h ago gemini-fp-retention.timer                              gemini-fp-retention.service
Fri 2026-07-10 09:16:55 CDT         5 days Fri 2026-07-03 09:16:55 CDT 1 day 14h ago ubuntu-insights-upload.timer                           ubuntu-insights-upload.service
Sun 2026-08-02 19:43:55 CDT 4 weeks 0 days Fri 2026-07-03 09:13:55 CDT 1 day 14h ago ubuntu-insights-collect.timer                          ubuntu-insights-collect.service
-                                        - Sun 2026-07-05 00:10:00 CDT   2min 6s ago claude-chat-sync.timer                                 claude-chat-sync.service
-                                        - Sun 2026-07-05 00:10:00 CDT   2min 6s ago full-picture-latest-refresh.timer                      full-picture-latest-refresh.service
-                                        - Sun 2026-07-05 00:11:51 CDT       15s ago gemini-ds-source-parity.timer                          gemini-ds-source-parity.service
-                                        - Sun 2026-07-05 00:11:34 CDT       32s ago gemini-liquidity-rewards-scanner.timer                 gemini-liquidity-rewards-scanner.service
-                                        - Sat 2026-07-04 22:55:58 CDT  1h 16min ago gemini-reward-account-monitor.timer                    gemini-reward-account-monitor.service
-                                        - Sat 2026-07-04 22:51:58 CDT  1h 20min ago gemini-reward-inventory-exit.timer                     gemini-reward-inventory-exit.service
-                                        - Sat 2026-07-04 22:51:12 CDT  1h 20min ago gemini-reward-quote-pilot.timer                        gemini-reward-quote-pilot.service
-                                        - Sun 2026-07-05 00:07:48 CDT  4min 18s ago gemini-trade-print-capture.timer                       gemini-trade-print-capture.service
-                                        - Fri 2026-07-03 15:00:00 CDT  1 day 9h ago snap.firmware-updater.firmware-notifier.timer          snap.firmware-updater.firmware-notifier.service
...
- operations-knowledge: head=52b1969 branch=master in_sync=true remote=https://github.com/PhotonRahm/operations-knowledge.git dirty=yes
