...
last_updated_utc: 2026-07-02T18:52:41+00:00
pipeline_heartbeat_utc: 2026-07-02T18:52:41+00:00
generator: Codex generate_current_state.py
workspace_head: 0710930

## Chat Startup Critical Summary
- Generated for Claude-in-chat startup at 2026-07-02T13:52:41-05:00; missing artifacts render UNAVAILABLE instead of breaking sync.
- Full-picture artifact: FULL PICTURE - 2026-07-02 01:50 PM
...
- Kalshi: Cash balance: $1,190.42
- Kalshi reconciliation: Reconciliation: resolved_pnl=$-1498.89 open_cost=$0.47 open_fees=$0.03 recon_adj=$189.81 expected_cash=$1190.42 cash_gap=$+0.00 unrealized=$-0.37 [MATCH]
- IBKR: NLV: $1,949.48
- IBKR state: Status: ⚠️ Flex sync 189h stale | ❌ Gateway DOWN | ❌ KILL switch active
...
- Codex locked-MVE passive-maker pilot: locked-MVE passive-maker closeout source unavailable
...
- • Combined true P&L: **$-16330.17**
- **True lifetime P&L (after costs):**
...
- strategy/cohort excerpts:
  ...
  - 24h P&L: -$0.10 (0W-1L resolved, 4 placed)
  - Today's P&L: -$0.10
  ...
  - Next decision gate: 2026-07-02T19:30:00+00:00 - direct-index DS next resolution (587 rows/6 events unresolved | current qty5: 391 rows/6 events unresolved | micro qty1: 196 rows/6 events unresolved) resolution checks; no live expansion before event-collapsed results
...
- reconciliation:
  - Reconciliation: resolved_pnl=$-1498.89 open_cost=$0.47 open_fees=$0.03 recon_adj=$189.81 expected_cash=$1190.42 cash_gap=$+0.00 unrealized=$-0.37 [MATCH]
  - ✓ HARD CHECK PASSED — gap $0.00
  - Reconciliation adjustment: $189.81 (auto-computed from exchange balance)
  - Expected cash: $1190.42
  - Actual cash (API): $1190.42
- selected env:
...
- strategy/cohort excerpts:
  ...
  - 24h P&L: -$0.14 (0W-3L resolved, 4 placed)
  ...
  - Live-matched v2 first-ticker: 218W-12L (94.8%) | taker -$69.16 | Wilson 91.1% vs BE 95.1% | 7d -$170.02 | gate=NOT_LIVE_DEPLOYABLE
  - v1→v2 drops: tier=4335, volume=2653, excluded=1149, category=162, spread=55, nws=52, hours=36
  - [2.5] Moderate Favorites Pilot ($0.80-$0.85 only)
  - Validation vs shadow: shadow WR 82.3% / -$398.00 (spread<=0.05 + allowed assets, matches pilot) | live WR 82.8% | shadow P&L negative; no revival
  ...
  - Mean reversion shadow freshness: last_row=2026-04-22T03:02:54Z age=71.7d live_match_last=2026-04-21T02:43:31Z post_kill_shadow_rows=0 post_kill_live_placements=0 | gate=STALE_NO_FORWARD_EVIDENCE
  ...
  - Forecast accuracy YES 90-93 above-live-threshold: event-first 115W-1L n=116 | +$1,652.43 avg_ask=0.915 | Wilson 95.3% vs BE 92.6% margin=+2.7pp | recent 35W-0L n=35 Wilson 90.1% vs BE 92.7% | pending=2 stale_pending=0 | gate=THIN_MARGIN_RECENT_UNDERPOWERED_FORWARD_ONLY | next_pending=KXLOWTCHI-26JUL02-B77.5 city=CHI due=2026-07-03T05:59:59.945606+00:00 ask=0.92 reason=ask_above_max(0.92>0.90)
  - Forecast accuracy high-ask NO event-first: ask>=0.98 all 925W-4L n=929 | +$1,683.14 avg_ask=0.986 | Wilson 98.9% vs BE 98.8%
  - Forecast accuracy high-ask NO ex-LAX: 849W-1L n=850 | +$2,072.96 avg_ask=0.986 | Wilson 99.3% vs BE 98.8% | unresolved_live_est_events=40 | gate=FORWARD_WATCH_ONLY
  - Forecast accuracy high-ask NO native preflight: rows=43706 events=176 actionable_qty1=803 latest=2026-07-02T18:51:06+00:00 | reasons: missing_native_no_ask=38829, nonpositive_qty1_win:0.0000=2980, actionable_qty1_fee_positive=803, native_no_ask_out_of_band:0.9700=238 | latest_run=2026-07-02T18:51:06+00:00 candidates=20 checked=20 actionable=1 run_reasons={"actionable_qty1_fee_positive": 1, "missing_native_no_ask": 18, "native_no_ask_out_of_band:0.9700": 1}
  - Forecast accuracy high-ask NO latest actionables: captured=2026-07-02T18:51:06+00:00 events=20 actionable_events=1 best=KXLOWTCHI-26JUL02-T73 city=CHI event=KXLOWTCHI-26JUL02 due=2026-07-03T19:00:00+00:00 no_ask=0.98 depth=869.64 win1=+$0.01 loss1=-$0.99
  ...
  - Forecast accuracy NO candidate-cell preflight: rows=28185 cohorts=2 events=67 actionable_qty1=8054 latest=2026-07-02T18:51:01+00:00 | latest_run=2026-07-02T18:51:01+00:00 candidates=15 checked=15 actionable=5 run_reasons={"no_90_95_min_probe_v1:missing_native_no_ask": 1, "no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive": 5, "no_95_98_zero_loss_cities_v1:missing_native_no_ask": 7, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9900": 2}
  - Forecast accuracy NO candidate-cell cohorts: no_95_98_zero_loss_cities_v1 rows=25476 events=67 actionable=7351; no_90_95_min_probe_v1 rows=2709 events=8 actionable=703
  - Forecast accuracy NO candidate-cell latest cohort actionables: no_90_95_min_probe_v1 captured=2026-07-02T18:51:01+00:00 events=1 actionable_events=0 top_reason=missing_native_no_ask; no_95_98_zero_loss_cities_v1 captured=2026-07-02T18:51:01+00:00 events=14 actionable_events=5 best=KXLOWTMIA-26JUL03-T81 city=MIA event=KXLOWTMIA-26JUL03 due=2026-07-04T19:00:00+00:00 no_ask=0.95 depth=4.00 win1=+$0.04 loss1=-$0.96
  - Forecast accuracy NO candidate-cell historical control: all-city 95-98 883W-25L n=908 Wilson 96.0% vs BE 96.7%; selected-cities 302W-2L n=304 Wilson 97.6% vs BE 96.8%; weakest_city=AUS 39W-1L n=40 Wilson 87.1% vs BE 96.8% | selected-city filter is in-sample; no live order
  ...
  - Legacy untapped FX/Index NO shadow: bid=0.85-0.90 12-24h first-ticker-side 468W-32L n=500 | +$3,233.64 | avg_bid=0.865 | Wilson 91.1% vs modeled BE 87.1% margin=+4.0pp | pending=16 | gate=LEGACY_MAKER_FORWARD_REQUIRED
  - Legacy untapped FX/Index NO recency: since_2026-06-17 142W-7L n=149 +$1,186.72 pending=16 Wilson 90.6% vs modeled BE 87.2% | forward_since_2026-06-25T09:25Z resolved=64 pending=16 | KXEURUSD 25W-2L pending=0, KXINX 25W-2L pending=1, KXNASDAQ100 15W-0L pending=1, KXUSDJPY 27W-1L pending=0 | next_pending=KXNASDAQ100-26JUL02H1300-B28950 category=INDEX due_est=2026-07-02T16:59:59.055223+00:00 ttl_at_capture=13.9h bid=0.87 ask=1.00 | bid-side/maker-priced shadow, not taker-executable
  - Legacy untapped FX/Index NO event collapse: event-side 92W-5L n=97 +$700.72 pending=2 Wilson 88.5% vs modeled BE 87.6% margin=+0.9pp | recent_event_side 34W-2L n=36 Wilson 81.9% vs BE 87.5% | forward_event_side resolved=15 pending=2 | gate=RECENT_EVENT_UNDERPOWERED_MAKER_FORWARD_REQUIRED
  ...
  - Legacy weather-city NO shadow: bid>=0.88 first-ticker-side 5321W-255L n=5576 | +$10,070.41 | avg_bid=0.932 | Wilson 94.8% vs modeled BE 93.6% margin=+1.2pp | pending=203 | gate=LEGACY_MAKER_FORWARD_REQUIRED
  - Legacy weather-city NO recency: since_2026-06-17 1909W-76L n=1985 +$3,754.74 pending=201 Wilson 95.2% vs modeled BE 94.3% | forward_since_2026-06-25T09:35Z resolved=842 pending=201 | blocked 1522W-85L +$1,815.70, unblocked 3799W-170L +$8,254.71 | best=KXLOWTNYC 219W-5L +$1,041.65; worst=KXLOWTDEN 215W-19L -$413.11 | next_pending=KXHIGHMIA-26JUL02-B93.5 city=MIA due_est=2026-07-03T04:58:59.011499+00:00 ttl_at_capture=37.9h bid=0.92 overdue_pending=7 | bid-side/maker-priced shadow, not taker-executable
  - Legacy weather-city NO event collapse: event-side 1062W-17L n=1079 +$3,745.62 pending=49 Wilson 97.5% vs modeled BE 95.0% margin=+2.5pp | recent_event_side 375W-8L n=383 Wilson 95.9% vs BE 95.6% | forward_event_side resolved=167 pending=49 | gate=EVENT_MAKER_FORWARD_REQUIRED
  ...
  - Crypto price-range bid-side shadow: side-aware ticker+side first rows 591W-0L n=591 | +$3,648.00 | Wilson 99.4% vs modeled BE 93.8% | pending=6 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range bid-side recency: since_2026-06-17 113W-0L n=113 +$683.56 pending=6 | forward_since_2026-06-25T07:30Z resolved=66 pending=6 | YES 58W-0L pending=1, NO 42W-0L pending=1 | bid-side shadow, not taker-executable
  - Crypto price-range bid-side event collapse: event-side 100W-0L n=100 +$610.76 pending=2 Wilson 96.3% vs BE 93.9% margin=+2.4pp | event_only 67W-0L n=67 Wilson 94.6% vs BE 93.9% margin=+0.7pp | recent_event_side 28W-0L n=28 Wilson 87.9% vs BE 93.9% | forward_event_side resolved=16 pending=2 | gate=RECENT_EVENT_UNDERPOWERED_MAKER_FORWARD_REQUIRED
  ...
  - Crypto long-expiry maker/cancel proxy: v2 crypto side_bid=0.90-0.95 candidates=440 markets=233 fills=95 pending_fills=13 resolved_indep=82/50 75W-7L pnl=-$17.35 Wilson 83.4% vs modeled BE 93.6% | 24hplus_candidates=89 24hplus_fills=9 24hplus_pending_fills=0 | cancels=326 late_cross_ttl=37 open=19 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel shadow: v2 side_bid=0.92-0.94 candidates=233 markets=133 fills=52 filled_units=52 pending_fills=11 resolved_indep=41/50 38W-3L pnl=-$6.23 Wilson 80.6% vs modeled BE 94.2% | cancels=173 late_cross_ttl=21 open=8 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel sides: NO rows=124 markets=64 fills=20 pending=3 resolved_rows=17; YES rows=109 markets=69 fills=32 pending=8 resolved_rows=24 | source=kalshi_high_price_maker_cancel_shadow | no live orders
  - Crypto legacy taker NO shadow: ask=0.90-0.95 12-24h first-ticker-side 237W-12L n=249 | +$784.72 | avg_ask=0.915 | Wilson 91.8% vs modeled BE 92.0% margin=-0.3pp | pending=8 | gate=NO_GO
  - Crypto favorite taker native preflight: rows=8976 cohorts=2 contracts=50 actionable_obs=1914 latest=2026-07-02T18:48:27+00:00 | latest_run=2026-07-02T18:48:27+00:00 candidates=8 checked=8 actionable=3 reasons={"crypto_favorite_no_90_95_12_24h:actionable_qty1_fee_positive": 1, "crypto_favorite_no_90_95_12_24h:native_no_ask_out_of_band:0.4800": 1, "crypto_near_certain_95_99_12_24h:actionable_qty1_fee_positive": 2, "crypto_near_certain_95_99_12_24h:missing_native_yes_ask": 3, "crypto_near_certain_95_99_12_24h:nonpositive_qty1_win:0.0000": 1} | no order path
  - Crypto favorite taker native cohorts: crypto_near_certain_95_99_12_24h rows=7249 contracts=40 actionable_obs=1533; crypto_favorite_no_90_95_12_24h rows=1727 contracts=10 actionable_obs=381
  - Crypto favorite taker latest cohort actionables: crypto_favorite_no_90_95_12_24h captured=2026-07-02T18:48:27+00:00 contracts=2 actionable_contracts=1 best=KXBTCD-26JUL0217-T62249.99 side=NO asset=BTC event=KXBTCD-26JUL0217 due=2026-07-02T20:59:59.397148+00:00 ask=0.92 depth=200.00 win1=+$0.07 loss1=-$0.93; crypto_near_certain_95_99_12_24h captured=2026-07-02T18:48:27+00:00 contracts=6 actionable_contracts=2 best=KXBTCD-26JUL0217-T62499.99 side=NO asset=BTC event=KXBTCD-26JUL0217 due=2026-07-02T20:59:59.402944+00:00 ask=0.97 depth=404.00 win1=+$0.02 loss1=-$0.98
  - Crypto favorite taker native gate: crypto_favorite_no_90_95_12_24h first_actionable_contracts=8 resolved=6 pending=2 5W-1L native_pnl=-$0.52 Wilson 43.6% vs BE 92.0% next_pending=KXBTCD-26JUL0217-T62249.99 side=NO asset=BTC event=KXBTCD-26JUL0217 due=2026-07-02T20:59:59.397148+00:00 ask=0.92 depth=479.00 win1=+$0.07 loss1=-$0.93 gate=NATIVE_FORWARD_ACCUMULATING; crypto_near_certain_95_99_12_24h first_actionable_contracts=37 resolved=31 pending=6 30W-1L native_pnl=-$0.29 Wilson 83.8% vs BE 97.6% next_pending=KXBTCD-26JUL0217-T58499.99 side=YES asset=BTC event=KXBTCD-26JUL0217 due=2026-07-02T20:59:59.336229+00:00 ask=0.97 depth=474.00 win1=+$0.02 loss1=-$0.98 gate=NATIVE_FORWARD_ACCUMULATING
  - Crypto contrarian NO underdog shadow: ask=0.20-0.25 18-24h event-first 21W-40L n=61 +$625.28 avg_ask=0.229 Wilson 23.7% vs modeled BE 24.2% pending=2 active_pending=1 stale_pending=1 old_live_match_events=5/63 | gate=ALL_PERIOD_BELOW_BREAKEVEN_POSTHOC
  - Crypto contrarian NO recency: since_2026-06-17 13W-13L n=26 +$662.40 pending=1 Wilson 32.1% vs modeled BE 24.5% | forward_since_2026-06-25T10:40Z resolved=8 pending=1 | 2026-04 8W-27L -$37.12, 2026-06 13W-11L +$711.92 | BTC 8W-17L +$191.82 pending=1, ETH 9W-9L +$477.11 pending=0, SOL 4W-14L -$43.65 pending=1 | next_pending=KXBTCD-26JUL0217-T59999.99 event=KXBTCD-26JUL0217 due_est=2026-07-02T20:59:59.398293+00:00 ttl=2.1h ask=0.23 spread=0.01 active_pending=1 stale_pending=1 unknown_pending=0 | exploratory ask-priced shadow; no live orders
  - Crypto last-hour longshot NO shadow: event-first 1158W-74L n=1232 | +$6,239.21 avg_ask=0.882 | Wilson 92.5% vs modeled BE 88.9% | recent 737W-60L +$2,405.39 | gate=LIQUIDITY_PROXY_FAIL_FORWARD_ONLY
  - Crypto last-hour longshot liquidity: volume=0 595W-8L +$6,810.50; volume>=500/spread<=5c 363W-40L -$274.66 Wilson 86.8% vs BE 90.8%; 80-85c volume-backed 31W-5L +$83.92 Wilson 71.3% vs BE 83.8%; 90-95c volume-backed 240W-20L -$133.17 Wilson 88.4% vs BE 92.8%; 95-99c volume-backed 555W-22L -$542.70 Wilson 94.3% vs BE 97.1%; forward_since_2026-06-25T11:20Z 361W-36L +$419.61 Wilson 87.7% vs BE 89.9% resolved=397 pending=1 | no live orders
  - Crypto last-hour longshot native preflight: rows=5127 events=397 actionable_qty1=1337 latest=2026-07-02T18:50:00+00:00 | latest_run=2026-07-02T18:50:00+00:00 candidates=1 checked=1 actionable=0 reasons={"native_no_ask_out_of_band:0.9900": 1} | no order path
  - Crypto last-hour longshot latest actionables: captured=2026-07-02T18:50:00+00:00 events=1 contracts=1 actionable_contracts=0 top_reason=native_no_ask_out_of_band:0.9900
  - Crypto last-hour longshot native gate: native_events=298 resolved=297 pending=1 active_pending=1 stale_pending=0 unknown_pending=0 266W-31L native_pnl=-$3.88 Wilson 85.6% vs BE 90.9% next_pending=KXBTCD-26JUL0215-T61999.99 asset=BTC event=KXBTCD-26JUL0215 due=2026-07-02T18:59:59.516179+00:00 no_ask=0.92 depth=51.00 win1=+$0.07 loss1=-$0.93 | gate=NATIVE_FORWARD_ACCUMULATING
  ...
  - Summary: rows=6773 open=181 fills=1648 markets=1501 cancels=4944 late_cross_ttl=417 resolved=1158 markets=1075 pnl=-2406.36 last=2026-07-02T18:52:08+00:00
  - Pending fills: unresolved=490 markets=426 next=KXINX-26JUL02H1300-B7462 index NO close=2026-07-02T17:00:00+00:00 expiration=2026-07-09T20:00:00+00:00 | units=490 active=477 stale=13 unknown=0
  - Overall independent fills: resolved=1158 773W-385L pnl=-2406.36 wilson_low=64.0% breakeven=87.5% toxic=385 status=NO_GO_REVIEW
  - Review progress: best_cell=sports NO resolved_independent=322/50 indep=248W-74L pnl=-335.21 wilson_low=72.1% breakeven=87.4% toxic=74 pending_markets=282 filled_markets=604 next_close=2026-07-02T22:35:00+00:00 status=NO_GO_REVIEW
  - Cell scan: resolved_cells=7 edge_positive_cells=0 leader=sports NO resolved_indep=322 best_edge_positive=none best_alternate=crypto YES resolved_indep=272 151W-121L pnl=-836.02 wilson_low=49.6% breakeven=86.3% toxic=121 status=NO_GO_REVIEW
  - KALSHI CRYPTO LOW-PRICE NO CELL AUDIT
  - Status: SHADOW_ONLY | broad low-price NO kill=present | standard DS kill=present
  - NO <10c first-market: n=169 151W-18L wr=89.3% wilson_low=83.8% breakeven=4.5% pnl=+143.89 avg=+0.8514
  - NO <10c first-eligible: n=236 217W-19L wr=91.9% wilson_low=87.8% breakeven=4.8% pnl=+206.36 avg=+0.8744
  - NO <10c concentration: underliers=3 top=BTC n=173 share=73.3% pnl=+151.28 worst=SOL n=31 pnl=+25.47
  - NO <10c day stability: days=3 positive=3 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - NO <10c UTC-hour stability: hours=23 positive=23 losing=0 worst=18Z n=2 pnl=+1.95
  - Post-kill NO <10c first-market: n=169 151W-18L wr=89.3% wilson_low=83.8% breakeven=4.5% pnl=+143.89 avg=+0.8514
  - Post-kill NO <10c first-eligible: n=236 217W-19L wr=91.9% wilson_low=87.8% breakeven=4.8% pnl=+206.36 avg=+0.8744
  - Review: post-kill NO <10c first-eligible progress 236/50 status=NOT_READY reason=native taker NO ask <10c evidence absent
  - Post-kill NO <10c first-eligible concentration: underliers=3 top=BTC n=173 share=73.3% pnl=+151.28 worst=SOL n=31 pnl=+25.47
  - Post-kill NO <10c first-eligible day stability: days=3 positive=3 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - Post-kill NO <10c first-eligible UTC-hour stability: hours=23 positive=23 losing=0 worst=18Z n=2 pnl=+1.95
  - Post-kill NO <10c first-eligible loss cluster: losses=19 loss_hours=6 top_hour=03Z top_hour_losses=6/19 share=31.6% top_underlier=BTC 4/6 | excluding_top_loss_hour=POST_HOC_FORWARD_ONLY n=226 213W-13L pnl=+202.79 Wilson 90.4% vs modeled BE 4.8%
  - Post-kill NO <10c first-eligible source provenance: rows=236 sources=1 top=kalshi.shadow_deterministic_settlement n=236 distinct_source_row_ids=236 missing_source_row_ids=0
  - Post-kill NO <10c first-eligible native source check: source_ids=236 checked=231 native_taker_ask_lt10c=0/231 min=0.6900 avg=0.9638 max=0.9900
  - Fresh non-04Z NO <10c first-eligible: n=224 205W-19L wr=91.5% wilson_low=87.1% breakeven=4.8% pnl=+194.94 avg=+0.8703
  - Forward gate: fresh non-04Z NO <10c first-eligible start=2026-06-25T08:30:00+00:00 excluded_hour=04Z progress 224/50 pending_markets=0 status=NOT_READY reason=wilson 87.1% < 90.0%; native taker NO ask <10c evidence absent
  - Fresh non-04Z NO <10c first-eligible pending horizon: resolved=224/50 pending_markets=0 max_if_all_pending_resolve=50/50 need_new_after_pending=0 next_due=unknown last_due=unknown next_backfill_after=unknown last_backfill_after=unknown
  - Fresh 04Z excluded-control NO <10c first-eligible: n=13 13W-0L wr=100.0% wilson_low=77.2% breakeven=5.2% pnl=+12.37 avg=+0.9515
  - Fresh non-04Z NO <10c first-eligible source provenance: rows=224 sources=1 top=kalshi.shadow_deterministic_settlement n=224 distinct_source_row_ids=224 missing_source_row_ids=0
  - Fresh non-04Z NO <10c first-eligible native source check: source_ids=224 checked=219 native_taker_ask_lt10c=0/219 min=0.6900 avg=0.9638 max=0.9900
  - Fresh non-04Z NO <10c first-eligible concentration: underliers=3 top=BTC n=164 share=73.2% pnl=+142.72 worst=SOL n=30 pnl=+24.52
  - Fresh non-04Z NO <10c first-eligible day stability: days=3 positive=3 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - Fresh non-04Z NO <10c first-eligible UTC-hour stability: hours=22 positive=22 losing=0 worst=18Z n=2 pnl=+1.95
  - Post-kill pending NO: rows=16 markets=8 actionable=12 qty50=15 avg_price=0.915 first=2026-07-02T18:30:48+00:00 last=2026-07-02T18:46:55+00:00
  - Post-kill pending NO <10c first-eligible: rows=0 markets=0 actionable=0 qty50=0 avg_price=n/a first=none last=none
  - Post-kill NO <10c first-eligible pending horizon: resolved=236/50 pending_markets=0 max_if_all_pending_resolve=50/50 need_new_after_pending=0 next_due=unknown last_due=unknown next_backfill_after=unknown last_backfill_after=unknown
  - Post-kill NO <10c first-eligible live pending preview: pending_first_eligible=0 live_actionable=0 settlement_pending_or_ineligible=0 now=2026-07-02T18:52:57+00:00 | no order path
  - Pilot readiness: NOT_READY | proposed_strategy=kalshi_crypto_no_lt10c_first_eligible_pilot | new identity required; do not revive ds_low_price_no | reason=wilson 87.8% < 90.0%; native taker NO ask <10c evidence absent
...
-   Disk: 155.22 GiB used / 936.79 GiB total (16.6%), 733.91 GiB free
-   Envelope: TARGET 50.0%, WARN 65.0%, CRITICAL 75.0%, HARD_LIMIT 85.0%
-   DS storage: active 1.17 GiB (state TARGET), hot 29.71 GiB, warm 0.02 GiB, cold 0.00 GiB, archive_state TARGET, total 30.92 GiB (3.3% of disk)
-   Archive sidecars: OK
...
- latest_run: id=11 captured_at=2026-07-02T18:23:43+00:00 | markets_seen=80000 post_expiration_open_unresolved=408 candidate_count=0 | direct_market_recheck=True pages=80 page_cap=True rate_limited=False | trigger_fields={"expected_expiration_time": 408} | top_series=KXMVESPORTSMULTIGAMEEXTENDED=246, KXMVECROSSCATEGORY=162

## Kalshi Duplicate Proposition Scan
- command: `python3 scripts/kalshi_duplicate_proposition_scanner.py --limit 1000 --max-pages 80 --pause-seconds 0.08 --min-ask-gap 0.10 --min-bid-edge 0.05 --max-cheap-ask 0.75 --min-depth 1 --max-candidates 20 --record --json`
- latest_run: id=6 captured_at=2026-07-02T16:42:08+00:00 | markets_seen=80000 grouped_markets=79967 duplicate_groups=837 candidate_count=1 | pages=80 page_cap=True rate_limited=False | top_series=KXMVESPORTSMULTIGAMEEXTENDED=65475, KXMVECROSSCATEGORY=14291, KXMLBHRR=69, KXMLBTB=60, KXPOLITICSMENTION=13
- latest_candidates: KXMVECROSSCATEGORY KXMVECROSSCATEGORY-S20262A8A920A811-064C9288F17 YES cheap=0.280 peer_max=0.380 gap=0.100 depth=4000 key=kxmvecrosscategory|yes chicago ws yes over 7.5 runs scored|y
...
- reasons: wilson 87.8% < 90.0%; open_filled_trades=5; source reconciliation checked 399/236; source reconciliation mismatches 40; native taker NO ask <10c evidence absent
- resolved: 236/50 | 217W-19L | pnl=+206.36 | wilson=87.8%
...
- fresh_non04z_review: status=NOT_READY | ready=false | reason=fresh gate status NOT_READY; wilson 87.1% < 90.0%; open_filled_trades=5; source reconciliation checked 350/224; source reconciliation mismatches 40; native taker NO ask <10c evidence absent | resolved=224/50 | 205W-19L | pnl=+194.94 | wilson=87.1% | pending=0 | shadow_live_actionable=0 | native_taker_actionable=0 | native_taker_blocked=0 | expired_unresolved=0 | next_backfill_after=unknown | source_reconciliation=350/350 mismatches=40 | native_taker_ask_lt10c=0/345
...
- status: NO_LIVE_READY | ready=false | cells=9 | ready_cells=0 | min_resolved=30 | edge_buffer=+2.0pp | pending=29 active=29 stale=0 unknown=0 | next_pending=crypto_last_hour_longshot_no:KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00
- best: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=298 resolved=297 pending=1 active=1 stale=0 unknown=0 | 266W-31L | pnl=-3.88 | Wilson 85.6% vs BE 90.9% | gap=-5.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=313 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.92
- rank 1: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=298 resolved=297 pending=1 active=1 stale=0 unknown=0 | 266W-31L | pnl=-3.88 | Wilson 85.6% vs BE 90.9% | gap=-5.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=313 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.92
...
- rank 4: weather_yes_90_93:yes_90_93_above_live_threshold_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=18 resolved=16 pending=2 active=2 stale=0 unknown=0 | 16W-0L | pnl=+1.19 | Wilson 80.6% vs BE 92.6% | gap=-11.9pp | blockers=resolved<30; wilson<BE+2pp | perfect_wins_needed=51 | next_pending=KXLOWTCHI-26JUL02-B77.5 status=active due=2026-07-03T19:00:00+00:00 ask=0.91
- rank 5: crypto_favorite_taker:crypto_near_certain_95_99_12_24h | gate=NATIVE_FORWARD_ACCUMULATING | native_events=37 resolved=31 pending=6 active=6 stale=0 unknown=0 | 30W-1L | pnl=-0.29 | Wilson 83.8% vs BE 97.6% | gap=-13.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=1463 | next_pending=KXBTCD-26JUL0217-T58499.99 status=active due=2026-07-02T20:59:59.336229+00:00 ask=0.97
...
- status: NO_NATIVE_CUT_READY | ready=false | observations=13626 | cuts=2234 | display_cuts=447 | candidate_cuts=0 | ready_cuts=0 | min_resolved=30 | min_display_resolved=10 | edge_buffer=+2.0pp | scope=posthoc_native_executable_cut_discovery_requires_predeclared_forward_gate
...
- rank 3: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=70 resolved=70 pending=0 active=0 stale=0 unknown=0 | 69W-1L | pnl=+$4.00 | Wilson 92.3% vs target 94.9% (BE 92.9%) | gap=-2.5pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=37
- rank 4: crypto_last_hour_longshot_no|native_ask_band=85-90 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=170 resolved=169 pending=1 active=1 stale=0 unknown=0 | 153W-16L | pnl=+$3.65 | Wilson 85.2% vs target 90.4% (BE 88.4%) | gap=-5.2pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=95 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.87
- rank 5: crypto_last_hour_longshot_no|shadow_spread_band=<=1c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=211 resolved=210 pending=1 active=1 stale=0 unknown=0 | 194W-16L | pnl=+$1.75 | Wilson 88.0% vs target 93.6% (BE 91.6%) | gap=-5.6pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=188 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.92
- rank 6: crypto_last_hour_longshot_no|minutes_to_expiry_band=40-60m|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=181 resolved=180 pending=1 active=1 stale=0 unknown=0 | 169W-11L | pnl=+$1.37 | Wilson 89.4% vs target 95.1% (BE 93.1%) | gap=-5.7pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=219 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.92
- rank 7: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=38 resolved=38 pending=0 active=0 stale=0 unknown=0 | 36W-2L | pnl=+$3.12 | Wilson 82.7% vs target 88.5% (BE 86.5%) | gap=-5.8pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=22
- rank 8: crypto_last_hour_longshot_no|native_spread_band=<=1c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=257 resolved=256 pending=1 active=1 stale=0 unknown=0 | 234W-22L | pnl=+$0.48 | Wilson 87.3% vs target 93.2% (BE 91.2%) | gap=-5.9pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=229 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.92
...
- best: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=40 resolved=39 pending=1 active=1 stale=0 unknown=0 | 31W-8L | pnl=$-4.54 | Wilson 64.5% vs target 93.1% (BE 91.1%) | gap=-28.7pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=186 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.87 | excluded_post_start_actionables=163 (native_spread_band=<=5c=51, native_spread_band=<=2c=45, native_depth_band=1000+=39, native_depth_band=10-99=19) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=89 (not_actionable=89) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 1: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=40 resolved=39 pending=1 active=1 stale=0 unknown=0 | 31W-8L | pnl=$-4.54 | Wilson 64.5% vs target 93.1% (BE 91.1%) | gap=-28.7pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=186 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.87 | excluded_post_start_actionables=163 (native_spread_band=<=5c=51, native_spread_band=<=2c=45, native_depth_band=1000+=39, native_depth_band=10-99=19) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=89 (not_actionable=89) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 2: native_watch|crypto_strong_no_90_95 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=32 resolved=31 pending=1 active=1 stale=0 unknown=0 | 24W-7L | pnl=$-4.90 | Wilson 60.2% vs target 95.2% (BE 93.2%) | gap=-35.0pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=267 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.92 | excluded_post_start_actionables=169 (signal_tier=weak=58, signal_tier=moderate=55, native_ask_band=85-90=27, native_ask_band=95-98=18) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89 | target_window_misses=386 (not_actionable_native_ask_band=missing=98, not_actionable_native_ask_band=<80=78, not_actionable_native_ask_band=95-98=60, not_actionable_native_ask_band=98-99=51) | target_window_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89
- rank 3: native_watch|crypto_20_40m_no_80_85 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-29T11:05:00+00:00 | observations=22 resolved=22 pending=0 active=0 stale=0 unknown=0 | 20W-2L | pnl=$+1.54 | Wilson 72.2% vs target 85.9% (BE 83.9%) | gap=-13.7pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=26 | excluded_post_start_actionables=668 (minutes_band=40-60m=351, native_ask_band=90-95=118, native_ask_band=85-90=68, minutes_band=10-20m=65) | excluded_sample=KXBTCD-26JUN2908-T60299.99 minutes_band=40-60m ask=0.95 | target_window_misses=970 (not_actionable_native_ask_band=98-99=183, not_actionable_native_ask_band=missing=162, not_actionable_native_ask_band=99+=144, not_actionable_native_ask_band=95-98=137) | target_window_sample=KXBTCD-26JUN2908-T60299.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 4: native_watch|crypto_btc_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-30T07:13:19+00:00 | observations=22 resolved=21 pending=1 active=1 stale=0 unknown=0 | 14W-7L | pnl=$-4.63 | Wilson 45.4% vs target 90.7% (BE 88.7%) | gap=-45.3pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=130 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.87 | excluded_post_start_actionables=458 (asset=SOL=164, asset=ETH=155, native_ask_band=90-95=95, native_ask_band=95-98=35) | excluded_sample=KXBTCD-26JUN3005-T59699.99 native_ask_band=90-95 ask=0.94 | target_window_misses=774 (not_actionable_native_ask_band=missing=307, not_actionable_native_ask_band=98-99=106, native_ask_band=90-95=95, not_actionable_native_ask_band=95-98=87) | target_window_sample=KXBTCD-26JUN3004-T59799.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 5: native_watch|crypto_spread_le1_depth_10_99 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T07:10:00+00:00 | observations=18 resolved=17 pending=1 active=1 stale=0 unknown=0 | 13W-4L | pnl=$-2.43 | Wilson 52.7% vs target 92.8% (BE 90.8%) | gap=-40.0pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=121 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.92 | excluded_post_start_actionables=248 (native_depth_band=100-999=99, native_spread_band=<=5c=53, native_spread_band=<=2c=47, native_depth_band=1000+=40) | excluded_sample=KXBTCD-26JUL0104-T58899.99 native_depth_band=100-999 ask=0.93 | target_window_misses=25 (not_actionable=25) | target_window_sample=KXSOLD-26JUL0107-T75.9999 not_actionable ask=0.99
- rank 6: native_watch|crypto_sol_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T13:00:00+00:00 | observations=12 resolved=12 pending=0 active=0 stale=0 unknown=0 | 12W-0L | pnl=$+1.35 | Wilson 75.7% vs target 90.8% (BE 88.8%) | gap=-15.0pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=26 | excluded_post_start_actionables=199 (asset=BTC=83, asset=ETH=68, native_ask_band=90-95=25, native_ask_band=80-85=18) | excluded_sample=KXBTCD-26JUL0110-T59199.99 asset=BTC ask=0.93 | target_window_misses=179 (not_actionable_native_ask_band=missing=39, not_actionable_native_ask_band=<80=32, native_ask_band=90-95=25, not_actionable_native_ask_band=99+=25) | target_window_sample=KXSOLD-26JUL0111-T79.9999 not_actionable_native_ask_band=missing
- rank 7: native_watch|crypto_btc_strong_no_90_95_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T14:00:00+00:00 | observations=9 resolved=9 pending=0 active=0 stale=0 unknown=0 | 8W-1L | pnl=$-0.44 | Wilson 56.5% vs target 95.8% (BE 93.8%) | gap=-39.3pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=122 | excluded_post_start_actionables=195 (asset=SOL=71, asset=ETH=68, native_depth_band=1000+=26, native_ask_band=85-90=8) | excluded_sample=KXETHD-26JUL0111-T1609.99 asset=ETH ask=0.90 | target_window_misses=42 (not_actionable_native_ask_band=95-98=13, native_ask_band=85-90=8, not_actionable_native_ask_band=99+=8, not_actionable_native_ask_band=<80=7) | target_window_sample=KXBTCD-26JUL0112-T60099.99 native_ask_band=85-90 ask=0.89
- rank 8: native_watch|crypto_tue_no_any_ask | gate=FORWARD_WATCH_WAITING | start=2026-07-01T07:10:00+00:00 | observations=0 resolved=0 pending=0 active=0 stale=0 unknown=0 | 0W-0L | pnl=$+0.00 | Wilson 0.0% vs target 2.0% (BE 0.0%) | gap=-2.0pp | blockers=no_forward_observations;resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=>5000_or_target_impossible | excluded_post_start_actionables=268 (captured_weekday=Thu=135, captured_weekday=Wed=133) | excluded_sample=KXBTCD-26JUL0104-T58899.99 captured_weekday=Wed ask=0.93

## Kalshi Native Preflight Walk-Forward Validation
- command: `python3 scripts/kalshi_native_preflight_walkforward.py --limit 8`
- status: NO_WALKFORWARD_NATIVE_CUT | ready=false | observations=13626 | cuts=2234 | display_cuts=202 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-29T08:30:21+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_walkforward_native_cut_validation_requires_predeclared_forward_gate
...
- rank 5: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=WALKFORWARD_REJECT | type=single | train=17 resolved 15W-2L +$0.21 Wilson 65.7% vs target 89.0% gap=-23.3pp | validation=21 resolved 21W-0L +$2.91 Wilson 84.5% vs target 88.1% gap=-3.6pp | blockers=train_resolved<30;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 6: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=WALKFORWARD_REJECT | type=pair | train=34 resolved 33W-1L +$1.39 Wilson 85.1% vs target 95.0% gap=-9.9pp | validation=36 resolved 36W-0L +$2.61 Wilson 90.4% vs target 94.8% gap=-4.4pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 7: crypto_last_hour_longshot_no|asset=SOL|native_ask_band=85-90 | gate=WALKFORWARD_REJECT | type=pair | train=20 resolved 17W-3L -$0.65 Wilson 64.0% vs target 90.2% gap=-26.3pp | validation=34 resolved 33W-1L +$2.86 Wilson 85.1% vs target 90.6% gap=-5.6pp | blockers=train_resolved<30;train_pnl<=0;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 8: crypto_last_hour_longshot_no|signal_tier=moderate | gate=WALKFORWARD_REJECT | type=single | train=43 resolved 39W-4L +$0.73 Wilson 78.4% vs target 91.0% gap=-12.6pp | validation=43 resolved 41W-2L +$2.22 Wilson 84.5% vs target 92.2% gap=-7.6pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
...
- best: crypto_last_hour_native_subcell:moderate:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=57 resolved=57 pending=0 active=0 stale=0 unknown=0 | 55W-2L | pnl=+4.34 | Wilson 88.1% vs BE 88.9% | gap=-0.8pp | blockers=wilson<BE+2pp | perfect_wins_needed=19
- rank 1: crypto_last_hour_native_subcell:moderate:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=57 resolved=57 pending=0 active=0 stale=0 unknown=0 | 55W-2L | pnl=+4.34 | Wilson 88.1% vs BE 88.9% | gap=-0.8pp | blockers=wilson<BE+2pp | perfect_wins_needed=19
- rank 2: crypto_last_hour_native_subcell:strong:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=144 resolved=143 pending=1 active=1 stale=0 unknown=0 | 129W-14L | pnl=-4.32 | Wilson 84.2% vs BE 93.2% | gap=-9.0pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=344 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.92
- rank 3: crypto_last_hour_native_subcell:weak:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=68 resolved=68 pending=0 active=0 stale=0 unknown=0 | 57W-11L | pnl=-2.51 | Wilson 73.3% vs BE 87.5% | gap=-14.2pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=115
- rank 4: crypto_last_hour_native_subcell:native_ask:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=127 resolved=127 pending=0 active=0 stale=0 unknown=0 | 111W-16L | pnl=+0.64 | Wilson 80.5% vs BE 86.9% | gap=-6.4pp | blockers=wilson<BE+2pp | perfect_wins_needed=101
- rank 5: crypto_last_hour_native_subcell:native_ask:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=131 resolved=130 pending=1 active=1 stale=0 unknown=0 | 119W-11L | pnl=-2.12 | Wilson 85.5% vs BE 93.2% | gap=-7.7pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=273 | next_pending=KXBTCD-26JUL0215-T61999.99 status=active due=2026-07-02T18:59:59.516179+00:00 ask=0.92
- rank 6: crypto_last_hour_native_subcell:moderate:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=29 resolved=29 pending=0 active=0 stale=0 unknown=0 | 25W-4L | pnl=-1.39 | Wilson 69.4% vs BE 91.0% | gap=-21.6pp | blockers=resolved<30; pnl<=0; wilson<BE+2pp | perfect_wins_needed=114

## Kalshi Crypto Last-Hour Entry Timing Audit
- command: `python3 scripts/kalshi_crypto_last_hour_entry_timing_audit.py --limit 8`
- status: NO_ENTRY_TIMING_CANDIDATE | ready=false | posthoc_candidates=0 | source_actionable_rows=1337 | selected_observations=754 | cuts=374 | min_resolved=30 | edge_buffer=+2.0pp
- best: crypto_last_hour_entry_timing:first_actionable|asset=SOL|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=30 resolved=30 pending=0 | 30W-0L | pnl=+$3.45 | Wilson 88.6% vs target 90.5% (BE 88.5%) | gap=-1.9pp | blockers=wilson<BE+2pp
- rank 1: crypto_last_hour_entry_timing:first_actionable|asset=SOL|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=30 resolved=30 pending=0 | 30W-0L | pnl=+$3.45 | Wilson 88.6% vs target 90.5% (BE 88.5%) | gap=-1.9pp | blockers=wilson<BE+2pp
- rank 2: crypto_last_hour_entry_timing:latest_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=158 resolved=157 pending=1 | 151W-6L | pnl=+$4.08 | Wilson 91.9% vs target 95.6% (BE 93.6%) | gap=-3.7pp | blockers=wilson<BE+2pp
...
- rank 4: crypto_last_hour_entry_timing:first_actionable|native_depth_band=1000+ | gate=ENTRY_TIMING_ACCUMULATING | observations=74 resolved=74 pending=0 | 71W-3L | pnl=+$2.76 | Wilson 88.7% vs target 94.2% (BE 92.2%) | gap=-5.5pp | blockers=wilson<BE+2pp
- rank 5: crypto_last_hour_entry_timing:latest_actionable|signal_tier=moderate|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=50 resolved=50 pending=0 | 49W-1L | pnl=+$2.33 | Wilson 89.5% vs target 95.3% (BE 93.3%) | gap=-5.8pp | blockers=wilson<BE+2pp
- rank 6: crypto_last_hour_entry_timing:first_actionable|signal_tier=moderate | gate=ENTRY_TIMING_ACCUMULATING | observations=86 resolved=86 pending=0 | 80W-6L | pnl=+$2.95 | Wilson 85.6% vs target 91.6% (BE 89.6%) | gap=-6.0pp | blockers=wilson<BE+2pp
- rank 7: crypto_last_hour_entry_timing:first_actionable|native_spread_band=<=1c | gate=ENTRY_TIMING_ACCUMULATING | observations=210 resolved=209 pending=1 | 192W-17L | pnl=+$1.06 | Wilson 87.4% vs target 93.4% (BE 91.4%) | gap=-6.0pp | blockers=wilson<BE+2pp
- rank 8: crypto_last_hour_entry_timing:first_actionable|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=86 resolved=86 pending=0 | 79W-7L | pnl=+$2.93 | Wilson 84.1% vs target 90.5% (BE 88.5%) | gap=-6.3pp | blockers=wilson<BE+2pp

## Kalshi Crypto Ladder Dislocation Preflight
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_preflight.py --json`
- latest_run: captured_at=2026-07-02T18:51:09+00:00 | lookahead=75m | events=5 rows_per_event=40 | candidates=101 checked=101 dislocation_qty1=0 | min_source_edge=0.03 max_source_age=300s | top_reasons=missing_native_no_ask=100, source_age_too_old:2977s=1
- latest_rows: KXETHD-26JUL0215-T1709.99 ETH/strong source_no=0.94 native_no_ask=0.98 edge=-0.04 age=2977s spread=0.01 depth=871 win=0.01 due=2026-07-02T18:59:59.143166+00:00 reason=source_age_too_old:2977s ; KXETHD-26JUL0215-T1729.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=2977s spread=missing depth=0 win=missing due=2026-07-02T18:59:59.146815+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0215-T1749.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=2977s spread=missing depth=0 win=missing due=2026-07-02T18:59:59.151213+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0215-T1769.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=2977s spread=missing depth=0 win=missing due=2026-07-02T18:59:59.155399+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0215-T1829.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=2977s spread=missing depth=0 win=missing due=2026-07-02T18:59:59.167392+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0215-T1849.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=2977s spread=missing depth=0 win=missing due=2026-07-02T18:59:59.171657+00:00 reason=missing_native_no_ask
...
- latest_run: captured_at=2026-07-02T17:40:20+00:00 | markets_checked=975 parsed=975 espn_games=9 locked_rows=18 actionable_qty1=0 | max_ask=0.15 min_depth=1 | series=KXMLBKS,KXMLBOUTS,KXMLBHIT,KXMLBHRR,KXMLBHR,KXMLBTB,KXMLBRBI,KXMLBSB dates=2026-07-02 | state_games=9 | reasons=mlb_boxscore_not_current=634, player_stat_waiting_for_threshold_or_final=214, player_stat_missing_after_final=76, player_stat_missing_before_final=33, mlb_player_stat_already_reached=18
- locked_rows: KXMLBHIT-26JUL021235PITPHI-PHIABOHM28-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL021235PITPHI-PHIBHARPER3-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL021235PITPHI-PITBREYNOLDS10-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL021235PITPHI-PITJMANGUM28-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL021235PITPHI-PITROHEARN29-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHRR-26JUL021235PITPHI-PHIABOHM28-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits_runs_rbi:1/1 game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHRR-26JUL021235PITPHI-PHIBHARPER3-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits_runs_rbi:2/1 game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHRR-26JUL021235PITPHI-PHIBHARPER3-2 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits_runs_rbi:2/2 game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0
...
- latest_run: captured_at=2026-07-02T17:47:56+00:00 | markets_checked=120000 with_legs=120000 component_events=375/375 fetched=375 component_markets=4075 resolved=536 locked_rows=780 actionable_qty1=0 | max_target_ask=0.15 min_depth=1 | series=KXMVESPORTSMULTIGAMEEXTENDED,KXMVECROSSCATEGORY counts=KXMVECROSSCATEGORY=60000, KXMVESPORTSMULTIGAMEEXTENDED=60000 | page_cap=KXMVECROSSCATEGORY,KXMVESPORTSMULTIGAMEEXTENDED rate_limited=none component_cap=false component_rate_limited=false | reasons=not_locked_by_component_results=119220, component_false_locks_mve_no=663, component_market_resolved=536, all_components_true_locks_mve_yes=117
- latest_rows: KXMVECROSSCATEGORY-S202601A82A6AB92-8038A680942 YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=5/5 decisive=KXWTAMATCH-26JUL02RAKSAK-SAK:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S2026060358D2503-8E72E28D1B0 YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=7/7 decisive=KXWTAMATCH-26JUL02RAKSAK-SAK:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S202608AFDACD049-3CDE2DAE50B YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=5/5 decisive=KXWTAMATCH-26JUL02RAKSAK-SAK:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S20260927370C49E-5907D89A38D YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=4/4 decisive=KXWTAMATCH-26JUL02RAKSAK-SAK:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S202609D451E4451-E7B05447D9B YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=6/6 decisive=KXWTAMATCH-26JUL02RAKSAK-SAK:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S20261817930C0CA-B117766E80B YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=5/5 decisive=KXWTAMATCH-26JUL02RAKSAK-SAK:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S20263666CF0087B-7BE6A483B1D YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=7/7 decisive=KXWTAMATCH-26JUL02RAKSAK-SAK:YES->YES reason=all_components_true_locks_mve_yes actionable=0 ; KXMVECROSSCATEGORY-S2026417F72E363D-1E22E418B0A YES ask=0.00 depth=0 bid=0.00 win=1.00 series=KXMVECROSSCATEGORY legs=2/2 decisive=KXETH15M-26JUL021345-45:NO->NO reason=all_components_true_locks_mve_yes actionable=0
...
- latest_run: captured_at=2026-07-02T17:39:12+00:00 | markets_checked=384 parsed=384 espn_games=40 locked_rows=4 actionable_qty1=0 | max_ask=0.15 min_depth=1 | series=KXMLBRFI,KXMLBF3,KXMLBF5,KXMLBF5SPREAD,KXMLBF5TOTAL,KXMLBF7,KXMLBTEAMTOTAL,KXMLBEXTRAS dates=2026-07-02,2026-07-03,2026-07-04,2026-07-05 | state_games=40 | counts=KXMLBEXTRAS=40, KXMLBF3=27, KXMLBF5=27, KXMLBF5SPREAD=36, KXMLBF5TOTAL=63, KXMLBF7=27, KXMLBRFI=38, KXMLBTEAMTOTAL=126 | reasons=mlb_teamtotal_game_not_final=126, mlb_f5total_window_not_complete=62, mlb_extras_game_not_final=40, mlb_rfi_first_inning_not_complete=38, mlb_f5spread_window_not_complete=36, mlb_f5_window_not_complete=27, mlb_f7_window_not_complete=27, mlb_f3_window_not_complete=24
- locked_rows: KXMLBF3-26JUL021235PITPHI-PHI YES ask=1.00 depth=0 bid=0.99 win=0.00 type=f3 window=3 target=PHI threshold=missing margin=1.00 total=None game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_f3_window_final actionable=0 ; KXMLBF3-26JUL021235PITPHI-PIT NO ask=1.00 depth=0 bid=0.01 win=0.00 type=f3 window=3 target=PIT threshold=missing margin=-1.00 total=None game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_f3_window_final actionable=0 ; KXMLBF3-26JUL021235PITPHI-TIE NO ask=1.00 depth=0 bid=0.99 win=0.00 type=f3 window=3 target=TIE threshold=missing margin=0.00 total=None game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_f3_window_final actionable=0 ; KXMLBF5TOTAL-26JUL021235PITPHI-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=f5total window=5 target=None threshold=0.50 margin=missing total=1 game=PIT@PHI 0-1 STATUS_IN_PROGRESS reason=mlb_f5total_over_already_exceeded actionable=0
...
- latest_run: captured_at=2026-07-02T17:07:29+00:00 | markets_checked=42 parsed=42 official_games=80 locked_rows=2 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXVALORANTGAME dates=2026-07-02,2026-07-03,2026-07-04 | state_games=45 events_raw=80 supported_games=80 | counts=KXVALORANTGAME=42 | source_errors=0 | reasons=valorant_game_not_final=38, no_matching_official_valorant_game_state=2, valorant_game_final=2
- locked_rows: KXVALORANTGAME-26JUL021100FKSNVU-FKS YES ask=1.00 depth=0 bid=0.99 win=0.00 type=game target=FOKUS Clan margin=2.00 winner=FOKUS Clan game=MISA Espoırts vs FOKUS Clan 0-2 completed league=Challengers EMEA tournament=Split 3 2026 block=Playoffs format=best-of-3 source=valorant_esports_official_schedule reason=valorant_game_final actionable=0 ; KXVALORANTGAME-26JUL021100FKSNVU-NVU NO ask=1.00 depth=0 bid=0.99 win=0.00 type=game target=MISA Espoırts margin=-2.00 winner=FOKUS Clan game=MISA Espoırts vs FOKUS Clan 0-2 completed league=Challengers EMEA tournament=Split 3 2026 block=Playoffs format=best-of-3 source=valorant_esports_official_schedule reason=valorant_game_final actionable=0
...
- latest_run: captured_at=2026-07-02T17:07:29+00:00 | markets_checked=28 parsed=28 official_games=80 locked_rows=2 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXLOLGAME dates=2026-07-02,2026-07-03,2026-07-04 | state_games=22 events_raw=80 supported_games=80 | counts=KXLOLGAME=28 | source_errors=0 | reasons=lol_game_not_final=18, no_matching_official_lol_game_state=4, lol_game_final=2, lol_game_final_no_unique_winner=2, lol_game_target_not_in_game=2
- locked_rows: KXLOLGAME-26JUL020900ZRLSPAR-SPAR YES ask=1.00 depth=0 bid=0.99 win=0.00 type=game target=Spartans EU margin=2.00 winner=Spartans EU game=Spartans EU vs Hell ZeroLag 2-0 completed league=Hellenic Legends League tournament=Summer 2026 block=Week 1 format=playAll-2 source=lol_esports_official_schedule reason=lol_game_final actionable=0 ; KXLOLGAME-26JUL020900ZRLSPAR-ZRL NO ask=1.00 depth=0 bid=0.99 win=0.00 type=game target=Hell ZeroLag margin=-2.00 winner=Spartans EU game=Spartans EU vs Hell ZeroLag 2-0 completed league=Hellenic Legends League tournament=Summer 2026 block=Week 1 format=playAll-2 source=lol_esports_official_schedule reason=lol_game_final actionable=0
...
- latest_run: captured_at=2026-07-02T16:51:33+00:00 | kalshi_markets=156 groups=78 espn_matches=563 locked_rows=2 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXATPMATCH,KXWTAMATCH,KXATPDOUBLES,KXWTADOUBLES counts=KXATPDOUBLES=34, KXATPMATCH=40, KXWTADOUBLES=44, KXWTAMATCH=38 | espn_events=atp=1, wta=1 competitions=atp=284, wta=279 status_fetches=563 | reasons=espn_match_not_unique_completed=66, no_espn_match_pair=10, espn_tennis_walkover_no_ball_played=1, locked=1
- latest_rows: KXWTADOUBLES-26JUL02SINTOWCHATAU-SINTOW YES ask=1.00 depth=0 bid=0.99 win=0.00 series=KXWTADOUBLES player=Katerina Siniakova / Taylor Townsend winner=Katerina Siniakova/Taylor Townsend status=STATUS_FINAL league=wta event=Wimbledon reason=espn_tennis_match_final actionable=0 ; KXWTADOUBLES-26JUL02SINTOWCHATAU-CHATAU NO ask=1.00 depth=0 bid=0.99 win=0.00 series=KXWTADOUBLES player=Hao-Ching Chan / Clara Tauson winner=Katerina Siniakova/Taylor Townsend status=STATUS_FINAL league=wta event=Wimbledon reason=espn_tennis_match_final actionable=0
...
- latest_run: captured_at=2026-07-02T16:53:07+00:00 | kalshi_markets=298 groups=109 espn_matches=564 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXATPSETWINNER,KXWTASETWINNER,KXATPEXACTMATCH,KXWTAEXACTMATCH counts=KXATPEXACTMATCH=120, KXATPSETWINNER=106, KXWTAEXACTMATCH=0, KXWTASETWINNER=72 | espn_events=atp=1, wta=1 competitions=atp=284, wta=280 status_fetches=564 linescore_fetches=1128 | reasons=espn_match_not_unique_completed=109
...
- latest_run: captured_at=2026-07-02T17:07:29+00:00 | markets_checked=114 parsed=114 official_games=160 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXVALORANTMAP,KXLOLMAP dates=2026-07-02,2026-07-03,2026-07-04 | state_games=67 events_raw=160 supported_games=160 | counts=KXLOLMAP=40, KXVALORANTMAP=74 | source_errors=0 | proof=completed_clean_sweep_only | reasons=valorant_match_not_final=70, lol_match_not_final=34, no_matching_official_lol_map_sweep_state=6, no_matching_official_valorant_map_sweep_state=4
...
- latest_run: captured_at=2026-07-02T17:07:08+00:00 | markets_checked=110 parsed=110 espn_games=10 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWCCORNERS,KXWCTCORNERS dates=2026-07-02,2026-07-03,2026-07-04,2026-07-05 | state_games=10 needed_events=10 | counts=KXWCCORNERS=50, KXWCTCORNERS=60 | reasons=team_corner_state_unknown=60, corner_state_unknown=50
...
- latest_run: captured_at=2026-07-02T17:40:12+00:00 | markets_checked=409 parsed=405 espn_games=11 locked_rows=0 actionable_qty1=0 | max_ask=0.15 min_depth=1 | series=KXWCGOAL,KXWCAST,KXWCSOA dates=2026-07-02,2026-07-03,2026-07-04,2026-07-05,2026-07-06 | state_games=11 needed_events=11 | counts=KXWCAST=137, KXWCGOAL=178, KXWCSOA=94 | reasons=wc_player_goal_waiting_for_threshold_or_final=176, wc_player_assist_waiting_for_threshold_or_final=136, wc_player_score_or_assist_waiting_for_threshold_or_final=93, unparsed_market=4
...
- best: shadow_longshot_fading:other:NO:weak:80-90:4-24h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=53 | 52W-1L | pnl=+733.53 | Wilson 90.1% vs target 85.5% (avg_price 83.5%) | target_gap=+4.6pp | blockers=none
- rank 1: shadow_longshot_fading:other:NO:weak:80-90:4-24h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=53 | 52W-1L | pnl=+733.53 | Wilson 90.1% vs target 85.5% (avg_price 83.5%) | target_gap=+4.6pp | blockers=none
- rank 2: shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=579 | 535W-44L | pnl=+2369.16 | Wilson 90.0% vs target 89.5% (avg_price 87.5%) | target_gap=+0.4pp | blockers=none
- rank 3: shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=818 | 715W-103L | pnl=+2961.00 | Wilson 85.0% vs target 84.8% (avg_price 82.8%) | target_gap=+0.2pp | blockers=none

## Kalshi Shadow Longshot Stability Audit
- command: `python3 scripts/kalshi_shadow_longshot_stability_audit.py --limit 8`
- status: NO_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=6766 | eligible_cells=25 | base_candidate_cells=3 | stable_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=579ev 535W-44L +2369.16 Wilson 90.0% vs target 89.5% gap +0.4pp | train=405ev 376W-29L +1811.15 Wilson 89.9% vs target 89.6% gap +0.3pp | validation=174ev 159W-15L +558.01 Wilson 86.3% vs target 89.4% gap -3.1pp | worst_asset=KXSOLD 109ev 101W-8L +477.20 Wilson 86.2% vs target 89.5% gap -3.3pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 2. shadow_longshot_fading:other:NO:weak:80-90:4-24h | gate=SHADOW_STABILITY_REJECT | aggregate=53ev 52W-1L +733.53 Wilson 90.1% vs target 85.5% gap +4.6pp | train=37ev 36W-1L +469.82 Wilson 86.2% vs target 85.8% gap +0.4pp | validation=16ev 16W-0L +263.71 Wilson 80.6% vs target 84.6% gap -4.0pp | worst_asset=none>=min_slice | worst_hour=none>=min_slice | blockers=validation_wilson<avg_price+buffer
- 3. shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=818ev 715W-103L +2961.00 Wilson 85.0% vs target 84.8% gap +0.2pp | train=572ev 512W-60L +3392.43 Wilson 86.7% vs target 84.6% gap +2.1pp | validation=246ev 203W-43L -431.43 Wilson 77.3% vs target 85.3% gap -8.0pp | worst_asset=KXBTCD 432ev 369W-63L +744.55 Wilson 81.8% vs target 84.7% gap -2.9pp | worst_hour=13Z 35ev 25W-10L -449.18 Wilson 54.9% vs target 85.3% gap -30.3pp | blockers=validation_pnl<=0;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXBTCD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
...
- status: NO_FILTERED_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=6766 | base_candidate_cells=3 | filtered_cells=74 | filtered_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=02Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=02Z | excluded=33 | aggregate=546ev 507W-39L +2464.54 Wilson 90.4% vs target 89.6% gap +0.8pp | train=382ev 355W-27L +1728.56 Wilson 89.9% vs target 89.6% gap +0.3pp | validation=164ev 152W-12L +735.98 Wilson 87.6% vs target 89.4% gap -1.8pp | worst_asset=KXSOLD 100ev 93W-7L +462.63 Wilson 86.3% vs target 89.6% gap -3.4pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 2. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=13Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=13Z | excluded=22 | aggregate=557ev 517W-40L +2512.03 Wilson 90.4% vs target 89.5% gap +0.8pp | train=389ev 362W-27L +1822.51 Wilson 90.1% vs target 89.6% gap +0.5pp | validation=168ev 155W-13L +689.52 Wilson 87.2% vs target 89.4% gap -2.2pp | worst_asset=KXETHD 89ev 83W-6L +454.75 Wilson 86.1% vs target 89.4% gap -3.3pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 3. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=15Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=15Z | excluded=21 | aggregate=558ev 519W-39L +2624.26 Wilson 90.6% vs target 89.5% gap +1.0pp | train=390ev 364W-26L +1938.52 Wilson 90.4% vs target 89.6% gap +0.8pp | validation=168ev 155W-13L +685.74 Wilson 87.2% vs target 89.4% gap -2.2pp | worst_asset=KXETHD 88ev 82W-6L +446.33 Wilson 85.9% vs target 89.3% gap -3.4pp | worst_hour=13Z 22ev 18W-4L -142.87 Wilson 61.5% vs target 89.5% gap -28.1pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
- 4. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=01Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=01Z | excluded=37 | aggregate=542ev 501W-41L +2245.10 Wilson 89.9% vs target 89.5% gap +0.4pp | train=379ev 351W-28L +1617.53 Wilson 89.5% vs target 89.6% gap -0.1pp | validation=163ev 150W-13L +627.57 Wilson 86.8% vs target 89.4% gap -2.6pp | worst_asset=KXSOLD 99ev 91W-8L +363.69 Wilson 84.9% vs target 89.5% gap -4.6pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 5. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=09Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=09Z | excluded=22 | aggregate=557ev 514W-43L +2213.00 Wilson 89.8% vs target 89.5% gap +0.2pp | train=389ev 360W-29L +1624.42 Wilson 89.5% vs target 89.6% gap -0.1pp | validation=168ev 154W-14L +588.58 Wilson 86.5% vs target 89.4% gap -2.9pp | worst_asset=KXETHD 86ev 80W-6L +420.04 Wilson 85.6% vs target 89.4% gap -3.8pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 6. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=21Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=21Z | excluded=24 | aggregate=555ev 513W-42L +2290.48 Wilson 89.9% vs target 89.5% gap +0.4pp | train=388ev 360W-28L +1714.11 Wilson 89.8% vs target 89.6% gap +0.2pp | validation=167ev 153W-14L +576.37 Wilson 86.4% vs target 89.4% gap -3.0pp | worst_asset=KXSOLD 106ev 98W-8L +441.54 Wilson 85.8% vs target 89.5% gap -3.7pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 7. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=03Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=03Z | excluded=31 | aggregate=548ev 507W-41L +2314.51 Wilson 90.0% vs target 89.5% gap +0.5pp | train=383ev 356W-27L +1763.48 Wilson 89.9% vs target 89.6% gap +0.4pp | validation=165ev 151W-14L +551.03 Wilson 86.3% vs target 89.4% gap -3.1pp | worst_asset=KXETHD 86ev 80W-6L +420.03 Wilson 85.6% vs target 89.4% gap -3.8pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 8. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=00Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=00Z | excluded=31 | aggregate=548ev 506W-42L +2209.77 Wilson 89.8% vs target 89.5% gap +0.3pp | train=383ev 355W-28L +1659.70 Wilson 89.6% vs target 89.6% gap +0.0pp | validation=165ev 151W-14L +550.07 Wilson 86.3% vs target 89.4% gap -3.1pp | worst_asset=KXSOLD 100ev 92W-8L +369.25 Wilson 85.0% vs target 89.5% gap -4.5pp | worst_hour=15Z 21ev 16W-5L -255.10 Wilson 54.9% vs target 89.6% gap -34.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
...
- best: moderate_favorites:CRYPTO:ETH:YES:80-90:0-1H:liq1:spread1 | gate=LEGACY_SHADOW_FORWARD_REQUIRED | execution=legacy_taker_like_shadow | events=61 | 58W-3L | pnl=+$756.00 | Wilson 86.5% vs target 84.6% (BE 82.6%, avg_price 82.7%) | gap=+2.0pp | blockers=none | promotion_blockers=requires_native_or_maker_forward_gate
- rank 1: moderate_favorites:CRYPTO:ETH:YES:80-90:0-1H:liq1:spread1 | gate=LEGACY_SHADOW_FORWARD_REQUIRED | execution=legacy_taker_like_shadow | events=61 | 58W-3L | pnl=+$756.00 | Wilson 86.5% vs target 84.6% (BE 82.6%, avg_price 82.7%) | gap=+2.0pp | blockers=none | promotion_blockers=requires_native_or_maker_forward_gate
...
- rank 8: sell_inverse:CRYPTO:NO:95+:24-72h | gate=LEGACY_SHADOW_REJECT | execution=legacy_inverse_shadow | events=96 | 1W-95L | pnl=-$46.51 | Wilson 0.2% vs target 3.8% (BE 1.8%, avg_price 98.6%) | gap=-3.6pp | blockers=pnl<=0;wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=7
...
- latest_run: captured_at=2026-07-02T18:52:54+00:00 | cohort=yes_90_93_above_live_threshold_v1 | start=2026-06-25T11:45:00+00:00 | include_pre_cutoff_live=true | candidates=2 checked=2 actionable_qty1=0 | top_reasons=yes_90_93_above_live_threshold_v1:native_yes_ask_out_of_band:0.9300=1, yes_90_93_above_live_threshold_v1:native_yes_ask_out_of_band:0.9500=1
- latest_rows: KXHIGHTMIN-26JUL02-T87 city=MIN yes_ask=0.93 no_depth=9 reason=native_yes_ask_out_of_band:0.9300 ; KXLOWTCHI-26JUL02-B77.5 city=CHI yes_ask=0.95 no_depth=5 reason=native_yes_ask_out_of_band:0.9500
...
- latest_run: captured_at=2026-07-02T18:51:01+00:00 | start=2026-06-25T07:05:00+00:00 | include_pre_cutoff_live=true | candidates=15 checked=15 actionable_qty1=5 | top_reasons=no_95_98_zero_loss_cities_v1:missing_native_no_ask=7, no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive=5, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9900=2, no_90_95_min_probe_v1:missing_native_no_ask=1
- latest_rows: KXLOWTAUS-26JUL03-B70.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=0.97 no_ask_depth=15 qty1=+0.02/-0.98 reason=actionable_qty1_fee_positive due=2026-07-04T19:00:00+00:00 ; KXHIGHTDAL-26JUL03-B101.5 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=0.96 no_ask_depth=51 qty1=+0.03/-0.97 reason=actionable_qty1_fee_positive due=2026-07-04T19:00:00+00:00 ; KXLOWTMIA-26JUL03-T81 cohort=no_95_98_zero_loss_cities_v1 city=MIA no_ask=0.95 no_ask_depth=4 qty1=+0.04/-0.96 reason=actionable_qty1_fee_positive due=2026-07-04T19:00:00+00:00 ; KXHIGHTMIN-26JUL03-B87.5 cohort=no_95_98_zero_loss_cities_v1 city=MIN no_ask=0.96 no_ask_depth=103 qty1=+0.03/-0.97 reason=actionable_qty1_fee_positive due=2026-07-04T19:00:00+00:00 ; KXHIGHTOKC-26JUL03-B99.5 cohort=no_95_98_zero_loss_cities_v1 city=OKC no_ask=0.98 no_ask_depth=71 qty1=+0.01/-0.99 reason=actionable_qty1_fee_positive due=2026-07-04T19:00:00+00:00 ; KXHIGHTMIN-26JUL02-B93.5 cohort=no_90_95_min_probe_v1 city=MIN no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-03T19:00:00+00:00 ; KXLOWTAUS-26JUL02-B69.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-03T19:00:00+00:00 ; KXHIGHTDAL-26JUL02-B100.5 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-03T19:00:00+00:00
...
- latest_run: captured_at=2026-07-02T18:52:15+00:00 | cohort=all | start=2026-06-25T20:00:00+00:00 | include_pre_cutoff_live=true | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- status: NO_LIVE_READY | ready=false | cells=15 | ready_cells=0 | review_min=50 | fills=1648 pending_units=490 active=477 stale=13 unknown=0 overall_resolved_indep=1158 toxic=385 | next_pending=cell_crypto_no:KXETHD-26JUL0215-T1709.99 status=active close=2026-07-02T19:00:00+00:00
- best: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=322/50 max_if_pending_resolve=604 new_needed_after_pending=0 | 248W-74L | pnl=-335.21 | Wilson 72.1% vs BE 87.4% | gap=-15.3pp | fills=604/2144 fill_rate=28.2% pending_units=282 active=282 stale=0 unknown=0 toxic=74 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUN291835CWSBAL-CWS4 status=active close=2026-07-02T22:35:00+00:00 price=0.92
- rank 1: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=322/50 max_if_pending_resolve=604 new_needed_after_pending=0 | 248W-74L | pnl=-335.21 | Wilson 72.1% vs BE 87.4% | gap=-15.3pp | fills=604/2144 fill_rate=28.2% pending_units=282 active=282 stale=0 unknown=0 toxic=74 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUN291835CWSBAL-CWS4 status=active close=2026-07-02T22:35:00+00:00 price=0.92
- rank 2: cell_crypto_yes | gate=NO_GO_REVIEW | resolved_indep=272/50 max_if_pending_resolve=309 new_needed_after_pending=0 | 151W-121L | pnl=-836.02 | Wilson 49.6% vs BE 86.3% | gap=-36.7pp | fills=309/1100 fill_rate=28.1% pending_units=37 active=37 stale=0 unknown=0 toxic=121 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0217-T57249.99 status=active close=2026-07-02T21:00:00+00:00 price=0.94
- rank 3: cell_crypto_no | gate=NO_GO_REVIEW | resolved_indep=251/50 max_if_pending_resolve=281 new_needed_after_pending=0 | 143W-108L | pnl=-747.82 | Wilson 50.8% vs BE 86.8% | gap=-36.0pp | fills=281/954 fill_rate=29.5% pending_units=30 active=30 stale=0 unknown=0 toxic=108 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXETHD-26JUL0215-T1709.99 status=active close=2026-07-02T19:00:00+00:00 price=0.90
- rank 4: cell_index_no | gate=NO_GO_REVIEW | resolved_indep=100/50 max_if_pending_resolve=113 new_needed_after_pending=0 | 90W-10L | pnl=-19.21 | Wilson 82.6% vs BE 91.8% | gap=-9.3pp | fills=113/1944 fill_rate=5.8% pending_units=13 active=0 stale=13 unknown=0 toxic=10 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXINX-26JUL02H1300-B7462 status=stale close=2026-07-02T17:00:00+00:00 price=0.93
- rank 5: cell_weather_no | gate=NO_GO_REVIEW | resolved_indep=98/50 max_if_pending_resolve=122 new_needed_after_pending=0 | 81W-17L | pnl=-69.45 | Wilson 74.0% vs BE 89.7% | gap=-15.8pp | fills=122/256 fill_rate=47.7% pending_units=24 active=24 stale=0 unknown=0 toxic=17 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXHIGHMIA-26JUL02-B87.5 status=active close=2026-07-03T04:59:00+00:00 price=0.91
- rank 6: cell_sports_yes | gate=NO_GO_REVIEW | resolved_indep=92/50 max_if_pending_resolve=196 new_needed_after_pending=0 | 39W-53L | pnl=-411.20 | Wilson 32.8% vs BE 87.1% | gap=-54.3pp | fills=196/322 fill_rate=60.9% pending_units=104 active=104 stale=0 unknown=0 toxic=53 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUN291835CWSBAL-BAL3 status=active close=2026-07-02T22:35:00+00:00 price=0.94
- rank 7: watch_crypto_bid_90_95 | gate=NO_GO_REVIEW | resolved_indep=82/50 max_if_pending_resolve=95 new_needed_after_pending=0 | 75W-7L | pnl=-17.35 | Wilson 83.4% vs BE 93.6% | gap=-10.2pp | fills=95/440 fill_rate=21.6% pending_units=13 active=13 stale=0 unknown=0 toxic=7 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0217-T57249.99 status=active close=2026-07-02T21:00:00+00:00 price=0.94
- rank 8: watch_crypto_no_4_24h | gate=NEGATIVE_INTERIM | resolved_indep=45/50 max_if_pending_resolve=58 new_needed_after_pending=0 | 34W-11L | pnl=-50.60 | Wilson 61.3% vs BE 86.8% | gap=-25.5pp | fills=58/232 fill_rate=25.0% pending_units=13 active=13 stale=0 unknown=0 toxic=11 | blockers=resolved<50; pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0217-T61249.99 status=active close=2026-07-02T21:00:00+00:00 price=0.81
...
- best: index NO maker_band=85-90 | gate=ACCUMULATING | resolved_indep=14/50 | 13W-1L | pnl=+7.32 | Wilson 68.5% vs BE 87.6% | gap=-19.0pp | candidates=181 fills=15 fill_rate=8.3% pending_units=1 toxic=1 | blockers=resolved<50; wilson<=BE; toxic>0
- rank 1: index NO maker_band=85-90 | gate=ACCUMULATING | resolved_indep=14/50 | 13W-1L | pnl=+7.32 | Wilson 68.5% vs BE 87.6% | gap=-19.0pp | candidates=181 fills=15 fill_rate=8.3% pending_units=1 toxic=1 | blockers=resolved<50; wilson<=BE; toxic>0
- rank 2: weather YES maker_band=<85 | gate=ACCUMULATING | resolved_indep=11/50 | 10W-1L | pnl=+9.56 | Wilson 62.3% vs BE 82.2% | gap=-20.0pp | candidates=21 fills=11 fill_rate=52.4% pending_units=0 toxic=1 | blockers=resolved<50; wilson<=BE; toxic>0
...
- rank 4: index NO maker_band=<85 | gate=ACCUMULATING | resolved_indep=3/50 | 3W-0L | pnl=+5.04 | Wilson 43.8% vs BE 83.2% | gap=-39.4pp | candidates=54 fills=4 fill_rate=7.4% pending_units=1 toxic=0 | blockers=resolved<50; wilson<=BE
- rank 5: weather NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=52/50 | 48W-4L | pnl=-6.49 | Wilson 81.8% vs BE 93.6% | gap=-11.7pp | candidates=160 fills=66 fill_rate=41.2% pending_units=14 toxic=4 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 6: index NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=83/50 | 74W-9L | pnl=-31.57 | Wilson 80.7% vs BE 92.9% | gap=-12.2pp | candidates=1709 fills=94 fill_rate=5.5% pending_units=11 toxic=9 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 7: crypto YES maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=81/50 | 72W-9L | pnl=-33.61 | Wilson 80.2% vs BE 93.0% | gap=-12.8pp | candidates=341 fills=90 fill_rate=26.4% pending_units=9 toxic=9 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 8: sports NO maker_band=85-90 | gate=NO_GO_REVIEW | resolved_indep=83/50 | 67W-16L | pnl=-58.49 | Wilson 71.0% vs BE 87.8% | gap=-16.8pp | candidates=578 fills=184 fill_rate=31.8% pending_units=101 toxic=16 | blockers=pnl<=0; wilson<=BE; toxic>0

## Kalshi Maker Walk-Forward Validation
- command: `python3 scripts/kalshi_maker_walkforward.py --limit 8`
- status: NO_MAKER_WALKFORWARD_CUT | ready=false | observations=1648 | cuts=187 | display_cuts=114 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-28T00:35:10+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_maker_cut_walkforward_requires_predeclared_live_spec
- best: maker_all_fills|category=crypto|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=44 resolved 37W-7L -$17.41 toxic=7 Wilson 70.6% vs target 90.0% gap=-19.4pp | validation=88 resolved 82W-6L +$39.38 toxic=6 Wilson 85.9% vs target 90.7% gap=-4.8pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0217-T57249.99 status=active due=2026-07-02T21:00:00+00:00 price=0.94
- rank 1: maker_all_fills|category=crypto|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=44 resolved 37W-7L -$17.41 toxic=7 Wilson 70.6% vs target 90.0% gap=-19.4pp | validation=88 resolved 82W-6L +$39.38 toxic=6 Wilson 85.9% vs target 90.7% gap=-4.8pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0217-T57249.99 status=active due=2026-07-02T21:00:00+00:00 price=0.94
- rank 2: maker_all_fills|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=single | train=154 resolved 126W-28L -$99.96 toxic=28 Wilson 75.0% vs target 90.3% gap=-15.3pp | validation=147 resolved 134W-13L +$28.33 toxic=13 Wilson 85.5% vs target 91.2% gap=-5.7pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0217-T57249.99 status=active due=2026-07-02T21:00:00+00:00 price=0.94
- rank 3: maker_all_fills|due_hour=04Z | gate=MAKER_WALKFORWARD_REJECT | type=single | train=33 resolved 25W-8L -$43.58 toxic=8 Wilson 59.0% vs target 91.0% gap=-32.0pp | validation=31 resolved 29W-2L +$14.08 toxic=2 Wilson 79.3% vs target 91.0% gap=-11.7pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHMIA-26JUL02-B87.5 status=active due=2026-07-03T04:59:00+00:00 price=0.91
- rank 4: maker_all_fills|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=36 resolved 32W-4L -$14.68 toxic=4 Wilson 74.7% vs target 95.0% gap=-20.3pp | validation=47 resolved 44W-3L +$3.37 toxic=3 Wilson 82.8% vs target 94.9% gap=-12.0pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0217-T61999.99 status=active due=2026-07-02T21:00:00+00:00 price=0.91
...
- rank 6: maker_all_fills|side_ask_band=92-94 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=141 resolved 107W-34L -$237.59 toxic=34 Wilson 68.2% vs target 94.7% gap=-26.5pp | validation=91 resolved 82W-9L -$23.34 toxic=9 Wilson 82.3% vs target 94.6% gap=-12.4pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_pnl<=0;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0217-T57749.99 status=active due=2026-07-02T21:00:00+00:00 price=0.93
- rank 7: maker_all_fills|side=YES|side_bid_band=80-85 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=22 resolved 19W-3L +$1.18 toxic=3 Wilson 66.7% vs target 87.8% gap=-21.2pp | validation=42 resolved 37W-5L +$10.93 toxic=5 Wilson 75.0% vs target 87.5% gap=-12.5pp | blockers=train_resolved<30;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXETHD-26JUL0217-T1589.99 status=active due=2026-07-02T21:00:00+00:00 price=0.82
- rank 8: maker_all_fills|category=crypto|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=13 resolved 10W-3L -$20.80 toxic=3 Wilson 49.7% vs target 94.9% gap=-45.2pp | validation=28 resolved 27W-1L +$9.68 toxic=1 Wilson 82.3% vs target 95.0% gap=-12.7pp | blockers=train_resolved<30;train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0217-T61999.99 status=active due=2026-07-02T21:00:00+00:00 price=0.91
...
- status: native=NO_LIVE_READY pending=29 active=29 stale=0 unknown=0 | maker=NO_LIVE_READY pending_units=490 active=477 stale=13 unknown=0 | queued=24
- 1. maker:cell_index_no | ticker=KXINX-26JUL02H1300-B7462 | status=stale | time=2026-07-02T17:00:00+00:00 | resolved_indep=100 pending_units=13
- 2. maker_stale:index_no | ticker=KXINX-26JUL02H1300-B7462 | status=stale | time=2026-07-02T17:00:00+00:00 | closed_unfinalized expiration=2026-07-09T20:00:00+00:00 price=0.93
- 3. maker_stale:index_no | ticker=KXINX-26JUL02H1300-B7487 | status=stale | time=2026-07-02T17:00:00+00:00 | closed_unfinalized expiration=2026-07-09T20:00:00+00:00 price=0.91
- 4. maker_stale:index_no | ticker=KXINX-26JUL02H1300-B7537 | status=stale | time=2026-07-02T17:00:00+00:00 | closed_unfinalized expiration=2026-07-09T20:00:00+00:00 price=0.93
- 5. maker_stale:index_no | ticker=KXNASDAQ100-26JUL02H1300-B29750 | status=stale | time=2026-07-02T17:00:00+00:00 | closed_unfinalized expiration=2026-07-09T20:00:00+00:00 price=0.93
- 6. maker_stale:index_no | ticker=KXNASDAQ100-26JUL02H1300-B30050 | status=stale | time=2026-07-02T17:00:00+00:00 | closed_unfinalized expiration=2026-07-09T20:00:00+00:00 price=0.94
- 7. native:crypto_last_hour_longshot_no | ticker=KXBTCD-26JUL0215-T61999.99 | status=active | time=2026-07-02T18:59:59.516179+00:00 | resolved=297 pending=1
- 8. maker:cell_crypto_no | ticker=KXETHD-26JUL0215-T1709.99 | status=active | time=2026-07-02T19:00:00+00:00 | resolved_indep=251 pending_units=30
- 9. native:crypto_favorite_taker:crypto_near_certain_95_99_12_24h | ticker=KXBTCD-26JUL0217-T58499.99 | status=active | time=2026-07-02T20:59:59.336229+00:00 | resolved=31 pending=6
- 10. native:crypto_favorite_taker:crypto_favorite_no_90_95_12_24h | ticker=KXBTCD-26JUL0217-T62249.99 | status=active | time=2026-07-02T20:59:59.397148+00:00 | resolved=6 pending=2

## Kalshi Academic-Prior Aligned Queue
- command: `python3 scripts/kalshi_academic_prior_queue.py --report --per-family 2`
- KALSHI ACADEMIC-PRIOR ALIGNED QUEUE
- generated_at=2026-07-02T18:54:41.105168+00:00 db=/home/eric-king/kalshi_favorites_bot/trades.db
- Lower rank_score means closer to review, not approval.
- 1. high_price_native_taker:crypto_last_hour_longshot_no | status=NATIVE_FORWARD_ACCUMULATING rank=0.0731 | 297 resolved 266W-31L -$3.88 | Wilson 85.6% vs target 92.9% | next=KXBTCD-26JUL0215-T61999.99 active due=2026-07-02T18:59:59.516179+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
...
- 3. source_shadow_requires_native:shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | status=SHADOW_STABILITY_REJECT rank=0.2500 | 579 events 535W-44L +$2369.16 | Wilson 90.0% vs target 89.5% | stability_validation=174ev 159W-15L +$558.01 Wilson 86.3% vs target 89.4% | blockers=source_only_requires_native_forward_gate, shadow_stability_reject, validation_wilson<avg_price+buffer, asset_slice_wilson<avg_price:KXSOLD, utc_hour_slice_pnl<=0:15Z, utc_hour_slice_wilson<avg_price:15Z | next=only promote if a matching native first-actionable gate clears after fees and depth
- 4. source_shadow_requires_native:shadow_longshot_fading:other:NO:weak:80-90:4-24h | status=SHADOW_STABILITY_REJECT rank=0.2500 | 53 events 52W-1L +$733.53 | Wilson 90.1% vs target 85.5% | stability_validation=16ev 16W-0L +$263.71 Wilson 80.6% vs target 84.6% | blockers=source_only_requires_native_forward_gate, shadow_stability_reject, validation_wilson<avg_price+buffer | next=only promote if a matching native first-actionable gate clears after fees and depth
- 5. maker_adverse_selection:cell_sports_no | status=NO_GO_REVIEW rank=0.6531 | 322 independent resolved 248W-74L -$335.21 | Wilson 72.1% vs BE 87.4% | toxic=74 fill_rate=28.2% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
- 6. maker_adverse_selection:cell_crypto_yes | status=NO_GO_REVIEW rank=0.8668 | 272 independent resolved 151W-121L -$836.02 | Wilson 49.6% vs BE 86.3% | toxic=121 fill_rate=28.1% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
- 7. structural_arbitrage:same_strike_last_24h | status=WATCH_ONLY rank=1.0000 | 56785 observations | fresh_pairs=56785 execution_ready_tier=5049 gross_positive=0 execution_ready_gross_positive=0 qty10_positive=0 execution_ready_qty10_positive=0 best_gross_edge=0.0 | blockers=no_gross_positive_same_strike, no_execution_ready_gross_positive, no_execution_ready_fee_net_qty10_positive | next=continue simultaneous quote scans; only trade fee-net positive executable dislocations
...
- recent_36h_backlog: unresolved=1623 | expired_after_60s_grace=1355 | oldest_expired=2026-07-01 13:59:59 | oldest_expected=2026-07-01 13:59:59
- recent_36h_crypto_backlog: unresolved=183 | expired_after_60s_grace=0 | oldest_expired=none | oldest_expected=2026-07-02 18:59:59
- native_gate_stale_unresolved=0
- resolved_last_30m=0
- all_expired_backlog: unresolved=7785 | crypto=6171 | other=1611 | weather=3 | oldest_expired=2026-04-15 21:59:59 | newest_expired=2026-07-02 17:00:00
- legacy_pre36h_expired_backlog: unresolved=6430 | crypto=6171 | other=256 | weather=3 | oldest_expired=2026-04-15 21:59:59 | newest_expired=2026-07-01 13:59:59
...
- recent_72h_backlog: unresolved=309 | expired_after_60s_grace=15 | oldest_expired=2026-07-02 06:59:59 | oldest_expected=2026-07-02 06:59:59
...
-   5-10c: candidates=57263 fill=0.3% resolved=31 benign/toxic=9/22 net=$-13.96 benign=$+7.48 Wilson=70.1% BE=0.0% margin=+70.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   10-20c: candidates=56431 fill=0.4% resolved=47 benign/toxic=15/32 net=$-16.67 benign=$+44.57 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   20-35c: candidates=57331 fill=0.6% resolved=59 benign/toxic=21/38 net=$-17.84 benign=$+64.14 Wilson=84.5% BE=0.0% margin=+84.5pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   35-50c: candidates=35049 fill=0.6% resolved=41 benign/toxic=15/26 net=$+22.03 benign=$+65.98 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   50-65c: candidates=35269 fill=0.8% resolved=41 benign/toxic=12/29 net=$-42.10 benign=$+50.56 Wilson=75.7% BE=0.0% margin=+75.7pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   65-80c: candidates=30320 fill=0.7% resolved=51 benign/toxic=15/36 net=$-6.55 benign=$+68.80 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   80-90c: candidates=28587 fill=0.7% resolved=58 benign/toxic=15/43 net=$+13.69 benign=$+35.81 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   90-95c: candidates=16609 fill=0.5% resolved=36 benign/toxic=11/25 net=$-16.37 benign=$+10.53 Wilson=74.1% BE=0.0% margin=+74.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   95-99c: candidates=34821 fill=0.2% resolved=40 benign/toxic=7/33 net=$+0.30 benign=$+2.55 Wilson=64.6% BE=0.0% margin=+64.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT

## Timers
```
NEXT                                  LEFT LAST                                   PASSED UNIT                                                   ACTIVATES
Thu 2026-07-02 13:54:44 CDT          870ms Thu 2026-07-02 13:54:02 CDT           41s ago kalshi-worldcup-score-state-live-pilot.timer           kalshi-worldcup-score-state-live-pilot.service
Thu 2026-07-02 13:54:45 CDT             2s Thu 2026-07-02 13:53:43 CDT       1min 0s ago kalshi-worldcup-final-state-live-pilot.timer           kalshi-worldcup-final-state-live-pilot.service
Thu 2026-07-02 13:54:56 CDT            12s Thu 2026-07-02 13:53:56 CDT           47s ago gateway-watchdog.timer                                 gateway-watchdog.service
Thu 2026-07-02 13:55:00 CDT            16s Thu 2026-07-02 13:54:00 CDT           43s ago cushion-ds-multi-series-scanner.timer                  cushion-ds-multi-series-scanner.service
Thu 2026-07-02 13:55:00 CDT            16s Thu 2026-07-02 13:54:30 CDT           13s ago gemini-cushion-ds-scanner.timer                        gemini-cushion-ds-scanner.service
Thu 2026-07-02 13:55:05 CDT            22s Thu 2026-07-02 13:50:00 CDT      4min 43s ago kalshi-crypto-last-hour-longshot-no-preflight.timer    kalshi-crypto-last-hour-longshot-no-preflight.service
Thu 2026-07-02 13:55:17 CDT            33s Thu 2026-07-02 13:50:17 CDT      4min 26s ago gemini-reward-post-only-safety.timer                   gemini-reward-post-only-safety.service
Thu 2026-07-02 13:56:01 CDT       1min 17s Thu 2026-07-02 13:51:01 CDT      3min 42s ago kalshi-weather-no-candidate-preflight.timer            kalshi-weather-no-candidate-preflight.service
Thu 2026-07-02 13:56:08 CDT       1min 24s Thu 2026-07-02 13:51:06 CDT      3min 37s ago kalshi-weather-high-ask-no-preflight.timer             kalshi-weather-high-ask-no-preflight.service
Thu 2026-07-02 13:56:14 CDT       1min 30s Thu 2026-07-02 13:26:14 CDT         28min ago gemini-db-size-monitor.timer                           gemini-db-size-monitor.service
Thu 2026-07-02 13:56:17 CDT       1min 34s Thu 2026-07-02 13:51:09 CDT      3min 33s ago kalshi-crypto-ladder-dislocation-preflight.timer       kalshi-crypto-ladder-dislocation-preflight.service
Thu 2026-07-02 13:56:29 CDT       1min 46s Thu 2026-07-02 13:50:30 CDT      4min 13s ago kalshi-sports-final-state-live-pilot.timer             kalshi-sports-final-state-live-pilot.service
Thu 2026-07-02 13:56:47 CDT        2min 4s Thu 2026-07-02 13:51:41 CDT       3min 1s ago kalshi-shadow-deterministic-settlement-backfill.timer  kalshi-shadow-deterministic-settlement-backfill.service
Thu 2026-07-02 13:57:23 CDT       2min 39s Thu 2026-07-02 13:52:15 CDT      2min 28s ago kalshi-other-longshot-no-80-90-preflight.timer         kalshi-other-longshot-no-80-90-preflight.service
Thu 2026-07-02 13:57:26 CDT       2min 43s Thu 2026-07-02 13:52:26 CDT      2min 16s ago kalshi-side-equivalence-scanner.timer                  kalshi-side-equivalence-scanner.service
Thu 2026-07-02 13:57:57 CDT       3min 14s Thu 2026-07-02 13:52:54 CDT      1min 49s ago kalshi-weather-yes-90-93-preflight.timer               kalshi-weather-yes-90-93-preflight.service
Thu 2026-07-02 13:58:30 CDT       3min 46s Thu 2026-07-02 13:53:30 CDT      1min 13s ago gemini-fp-orderbook-capture.timer                      gemini-fp-orderbook-capture.service
Thu 2026-07-02 13:58:30 CDT       3min 46s Thu 2026-07-02 13:53:30 CDT      1min 13s ago kalshi-shadow-forecast-accuracy-backfill.timer         kalshi-shadow-forecast-accuracy-backfill.service
Thu 2026-07-02 13:58:34 CDT       3min 51s Thu 2026-07-02 13:53:28 CDT      1min 15s ago kalshi-crypto-favorite-taker-preflight.timer           kalshi-crypto-favorite-taker-preflight.service
Thu 2026-07-02 13:59:15 CDT       4min 32s Thu 2026-07-02 13:54:09 CDT           34s ago kalshi-shadow-longshot-fading-backfill.timer           kalshi-shadow-longshot-fading-backfill.service
Thu 2026-07-02 14:00:00 CDT           5min Thu 2026-07-02 13:45:00 CDT          9min ago cushion-ds-multi-series-resolver.timer                 cushion-ds-multi-series-resolver.service
Thu 2026-07-02 14:00:00 CDT           5min Thu 2026-07-02 13:50:00 CDT      4min 43s ago full-picture-latest-refresh.timer                      full-picture-latest-refresh.service
Thu 2026-07-02 14:00:00 CDT           5min Thu 2026-07-02 13:45:00 CDT          9min ago gemini-cushion-ds-resolver.timer                       gemini-cushion-ds-resolver.service
Thu 2026-07-02 14:01:17 CDT           6min Thu 2026-07-02 13:46:17 CDT          8min ago gemini-ds-source-parity.timer                          gemini-ds-source-parity.service
Thu 2026-07-02 14:02:09 CDT           7min Thu 2026-07-02 13:47:09 CDT          7min ago ds-storage-pressure-monitor.timer                      ds-storage-pressure-monitor.service
Thu 2026-07-02 14:02:38 CDT           7min Thu 2026-07-02 13:52:37 CDT       2min 6s ago ds-shadow-continuous-archive.timer                     ds-shadow-continuous-archive.service
Thu 2026-07-02 14:03:29 CDT           8min Thu 2026-07-02 13:48:29 CDT          6min ago kalshi-side-equivalence-resolver.timer                 kalshi-side-equivalence-resolver.service
Thu 2026-07-02 14:04:18 CDT           9min Thu 2026-07-02 13:49:18 CDT          5min ago btc-moderate-v2-shadow-resolver.timer                  btc-moderate-v2-shadow-resolver.service
Thu 2026-07-02 14:04:18 CDT           9min Thu 2026-07-02 13:49:18 CDT          5min ago gemini-categorical-scanner.timer                       gemini-categorical-scanner.service
Thu 2026-07-02 14:09:19 CDT          14min Thu 2026-07-02 13:54:19 CDT           24s ago gemini-categorical-resolver.timer                      gemini-categorical-resolver.service
Thu 2026-07-02 14:16:33 CDT          21min Thu 2026-07-02 13:46:33 CDT          8min ago ds-storage-monitor.timer                               ds-storage-monitor.service
Thu 2026-07-02 14:16:41 CDT          21min Thu 2026-07-02 13:15:03 CDT         39min ago macro-release-resolver.timer                           macro-release-resolver.service
Thu 2026-07-02 14:19:01 CDT          24min Thu 2026-07-02 11:19:01 CDT      2h 35min ago db-auto-vacuum.timer                                   db-auto-vacuum.service
Thu 2026-07-02 14:19:56 CDT          25min Thu 2026-07-02 13:19:56 CDT         34min ago gemini-db-retention.timer                              gemini-db-retention.service
Thu 2026-07-02 14:20:30 CDT          25min Thu 2026-07-02 13:20:11 CDT         34min ago ladder-coherence-two-leg-resolver.timer                ladder-coherence-two-leg-resolver.service
Thu 2026-07-02 14:21:24 CDT          26min Thu 2026-07-02 13:51:24 CDT      3min 19s ago eth-ds-fg-filter-blocks-resolver.timer                 eth-ds-fg-filter-blocks-resolver.service
Thu 2026-07-02 14:30:00 CDT          35min Thu 2026-07-02 13:30:00 CDT         24min ago gemini-direct-index-ds-first-resolution-verifier.timer gemini-direct-index-ds-first-resolution-verifier.service
Thu 2026-07-02 15:10:36 CDT       1h 15min Thu 2026-07-02 09:10:36 CDT      4h 44min ago ds-shadow-db-maintenance.timer                         ds-shadow-db-maintenance.service
Thu 2026-07-02 15:24:20 CDT       1h 29min Thu 2026-07-02 09:24:20 CDT      4h 30min ago ds-shadow-archive.timer                                ds-shadow-archive.service
Thu 2026-07-02 18:10:00 CDT       4h 15min Thu 2026-07-02 12:10:00 CDT      1h 44min ago claude-chat-sync.timer                                 claude-chat-sync.service
Thu 2026-07-02 19:17:00 CDT       5h 22min Thu 2026-07-02 13:17:01 CDT         37min ago ds-shadow-retention-engine.timer                       ds-shadow-retention-engine.service
Thu 2026-07-02 20:13:54 CDT             6h Wed 2026-07-01 20:13:54 CDT           17h ago launchpadlib-cache-clean.timer                         launchpadlib-cache-clean.service
Thu 2026-07-02 20:18:36 CDT             6h Wed 2026-07-01 20:18:36 CDT           17h ago gemini-fp-retention.timer                              gemini-fp-retention.service
Fri 2026-07-03 03:15:00 CDT            13h Thu 2026-07-02 03:15:00 CDT           10h ago shadow-verification.timer                              shadow-verification.service
Fri 2026-07-03 03:30:00 CDT            13h Thu 2026-07-02 03:30:00 CDT           10h ago ibkr-independent-verification.timer                    ibkr-independent-verification.service
Fri 2026-07-03 04:30:00 CDT            14h Thu 2026-07-02 04:30:00 CDT            9h ago tax-ledger-ingest.timer                                tax-ledger-ingest.service
Fri 2026-07-03 04:46:49 CDT            14h Thu 2026-07-02 04:45:15 CDT            9h ago ds-archive-tier-rotation.timer                         ds-archive-tier-rotation.service
Fri 2026-07-03 05:20:00 CDT            15h Thu 2026-07-02 05:20:00 CDT            8h ago logrotate-user.timer                                   logrotate-user.service
Fri 2026-07-03 05:30:00 CDT            15h Thu 2026-07-02 05:30:01 CDT            8h ago disk-hygiene-audit.timer                               disk-hygiene-audit.service
Fri 2026-07-03 05:30:00 CDT            15h Thu 2026-07-02 05:30:01 CDT            8h ago full-picture-daily-save.timer                          full-picture-daily-save.service
Fri 2026-07-03 05:40:00 CDT            15h Thu 2026-07-02 05:40:00 CDT            8h ago database-autonomous-maintenance.timer                  database-autonomous-maintenance.service
Fri 2026-07-03 06:40:00 CDT            16h Thu 2026-07-02 08:05:01 CDT      5h 49min ago ibkr-deterministic-fx-poc.timer                        ibkr-deterministic-fx-poc.service
...
-                                        - Thu 2026-07-02 13:53:30 CDT      1min 13s ago btc-moderate-v2-shadow-scanner.timer                   btc-moderate-v2-shadow-scanner.service
-                                        - Thu 2026-07-02 13:53:10 CDT      1min 33s ago gemini-ds-index-micro-parity.timer                     gemini-ds-index-micro-parity.service
-                                        - Thu 2026-07-02 13:53:44 CDT           59s ago gemini-ds-index-parity.timer                           gemini-ds-index-parity.service
-                                        - Thu 2026-07-02 13:54:31 CDT           12s ago gemini-liquidity-rewards-scanner.timer                 gemini-liquidity-rewards-scanner.service
-                                        - Thu 2026-07-02 13:54:38 CDT            4s ago gemini-maker-fill-simulator.timer                      gemini-maker-fill-simulator.service
-                                        - Thu 2026-07-02 07:27:13 CDT            6h ago gemini-reward-account-monitor.timer                    gemini-reward-account-monitor.service
-                                        - Thu 2026-07-02 07:23:13 CDT            6h ago gemini-reward-inventory-exit.timer                     gemini-reward-inventory-exit.service
-                                        - Thu 2026-07-02 07:25:01 CDT            6h ago gemini-reward-live-readiness.timer                     gemini-reward-live-readiness.service
-                                        - Thu 2026-07-02 07:22:48 CDT            6h ago gemini-reward-quote-pilot.timer                        gemini-reward-quote-pilot.service
-                                        - Thu 2026-07-02 13:52:15 CDT      2min 28s ago gemini-trade-print-capture.timer                       gemini-trade-print-capture.service
-                                        - Thu 2026-07-02 13:53:16 CDT      1min 26s ago kalshi-mve-component-result-live-pilot.timer           kalshi-mve-component-result-live-pilot.service
-                                        - Wed 2026-07-01 09:00:00 CDT      1 day 4h ago snap.firmware-updater.firmware-notifier.timer          snap.firmware-updater.firmware-notifier.service
...
- operations-knowledge: head=6eff9a4 branch=master in_sync=true remote=https://github.com/PhotonRahm/operations-knowledge.git dirty=yes
