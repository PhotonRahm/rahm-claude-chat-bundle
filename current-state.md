...
- latest_run: id=42 captured_at=2026-07-05T22:18:24+00:00 | version=event_result_propagation_v1 events_seen=6676 events_examined=1651 mutex_events=241 details=240/240 detail_cap=true markets=2322 locked=0 actionable_qty1=0 max_ask=0.25 min_depth=1 | pages=34 page_cap=false rate_limited=false | reasons=event_not_mutually_exclusive_summary=1410, no_exhaustive_proof=240, detail_cap_reached=1
...
- rank 5: weather_yes_90_93:yes_90_93_above_live_threshold_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=34 resolved=29 pending=5 active=5 stale=0 unknown=0 | 26W-3L | pnl=-0.78 | Wilson 73.6% vs BE 92.3% | gap=-18.7pp | blockers=resolved<30; pnl<=0; wilson<BE+2pp | perfect_wins_needed=123 | next_pending=KXHIGHCHI-26JUL05-T79 status=active due=2026-07-06T14:00:00+00:00 ask=0.91
- rank 6: other_longshot_no_80_90:other_weak_no_80_90_4_24h_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=8 resolved=6 pending=2 active=2 stale=0 unknown=0 | 6W-0L | pnl=+0.77 | Wilson 61.0% vs BE 86.9% | gap=-25.9pp | blockers=resolved<30; wilson<BE+2pp | perfect_wins_needed=25 | next_pending=KXUSDJPY-26JUL0610-B161.375 status=active due=2026-07-06T13:59:59.769990+00:00 ask=0.85
...
- rank 6: crypto_last_hour_longshot_no|signal_tier=weak|native_ask_band=85-90 | gate=WALKFORWARD_REJECT | type=pair | train=39 resolved 35W-4L +$0.66 Wilson 76.4% vs target 90.1% gap=-13.6pp | validation=40 resolved 38W-2L +$3.00 Wilson 83.5% vs target 89.5% gap=-6.0pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 7: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=WALKFORWARD_REJECT | type=pair | train=59 resolved 58W-1L +$3.19 Wilson 91.0% vs target 94.9% gap=-3.9pp | validation=49 resolved 47W-2L +$1.80 Wilson 86.3% vs target 94.2% gap=-8.0pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 8: crypto_last_hour_longshot_no|signal_tier=moderate | gate=WALKFORWARD_REJECT | type=single | train=73 resolved 67W-6L +$1.71 Wilson 83.2% vs target 91.4% gap=-8.2pp | validation=55 resolved 51W-4L +$1.65 Wilson 82.7% vs target 91.7% gap=-9.0pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
...
- rank 5: crypto_last_hour_entry_timing:latest_actionable|asset=BTC|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=102 resolved=101 pending=1 | 98W-3L | pnl=+$3.33 | Wilson 91.6% vs target 95.7% (BE 93.7%) | gap=-4.1pp | blockers=wilson<BE+2pp
- rank 6: crypto_last_hour_entry_timing:first_actionable|native_spread_band=<=1c | gate=ENTRY_TIMING_ACCUMULATING | observations=278 resolved=277 pending=1 | 256W-21L | pnl=+$4.28 | Wilson 88.7% vs target 92.9% (BE 90.9%) | gap=-4.2pp | blockers=wilson<BE+2pp
- rank 7: crypto_last_hour_entry_timing:first_actionable|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=118 resolved=118 pending=0 | 109W-9L | pnl=+$4.66 | Wilson 86.1% vs target 90.4% (BE 88.4%) | gap=-4.3pp | blockers=wilson<BE+2pp
...
- status: live_rows=1 dry_runs=24 filled_rows=0 cancelled_rows=0 | strategy_open=0 strategy_open_cost=$0.00 | all_live_pilot_open=7 all_live_pilot_cost=$1.37
...
- rank 2: shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=635 | 587W-48L | pnl=+2615.66 | Wilson 90.1% vs target 89.6% (avg_price 87.6%) | target_gap=+0.6pp | blockers=none
- rank 3: shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=911 | 798W-113L | pnl=+3393.53 | Wilson 85.3% vs target 84.9% (avg_price 82.9%) | target_gap=+0.4pp | blockers=none

## Kalshi Shadow Longshot Stability Audit
- command: `python3 scripts/kalshi_shadow_longshot_stability_audit.py --limit 8`
- status: NO_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=7528 | eligible_cells=25 | base_candidate_cells=3 | stable_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=635ev 587W-48L +2615.66 Wilson 90.1% vs target 89.6% gap +0.6pp | train=444ev 411W-33L +1876.66 Wilson 89.7% vs target 89.6% gap +0.2pp | validation=191ev 176W-15L +739.00 Wilson 87.4% vs target 89.5% gap -2.1pp | worst_asset=KXETHD 101ev 94W-7L +494.58 Wilson 86.4% vs target 89.4% gap -3.0pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
...
- 3. shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=911ev 798W-113L +3393.53 Wilson 85.3% vs target 84.9% gap +0.4pp | train=637ev 569W-68L +3645.38 Wilson 86.7% vs target 84.6% gap +2.1pp | validation=274ev 229W-45L -251.85 Wilson 78.7% vs target 85.5% gap -6.8pp | worst_asset=KXSOLD 170ev 150W-20L +661.85 Wilson 82.5% vs target 85.4% gap -2.8pp | worst_hour=13Z 38ev 27W-11L -504.02 Wilson 55.2% vs target 85.3% gap -30.1pp | blockers=validation_pnl<=0;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
...
- status: NO_FILTERED_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=7528 | base_candidate_cells=3 | filtered_cells=74 | filtered_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=15Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=15Z | excluded=26 | aggregate=609ev 568W-41L +3012.58 Wilson 91.0% vs target 89.6% gap +1.4pp | train=426ev 397W-29L +2066.48 Wilson 90.4% vs target 89.6% gap +0.8pp | validation=183ev 171W-12L +946.10 Wilson 88.9% vs target 89.5% gap -0.6pp | worst_asset=KXETHD 97ev 91W-6L +551.44 Wilson 87.2% vs target 89.4% gap -2.2pp | worst_hour=13Z 23ev 19W-4L -131.61 Wilson 62.9% vs target 89.6% gap -26.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
- 2. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=02Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=02Z | excluded=36 | aggregate=599ev 556W-43L +2678.22 Wilson 90.5% vs target 89.6% gap +0.9pp | train=419ev 388W-31L +1767.77 Wilson 89.7% vs target 89.6% gap +0.1pp | validation=180ev 168W-12L +910.45 Wilson 88.7% vs target 89.5% gap -0.8pp | worst_asset=KXSOLD 107ev 100W-7L +542.38 Wilson 87.1% vs target 89.6% gap -2.5pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 3. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_asset=KXETHD,exclude_hour=15Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_asset=KXETHD,exclude_hour=15Z | excluded=123 | aggregate=512ev 477W-35L +2461.14 Wilson 90.6% vs target 89.6% gap +1.0pp | train=358ev 333W-25L +1654.74 Wilson 89.9% vs target 89.6% gap +0.3pp | validation=154ev 144W-10L +806.40 Wilson 88.5% vs target 89.5% gap -1.0pp | worst_asset=KXSOLD 112ev 105W-7L +610.98 Wilson 87.7% vs target 89.5% gap -1.9pp | worst_hour=13Z 21ev 17W-4L -156.02 Wilson 60.0% vs target 89.6% gap -29.6pp | blockers=validation_wilson<avg_price+buffer;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
- 4. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=01Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=01Z | excluded=40 | aggregate=595ev 550W-45L +2458.77 Wilson 90.0% vs target 89.5% gap +0.5pp | train=416ev 384W-32L +1659.58 Wilson 89.3% vs target 89.6% gap -0.2pp | validation=179ev 166W-13L +799.19 Wilson 88.0% vs target 89.5% gap -1.5pp | worst_asset=KXETHD 95ev 88W-7L +423.26 Wilson 85.6% vs target 89.4% gap -3.8pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 5. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=05Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=05Z | excluded=19 | aggregate=616ev 569W-47L +2485.68 Wilson 90.0% vs target 89.6% gap +0.4pp | train=431ev 398W-33L +1719.90 Wilson 89.4% vs target 89.6% gap -0.1pp | validation=185ev 171W-14L +765.78 Wilson 87.7% vs target 89.5% gap -1.8pp | worst_asset=KXETHD 98ev 91W-7L +456.07 Wilson 86.0% vs target 89.4% gap -3.5pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 6. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=13Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=13Z | excluded=23 | aggregate=612ev 568W-44L +2747.27 Wilson 90.5% vs target 89.6% gap +0.9pp | train=428ev 398W-30L +1988.02 Wilson 90.2% vs target 89.6% gap +0.6pp | validation=184ev 170W-14L +759.25 Wilson 87.6% vs target 89.5% gap -1.9pp | worst_asset=KXETHD 99ev 92W-7L +470.17 Wilson 86.1% vs target 89.4% gap -3.3pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 7. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=09Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=09Z | excluded=23 | aggregate=612ev 565W-47L +2449.19 Wilson 89.9% vs target 89.6% gap +0.4pp | train=428ev 395W-33L +1692.77 Wilson 89.4% vs target 89.6% gap -0.2pp | validation=184ev 170W-14L +756.42 Wilson 87.6% vs target 89.5% gap -1.9pp | worst_asset=KXETHD 97ev 90W-7L +446.72 Wilson 85.8% vs target 89.4% gap -3.6pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 8. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=07Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=07Z | excluded=26 | aggregate=609ev 563W-46L +2512.56 Wilson 90.1% vs target 89.6% gap +0.5pp | train=426ev 394W-32L +1762.67 Wilson 89.6% vs target 89.6% gap -0.0pp | validation=183ev 169W-14L +749.89 Wilson 87.6% vs target 89.5% gap -1.9pp | worst_asset=KXSOLD 114ev 106W-8L +534.43 Wilson 86.8% vs target 89.5% gap -2.8pp | worst_hour=15Z 26ev 19W-7L -396.92 Wilson 53.9% vs target 89.6% gap -35.7pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
...
- latest_run: captured_at=2026-07-05T23:11:19+00:00 | cohort=all | start=2026-06-25T20:00:00+00:00 | include_pre_cutoff_live=true | candidates=5 checked=5 actionable_qty1=0 | top_reasons=other_strong_no_90_95_4_24h_v1:native_no_ask_out_of_band:0.9500=1, other_strong_no_90_95_4_24h_v1:native_no_ask_out_of_band:0.9600=1, other_weak_no_80_90_4_24h_v1:missing_native_no_ask=1, other_weak_no_80_90_4_24h_v1:native_no_ask_out_of_band:0.9500=1
- latest_rows: KXEURUSD-26JUL0610-B1.157 cohort=other_weak_no_80_90_4_24h_v1 group=FX no_ask=missing no_ask_depth=0 spread=unknown qty1=n/a/n/a reason=missing_native_no_ask ; KXUSDJPY-26JUL0610-B160.375 cohort=other_strong_no_90_95_4_24h_v1 group=FX no_ask=0.95 no_ask_depth=1 spread=0.17 qty1=+0.04/-0.96 reason=native_no_ask_out_of_band:0.9500 ; KXUSDJPY-26JUL0610-B161.375 cohort=other_weak_no_80_90_4_24h_v1 group=FX no_ask=0.86 no_ask_depth=10 spread=0.30 qty1=+0.13/-0.87 reason=native_spread_too_wide:0.3000 ; KXINX-26JUL06H1600-B7487 cohort=other_weak_no_80_90_4_24h_v1 group=INDEX no_ask=0.95 no_ask_depth=96 spread=0.18 qty1=+0.04/-0.96 reason=native_no_ask_out_of_band:0.9500 ; KXNASDAQ100-26JUL06H1600-B30150 cohort=other_strong_no_90_95_4_24h_v1 group=INDEX no_ask=0.96 no_ask_depth=96 spread=0.16 qty1=+0.03/-0.97 reason=native_no_ask_out_of_band:0.9600
...
- best: index NO maker_band=85-90 | gate=ACCUMULATING | resolved_indep=15/50 | 14W-1L | pnl=+8.38 | Wilson 70.2% vs BE 87.7% | gap=-17.5pp | candidates=400 fills=16 fill_rate=4.0% pending_units=1 toxic=1 | blockers=resolved<50; wilson<=BE; toxic>0
- rank 1: index NO maker_band=85-90 | gate=ACCUMULATING | resolved_indep=15/50 | 14W-1L | pnl=+8.38 | Wilson 70.2% vs BE 87.7% | gap=-17.5pp | candidates=400 fills=16 fill_rate=4.0% pending_units=1 toxic=1 | blockers=resolved<50; wilson<=BE; toxic>0
...
- rank 3: crypto YES maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=109/50 | 96W-13L | pnl=-55.73 | Wilson 80.7% vs BE 93.2% | gap=-12.5pp | candidates=437 fills=116 fill_rate=26.5% pending_units=7 toxic=13 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 4: index NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=94/50 | 83W-11L | pnl=-44.59 | Wilson 80.2% vs BE 93.0% | gap=-12.7pp | candidates=2666 fills=108 fill_rate=4.1% pending_units=14 toxic=11 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 5: weather NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=68/50 | 60W-8L | pnl=-35.70 | Wilson 78.5% vs BE 93.5% | gap=-15.0pp | candidates=200 fills=83 fill_rate=41.5% pending_units=15 toxic=8 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 6: sports NO maker_band=<85 | gate=NO_GO_REVIEW | resolved_indep=221/50 | 154W-67L | pnl=-281.04 | Wilson 63.3% vs BE 82.4% | gap=-19.1pp | candidates=1659 fills=347 fill_rate=20.9% pending_units=126 toxic=67 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 7: sports NO maker_band=85-90 | gate=NO_GO_REVIEW | resolved_indep=180/50 | 133W-47L | pnl=-248.27 | Wilson 67.0% vs BE 87.7% | gap=-20.7pp | candidates=867 fills=256 fill_rate=29.5% pending_units=76 toxic=47 | blockers=pnl<=0; wilson<=BE; toxic>0
...
- 10. native:weather_no_candidate:no_95_98_zero_loss_cities_v1 | ticker=KXHIGHMIA-26JUL05-T94 | status=active | time=2026-07-06T14:00:00+00:00 | resolved=71 pending=14
