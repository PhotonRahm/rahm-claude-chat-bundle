...
last_updated_utc: 2026-07-04T05:10:00+00:00
pipeline_heartbeat_utc: 2026-07-04T05:10:00+00:00
generator: Codex generate_current_state.py
workspace_head: 0710930

## Chat Startup Critical Summary
- Generated for Claude-in-chat startup at 2026-07-04T00:10:00-05:00; missing artifacts render UNAVAILABLE instead of breaking sync.
- Full-picture artifact: FULL PICTURE - 2026-07-04 12:00 AM
...
- Kalshi reconciliation: Reconciliation: resolved_pnl=$-1500.51 open_cost=$0.47 open_fees=$0.03 recon_adj=$189.84 expected_cash=$1188.83 cash_gap=$+0.00 unrealized=$-0.43 [MATCH]
- IBKR: NLV: $1,949.48
- IBKR state: Status: ⚠️ Flex sync 223h stale | ❌ Gateway DOWN | ❌ KILL switch active
...
- strategy/cohort excerpts:
  ...
  - Next decision gate: 2026-07-04T06:30:00+00:00 - direct-index DS next resolution (126 rows/5 events unresolved | current qty5: 84 rows/5 events unresolved | micro qty1: 42 rows/5 events unresolved) resolution checks; no live expansion before event-collapsed results
...
- active_enter: Fri 2026-07-03 09:09:17 CDT
- reconciliation:
  - Reconciliation: resolved_pnl=$-1500.51 open_cost=$0.47 open_fees=$0.03 recon_adj=$189.84 expected_cash=$1188.83 cash_gap=$+0.00 unrealized=$-0.43 [MATCH]
  - ✓ HARD CHECK PASSED — gap $0.00
...
- strategy/cohort excerpts:
  ...
  - 24h P&L: -$1.63 (0W-2L resolved, 1 placed)
  ...
  - Live-matched v2 first-ticker: 229W-13L (94.6%) | taker -$116.93 | Wilson 91.0% vs BE 95.1% | 7d -$271.85 | gate=NOT_LIVE_DEPLOYABLE
  ...
  - Validation vs shadow: shadow WR 83.0% / -$82.00 (spread<=0.05 + allowed assets, matches pilot) | live WR 82.8% | shadow P&L negative; no revival
  ...
  - Mean reversion shadow freshness: last_row=2026-04-22T03:02:54Z age=73.1d live_match_last=2026-04-21T02:43:31Z post_kill_shadow_rows=0 post_kill_live_placements=0 | gate=STALE_NO_FORWARD_EVIDENCE
  ...
  - Forecast accuracy YES 90-93 above-live-threshold: event-first 118W-2L n=120 | +$1,514.16 avg_ask=0.915 | Wilson 94.1% vs BE 92.6% margin=+1.6pp | recent 38W-1L n=39 Wilson 86.8% vs BE 92.7% | pending=4 stale_pending=3 | gate=THIN_MARGIN_RECENT_UNDERPOWERED_FORWARD_ONLY | next_pending=KXLOWTPHIL-26JUL03-B82.5 city=PHIL due=2026-07-04T04:59:59.757304+00:00 ask=0.92 reason=ask_above_max(0.92>0.90)
  - Forecast accuracy high-ask NO event-first: ask>=0.98 all 949W-5L n=954 | +$1,559.40 avg_ask=0.986 | Wilson 98.8% vs BE 98.8%
  - Forecast accuracy high-ask NO ex-LAX: 871W-2L n=873 | +$1,941.78 avg_ask=0.986 | Wilson 99.2% vs BE 98.8% | unresolved_live_est_events=33 | gate=FORWARD_WATCH_ONLY
  - Forecast accuracy high-ask NO native preflight: rows=50510 events=204 actionable_qty1=864 latest=2026-07-04T05:07:03+00:00 | reasons: missing_native_no_ask=44744, nonpositive_qty1_win:0.0000=3254, actionable_qty1_fee_positive=864, native_no_ask_out_of_band:0.0100=308 | latest_run=2026-07-04T05:07:03+00:00 candidates=20 checked=20 actionable=1 run_reasons={"actionable_qty1_fee_positive": 1, "missing_native_no_ask": 15, "native_no_ask_out_of_band:0.0100": 1, "native_no_ask_out_of_band:0.8200": 1, "nonpositive_qty1_win:0.0000": 2}
  - Forecast accuracy high-ask NO latest actionables: captured=2026-07-04T05:07:03+00:00 events=20 actionable_events=1 best=KXHIGHMIA-26JUL04-T95 city=MIA event=KXHIGHMIA-26JUL04 due=2026-07-05T14:00:00+00:00 no_ask=0.98 depth=300.11 win1=+$0.01 loss1=-$0.99
  - Forecast accuracy high-ask NO native gate: native_events=49 resolved=45 pending=4 43W-2L native_pnl=-$1.55 Wilson 85.2% vs BE 99.0% next_pending=KXLOWTNYC-26JUL03-T77 city=NYC event=KXLOWTNYC-26JUL03 due=2026-07-04T19:00:00+00:00 ttl=37.4h no_ask=0.98 depth=100.00 win1=+$0.01 loss1=-$0.99
  - Forecast accuracy NO candidate-cell preflight: rows=34206 cohorts=2 events=76 actionable_qty1=9307 latest=2026-07-04T05:06:57+00:00 | latest_run=2026-07-04T05:06:57+00:00 candidates=14 checked=14 actionable=4 run_reasons={"no_90_95_min_probe_v1:missing_native_no_ask": 1, "no_90_95_min_probe_v1:native_no_ask_out_of_band:0.9900": 1, "no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive": 4, "no_95_98_zero_loss_cities_v1:missing_native_no_ask": 7, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.8600": 1}
  - Forecast accuracy NO candidate-cell cohorts: no_95_98_zero_loss_cities_v1 rows=30875 events=75 actionable=8503; no_90_95_min_probe_v1 rows=3331 events=10 actionable=804
  - Forecast accuracy NO candidate-cell latest cohort actionables: no_90_95_min_probe_v1 captured=2026-07-04T05:06:57+00:00 events=2 actionable_events=0 top_reason=native_no_ask_out_of_band:0.9900; no_95_98_zero_loss_cities_v1 captured=2026-07-04T05:06:57+00:00 events=12 actionable_events=4 best=KXHIGHTOKC-26JUL04-B104.5 city=OKC event=KXHIGHTOKC-26JUL04 due=2026-07-05T19:00:00+00:00 no_ask=0.97 depth=168.83 win1=+$0.02 loss1=-$0.98
  ...
  - Legacy weather-city NO shadow: bid>=0.88 first-ticker-side 5446W-260L n=5706 | +$10,365.36 | avg_bid=0.932 | Wilson 94.9% vs modeled BE 93.6% margin=+1.2pp | pending=226 | gate=LEGACY_MAKER_FORWARD_REQUIRED
  - Legacy weather-city NO recency: since_2026-06-17 2034W-81L n=2115 +$4,049.69 pending=224 Wilson 95.3% vs modeled BE 94.3% | forward_since_2026-06-25T09:35Z resolved=972 pending=224 | blocked 1562W-86L +$1,981.40, unblocked 3884W-174L +$8,383.96 | best=KXLOWTNYC 224W-5L +$1,073.43; worst=KXLOWTDEN 225W-19L -$364.54 | next_pending=KXHIGHCHI-26JUL03-B89.5 city=CHI due_est=2026-07-04T05:58:59.079652+00:00 ttl_at_capture=11.7h bid=0.99 overdue_pending=45 | bid-side/maker-priced shadow, not taker-executable
  ...
  - Crypto long-expiry maker/cancel proxy: v2 crypto side_bid=0.90-0.95 candidates=503 markets=271 fills=111 pending_fills=8 resolved_indep=103/50 95W-8L pnl=-$14.13 Wilson 85.4% vs modeled BE 93.6% | 24hplus_candidates=108 24hplus_fills=14 24hplus_pending_fills=5 | cancels=369 late_cross_ttl=42 open=23 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel shadow: v2 side_bid=0.92-0.94 candidates=269 markets=156 fills=62 filled_units=62 pending_fills=4 resolved_indep=58/50 54W-4L pnl=-$6.17 Wilson 83.6% vs modeled BE 94.2% | cancels=195 late_cross_ttl=23 open=12 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range maker/cancel sides: NO rows=142 markets=76 fills=26 pending=3 resolved_rows=23; YES rows=127 markets=80 fills=36 pending=1 resolved_rows=35 | source=kalshi_high_price_maker_cancel_shadow | no live orders
  ...
  - Crypto favorite taker native preflight: rows=10050 cohorts=2 contracts=55 actionable_obs=2041 latest=2026-07-04T05:06:16+00:00 | latest_run=2026-07-04T05:06:16+00:00 candidates=1 checked=1 actionable=1 reasons={"crypto_near_certain_95_99_12_24h:actionable_qty1_fee_positive": 1} | no order path
  - Crypto favorite taker native cohorts: crypto_near_certain_95_99_12_24h rows=7885 contracts=43 actionable_obs=1632; crypto_favorite_no_90_95_12_24h rows=2165 contracts=12 actionable_obs=409
  - Crypto favorite taker latest cohort actionables: crypto_favorite_no_90_95_12_24h captured=2026-07-03T20:58:01+00:00 contracts=2 actionable_contracts=0; crypto_near_certain_95_99_12_24h captured=2026-07-04T05:06:16+00:00 contracts=1 actionable_contracts=1 best=KXBTCD-26JUL0417-T64499.99 side=NO asset=BTC event=KXBTCD-26JUL0417 due=2026-07-04T20:59:59.946773+00:00 ask=0.98 depth=849.17 win1=+$0.01 loss1=-$0.99
  ...
  - Crypto contrarian NO recency: since_2026-06-17 13W-14L n=27 +$638.16 pending=0 Wilson 30.7% vs modeled BE 24.5% | forward_since_2026-06-25T10:40Z resolved=9 pending=0 | 2026-04 8W-27L -$37.12, 2026-06 13W-11L +$711.92 | BTC 8W-18L +$167.58 pending=0, ETH 9W-9L +$477.11 pending=0, SOL 4W-14L -$43.65 pending=1 | next_pending=KXSOLD-26APR2417-T83.9999 event=KXSOLD-26APR2417 due_est=2026-04-24T20:59:59.002927+00:00 ttl=-1688.2h ask=0.22 spread=0.09 active_pending=0 stale_pending=1 unknown_pending=0 | exploratory ask-priced shadow; no live orders
  - Crypto last-hour longshot NO shadow: event-first 1212W-79L n=1291 | +$6,344.45 avg_ask=0.883 | Wilson 92.4% vs modeled BE 89.0% | recent 791W-65L +$2,510.63 | gate=LIQUIDITY_PROXY_FAIL_FORWARD_ONLY
  - Crypto last-hour longshot liquidity: volume=0 603W-9L +$6,825.14; volume>=500/spread<=5c 400W-42L -$91.92 Wilson 87.4% vs BE 90.7%; 80-85c volume-backed 41W-5L +$243.03 Wilson 77.0% vs BE 83.8%; 90-95c volume-backed 263W-21L -$67.72 Wilson 89.0% vs BE 92.8%; 95-99c volume-backed 602W-23L -$511.41 Wilson 94.5% vs BE 97.1%; forward_since_2026-06-25T11:20Z 415W-41L +$524.85 Wilson 88.0% vs BE 89.9% resolved=456 pending=1 | no live orders
  - Crypto last-hour longshot native preflight: rows=5919 events=456 actionable_qty1=1603 latest=2026-07-04T05:07:35+00:00 | latest_run=2026-07-04T05:07:35+00:00 candidates=1 checked=1 actionable=1 reasons={"actionable_qty1_fee_positive": 1} | no order path
  - Crypto last-hour longshot latest actionables: captured=2026-07-04T05:07:35+00:00 events=1 contracts=1 actionable_contracts=1 best=KXBTCD-26JUL0402-T62799.99 asset=BTC event=KXBTCD-26JUL0402 due=2026-07-04T05:59:59.894123+00:00 no_ask=0.90 depth=8285.34 win1=+$0.09 loss1=-$0.91
  - Crypto last-hour longshot native gate: native_events=343 resolved=342 pending=1 active_pending=1 stale_pending=0 unknown_pending=0 307W-35L native_pnl=-$3.50 Wilson 86.1% vs BE 90.8% next_pending=KXBTCD-26JUL0402-T62799.99 asset=BTC event=KXBTCD-26JUL0402 due=2026-07-04T05:59:59.894123+00:00 no_ask=0.90 depth=13661.86 win1=+$0.09 loss1=-$0.91 | gate=NATIVE_FORWARD_ACCUMULATING
  ...
  - Weather near-expiry favorite shadow: 1-4h ask>=0.90 event-first 47W-0L n=47 +$265.00 avg_ask=0.944 Wilson 92.4% vs modeled BE 94.7% pending=3 overdue_pending=2 | gate=UNDERPOWERED_BELOW_BREAKEVEN
  - Weather near-expiry favorite recency: since_2026-06-17 32W-0L n=32 +$189.00 pending=3 Wilson 89.3% vs modeled BE 94.5% | best_event_price_cell=2-4h/p90_95 28W-0L n=28 +$212.00 pending=2 | next_pending=KXLOWTMIA-26JUL03-B78.5 event=KXLOWTMIA-26JUL03 due_est=2026-07-04T04:59:47+00:00 ask=0.93 spread=0.06 | ask-priced near-expiry shadow; no live orders
  ...
  - Summary: rows=7683 open=200 fills=1970 markets=1767 cancels=5513 late_cross_ttl=472 resolved=1490 markets=1369 pnl=-3308.17 last=2026-07-04T05:08:14+00:00
  - Pending fills: unresolved=480 markets=398 next=KXHIGHNY-26JUL03-T98 weather NO close=2026-07-04T04:59:00+00:00 expiration=2026-07-10T14:00:00+00:00 | units=480 active=470 stale=10 unknown=0
  - Overall independent fills: resolved=1490 973W-517L pnl=-3308.17 wilson_low=62.8% breakeven=87.5% toxic=517 status=NO_GO_REVIEW
  - Review progress: best_cell=sports NO resolved_independent=467/50 indep=357W-110L pnl=-515.92 wilson_low=72.4% breakeven=87.5% toxic=110 pending_markets=275 filled_markets=742 next_close=2026-07-04T16:35:00+00:00 status=NO_GO_REVIEW
  - Cell scan: resolved_cells=7 edge_positive_cells=0 leader=sports NO resolved_indep=467 best_edge_positive=none best_alternate=crypto YES resolved_indep=320 176W-144L pnl=-1002.41 wilson_low=49.5% breakeven=86.3% toxic=144 status=NO_GO_REVIEW
  - KALSHI CRYPTO LOW-PRICE NO CELL AUDIT
  - Status: SHADOW_ONLY | broad low-price NO kill=present | standard DS kill=present
  - NO <10c first-market: n=15 12W-3L wr=80.0% wilson_low=54.8% breakeven=4.5% pnl=+11.36 avg=+0.7573
  - NO <10c first-eligible: n=19 16W-3L wr=84.2% wilson_low=62.4% breakeven=4.4% pnl=+15.22 avg=+0.8011
  - NO <10c concentration: underliers=3 top=BTC n=16 share=84.2% pnl=+12.39 worst=SOL n=1 pnl=+0.90
  - NO <10c day stability: days=2 positive=2 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - NO <10c UTC-hour stability: hours=5 positive=5 losing=0 worst=12Z n=4 pnl=+1.79
  - Post-kill NO <10c first-market: n=15 12W-3L wr=80.0% wilson_low=54.8% breakeven=4.5% pnl=+11.36 avg=+0.7573
  - Post-kill NO <10c first-eligible: n=19 16W-3L wr=84.2% wilson_low=62.4% breakeven=4.4% pnl=+15.22 avg=+0.8011
  - Review: post-kill NO <10c first-eligible progress 19/50 status=ACCUMULATING reason=native taker NO ask <10c evidence absent
  - Post-kill NO <10c first-eligible concentration: underliers=3 top=BTC n=16 share=84.2% pnl=+12.39 worst=SOL n=1 pnl=+0.90
  - Post-kill NO <10c first-eligible day stability: days=2 positive=2 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - Post-kill NO <10c first-eligible UTC-hour stability: hours=5 positive=5 losing=0 worst=12Z n=4 pnl=+1.79
  - Post-kill NO <10c first-eligible loss cluster: losses=3 loss_hours=2 top_hour=12Z top_hour_losses=2/3 share=66.7% top_underlier=BTC 2/2 | excluding_top_loss_hour=POST_HOC_FORWARD_ONLY n=15 14W-1L pnl=+13.43 Wilson 70.2% vs modeled BE 4.1%
  - Post-kill NO <10c first-eligible source provenance: rows=19 sources=1 top=kalshi.shadow_deterministic_settlement n=19 distinct_source_row_ids=19 missing_source_row_ids=0
  - Post-kill NO <10c first-eligible native source check: source_ids=19 checked=17 native_taker_ask_lt10c=0/17 min=0.7300 avg=0.9324 max=0.9900
  - Fresh non-04Z NO <10c first-eligible: n=16 13W-3L wr=81.2% wilson_low=57.0% breakeven=4.3% pnl=+12.36 avg=+0.7725
  ...
  - Fresh non-04Z NO <10c first-eligible native source check: source_ids=16 checked=14 native_taker_ask_lt10c=0/14 min=0.7300 avg=0.9221 max=0.9900
  - Fresh non-04Z NO <10c first-eligible concentration: underliers=3 top=BTC n=13 share=81.2% pnl=+9.53 worst=SOL n=1 pnl=+0.90
  - Fresh non-04Z NO <10c first-eligible day stability: days=2 positive=2 losing=0 worst=2026-06-27 n=6 pnl=+3.72
  - Fresh non-04Z NO <10c first-eligible UTC-hour stability: hours=4 positive=4 losing=0 worst=12Z n=4 pnl=+1.79
  ...
  - Post-kill NO <10c first-eligible pending horizon: resolved=19/50 pending_markets=0 max_if_all_pending_resolve=19/50 need_new_after_pending=31 next_due=unknown last_due=unknown next_backfill_after=unknown last_backfill_after=unknown
  - Post-kill NO <10c first-eligible live pending preview: pending_first_eligible=0 live_actionable=0 settlement_pending_or_ineligible=0 now=2026-07-04T05:10:16+00:00 | no order path
  - Pilot readiness: NOT_READY | proposed_strategy=kalshi_crypto_no_lt10c_first_eligible_pilot | new identity required; do not revive ds_low_price_no | reason=resolved 19/50; needs 31 new markets after pending; native taker NO ask <10c evidence absent
  ...
  - Pending native-actionable rows: FX=5235, INDEX=1143
  - Gate: failed; native executable rows disprove Index/FX favorite-tracking salvage

## Storage State
- DATABASE STORAGE HEALTH
-   Overall status: GREEN / TARGET
-   Disk: 168.46 GiB used / 936.79 GiB total (18.0%), 720.67 GiB free
-   Envelope: TARGET 50.0%, WARN 65.0%, CRITICAL 75.0%, HARD_LIMIT 85.0%
-   DS storage: active 1.10 GiB (state TARGET), hot 24.05 GiB, warm 0.06 GiB, cold 0.00 GiB, archive_state TARGET, total 25.23 GiB (2.7% of disk)
-   Archive sidecars: OK
...
-   Tier rotation: last=2026-07-04T00:20:55+00:00 status=DRY_RUN actions=2, compression_ratio_avg=0.006
...
- latest_run: id=36 captured_at=2026-07-04T04:13:59+00:00 | markets_seen=10000 post_expiration_open_unresolved=0 candidate_count=0 | direct_market_recheck=True pages=100 page_cap=True rate_limited=False | trigger_fields={} | top_series=none
...
- latest_run: id=33 captured_at=2026-07-04T00:42:05+00:00 | mode=global_open_cursor markets_seen=8000 grouped_markets=8000 duplicate_groups=59 candidate_count=1 | pages=8 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=6557, KXMVECROSSCATEGORY=1443
- latest_candidates: KXMVESPORTSMULTIGAMEEXTENDED KXMVESPORTSMULTIGAMEEXTENDED-S2026EE2C0242BD0-992324319D8 YES cheap=0.554 peer_max=0.682 gap=0.128 depth=56 key=kxmvesportsmultigameextended|yes colombia advances yes reg t
...
- latest_run: id=35 captured_at=2026-07-04T04:15:18+00:00 | mode=global_open_cursor markets=10000 parsed=0 groups=0 relations=0 candidates=0 | pages=100 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=8432, KXMVECROSSCATEGORY=1566, KXWNBATOTAL=2 | parse_rejects=not_strict_binary_labels=10000
...
- latest_run: id=52 captured_at=2026-07-04T03:39:10+00:00 | mode=series_tickers series=11 offset=0 max_series=0 discovered_to_window_end=11 regex=0 prefix=0 markets=1953 parsed=1776 families=569 multi_row=469 relations=5403 candidates=0 top_net=-2.0pp | pages=24 page_cap=false rate_limited=false
- nearest_relations: KXNATGASD KXNATGASD-26JUL0617 above loose=KXNATGASD-26JUL0617-T2.850(2.85)@0.99 strict=KXNATGASD-26JUL0617-T2.855(2.855)@0.01 net=-2.0pp ; KXWTI KXWTI-26JUL0714 above loose=KXWTI-26JUL0714-T74.99(74.99)@0.02 strict=KXWTI-26JUL0714-T75.99(75.99)@0.99 net=-3.0pp ; KXWTI KXWTI-26JUL0714 above loose=KXWTI-26JUL0714-T61.99(61.99)@0.99 strict=KXWTI-26JUL0714-T62.99(62.99)@0.02 net=-3.0pp ; KXWTI KXWTI-26JUL0614 above loose=KXWTI-26JUL0614-T74.99(74.99)@0.02 strict=KXWTI-26JUL0614-T75.99(75.99)@0.99 net=-3.0pp ; KXWTI KXWTI-26JUL0614 above loose=KXWTI-26JUL0614-T73.99(73.99)@0.02 strict=KXWTI-26JUL0614-T75.99(75.99)@0.99 net=-3.0pp
...
- latest_run: id=40 captured_at=2026-07-04T04:15:21+00:00 | mode=global_open_cursor markets=10000 parsed=1361 groups=1307 relations=0 candidates=0 | pages=100 page_cap=true rate_limited=false | top_series=KXMVESPORTSMULTIGAMEEXTENDED=8432, KXMVECROSSCATEGORY=1566, KXWNBATOTAL=2 | parse_rejects=not_single_threshold_title=8639
...
- latest_run: id=33 captured_at=2026-07-04T04:13:59+00:00 | markets_seen=10000 post_close_open_unresolved=0 candidates=0 min_age_min=1.00 max_ask=0.30 max_spread=0.15 min_depth=1 | pages=100 page_cap=true rate_limited=false | categories=none | top_series=unknown
...
- latest_run: id=39 captured_at=2026-07-04T04:13:59+00:00 | markets_seen=10000 public_result_active=0 candidates=0 max_ask=0.30 max_spread=0.15 min_depth=1 | pages=100 page_cap=true rate_limited=false | results=none | categories=none | top_series=unknown
...
- latest_run: id=26 captured_at=2026-07-04T03:31:09+00:00 | version=event_result_propagation_v1 events_seen=2000 events_examined=1585 mutex_events=201 details=200/200 detail_cap=true markets=1861 locked=0 actionable_qty1=0 max_ask=0.25 min_depth=1 | pages=10 page_cap=true rate_limited=false | reasons=event_not_mutually_exclusive_summary=1384, no_exhaustive_proof=200, detail_cap_reached=1
...
- latest_run: id=22 captured_at=2026-07-04T03:19:47+00:00 | version=event_exhaustive_yes_v2_esports events_seen=198 event_details=198 baskets_checked=143 actionable_qty1=0 min_net_edge=0.000 | series=14 page_limits=[200] | counts=KXATPCHALLENGERMATCH=7, KXITFMATCH=27, KXITFWMATCH=20, KXLOLGAME=8, KXLOLMAP=18, KXMLBGAME=44, KXNBAGAME=0, KXNHLGAME=0 | reasons=exhaustive_basket_checked=143, two_way_sports_shape_mismatch=52, event_not_mutually_exclusive=2, two_way_no_tie_match_shape_mismatch=1
- nearest_baskets: KXITFWMATCH-26JUL04ANDSAR two_way_no_tie_sports_match contracts=2 sum_asks=1.000 fees=0.040 net=-0.040 depth=147 actionable=0 ; KXWTAMATCH-26JUL05PEGJOV two_way_no_tie_sports_match contracts=2 sum_asks=1.000 fees=0.040 net=-0.040 depth=1385 actionable=0 ; KXWTAMATCH-26JUL05BENGAU two_way_no_tie_sports_match contracts=2 sum_asks=1.000 fees=0.040 net=-0.040 depth=199 actionable=0 ; KXITFMATCH-26JUL03HARNAS two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.040 net=-0.050 depth=44 actionable=0 ; KXITFWMATCH-26JUL03YUAWAN two_way_no_tie_sports_match contracts=2 sum_asks=1.010 fees=0.040 net=-0.050 depth=0 actionable=0
...
- reasons: resolved 19/50; wilson 62.4% < 90.0%; open_filled_trades=5; source reconciliation mismatches 46; native taker NO ask <10c evidence absent
- resolved: 19/50 | 16W-3L | pnl=+15.22 | wilson=62.4%
- pending: 0 markets | max_if_pending=19/50 | need_new_after_pending=31
...
- fresh_non04z_review: status=NOT_READY | ready=false | reason=fresh gate status ACCUMULATING; resolved 16/50; wilson 57.0% < 90.0%; open_filled_trades=5; source reconciliation mismatches 40; native taker NO ask <10c evidence absent | resolved=16/50 | 13W-3L | pnl=+12.36 | wilson=57.0% | pending=0 | shadow_live_actionable=0 | native_taker_actionable=0 | native_taker_blocked=0 | expired_unresolved=0 | next_backfill_after=unknown | source_reconciliation=16/16 mismatches=40 | native_taker_ask_lt10c=0/14
...
- status: NO_LIVE_READY | ready=false | cells=9 | ready_cells=0 | min_resolved=30 | edge_buffer=+2.0pp | pending=25 active=25 stale=0 unknown=0 | next_pending=crypto_last_hour_longshot_no:KXBTCD-26JUL0402-T62799.99 status=active due=2026-07-04T05:59:59.894123+00:00
- best: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=343 resolved=342 pending=1 active=1 stale=0 unknown=0 | 307W-35L | pnl=-3.50 | Wilson 86.1% vs BE 90.8% | gap=-4.7pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=326 | next_pending=KXBTCD-26JUL0402-T62799.99 status=active due=2026-07-04T05:59:59.894123+00:00 ask=0.90
- rank 1: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=343 resolved=342 pending=1 active=1 stale=0 unknown=0 | 307W-35L | pnl=-3.50 | Wilson 86.1% vs BE 90.8% | gap=-4.7pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=326 | next_pending=KXBTCD-26JUL0402-T62799.99 status=active due=2026-07-04T05:59:59.894123+00:00 ask=0.90
...
- rank 4: weather_high_ask_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=49 resolved=45 pending=4 active=4 stale=0 unknown=0 | 43W-2L | pnl=-1.55 | Wilson 85.2% vs BE 99.0% | gap=-13.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=>5000_or_target_impossible | next_pending=KXLOWTNYC-26JUL03-T77 status=active due=2026-07-04T19:00:00+00:00 ask=0.98
- rank 5: weather_yes_90_93:yes_90_93_above_live_threshold_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=23 resolved=19 pending=4 active=4 stale=0 unknown=0 | 18W-1L | pnl=+0.42 | Wilson 75.4% vs BE 92.5% | gap=-17.2pp | blockers=resolved<30; wilson<BE+2pp | perfect_wins_needed=81 | next_pending=KXHIGHPHIL-26JUL03-B101.5 status=active due=2026-07-04T14:00:00+00:00 ask=0.92
...
- status: NO_NATIVE_CUT_READY | ready=false | observations=15452 | cuts=2307 | display_cuts=509 | candidate_cuts=0 | ready_cuts=0 | min_resolved=30 | min_display_resolved=10 | edge_buffer=+2.0pp | scope=posthoc_native_executable_cut_discovery_requires_predeclared_forward_gate
...
- rank 2: crypto_last_hour_longshot_no|minutes_to_expiry_band=20-40m|native_ask_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=61 resolved=61 pending=0 active=0 stale=0 unknown=0 | 57W-4L | pnl=+$5.84 | Wilson 84.3% vs target 85.9% (BE 83.9%) | gap=-1.6pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=8
- rank 3: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=80 resolved=79 pending=1 active=1 stale=0 unknown=0 | 78W-1L | pnl=+$4.71 | Wilson 93.2% vs target 94.8% (BE 92.8%) | gap=-1.6pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=25 | next_pending=KXBTCD-26JUL0402-T62799.99 status=active due=2026-07-04T05:59:59.894123+00:00 ask=0.90
- rank 4: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=49 resolved=49 pending=0 active=0 stale=0 unknown=0 | 47W-2L | pnl=+$4.60 | Wilson 86.3% vs target 88.5% (BE 86.5%) | gap=-2.2pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=11
- rank 5: crypto_last_hour_longshot_no|native_ask_band=85-90 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=193 resolved=193 pending=0 active=0 stale=0 unknown=0 | 175W-18L | pnl=+$4.49 | Wilson 85.7% vs target 90.3% (BE 88.3%) | gap=-4.6pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=96
- rank 6: crypto_last_hour_longshot_no|shadow_spread_band=<=1c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=240 resolved=239 pending=1 active=1 stale=0 unknown=0 | 221W-18L | pnl=+$2.48 | Wilson 88.4% vs target 93.4% (BE 91.4%) | gap=-5.0pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=188 | next_pending=KXBTCD-26JUL0402-T62799.99 status=active due=2026-07-04T05:59:59.894123+00:00 ask=0.90
- rank 7: crypto_last_hour_longshot_no|asset=BTC|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=139 resolved=138 pending=1 active=1 stale=0 unknown=0 | 131W-7L | pnl=+$2.55 | Wilson 89.9% vs target 95.1% (BE 93.1%) | gap=-5.2pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=150 | next_pending=KXBTCD-26JUL0402-T62799.99 status=active due=2026-07-04T05:59:59.894123+00:00 ask=0.90
- rank 8: crypto_last_hour_longshot_no|native_spread_band=<=1c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=295 resolved=294 pending=1 active=1 stale=0 unknown=0 | 269W-25L | pnl=+$0.99 | Wilson 87.7% vs target 93.2% (BE 91.2%) | gap=-5.4pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=239 | next_pending=KXBTCD-26JUL0402-T62799.99 status=active due=2026-07-04T05:59:59.894123+00:00 ask=0.90
...
- best: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=70 resolved=70 pending=0 active=0 stale=0 unknown=0 | 60W-10L | pnl=$-3.76 | Wilson 75.7% vs target 93.1% (BE 91.1%) | gap=-17.4pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=191 | excluded_post_start_actionables=330 (native_spread_band=<=5c=110, native_spread_band=<=2c=83, native_depth_band=1000+=78, native_depth_band=10-99=42) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=173 (not_actionable=173) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 1: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=70 resolved=70 pending=0 active=0 stale=0 unknown=0 | 60W-10L | pnl=$-3.76 | Wilson 75.7% vs target 93.1% (BE 91.1%) | gap=-17.4pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=191 | excluded_post_start_actionables=330 (native_spread_band=<=5c=110, native_spread_band=<=2c=83, native_depth_band=1000+=78, native_depth_band=10-99=42) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=173 (not_actionable=173) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 2: native_watch|crypto_strong_no_90_95 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=48 resolved=48 pending=0 active=0 stale=0 unknown=0 | 40W-8L | pnl=$-4.81 | Wilson 70.4% vs target 95.4% (BE 93.4%) | gap=-24.9pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=287 | excluded_post_start_actionables=384 (signal_tier=weak=168, signal_tier=moderate=117, native_ask_band=85-90=48, native_ask_band=95-98=34) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89 | target_window_misses=665 (not_actionable_native_ask_band=missing=181, not_actionable_native_ask_band=<80=110, not_actionable_native_ask_band=95-98=105, not_actionable_native_ask_band=98-99=87) | target_window_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89
- rank 3: native_watch|crypto_20_40m_no_80_85 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-29T11:05:00+00:00 | observations=31 resolved=31 pending=0 active=0 stale=0 unknown=0 | 28W-3L | pnl=$+1.96 | Wilson 75.1% vs target 86.0% (BE 84.0%) | gap=-10.9pp | blockers=wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=28 | excluded_post_start_actionables=923 (minutes_band=40-60m=511, native_ask_band=90-95=157, native_ask_band=85-90=92, minutes_band=10-20m=84) | excluded_sample=KXBTCD-26JUN2908-T60299.99 minutes_band=40-60m ask=0.95 | target_window_misses=1222 (not_actionable_native_ask_band=98-99=211, not_actionable_native_ask_band=missing=206, not_actionable_native_ask_band=99+=182, not_actionable_native_ask_band=95-98=171) | target_window_sample=KXBTCD-26JUN2908-T60299.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 4: native_watch|crypto_btc_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-30T07:13:19+00:00 | observations=31 resolved=31 pending=0 active=0 stale=0 unknown=0 | 24W-7L | pnl=$-3.41 | Wilson 60.2% vs target 90.4% (BE 88.4%) | gap=-30.2pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=115 | excluded_post_start_actionables=694 (asset=SOL=242, asset=ETH=202, native_ask_band=90-95=169, native_ask_band=95-98=54) | excluded_sample=KXBTCD-26JUN3005-T59699.99 native_ask_band=90-95 ask=0.94 | target_window_misses=1137 (not_actionable_native_ask_band=missing=408, native_ask_band=90-95=169, not_actionable_native_ask_band=98-99=136, not_actionable_native_ask_band=95-98=126) | target_window_sample=KXBTCD-26JUN3004-T59799.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 5: native_watch|crypto_spread_le1_depth_10_99 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T07:10:00+00:00 | observations=30 resolved=30 pending=0 active=0 stale=0 unknown=0 | 25W-5L | pnl=$-2.14 | Wilson 66.4% vs target 92.5% (BE 90.5%) | gap=-26.0pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=121 | excluded_post_start_actionables=491 (native_depth_band=100-999=198, native_spread_band=<=5c=112, native_spread_band=<=2c=85, native_depth_band=1000+=79) | excluded_sample=KXBTCD-26JUL0104-T58899.99 native_depth_band=100-999 ask=0.93 | target_window_misses=54 (not_actionable=54) | target_window_sample=KXSOLD-26JUL0107-T75.9999 not_actionable ask=0.99
- rank 6: native_watch|crypto_sol_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T13:00:00+00:00 | observations=20 resolved=20 pending=0 active=0 stale=0 unknown=0 | 18W-2L | pnl=$+0.29 | Wilson 69.9% vs target 90.5% (BE 88.5%) | gap=-20.7pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=54 | excluded_post_start_actionables=439 (asset=BTC=224, asset=ETH=115, native_ask_band=90-95=64, native_ask_band=80-85=25) | excluded_sample=KXBTCD-26JUL0110-T59199.99 asset=BTC ask=0.93 | target_window_misses=367 (not_actionable_native_ask_band=missing=74, native_ask_band=90-95=64, not_actionable_native_ask_band=<80=58, not_actionable_native_ask_band=99+=56) | target_window_sample=KXSOLD-26JUL0111-T79.9999 not_actionable_native_ask_band=missing
- rank 7: native_watch|crypto_btc_strong_no_90_95_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T14:00:00+00:00 | observations=16 resolved=16 pending=0 active=0 stale=0 unknown=0 | 15W-1L | pnl=$+0.01 | Wilson 71.7% vs target 95.7% (BE 93.7%) | gap=-24.0pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=112 | excluded_post_start_actionables=442 (asset=SOL=149, asset=ETH=115, native_depth_band=1000+=46, signal_tier=weak=41) | excluded_sample=KXETHD-26JUL0111-T1609.99 asset=ETH ask=0.90 | target_window_misses=99 (not_actionable_native_ask_band=95-98=27, not_actionable_native_ask_band=99+=17, not_actionable_native_ask_band=<80=17, native_ask_band=85-90=14) | target_window_sample=KXBTCD-26JUL0112-T60099.99 native_ask_band=85-90 ask=0.89
- rank 8: native_watch|crypto_tue_no_any_ask | gate=FORWARD_WATCH_WAITING | start=2026-07-01T07:10:00+00:00 | observations=0 resolved=0 pending=0 active=0 stale=0 unknown=0 | 0W-0L | pnl=$+0.00 | Wilson 0.0% vs target 2.0% (BE 0.0%) | gap=-2.0pp | blockers=no_forward_observations;resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=>5000_or_target_impossible | excluded_post_start_actionables=534 (captured_weekday=Fri=180, captured_weekday=Thu=165, captured_weekday=Wed=133, captured_weekday=Sat=56) | excluded_sample=KXBTCD-26JUL0104-T58899.99 captured_weekday=Wed ask=0.93

## Kalshi Native Preflight Walk-Forward Validation
- command: `python3 scripts/kalshi_native_preflight_walkforward.py --limit 8`
- status: NO_WALKFORWARD_NATIVE_CUT | ready=false | observations=15452 | cuts=2307 | display_cuts=229 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-30T00:31:10+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_walkforward_native_cut_validation_requires_predeclared_forward_gate
- best: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=WALKFORWARD_REJECT | type=single | train=21 resolved 19W-2L +$0.73 Wilson 71.1% vs target 89.0% gap=-17.9pp | validation=28 resolved 28W-0L +$3.87 Wilson 87.9% vs target 88.2% gap=-0.2pp | blockers=train_resolved<30;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 1: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=WALKFORWARD_REJECT | type=single | train=21 resolved 19W-2L +$0.73 Wilson 71.1% vs target 89.0% gap=-17.9pp | validation=28 resolved 28W-0L +$3.87 Wilson 87.9% vs target 88.2% gap=-0.2pp | blockers=train_resolved<30;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 2: crypto_last_hour_longshot_no|captured_weekday=Tue | gate=WALKFORWARD_REJECT | type=single | train=1 resolved 1W-0L +$0.09 Wilson 20.7% vs target 93.0% gap=-72.3pp | validation=51 resolved 51W-0L +$4.45 Wilson 93.0% vs target 93.3% gap=-0.3pp | blockers=train_resolved<30;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
...
- rank 6: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=WALKFORWARD_REJECT | type=pair | train=41 resolved 40W-1L +$1.91 Wilson 87.4% vs target 94.9% gap=-7.5pp | validation=38 resolved 38W-0L +$2.80 Wilson 90.8% vs target 94.6% gap=-3.8pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0402-T62799.99 status=active due=2026-07-04T05:59:59.894123+00:00 ask=0.90
- rank 7: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=85-90 | gate=WALKFORWARD_REJECT | type=pair | train=34 resolved 31W-3L +$0.98 Wilson 77.0% vs target 90.3% gap=-13.3pp | validation=29 resolved 28W-1L +$2.18 Wilson 82.8% vs target 91.0% gap=-8.2pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 8: crypto_last_hour_longshot_no|shadow_spread_band=<=1c | gate=WALKFORWARD_REJECT | type=single | train=120 resolved 112W-8L +$2.76 Wilson 87.4% vs target 93.0% gap=-5.6pp | validation=119 resolved 109W-10L -$0.28 Wilson 85.2% vs target 93.8% gap=-8.6pp | blockers=train_wilson<BE+buffer;validation_pnl<=0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0402-T62799.99 status=active due=2026-07-04T05:59:59.894123+00:00 ask=0.90
...
- best: crypto_last_hour_native_subcell:moderate:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=62 resolved=62 pending=0 active=0 stale=0 unknown=0 | 59W-3L | pnl=+3.96 | Wilson 86.7% vs BE 88.8% | gap=-2.1pp | blockers=wilson<BE+2pp | perfect_wins_needed=30
- rank 1: crypto_last_hour_native_subcell:moderate:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=62 resolved=62 pending=0 active=0 stale=0 unknown=0 | 59W-3L | pnl=+3.96 | Wilson 86.7% vs BE 88.8% | gap=-2.1pp | blockers=wilson<BE+2pp | perfect_wins_needed=30
- rank 2: crypto_last_hour_native_subcell:strong:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=163 resolved=163 pending=0 active=0 stale=0 unknown=0 | 148W-15L | pnl=-3.95 | Wilson 85.4% vs BE 93.2% | gap=-7.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=349
- rank 3: crypto_last_hour_native_subcell:weak:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=81 resolved=81 pending=0 active=0 stale=0 unknown=0 | 69W-12L | pnl=-1.77 | Wilson 75.9% vs BE 87.4% | gap=-11.5pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=111
- rank 4: crypto_last_hour_native_subcell:native_ask:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=149 resolved=148 pending=1 active=1 stale=0 unknown=0 | 137W-11L | pnl=-0.91 | Wilson 87.2% vs BE 93.2% | gap=-6.0pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=255 | next_pending=KXBTCD-26JUL0402-T62799.99 status=active due=2026-07-04T05:59:59.894123+00:00 ask=0.90
- rank 5: crypto_last_hour_native_subcell:native_ask:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=149 resolved=149 pending=0 active=0 stale=0 unknown=0 | 129W-20L | pnl=-0.39 | Wilson 80.2% vs BE 86.8% | gap=-6.7pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=122
- rank 6: crypto_last_hour_native_subcell:moderate:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=37 resolved=36 pending=1 active=1 stale=0 unknown=0 | 31W-5L | pnl=-1.74 | Wilson 71.3% vs BE 90.9% | gap=-19.6pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=126 | next_pending=KXBTCD-26JUL0402-T62799.99 status=active due=2026-07-04T05:59:59.894123+00:00 ask=0.90

## Kalshi Crypto Last-Hour Entry Timing Audit
- command: `python3 scripts/kalshi_crypto_last_hour_entry_timing_audit.py --limit 8`
- status: NO_ENTRY_TIMING_CANDIDATE | ready=false | posthoc_candidates=0 | source_actionable_rows=1603 | selected_observations=862 | cuts=375 | min_resolved=30 | edge_buffer=+2.0pp
- best: crypto_last_hour_entry_timing:latest_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=181 resolved=180 pending=1 | 173W-7L | pnl=+$4.60 | Wilson 92.2% vs target 95.5% (BE 93.5%) | gap=-3.4pp | blockers=wilson<BE+2pp
- rank 1: crypto_last_hour_entry_timing:latest_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=181 resolved=180 pending=1 | 173W-7L | pnl=+$4.60 | Wilson 92.2% vs target 95.5% (BE 93.5%) | gap=-3.4pp | blockers=wilson<BE+2pp
- rank 2: crypto_last_hour_entry_timing:latest_actionable|signal_tier=moderate|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=57 resolved=56 pending=1 | 55W-1L | pnl=+$2.76 | Wilson 90.6% vs target 95.2% (BE 93.2%) | gap=-4.7pp | blockers=wilson<BE+2pp
- rank 3: crypto_last_hour_entry_timing:first_actionable|native_spread_band=<=1c | gate=ENTRY_TIMING_ACCUMULATING | observations=237 resolved=236 pending=1 | 218W-18L | pnl=+$2.63 | Wilson 88.3% vs target 93.3% (BE 91.3%) | gap=-5.0pp | blockers=wilson<BE+2pp
- rank 4: crypto_last_hour_entry_timing:first_actionable|native_depth_band=1000+ | gate=ENTRY_TIMING_ACCUMULATING | observations=86 resolved=85 pending=1 | 81W-4L | pnl=+$2.87 | Wilson 88.5% vs target 93.9% (BE 91.9%) | gap=-5.4pp | blockers=wilson<BE+2pp
- rank 5: crypto_last_hour_entry_timing:latest_actionable|asset=BTC|native_ask_band=95-98 | gate=ENTRY_TIMING_ACCUMULATING | observations=48 resolved=48 pending=0 | 48W-0L | pnl=+$1.92 | Wilson 92.6% vs target 98.0% (BE 96.0%) | gap=-5.4pp | blockers=wilson<BE+2pp
- rank 6: crypto_last_hour_entry_timing:latest_actionable|asset=BTC|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=82 resolved=81 pending=1 | 78W-3L | pnl=+$2.09 | Wilson 89.7% vs target 95.7% (BE 93.7%) | gap=-6.0pp | blockers=wilson<BE+2pp
- rank 7: crypto_last_hour_entry_timing:latest_actionable|asset=ETH|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=48 resolved=48 pending=0 | 47W-1L | pnl=+$2.11 | Wilson 89.1% vs target 95.5% (BE 93.5%) | gap=-6.4pp | blockers=wilson<BE+2pp
...
- latest_run: captured_at=2026-07-04T05:11:09+00:00 | lookahead=75m | events=5 rows_per_event=40 | candidates=109 checked=109 dislocation_qty1=0 | min_source_edge=0.03 max_source_age=300s | top_reasons=missing_native_no_ask=107, source_age_too_old:512s=1, source_edge_below_min:0.0000=1
- latest_rows: KXETHD-26JUL0402-T1759.99 ETH/weak source_no=0.82 native_no_ask=0.82 edge=0.00 age=54s spread=0.01 depth=300 win=0.16 due=2026-07-04T05:59:59.063170+00:00 reason=source_edge_below_min:0.0000 ; KXSOLD-26JUL0402-T83.9999 SOL/extreme source_no=0.95 native_no_ask=0.95 edge=0.00 age=512s spread=0.02 depth=63 win=0.04 due=2026-07-04T05:59:59.194400+00:00 reason=source_age_too_old:512s ; KXBTCD-26JUL0402-T63199.99 BTC/extreme source_no=0.99 native_no_ask=missing edge=missing age=512s spread=missing depth=0 win=missing due=2026-07-04T05:59:59.913462+00:00 reason=missing_native_no_ask ; KXBTCD-26JUL0402-T63299.99 BTC/extreme source_no=0.99 native_no_ask=missing edge=missing age=512s spread=missing depth=0 win=missing due=2026-07-04T05:59:59.918285+00:00 reason=missing_native_no_ask ; KXBTCD-26JUL0402-T63399.99 BTC/extreme source_no=0.99 native_no_ask=missing edge=missing age=512s spread=missing depth=0 win=missing due=2026-07-04T05:59:59.923401+00:00 reason=missing_native_no_ask ; KXBTCD-26JUL0402-T63499.99 BTC/extreme source_no=0.99 native_no_ask=missing edge=missing age=512s spread=missing depth=0 win=missing due=2026-07-04T05:59:59.928393+00:00 reason=missing_native_no_ask

## Kalshi Crypto Ladder Dislocation Forward Audit
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_audit.py --limit 8`
- status: NO_LIVE_READY | ready=false | cells=6 | ready_cells=0 | observations=105 | min_resolved=30 | edge_buffer=+2.0pp | scope=source-vs-native ladder gaps only; not riskless structural arbitrage
- best: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=65 resolved=65 pending=0 active=0 stale=0 | 45W-20L pnl_qty1=-$8.39 | Wilson 57.2% vs target 84.1% gap=-26.9pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=123
- rank 1: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=65 resolved=65 pending=0 active=0 stale=0 | 45W-20L pnl_qty1=-$8.39 | Wilson 57.2% vs target 84.1% gap=-26.9pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=123
- rank 2: ticker_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=69 resolved=68 pending=1 active=0 stale=1 | 47W-21L pnl_qty1=-$9.22 | Wilson 57.4% vs target 84.7% gap=-27.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=135 | next_pending=KXSOLD-26JUL0401-T83.9999 status=stale due=2026-07-04T04:59:59.767754+00:00
- rank 3: all_rows | gate=LADDER_DISLOCATION_ACCUMULATING | observations=105 resolved=104 pending=1 active=0 stale=1 | 67W-37L pnl_qty1=-$15.35 | Wilson 54.9% vs target 81.2% gap=-26.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=159 | next_pending=KXSOLD-26JUL0401-T83.9999 status=stale due=2026-07-04T04:59:59.767754+00:00
...
- rank 5: asset_eth | gate=LADDER_DISLOCATION_ACCUMULATING | observations=46 resolved=46 pending=0 active=0 stale=0 | 30W-16L pnl_qty1=-$6.51 | Wilson 50.8% vs target 81.4% gap=-30.6pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=88
- rank 6: asset_sol | gate=LADDER_DISLOCATION_ACCUMULATING | observations=52 resolved=51 pending=1 active=0 stale=1 | 33W-18L pnl_qty1=-$6.52 | Wilson 51.0% vs target 79.5% gap=-28.5pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=82 | next_pending=KXSOLD-26JUL0401-T83.9999 status=stale due=2026-07-04T04:59:59.767754+00:00
...
- latest_run: captured_at=2026-07-04T04:22:04+00:00 | markets_checked=24 parsed=24 source_observations=49 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXTEMPNYCH dates=2026-07-04 | state_keys=1 observations_raw=49 source=weathercom_kalshi_metar_primary source_errors=0 | counts=KXTEMPNYCH=24 | reasons=hourly_temp_observation_missing_or_future=24
...
- latest_run: captured_at=2026-07-04T04:17:56+00:00 | markets_checked=1506 parsed=1506 espn_games=14 locked_rows=202 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXMLBKS,KXMLBOUTS,KXMLBHIT,KXMLBHRR,KXMLBHR,KXMLBTB,KXMLBRBI,KXMLBSB dates=2026-07-04,2026-07-03 | state_games=14 | reasons=player_stat_waiting_for_threshold_or_final=561, mlb_boxscore_not_current=489, mlb_player_stat_already_reached=202, player_stat_missing_after_final=175, player_stat_missing_before_final=79
- locked_rows: KXMLBHIT-26JUL032140MIAATH-ATHAWILLIAMS12-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=MIA@ATH 10-5 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL032140MIAATH-ATHCCORTES26-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:2/1 game=MIA@ATH 10-5 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL032140MIAATH-ATHCCORTES26-2 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:2/2 game=MIA@ATH 10-5 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL032140MIAATH-ATHHBOLTE33-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=MIA@ATH 10-5 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL032140MIAATH-ATHJMCNEIL22-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=MIA@ATH 10-5 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL032140MIAATH-ATHLBUTLER4-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:1/1 game=MIA@ATH 10-5 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL032140MIAATH-ATHNKURTZ16-1 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:2/1 game=MIA@ATH 10-5 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0 ; KXMLBHIT-26JUL032140MIAATH-ATHNKURTZ16-2 YES ask=1.00 depth=0 bid=0.99 win=0.00 stat=hits:2/2 game=MIA@ATH 10-5 STATUS_IN_PROGRESS reason=mlb_player_stat_already_reached actionable=0
...
- latest_run: captured_at=2026-07-04T02:11:37+00:00 | markets_checked=20000 with_legs=20000 component_events=295/295 fetched=295 component_markets=4518 resolved=364 locked_rows=0 actionable_qty1=0 | max_target_ask=0.25 min_depth=1 | series=KXMVESPORTSMULTIGAMEEXTENDED,KXMVECROSSCATEGORY counts=KXMVECROSSCATEGORY=10000, KXMVESPORTSMULTIGAMEEXTENDED=10000 | page_cap=KXMVECROSSCATEGORY,KXMVESPORTSMULTIGAMEEXTENDED rate_limited=none component_cap=false component_rate_limited=false | reasons=not_locked_by_component_results=20000, component_market_resolved=364
...
- latest_run: captured_at=2026-07-04T03:45:46+00:00 | markets_checked=688 parsed=688 espn_games=44 locked_rows=27 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXMLBRFI,KXMLBF3,KXMLBF5,KXMLBF5SPREAD,KXMLBF5TOTAL,KXMLBF7,KXMLBTEAMTOTAL,KXMLBEXTRAS dates=2026-07-03,2026-07-04,2026-07-05,2026-07-06 | state_games=44 | counts=KXMLBEXTRAS=44, KXMLBF3=45, KXMLBF5=45, KXMLBF5SPREAD=60, KXMLBF5TOTAL=105, KXMLBF7=57, KXMLBRFI=38, KXMLBTEAMTOTAL=294 | reasons=mlb_teamtotal_game_not_final=268, mlb_f5total_window_not_complete=105, mlb_f5spread_window_not_complete=60, mlb_f7_window_not_complete=57, mlb_f3_window_not_complete=45, mlb_f5_window_not_complete=45, mlb_extras_game_not_final=43, mlb_rfi_first_inning_not_complete=38
- locked_rows: KXMLBEXTRAS-26JUL031910CWSCLE-EXTRAS YES ask=1.00 depth=0 bid=0.99 win=0.00 type=extras window=None target=None threshold=missing margin=missing total=None game=CWS@CLE 3-3 STATUS_IN_PROGRESS reason=mlb_extras_already_reached actionable=0 ; KXMLBTEAMTOTAL-26JUL031910CWSCLE-CLE2 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=CLE threshold=1.50 margin=missing total=None game=CWS@CLE 3-3 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL031910CWSCLE-CLE3 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=CLE threshold=2.50 margin=missing total=None game=CWS@CLE 3-3 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL031910CWSCLE-CWS2 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=CWS threshold=1.50 margin=missing total=None game=CWS@CLE 3-3 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL031910CWSCLE-CWS3 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=CWS threshold=2.50 margin=missing total=None game=CWS@CLE 3-3 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL032138BOSLAA-BOS2 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=BOS threshold=1.50 margin=missing total=None game=BOS@LAA 5-0 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL032138BOSLAA-BOS3 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=BOS threshold=2.50 margin=missing total=None game=BOS@LAA 5-0 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0 ; KXMLBTEAMTOTAL-26JUL032138BOSLAA-BOS4 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=teamtotal window=None target=BOS threshold=3.50 margin=missing total=None game=BOS@LAA 5-0 STATUS_IN_PROGRESS reason=mlb_teamtotal_over_already_exceeded actionable=0
...
- latest_run: captured_at=2026-07-04T04:17:56+00:00 | markets_checked=146 parsed=125 espn_games=4 locked_rows=57 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWNBAGAME,KXWNBASPREAD,KXWNBATOTAL,KXWNBAOT,KXWNBA1QWINNER,KXWNBA2QWINNER,KXWNBA3QWINNER,KXWNBA4QWINNER,KXWNBA1HWINNER,KXWNBA2HWINNER,KXWNBA1QSPREAD,KXWNBA2QSPREAD,KXWNBA3QSPREAD,KXWNBA4QSPREAD,KXWNBA1HSPREAD,KXWNBA2HSPREAD,KXWNBA1QTOTAL,KXWNBA2QTOTAL,KXWNBA3QTOTAL,KXWNBA4QTOTAL,KXWNBA1HTOTAL,KXWNBA2HTOTAL dates=2026-07-04,2026-07-03,2026-07-05 | state_games=4 | counts=KXWNBA1HSPREAD=0, KXWNBA1HTOTAL=0, KXWNBA1HWINNER=0, KXWNBA1QSPREAD=0, KXWNBA1QTOTAL=0, KXWNBA1QWINNER=0, KXWNBA2HSPREAD=8, KXWNBA2HTOTAL=7, KXWNBA2HWINNER=3, KXWNBA2QSPREAD=0, KXWNBA2QTOTAL=0, KXWNBA2QWINNER=0, KXWNBA3QSPREAD=7, KXWNBA3QTOTAL=7, KXWNBA3QWINNER=3, KXWNBA4QSPREAD=7, KXWNBA4QTOTAL=7, KXWNBA4QWINNER=3, KXWNBAGAME=10, KXWNBAOT=4, KXWNBASPREAD=42, KXWNBATOTAL=38 | reasons=wnba_spread_game_not_final=33, wnba_total_game_not_final=24, wnba_2h_spread_final=8, wnba_game_not_final=8, wnba_3q_spread_final=7, wnba_4q_spread_final=7, wnba_3q_total_over_already_exceeded=5, wnba_4q_total_final_under_or_equal=5
- locked_rows: KXWNBA2HSPREAD-26JUL03CHILV-CHI2 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=2h_spread target=CHI threshold=1.50 margin=12.00 total=86 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_2h_spread_final actionable=0 ; KXWNBA2HSPREAD-26JUL03CHILV-CHI4 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=2h_spread target=CHI threshold=3.50 margin=12.00 total=86 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_2h_spread_final actionable=0 ; KXWNBA2HSPREAD-26JUL03CHILV-CHI7 YES ask=1.00 depth=0 bid=0.99 win=0.00 type=2h_spread target=CHI threshold=6.50 margin=12.00 total=86 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_2h_spread_final actionable=0 ; KXWNBA2HSPREAD-26JUL03CHILV-LV11 NO ask=1.00 depth=0 bid=0.99 win=0.00 type=2h_spread target=LV threshold=10.50 margin=-12.00 total=86 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_2h_spread_final actionable=0 ; KXWNBA2HSPREAD-26JUL03CHILV-LV14 NO ask=1.00 depth=0 bid=0.99 win=0.00 type=2h_spread target=LV threshold=13.50 margin=-12.00 total=86 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_2h_spread_final actionable=0 ; KXWNBA2HSPREAD-26JUL03CHILV-LV2 NO ask=1.00 depth=0 bid=0.99 win=0.00 type=2h_spread target=LV threshold=1.50 margin=-12.00 total=86 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_2h_spread_final actionable=0 ; KXWNBA2HSPREAD-26JUL03CHILV-LV5 NO ask=1.00 depth=0 bid=0.99 win=0.00 type=2h_spread target=LV threshold=4.50 margin=-12.00 total=86 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_2h_spread_final actionable=0 ; KXWNBA2HSPREAD-26JUL03CHILV-LV8 NO ask=1.00 depth=0 bid=0.99 win=0.00 type=2h_spread target=LV threshold=7.50 margin=-12.00 total=86 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_2h_spread_final actionable=0
...
- latest_run: captured_at=2026-07-04T04:17:56+00:00 | markets_checked=47 parsed=47 espn_games=1 locked_rows=17 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWNBAPTS,KXWNBAREB,KXWNBAAST,KXWNBA3PT dates=2026-07-03 | state_games=1 titles=47 title_failures=0 summary_fetches=1 | counts=KXWNBA3PT=10, KXWNBAAST=3, KXWNBAPTS=19, KXWNBAREB=15 | reasons=wnba_player_stat_waiting_for_threshold_or_final=30, wnba_player_stat_already_reached=17
- locked_rows: KXWNBAREB-26JUL03CHILV-LVCGRAY12-4 YES ask=0.99 depth=1308 bid=0.75 win=0.00 player=Chelsea Gray stat=rebounds:4/4 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_player_stat_already_reached actionable=0 ; KXWNBA3PT-26JUL03CHILV-CHISDIGGINS4-2 YES ask=1.00 depth=0 bid=0.99 win=0.00 player=Skylar Diggins stat=made_threes:2/2 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_player_stat_already_reached actionable=0 ; KXWNBA3PT-26JUL03CHILV-LVJLOYD24-2 YES ask=1.00 depth=0 bid=0.99 win=0.00 player=Jewell Loyd stat=made_threes:3/2 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_player_stat_already_reached actionable=0 ; KXWNBA3PT-26JUL03CHILV-LVJLOYD24-3 YES ask=1.00 depth=0 bid=0.99 win=0.00 player=Jewell Loyd stat=made_threes:3/3 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_player_stat_already_reached actionable=0 ; KXWNBAPTS-26JUL03CHILV-CHIKCARDOSO10-10 YES ask=1.00 depth=0 bid=0.99 win=0.00 player=Kamilla Cardoso stat=points:16/10 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_player_stat_already_reached actionable=0 ; KXWNBAPTS-26JUL03CHILV-CHIKCARDOSO10-15 YES ask=1.00 depth=0 bid=0.99 win=0.00 player=Kamilla Cardoso stat=points:16/15 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_player_stat_already_reached actionable=0 ; KXWNBAPTS-26JUL03CHILV-CHISDIGGINS4-10 YES ask=1.00 depth=0 bid=0.99 win=0.00 player=Skylar Diggins stat=points:19/10 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_player_stat_already_reached actionable=0 ; KXWNBAPTS-26JUL03CHILV-CHISDIGGINS4-15 YES ask=1.00 depth=0 bid=0.99 win=0.00 player=Skylar Diggins stat=points:19/15 game=CHI@LV 90-92 STATUS_IN_PROGRESS reason=wnba_player_stat_already_reached actionable=0
...
- latest_run: captured_at=2026-07-04T04:21:38+00:00 | markets_checked=18 parsed=18 espn_games=9 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXAFLGAME dates=2026-07-04,2026-07-03,2026-07-05,2026-07-06,2026-07-09,2026-07-10,2026-07-11 | state_games=9 | counts=KXAFLGAME=18 | reasons=afl_game_not_final=18
...
- latest_run: captured_at=2026-07-04T04:21:38+00:00 | markets_checked=8 parsed=8 official_games=93 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXCFLGAME dates=2026-07-04,2026-07-05,2026-07-09,2026-07-10 | state_games=4 rounds_raw=27 tournaments_raw=93 supported_games=93 | counts=KXCFLGAME=8 | source_errors=0 | reasons=cfl_game_not_final=8
...
- latest_run: captured_at=2026-07-04T04:22:04+00:00 | markets_checked=8 parsed=8 official_games=32 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXBIG3GAME dates=2026-07-05 | state_games=4 events_raw=32 supported_games=32 | counts=KXBIG3GAME=8 | source_errors=0 | reasons=big3_game_not_final=8
...
- latest_run: captured_at=2026-07-04T04:21:51+00:00 | markets_checked=82 parsed=82 official_games=60 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXLMBGAME dates=2026-07-04,2026-07-03,2026-07-05,2026-07-02,2026-07-06,2026-07-07 | state_games=54 schedule_games=60 teams=20 | counts=KXLMBGAME=82 | source_errors=0 | reasons=lmb_game_not_final=60, no_matching_official_lmb_game_state=16, lmb_game_postponed_or_canceled=6
...
- latest_run: captured_at=2026-07-04T04:18:38+00:00 | markets_checked=28 parsed=28 official_games=80 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXVALORANTGAME dates=2026-07-04,2026-07-05,2026-07-07 | state_games=37 events_raw=80 supported_games=80 | counts=KXVALORANTGAME=28 | source_errors=0 | reasons=valorant_game_not_final=28
...
- latest_run: captured_at=2026-07-04T04:18:38+00:00 | markets_checked=17 parsed=17 official_games=80 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXLOLGAME dates=2026-07-04,2026-07-03,2026-07-05,2026-07-02 | state_games=28 events_raw=80 supported_games=80 | counts=KXLOLGAME=17 | source_errors=0 | reasons=lol_game_not_final=12, lol_game_final_no_unique_winner=2, no_matching_official_lol_game_state=2, lol_game_target_not_in_game=1
...
- latest_run: captured_at=2026-07-04T00:19:12+00:00 | kalshi_markets=100 groups=50 espn_matches=602 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXATPMATCH,KXWTAMATCH,KXATPDOUBLES,KXWTADOUBLES counts=KXATPDOUBLES=20, KXATPMATCH=24, KXWTADOUBLES=32, KXWTAMATCH=24 | espn_events=atp=1, wta=1 competitions=atp=304, wta=298 status_fetches=602 | reasons=espn_match_not_unique_completed=42, no_espn_match_pair=8
...
- latest_run: captured_at=2026-07-04T04:18:38+00:00 | markets_checked=94 parsed=94 official_games=160 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXVALORANTMAP,KXLOLMAP dates=2026-07-04,2026-07-03,2026-07-05,2026-07-07 | state_games=78 events_raw=160 supported_games=160 | counts=KXLOLMAP=34, KXVALORANTMAP=60 | source_errors=0 | proof=completed_clean_sweep_only | reasons=valorant_match_not_final=60, lol_match_not_final=30, no_matching_official_lol_map_sweep_state=4
...
- latest_run: captured_at=2026-07-04T04:21:51+00:00 | markets_checked=98 parsed=98 official_games=42 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXFIBAGAME dates=2026-06-30,2026-07-02,2026-07-03,2026-07-04,2026-07-05,2026-07-06 | state_games=84 matched_markets=84 raw_games=210 supported_games=88 | counts=KXFIBAGAME=98 | source_errors=0 | reasons=fiba_game_not_final=84, no_matching_official_fiba_game_state=14
...
- latest_run: captured_at=2026-07-04T04:21:51+00:00 | markets_checked=6 parsed=6 official_games=26 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXNZNBLGAME dates=2026-07-04,2026-07-05 | state_games=2 widget_rows=52 supported_games=26 | counts=KXNZNBLGAME=6 | source_errors=0 | reasons=nznbl_game_not_final=6
...
- latest_run: captured_at=2026-07-04T04:21:51+00:00 | markets_checked=4 parsed=4 official_games=16 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXVBAGAME dates=2026-07-04,2026-07-05 | state_games=2 widget_rows=16 supported_games=16 | counts=KXVBAGAME=4 | source_errors=0 | reasons=vba_game_not_final=4
...
- latest_run: captured_at=2026-07-04T04:21:38+00:00 | markets_checked=18 parsed=18 espn_games=9 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXNBASUMMERGAME dates=2026-07-04,2026-07-03,2026-07-05 | state_games=9 | counts=KXNBASUMMERGAME=18 | leagues=nba-summer-california=8, nba-summer-utah=2 | reasons=nba_summer_game_not_final=18
...
- latest_run: captured_at=2026-07-04T04:22:18+00:00 | markets_checked=55 parsed=55 espn_games=5 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWCCORNERS,KXWCTCORNERS dates=2026-07-04,2026-07-05,2026-07-06 | state_games=5 needed_events=5 | counts=KXWCCORNERS=25, KXWCTCORNERS=30 | reasons=team_corner_state_unknown=30, corner_state_unknown=25
...
- latest_run: captured_at=2026-07-04T04:22:22+00:00 | markets_checked=52 parsed=52 espn_games=1 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWCSTART dates=2026-07-06 | state_games=1 needed_events=1 | counts=KXWCSTART=52 | reasons=wc_start_lineup_not_available=52
...
- latest_run: captured_at=2026-07-04T04:18:39+00:00 | markets_checked=66 parsed=48 espn_games=10 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXCHNSLGAME,KXALLSVENSKANGAME,KXBRASILEIROBGAME,KXBRASILEIROCGAME,KXUSLGAME,KXECULPGAME dates=2026-07-04,2026-07-03,2026-07-05,2026-07-02,2026-07-06,2026-07-01,2026-07-07,2026-07-08 | state_games=10 | counts=KXALLSVENSKANGAME=0, KXBRASILEIROBGAME=21, KXBRASILEIROCGAME=27, KXCHNSLGAME=0, KXECULPGAME=18, KXUSLGAME=0 | reasons=soccer_game_not_final=30, no_matching_espn_soccer_game_state=18
...
- rank 2: shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=605 | 560W-45L | pnl=+2566.58 | Wilson 90.2% vs target 89.6% (avg_price 87.6%) | target_gap=+0.6pp | blockers=none
...
- rank 4: shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=858 | 749W-109L | pnl=+2978.43 | Wilson 84.9% vs target 84.8% (avg_price 82.8%) | target_gap=+0.1pp | blockers=none

## Kalshi Shadow Longshot Stability Audit
- command: `python3 scripts/kalshi_shadow_longshot_stability_audit.py --limit 8`
- status: NO_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=7094 | eligible_cells=25 | base_candidate_cells=3 | stable_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=605ev 560W-45L +2566.58 Wilson 90.2% vs target 89.6% gap +0.6pp | train=423ev 392W-31L +1829.86 Wilson 89.8% vs target 89.6% gap +0.2pp | validation=182ev 168W-14L +736.72 Wilson 87.5% vs target 89.5% gap -2.0pp | worst_asset=KXSOLD 113ev 105W-8L +523.18 Wilson 86.6% vs target 89.5% gap -2.9pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
...
- 3. shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=858ev 749W-109L +2978.43 Wilson 84.9% vs target 84.8% gap +0.1pp | train=600ev 536W-64L +3436.84 Wilson 86.6% vs target 84.6% gap +2.0pp | validation=258ev 213W-45L -458.41 Wilson 77.5% vs target 85.4% gap -7.9pp | worst_asset=KXBTCD 455ev 388W-67L +708.92 Wilson 81.7% vs target 84.7% gap -3.0pp | worst_hour=13Z 35ev 25W-10L -449.18 Wilson 54.9% vs target 85.3% gap -30.3pp | blockers=validation_pnl<=0;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXBTCD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
...
- status: NO_FILTERED_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=7094 | base_candidate_cells=3 | filtered_cells=74 | filtered_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=02Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=02Z | excluded=35 | aggregate=570ev 530W-40L +2641.34 Wilson 90.6% vs target 89.6% gap +1.0pp | train=399ev 369W-30L +1632.23 Wilson 89.5% vs target 89.6% gap -0.2pp | validation=171ev 161W-10L +1009.11 Wilson 89.6% vs target 89.5% gap +0.1pp | worst_asset=KXSOLD 104ev 97W-7L +508.61 Wilson 86.8% vs target 89.6% gap -2.9pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=train_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 2. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=13Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=13Z | excluded=22 | aggregate=583ev 542W-41L +2709.45 Wilson 90.6% vs target 89.6% gap +1.0pp | train=408ev 379W-29L +1850.59 Wilson 90.0% vs target 89.6% gap +0.4pp | validation=175ev 163W-12L +858.86 Wilson 88.4% vs target 89.5% gap -1.1pp | worst_asset=KXETHD 94ev 88W-6L +514.83 Wilson 86.8% vs target 89.4% gap -2.6pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 3. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=09Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=09Z | excluded=22 | aggregate=583ev 539W-44L +2410.42 Wilson 90.0% vs target 89.6% gap +0.5pp | train=408ev 376W-32L +1554.39 Wilson 89.1% vs target 89.6% gap -0.4pp | validation=175ev 163W-12L +856.03 Wilson 88.4% vs target 89.5% gap -1.1pp | worst_asset=KXSOLD 110ev 102W-8L +487.51 Wilson 86.3% vs target 89.5% gap -3.2pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 4. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=01Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=01Z | excluded=39 | aggregate=566ev 524W-42L +2420.95 Wilson 90.1% vs target 89.5% gap +0.6pp | train=396ev 366W-30L +1624.04 Wilson 89.4% vs target 89.6% gap -0.2pp | validation=170ev 158W-12L +796.91 Wilson 88.1% vs target 89.5% gap -1.4pp | worst_asset=KXSOLD 103ev 95W-8L +409.67 Wilson 85.4% vs target 89.5% gap -4.1pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 5. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=08Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=08Z | excluded=17 | aggregate=588ev 545W-43L +2570.48 Wilson 90.3% vs target 89.6% gap +0.7pp | train=411ev 381W-30L +1791.00 Wilson 89.8% vs target 89.6% gap +0.2pp | validation=177ev 164W-13L +779.48 Wilson 87.8% vs target 89.5% gap -1.6pp | worst_asset=KXSOLD 111ev 103W-8L +502.56 Wilson 86.4% vs target 89.5% gap -3.1pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 6. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=05Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=05Z | excluded=18 | aggregate=587ev 543W-44L +2447.86 Wilson 90.1% vs target 89.6% gap +0.5pp | train=410ev 379W-31L +1673.10 Wilson 89.5% vs target 89.6% gap -0.1pp | validation=177ev 164W-13L +774.76 Wilson 87.8% vs target 89.5% gap -1.7pp | worst_asset=KXSOLD 112ev 104W-8L +511.92 Wilson 86.5% vs target 89.5% gap -3.0pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 7. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=19Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=19Z | excluded=21 | aggregate=584ev 541W-43L +2525.46 Wilson 90.2% vs target 89.5% gap +0.7pp | train=408ev 378W-30L +1757.22 Wilson 89.7% vs target 89.6% gap +0.1pp | validation=176ev 163W-13L +768.24 Wilson 87.8% vs target 89.5% gap -1.7pp | worst_asset=KXETHD 92ev 86W-6L +494.21 Wilson 86.5% vs target 89.3% gap -2.8pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 8. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=07Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=07Z | excluded=24 | aggregate=581ev 537W-44L +2384.10 Wilson 90.0% vs target 89.6% gap +0.4pp | train=406ev 375W-31L +1627.13 Wilson 89.4% vs target 89.6% gap -0.2pp | validation=175ev 162W-13L +756.97 Wilson 87.7% vs target 89.5% gap -1.8pp | worst_asset=KXSOLD 111ev 103W-8L +500.66 Wilson 86.4% vs target 89.5% gap -3.1pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
...
- latest_run: captured_at=2026-07-04T05:08:42+00:00 | cohort=moderate_favorites_eth_yes_80_90_0_1h_v1 | start=2026-07-03T16:50:00+00:00 | include_pre_cutoff_live=false | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- latest_run: captured_at=2026-07-04T05:11:29+00:00 | cohort=yes_90_93_above_live_threshold_v1 | start=2026-06-25T11:45:00+00:00 | include_pre_cutoff_live=true | candidates=1 checked=1 actionable_qty1=0 | top_reasons=yes_90_93_above_live_threshold_v1:missing_native_yes_ask=1
- latest_rows: KXHIGHTSEA-26JUL03-B73.5 city=SEA yes_ask=missing no_depth=0 reason=missing_native_yes_ask
...
- latest_run: captured_at=2026-07-04T05:06:57+00:00 | start=2026-06-25T07:05:00+00:00 | include_pre_cutoff_live=true | candidates=14 checked=14 actionable_qty1=4 | top_reasons=no_95_98_zero_loss_cities_v1:missing_native_no_ask=7, no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive=4, no_90_95_min_probe_v1:missing_native_no_ask=1, no_90_95_min_probe_v1:native_no_ask_out_of_band:0.9900=1, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.8600=1
- latest_rows: KXHIGHTDAL-26JUL04-T96 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=0.98 no_ask_depth=28 qty1=+0.01/-0.99 reason=actionable_qty1_fee_positive due=2026-07-05T19:00:00+00:00 ; KXLOWTMIA-26JUL04-B74.5 cohort=no_95_98_zero_loss_cities_v1 city=MIA no_ask=0.97 no_ask_depth=39 qty1=+0.02/-0.98 reason=actionable_qty1_fee_positive due=2026-07-05T19:00:00+00:00 ; KXHIGHTOKC-26JUL04-B104.5 cohort=no_95_98_zero_loss_cities_v1 city=OKC no_ask=0.97 no_ask_depth=169 qty1=+0.02/-0.98 reason=actionable_qty1_fee_positive due=2026-07-05T19:00:00+00:00 ; KXHIGHTSEA-26JUL04-B78.5 cohort=no_95_98_zero_loss_cities_v1 city=SEA no_ask=0.98 no_ask_depth=161 qty1=+0.01/-0.99 reason=actionable_qty1_fee_positive due=2026-07-05T19:00:00+00:00 ; KXHIGHTMIN-26JUL03-B87.5 cohort=no_90_95_min_probe_v1 city=MIN no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-04T19:00:00+00:00 ; KXHIGHTMIN-26JUL04-T78 cohort=no_90_95_min_probe_v1 city=MIN no_ask=0.99 no_ask_depth=186 qty1=+0.00/-1.00 reason=native_no_ask_out_of_band:0.9900 due=2026-07-05T19:00:00+00:00 ; KXLOWTAUS-26JUL03-B70.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-04T19:00:00+00:00 ; KXLOWTAUS-26JUL04-B72.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=0.86 no_ask_depth=17 qty1=+0.13/-0.87 reason=native_no_ask_out_of_band:0.8600 due=2026-07-05T19:00:00+00:00
...
- latest_run: captured_at=2026-07-04T05:11:31+00:00 | cohort=all | start=2026-06-25T20:00:00+00:00 | include_pre_cutoff_live=true | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- status: NO_LIVE_READY | ready=false | cells=15 | ready_cells=0 | review_min=50 | fills=1970 pending_units=480 active=470 stale=10 unknown=0 overall_resolved_indep=1490 toxic=517 | next_pending=cell_weather_no:KXHIGHCHI-26JUL03-B89.5 status=active close=2026-07-04T05:59:00+00:00
- best: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=467/50 max_if_pending_resolve=742 new_needed_after_pending=0 | 357W-110L | pnl=-515.92 | Wilson 72.4% vs BE 87.5% | gap=-15.1pp | fills=742/2603 fill_rate=28.5% pending_units=275 active=275 stale=0 unknown=0 toxic=110 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUL011235CWSBAL-BAL3 status=active close=2026-07-04T16:35:00+00:00 price=0.81
- rank 1: cell_sports_no | gate=NO_GO_REVIEW | resolved_indep=467/50 max_if_pending_resolve=742 new_needed_after_pending=0 | 357W-110L | pnl=-515.92 | Wilson 72.4% vs BE 87.5% | gap=-15.1pp | fills=742/2603 fill_rate=28.5% pending_units=275 active=275 stale=0 unknown=0 toxic=110 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUL011235CWSBAL-BAL3 status=active close=2026-07-04T16:35:00+00:00 price=0.81
- rank 2: cell_crypto_yes | gate=NO_GO_REVIEW | resolved_indep=320/50 max_if_pending_resolve=346 new_needed_after_pending=0 | 176W-144L | pnl=-1002.41 | Wilson 49.5% vs BE 86.3% | gap=-36.8pp | fills=346/1193 fill_rate=29.0% pending_units=26 active=26 stale=0 unknown=0 toxic=144 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0417-T61499.99 status=active close=2026-07-04T21:00:00+00:00 price=0.94
- rank 3: cell_crypto_no | gate=NO_GO_REVIEW | resolved_indep=296/50 max_if_pending_resolve=320 new_needed_after_pending=0 | 163W-133L | pnl=-944.45 | Wilson 49.4% vs BE 87.0% | gap=-37.6pp | fills=320/1057 fill_rate=30.3% pending_units=24 active=24 stale=0 unknown=0 toxic=133 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0417-T59749.99 status=active close=2026-07-04T21:00:00+00:00 price=0.79
- rank 4: cell_sports_yes | gate=NO_GO_REVIEW | resolved_indep=158/50 max_if_pending_resolve=283 new_needed_after_pending=0 | 63W-95L | pnl=-736.54 | Wilson 32.6% vs BE 86.5% | gap=-53.9pp | fills=283/448 fill_rate=63.2% pending_units=125 active=125 stale=0 unknown=0 toxic=95 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXMLBSPREAD-26JUL011235CWSBAL-BAL2 status=active close=2026-07-04T16:35:00+00:00 price=0.91
- rank 5: cell_index_no | gate=NO_GO_REVIEW | resolved_indep=113/50 max_if_pending_resolve=113 new_needed_after_pending=0 | 101W-12L | pnl=-29.57 | Wilson 82.4% vs BE 91.9% | gap=-9.6pp | fills=113/2025 fill_rate=5.6% pending_units=0 active=0 stale=0 unknown=0 toxic=12 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000
- rank 6: cell_weather_no | gate=NO_GO_REVIEW | resolved_indep=110/50 max_if_pending_resolve=137 new_needed_after_pending=0 | 90W-20L | pnl=-87.20 | Wilson 73.6% vs BE 89.7% | gap=-16.2pp | fills=137/293 fill_rate=46.8% pending_units=27 active=19 stale=8 unknown=0 toxic=20 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXHIGHCHI-26JUL03-B89.5 status=active close=2026-07-04T05:59:00+00:00 price=0.84
- rank 7: watch_crypto_bid_90_95 | gate=NO_GO_REVIEW | resolved_indep=103/50 max_if_pending_resolve=111 new_needed_after_pending=0 | 95W-8L | pnl=-14.13 | Wilson 85.4% vs BE 93.6% | gap=-8.2pp | fills=111/503 fill_rate=22.1% pending_units=8 active=8 stale=0 unknown=0 toxic=8 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0417-T61499.99 status=active close=2026-07-04T21:00:00+00:00 price=0.94
- rank 8: watch_crypto_bid_92_94 | gate=NO_GO_REVIEW | resolved_indep=58/50 max_if_pending_resolve=62 new_needed_after_pending=0 | 54W-4L | pnl=-6.17 | Wilson 83.6% vs BE 94.2% | gap=-10.6pp | fills=62/269 fill_rate=23.0% pending_units=4 active=4 stale=0 unknown=0 toxic=4 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXBTCD-26JUL0417-T61499.99 status=active close=2026-07-04T21:00:00+00:00 price=0.94
...
- rank 4: crypto YES maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=95/50 | 85W-10L | pnl=-34.58 | Wilson 81.7% vs BE 93.1% | gap=-11.4pp | candidates=383 fills=100 fill_rate=26.1% pending_units=5 toxic=10 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 5: index NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=94/50 | 83W-11L | pnl=-44.59 | Wilson 80.2% vs BE 93.0% | gap=-12.7pp | candidates=1790 fills=94 fill_rate=5.3% pending_units=0 toxic=11 | blockers=pnl<=0; wilson<=BE; toxic>0
- rank 6: sports NO maker_band=85-90 | gate=NO_GO_REVIEW | resolved_indep=118/50 | 95W-23L | pnl=-85.73 | Wilson 72.4% vs BE 87.8% | gap=-15.3pp | candidates=682 fills=213 fill_rate=31.2% pending_units=95 toxic=23 | blockers=pnl<=0; wilson<=BE; toxic>0
...
- rank 8: sports NO maker_band=<85 | gate=NO_GO_REVIEW | resolved_indep=179/50 | 130W-49L | pnl=-174.03 | Wilson 65.7% vs BE 82.3% | gap=-16.7pp | candidates=1380 fills=287 fill_rate=20.8% pending_units=108 toxic=49 | blockers=pnl<=0; wilson<=BE; toxic>0

## Kalshi Maker Walk-Forward Validation
- command: `python3 scripts/kalshi_maker_walkforward.py --limit 8`
- status: NO_MAKER_WALKFORWARD_CUT | ready=false | observations=1970 | cuts=187 | display_cuts=122 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-28T19:58:13+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_maker_cut_walkforward_requires_predeclared_live_spec
...
- rank 2: maker_all_fills|category=crypto|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=57 resolved 50W-7L -$4.41 toxic=7 Wilson 76.8% vs target 90.5% gap=-13.7pp | validation=102 resolved 93W-9L +$21.06 toxic=9 Wilson 84.1% vs target 91.1% gap=-7.0pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0417-T61499.99 status=active due=2026-07-04T21:00:00+00:00 price=0.94
- rank 3: maker_all_fills|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=single | train=184 resolved 154W-30L -$85.87 toxic=30 Wilson 77.7% vs target 90.4% gap=-12.7pp | validation=158 resolved 141W-17L -$0.02 toxic=17 Wilson 83.4% vs target 91.2% gap=-7.8pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_pnl<=0;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHCHI-26JUL03-B95.5 status=active due=2026-07-04T05:59:00+00:00 price=0.94
- rank 4: maker_all_fills|side=YES|side_bid_band=80-85 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=29 resolved 26W-3L +$11.41 toxic=3 Wilson 73.6% vs target 87.7% gap=-14.1pp | validation=45 resolved 40W-5L +$15.45 toxic=5 Wilson 76.5% vs target 87.5% gap=-11.0pp | blockers=train_resolved<30;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUL012010MINHOU-MIN3 status=active due=2026-07-05T00:10:00+00:00 price=0.88
- rank 5: maker_all_fills|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=42 resolved 37W-5L -$20.23 toxic=5 Wilson 75.0% vs target 94.9% gap=-19.9pp | validation=49 resolved 46W-3L +$4.97 toxic=3 Wilson 83.5% vs target 94.8% gap=-11.3pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUL011235CWSBAL-BAL2 status=active due=2026-07-04T16:35:00+00:00 price=0.91
- rank 6: maker_all_fills|side_bid_band=80-85 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=115 resolved 93W-22L -$59.99 toxic=22 Wilson 72.7% vs target 88.1% gap=-15.4pp | validation=105 resolved 88W-17L -$27.74 toxic=17 Wilson 75.6% vs target 88.4% gap=-12.8pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_pnl<=0;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXHIGHCHI-26JUL03-B93.5 status=active due=2026-07-04T05:59:00+00:00 price=0.92
- rank 7: maker_all_fills|category=crypto|hours_band=<4h | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=157 resolved 84W-73L -$549.19 toxic=73 Wilson 45.7% vs target 90.5% gap=-44.8pp | validation=137 resolved 114W-23L -$77.10 toxic=23 Wilson 76.1% vs target 90.8% gap=-14.8pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_pnl<=0;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none
- rank 8: maker_all_fills|side=YES|side_bid_band=92-94 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=14 resolved 13W-1L -$1.71 toxic=1 Wilson 68.5% vs target 96.1% gap=-27.5pp | validation=26 resolved 25W-1L +$5.19 toxic=1 Wilson 81.1% vs target 96.2% gap=-15.1pp | blockers=train_resolved<30;train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0417-T61499.99 status=active due=2026-07-04T21:00:00+00:00 price=0.94
...
- status: native=NO_LIVE_READY pending=25 active=25 stale=0 unknown=0 | maker=NO_LIVE_READY pending_units=480 active=470 stale=10 unknown=0 | queued=23
- 1. maker_stale:weather_no | ticker=KXHIGHMIA-26JUL03-B88.5 | status=stale | time=2026-07-04T04:59:00+00:00 | closed_unfinalized expiration=2026-07-10T14:00:00+00:00 price=0.94
- 2. maker_stale:weather_no | ticker=KXHIGHMIA-26JUL03-B90.5 | status=stale | time=2026-07-04T04:59:00+00:00 | closed_unfinalized expiration=2026-07-10T14:00:00+00:00 price=0.79
- 3. maker_stale:weather_no | ticker=KXHIGHMIA-26JUL03-B94.5 | status=stale | time=2026-07-04T04:59:00+00:00 | closed_unfinalized expiration=2026-07-10T14:00:00+00:00 price=0.94
- 4. maker_stale:weather_no | ticker=KXHIGHNY-26JUL03-B102.5 | status=stale | time=2026-07-04T04:59:00+00:00 | closed_unfinalized expiration=2026-07-10T14:00:00+00:00 price=0.87
- 5. maker_stale:weather_no | ticker=KXHIGHNY-26JUL03-T98 | status=stale | time=2026-07-04T04:59:00+00:00 | closed_unfinalized expiration=2026-07-10T14:00:00+00:00 price=0.88
- 6. maker:cell_weather_no | ticker=KXHIGHCHI-26JUL03-B89.5 | status=active | time=2026-07-04T05:59:00+00:00 | resolved_indep=110 pending_units=27
- 7. maker:watch_weather_no_ge88 | ticker=KXHIGHCHI-26JUL03-B91.5 | status=active | time=2026-07-04T05:59:00+00:00 | resolved_indep=30 pending_units=6
- 8. native:crypto_last_hour_longshot_no | ticker=KXBTCD-26JUL0402-T62799.99 | status=active | time=2026-07-04T05:59:59.894123+00:00 | resolved=342 pending=1
- 9. maker:cell_weather_yes | ticker=KXHIGHLAX-26JUL03-B73.5 | status=active | time=2026-07-04T07:59:00+00:00 | resolved_indep=26 pending_units=3
- 10. native:weather_no_candidate:no_95_98_zero_loss_cities_v1 | ticker=KXHIGHMIA-26JUL03-B88.5 | status=active | time=2026-07-04T14:00:00+00:00 | resolved=58 pending=13

## Kalshi Academic-Prior Aligned Queue
- command: `python3 scripts/kalshi_academic_prior_queue.py --report --per-family 2`
- KALSHI ACADEMIC-PRIOR ALIGNED QUEUE
- generated_at=2026-07-04T05:11:47.464587+00:00 db=/home/eric-king/kalshi_favorites_bot/trades.db
- Lower rank_score means closer to review, not approval.
- 1. high_price_native_taker:crypto_last_hour_longshot_no | status=NATIVE_FORWARD_ACCUMULATING rank=0.0669 | 342 resolved 307W-35L -$3.50 | Wilson 86.1% vs target 92.8% | next=KXBTCD-26JUL0402-T62799.99 active due=2026-07-04T05:59:59.894123+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
...
- 5. maker_adverse_selection:cell_sports_no | status=NO_GO_REVIEW rank=0.6510 | 467 independent resolved 357W-110L -$515.92 | Wilson 72.4% vs BE 87.5% | toxic=110 fill_rate=28.5% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
...
- recent_36h_backlog: unresolved=1502 | expired_after_60s_grace=1223 | oldest_expired=2026-07-04 04:58:59 | oldest_expected=2026-07-04 04:58:59
- recent_36h_crypto_backlog: unresolved=1336 | expired_after_60s_grace=1185 | oldest_expired=2026-07-04 04:59:59 | oldest_expected=2026-07-04 04:59:59
- native_gate_stale_unresolved=0
- resolved_last_30m=1178
- all_expired_backlog: unresolved=7749 | crypto=7356 | other=352 | weather=41 | oldest_expired=2026-04-15 21:59:59 | newest_expired=2026-07-04 05:00:00
...
- recent_72h_backlog: unresolved=359 | expired_after_60s_grace=91 | oldest_expired=2026-07-04 04:58:59 | oldest_expected=2026-07-04 04:58:59
...
-   5-10c: candidates=64273 fill=0.2% resolved=31 benign/toxic=9/22 net=$-13.96 benign=$+7.48 Wilson=70.1% BE=0.0% margin=+70.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   10-20c: candidates=59255 fill=0.4% resolved=47 benign/toxic=15/32 net=$-16.67 benign=$+44.57 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   20-35c: candidates=59293 fill=0.5% resolved=59 benign/toxic=21/38 net=$-17.84 benign=$+64.14 Wilson=84.5% BE=0.0% margin=+84.5pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   35-50c: candidates=36369 fill=0.6% resolved=41 benign/toxic=15/26 net=$+22.03 benign=$+65.98 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   50-65c: candidates=36074 fill=0.8% resolved=41 benign/toxic=12/29 net=$-42.10 benign=$+50.56 Wilson=75.7% BE=0.0% margin=+75.7pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   65-80c: candidates=31040 fill=0.7% resolved=51 benign/toxic=15/36 net=$-6.55 benign=$+68.80 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   80-90c: candidates=29358 fill=0.7% resolved=58 benign/toxic=15/43 net=$+13.69 benign=$+35.81 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   90-95c: candidates=17397 fill=0.5% resolved=36 benign/toxic=11/25 net=$-16.37 benign=$+10.53 Wilson=74.1% BE=0.0% margin=+74.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   95-99c: candidates=35794 fill=0.2% resolved=40 benign/toxic=7/33 net=$+0.30 benign=$+2.55 Wilson=64.6% BE=0.0% margin=+64.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT

## Timers
```
NEXT                                 LEFT LAST                              PASSED UNIT                                                   ACTIVATES
Sat 2026-07-04 00:11:53 CDT            2s Sat 2026-07-04 00:10:53 CDT      57s ago gemini-ds-index-parity.timer                           gemini-ds-index-parity.service
Sat 2026-07-04 00:11:57 CDT            6s Sat 2026-07-04 00:06:57 CDT 4min 53s ago kalshi-side-equivalence-scanner.timer                  kalshi-side-equivalence-scanner.service
Sat 2026-07-04 00:11:57 CDT            6s Sat 2026-07-04 00:06:57 CDT 4min 53s ago kalshi-weather-no-candidate-preflight.timer            kalshi-weather-no-candidate-preflight.service
Sat 2026-07-04 00:12:00 CDT            9s Sat 2026-07-04 00:11:00 CDT      49s ago cushion-ds-multi-series-scanner.timer                  cushion-ds-multi-series-scanner.service
Sat 2026-07-04 00:12:00 CDT            9s Sat 2026-07-04 00:11:30 CDT      20s ago gemini-cushion-ds-scanner.timer                        gemini-cushion-ds-scanner.service
Sat 2026-07-04 00:12:02 CDT           11s Sat 2026-07-04 00:10:58 CDT      51s ago kalshi-mve-component-result-live-pilot.timer           kalshi-mve-component-result-live-pilot.service
Sat 2026-07-04 00:12:12 CDT           22s Sat 2026-07-04 00:07:02 CDT 4min 47s ago kalshi-weather-high-ask-no-preflight.timer             kalshi-weather-high-ask-no-preflight.service
Sat 2026-07-04 00:12:17 CDT           26s Fri 2026-07-03 23:57:17 CDT    14min ago ds-storage-pressure-monitor.timer                      ds-storage-pressure-monitor.service
Sat 2026-07-04 00:12:20 CDT           30s Sat 2026-07-04 00:07:14 CDT 4min 36s ago kalshi-shadow-longshot-fading-backfill.timer           kalshi-shadow-longshot-fading-backfill.service
Sat 2026-07-04 00:12:24 CDT           33s Sat 2026-07-04 00:11:47 CDT       2s ago kalshi-worldcup-score-state-live-pilot.timer           kalshi-worldcup-score-state-live-pilot.service
Sat 2026-07-04 00:12:25 CDT           34s Sat 2026-07-04 00:11:20 CDT      29s ago kalshi-worldcup-final-state-live-pilot.timer           kalshi-worldcup-final-state-live-pilot.service
Sat 2026-07-04 00:12:27 CDT           37s Sat 2026-07-04 00:11:27 CDT      22s ago gateway-watchdog.timer                                 gateway-watchdog.service
Sat 2026-07-04 00:12:27 CDT           37s Sat 2026-07-04 00:11:27 CDT      22s ago goal-loop-watchdog.timer                               goal-loop-watchdog.service
Sat 2026-07-04 00:12:39 CDT           49s Sat 2026-07-04 00:07:35 CDT 4min 15s ago kalshi-crypto-last-hour-longshot-no-preflight.timer    kalshi-crypto-last-hour-longshot-no-preflight.service
Sat 2026-07-04 00:12:47 CDT           56s Sat 2026-07-04 00:10:47 CDT  1min 3s ago gemini-ds-index-micro-parity.timer                     gemini-ds-index-micro-parity.service
Sat 2026-07-04 00:13:07 CDT      1min 17s Sat 2026-07-04 00:08:07 CDT 3min 42s ago btc-moderate-v2-shadow-scanner.timer                   btc-moderate-v2-shadow-scanner.service
Sat 2026-07-04 00:13:07 CDT      1min 17s Sat 2026-07-04 00:08:07 CDT 3min 42s ago gemini-fp-orderbook-capture.timer                      gemini-fp-orderbook-capture.service
Sat 2026-07-04 00:13:07 CDT      1min 17s Sat 2026-07-04 00:08:07 CDT 3min 42s ago gemini-reward-post-only-safety.timer                   gemini-reward-post-only-safety.service
Sat 2026-07-04 00:13:17 CDT      1min 27s Sat 2026-07-04 00:09:56 CDT 1min 53s ago kalshi-sports-final-state-live-pilot.timer             kalshi-sports-final-state-live-pilot.service
Sat 2026-07-04 00:13:21 CDT      1min 30s Fri 2026-07-03 23:58:21 CDT    13min ago kalshi-side-equivalence-resolver.timer                 kalshi-side-equivalence-resolver.service
Sat 2026-07-04 00:13:45 CDT      1min 55s Sat 2026-07-04 00:08:42 CDT  3min 8s ago kalshi-moderate-favorites-eth-yes-preflight.timer      kalshi-moderate-favorites-eth-yes-preflight.service
Sat 2026-07-04 00:14:00 CDT      2min 10s Sat 2026-07-04 00:08:59 CDT 2min 51s ago kalshi-shadow-deterministic-settlement-backfill.timer  kalshi-shadow-deterministic-settlement-backfill.service
Sat 2026-07-04 00:14:01 CDT      2min 10s Sat 2026-07-04 00:09:01 CDT 2min 49s ago gemini-maker-fill-simulator.timer                      gemini-maker-fill-simulator.service
Sat 2026-07-04 00:14:07 CDT      2min 16s Fri 2026-07-03 23:44:07 CDT    27min ago ds-storage-monitor.timer                               ds-storage-monitor.service
Sat 2026-07-04 00:14:15 CDT      2min 25s Fri 2026-07-03 23:59:15 CDT    12min ago btc-moderate-v2-shadow-resolver.timer                  btc-moderate-v2-shadow-resolver.service
Sat 2026-07-04 00:14:15 CDT      2min 25s Fri 2026-07-03 23:59:15 CDT    12min ago gemini-categorical-scanner.timer                       gemini-categorical-scanner.service
Sat 2026-07-04 00:15:00 CDT       3min 9s Sat 2026-07-04 00:00:00 CDT    11min ago cushion-ds-multi-series-resolver.timer                 cushion-ds-multi-series-resolver.service
Sat 2026-07-04 00:15:00 CDT       3min 9s Sat 2026-07-04 00:00:00 CDT    11min ago gemini-cushion-ds-resolver.timer                       gemini-cushion-ds-resolver.service
Sat 2026-07-04 00:16:09 CDT      4min 19s Sat 2026-07-04 00:11:08 CDT      41s ago kalshi-crypto-ladder-dislocation-preflight.timer       kalshi-crypto-ladder-dislocation-preflight.service
Sat 2026-07-04 00:16:28 CDT      4min 37s Sat 2026-07-04 00:11:23 CDT      27s ago kalshi-crypto-favorite-taker-preflight.timer           kalshi-crypto-favorite-taker-preflight.service
Sat 2026-07-04 00:16:33 CDT      4min 42s Sat 2026-07-04 00:11:31 CDT      19s ago kalshi-other-longshot-no-80-90-preflight.timer         kalshi-other-longshot-no-80-90-preflight.service
Sat 2026-07-04 00:16:39 CDT      4min 48s Sat 2026-07-04 00:11:29 CDT      20s ago kalshi-weather-yes-90-93-preflight.timer               kalshi-weather-yes-90-93-preflight.service
Sat 2026-07-04 00:17:52 CDT          6min Sat 2026-07-04 00:07:51 CDT 3min 59s ago ds-shadow-continuous-archive.timer                     ds-shadow-continuous-archive.service
Sat 2026-07-04 00:18:58 CDT          7min Fri 2026-07-03 21:18:58 CDT 2h 52min ago db-auto-vacuum.timer                                   db-auto-vacuum.service
Sat 2026-07-04 00:19:00 CDT          7min Fri 2026-07-03 23:19:00 CDT    52min ago gemini-db-retention.timer                              gemini-db-retention.service
Sat 2026-07-04 00:19:07 CDT          7min Fri 2026-07-03 23:49:07 CDT    22min ago eth-ds-fg-filter-blocks-resolver.timer                 eth-ds-fg-filter-blocks-resolver.service
Sat 2026-07-04 00:19:19 CDT          7min Sat 2026-07-04 00:04:19 CDT     7min ago gemini-categorical-resolver.timer                      gemini-categorical-resolver.service
Sat 2026-07-04 00:24:04 CDT         12min Fri 2026-07-03 23:54:04 CDT    17min ago gemini-db-size-monitor.timer                           gemini-db-size-monitor.service
Sat 2026-07-04 00:26:17 CDT         14min Sat 2026-07-04 00:11:17 CDT      32s ago gemini-ds-source-parity.timer                          gemini-ds-source-parity.service
Sat 2026-07-04 00:30:00 CDT         18min Fri 2026-07-03 23:30:00 CDT    41min ago gemini-direct-index-ds-first-resolution-verifier.timer gemini-direct-index-ds-first-resolution-verifier.service
Sat 2026-07-04 00:36:01 CDT         24min Fri 2026-07-03 23:34:36 CDT    37min ago ladder-coherence-two-leg-resolver.timer                ladder-coherence-two-leg-resolver.service
Sat 2026-07-04 00:41:01 CDT         29min Fri 2026-07-03 23:40:50 CDT    31min ago macro-release-resolver.timer                           macro-release-resolver.service
Sat 2026-07-04 01:07:00 CDT         55min Sat 2026-07-04 00:07:01 CDT 4min 49s ago claude-partition-arb-scan.timer                        claude-partition-arb-scan.service
Sat 2026-07-04 01:17:00 CDT       1h 5min Fri 2026-07-03 19:17:00 CDT 4h 54min ago ds-shadow-retention-engine.timer                       ds-shadow-retention-engine.service
Sat 2026-07-04 03:15:00 CDT       3h 3min Fri 2026-07-03 03:15:00 CDT            - shadow-verification.timer                              shadow-verification.service
Sat 2026-07-04 03:18:56 CDT       3h 7min Fri 2026-07-03 21:18:56 CDT 2h 52min ago ds-shadow-db-maintenance.timer                         ds-shadow-db-maintenance.service
Sat 2026-07-04 03:24:20 CDT      3h 12min Fri 2026-07-03 21:24:20 CDT 2h 47min ago ds-shadow-archive.timer                                ds-shadow-archive.service
Sat 2026-07-04 03:30:00 CDT      3h 18min Fri 2026-07-03 03:30:00 CDT            - ibkr-independent-verification.timer                    ibkr-independent-verification.service
Sat 2026-07-04 04:13:00 CDT       4h 1min Fri 2026-07-03 16:13:00 CDT       7h ago claude-calibration-logger.timer                        claude-calibration-logger.service
Sat 2026-07-04 04:30:00 CDT      4h 18min Fri 2026-07-03 04:30:00 CDT            - tax-ledger-ingest.timer                                tax-ledger-ingest.service
Sat 2026-07-04 04:49:19 CDT      4h 37min Fri 2026-07-03 04:46:50 CDT            - ds-archive-tier-rotation.timer                         ds-archive-tier-rotation.service
Sat 2026-07-04 05:20:00 CDT       5h 8min Fri 2026-07-03 05:20:01 CDT            - logrotate-user.timer                                   logrotate-user.service
Sat 2026-07-04 05:30:00 CDT      5h 18min Fri 2026-07-03 05:30:01 CDT            - disk-hygiene-audit.timer                               disk-hygiene-audit.service
Sat 2026-07-04 05:30:00 CDT      5h 18min Fri 2026-07-03 05:30:01 CDT            - full-picture-daily-save.timer                          full-picture-daily-save.service
Sat 2026-07-04 05:40:00 CDT      5h 28min Fri 2026-07-03 05:40:00 CDT            - database-autonomous-maintenance.timer                  database-autonomous-maintenance.service
Sat 2026-07-04 06:40:00 CDT            6h -                                      - ibkr-deterministic-fx-poc.timer                        ibkr-deterministic-fx-poc.service
Sat 2026-07-04 09:02:00 CDT            8h Fri 2026-07-03 20:57:00 CDT 3h 14min ago claude-crossing-no-v3.timer                            claude-crossing-no-v3.service
Sat 2026-07-04 09:14:12 CDT            9h Fri 2026-07-03 09:14:12 CDT      14h ago launchpadlib-cache-clean.timer                         launchpadlib-cache-clean.service
Sat 2026-07-04 09:18:56 CDT            9h Fri 2026-07-03 09:18:56 CDT      14h ago gemini-fp-retention.timer                              gemini-fp-retention.service
Sun 2026-07-05 02:00:00 CDT      1 day 1h Sun 2026-06-28 02:00:00 CDT            - gemini-archive-compression.timer                       gemini-archive-compression.service
Fri 2026-07-10 09:16:55 CDT        6 days Fri 2026-07-03 09:16:55 CDT      14h ago ubuntu-insights-upload.timer                           ubuntu-insights-upload.service
Sun 2026-08-02 19:43:55 CDT 4 weeks 1 day Fri 2026-07-03 09:13:55 CDT      14h ago ubuntu-insights-collect.timer                          ubuntu-insights-collect.service
-                                       - Sat 2026-07-04 00:10:00 CDT 1min 50s ago claude-chat-sync.timer                                 claude-chat-sync.service
-                                       - Sat 2026-07-04 00:10:00 CDT 1min 50s ago full-picture-latest-refresh.timer                      full-picture-latest-refresh.service
-                                       - Sat 2026-07-04 00:10:53 CDT      57s ago gemini-liquidity-rewards-scanner.timer                 gemini-liquidity-rewards-scanner.service
-                                       - Fri 2026-07-03 23:22:21 CDT    49min ago gemini-reward-account-monitor.timer                    gemini-reward-account-monitor.service
-                                       - Fri 2026-07-03 23:18:22 CDT    53min ago gemini-reward-inventory-exit.timer                     gemini-reward-inventory-exit.service
-                                       - Fri 2026-07-03 23:46:14 CDT    25min ago gemini-reward-live-readiness.timer                     gemini-reward-live-readiness.service
-                                       - Fri 2026-07-03 23:18:18 CDT    53min ago gemini-reward-quote-pilot.timer                        gemini-reward-quote-pilot.service
-                                       - Sat 2026-07-04 00:11:03 CDT      47s ago gemini-trade-print-capture.timer                       gemini-trade-print-capture.service
-                                       - Sat 2026-07-04 00:11:34 CDT      15s ago kalshi-shadow-forecast-accuracy-backfill.timer         kalshi-shadow-forecast-accuracy-backfill.service
-                                       - Fri 2026-07-03 15:00:00 CDT       9h ago snap.firmware-updater.firmware-notifier.timer          snap.firmware-updater.firmware-notifier.service
...
- operations-knowledge: head=75039c9 branch=master in_sync=true remote=https://github.com/PhotonRahm/operations-knowledge.git dirty=yes
