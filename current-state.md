...
last_updated_utc: 2026-07-03T18:04:27+00:00
pipeline_heartbeat_utc: 2026-07-03T18:04:27+00:00
generator: Codex generate_current_state.py
workspace_head: 0710930

## Chat Startup Critical Summary
- Generated for Claude-in-chat startup at 2026-07-03T13:04:27-05:00; missing artifacts render UNAVAILABLE instead of breaking sync.
- Full-picture artifact: FULL PICTURE - 2026-07-03 01:00 PM
...
- Kalshi reconciliation: Reconciliation: resolved_pnl=$-1500.51 open_cost=$0.52 open_fees=$0.03 recon_adj=$189.81 expected_cash=$1188.75 cash_gap=$+0.00 unrealized=$-0.43 [MATCH]
- IBKR: NLV: $1,949.48
- IBKR state: Status: ⚠️ Flex sync 212h stale | ❌ Gateway DOWN | ❌ KILL switch active
...
- • Combined true P&L: **$-16331.92**
- • True lifetime P&L (bots − one-time − recurring): **$-19195.65**
...
- strategy/cohort excerpts:
  ...
  - Next decision gate: 2026-07-03T19:30:00+00:00 - direct-index DS next resolution (63 rows/5 events unresolved | current qty5: 45 rows/5 events unresolved | micro qty1: 18 rows/5 events unresolved) resolution checks; no live expansion before event-collapsed results
...
- active_enter: Fri 2026-07-03 09:09:17 CDT
- reconciliation:
  - Reconciliation: resolved_pnl=$-1500.51 open_cost=$0.52 open_fees=$0.03 recon_adj=$189.81 expected_cash=$1188.75 cash_gap=$+0.00 unrealized=$-0.43 [MATCH]
  - ✓ HARD CHECK PASSED — gap $0.00
...
- strategy/cohort excerpts:
  ...
  - 24h P&L: -$1.62 (1W-2L resolved, 5 placed)
  ...
  - v1→v2 drops: tier=4981, volume=2791, excluded=1149, category=168, spread=56, nws=52, hours=36
  - [2.5] Moderate Favorites Pilot ($0.80-$0.85 only)
  - Validation vs shadow: shadow WR 82.8% / -$205.00 (spread<=0.05 + allowed assets, matches pilot) | live WR 82.8% | shadow P&L negative; no revival
  ...
  - Mean reversion shadow freshness: last_row=2026-04-22T03:02:54Z age=72.6d live_match_last=2026-04-21T02:43:31Z post_kill_shadow_rows=0 post_kill_live_placements=0 | gate=STALE_NO_FORWARD_EVIDENCE
  ...
  - Forecast accuracy high-ask NO native preflight: rows=47730 events=196 actionable_qty1=858 latest=2026-07-03T18:00:12+00:00 | reasons: missing_native_no_ask=42258, nonpositive_qty1_win:0.0000=3198, actionable_qty1_fee_positive=858, native_no_ask_out_of_band:0.9700=269 | latest_run=2026-07-03T18:00:12+00:00 candidates=20 checked=20 actionable=0 run_reasons={"missing_native_no_ask": 17, "native_no_ask_out_of_band:0.0100": 1, "nonpositive_qty1_win:0.0000": 2}
  - Forecast accuracy high-ask NO latest actionables: captured=2026-07-03T18:00:12+00:00 events=20 actionable_events=0 top_reason=missing_native_no_ask
  ...
  - Forecast accuracy NO candidate-cell preflight: rows=31849 cohorts=2 events=76 actionable_qty1=8757 latest=2026-07-03T18:01:12+00:00 | latest_run=2026-07-03T18:01:12+00:00 candidates=16 checked=16 actionable=4 run_reasons={"no_90_95_min_probe_v1:actionable_qty1_fee_positive": 1, "no_90_95_min_probe_v1:native_no_ask_out_of_band:0.9700": 1, "no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive": 3, "no_95_98_zero_loss_cities_v1:missing_native_no_ask": 6, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9300": 2, "no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9900": 3}
  - Forecast accuracy NO candidate-cell cohorts: no_95_98_zero_loss_cities_v1 rows=28813 events=75 actionable=8022; no_90_95_min_probe_v1 rows=3036 events=10 actionable=735
  - Forecast accuracy NO candidate-cell latest cohort actionables: no_90_95_min_probe_v1 captured=2026-07-03T18:01:12+00:00 events=2 actionable_events=1 best=KXHIGHTMIN-26JUL03-B87.5 city=MIN event=KXHIGHTMIN-26JUL03 due=2026-07-04T19:00:00+00:00 no_ask=0.93 depth=1.00 win1=+$0.06 loss1=-$0.94; no_95_98_zero_loss_cities_v1 captured=2026-07-03T18:01:12+00:00 events=14 actionable_events=3 best=KXHIGHTOKC-26JUL04-B104.5 city=OKC event=KXHIGHTOKC-26JUL04 due=2026-07-05T19:00:00+00:00 no_ask=0.97 depth=5.83 win1=+$0.02 loss1=-$0.98
  ...
  - Legacy weather-city NO shadow: bid>=0.88 first-ticker-side 5446W-260L n=5706 | +$10,365.36 | avg_bid=0.932 | Wilson 94.9% vs modeled BE 93.6% margin=+1.2pp | pending=194 | gate=LEGACY_MAKER_FORWARD_REQUIRED
  - Legacy weather-city NO recency: since_2026-06-17 2034W-81L n=2115 +$4,049.69 pending=192 Wilson 95.3% vs modeled BE 94.3% | forward_since_2026-06-25T09:35Z resolved=972 pending=192 | blocked 1562W-86L +$1,981.40, unblocked 3884W-174L +$8,383.96 | best=KXLOWTNYC 224W-5L +$1,073.43; worst=KXLOWTDEN 225W-19L -$364.54 | next_pending=KXHIGHPHIL-26JUL03-B101.5 city=PHIL due_est=2026-07-04T04:58:59.039229+00:00 ttl_at_capture=14.0h bid=0.90 overdue_pending=2 | bid-side/maker-priced shadow, not taker-executable
  ...
  - Legacy weather-city NO maker/cancel proxy: v2 side_bid>=0.88 candidates=114 markets=57 fills=36 pending_fills=6 resolved_indep=30/50 30W-0L pnl=+$19.74 Wilson 88.6% vs modeled BE 93.4% | cancels=78 late_cross_ttl=16 open=0 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range bid-side shadow: side-aware ticker+side first rows 597W-0L n=597 | +$3,684.42 | Wilson 99.4% vs modeled BE 93.8% | pending=1 | gate=MAKER_FILL_FORWARD_REQUIRED
  - Crypto price-range bid-side recency: since_2026-06-17 119W-0L n=119 +$719.98 pending=1 | forward_since_2026-06-25T07:30Z resolved=72 pending=1 | YES 59W-0L pending=0, NO 43W-0L pending=1 | bid-side shadow, not taker-executable
  - Crypto price-range bid-side event collapse: event-side 102W-0L n=102 +$621.96 pending=1 Wilson 96.4% vs BE 93.9% margin=+2.5pp | event_only 69W-0L n=69 Wilson 94.7% vs BE 93.9% margin=+0.8pp | recent_event_side 30W-0L n=30 Wilson 88.6% vs BE 93.9% | forward_event_side resolved=18 pending=1 | gate=RECENT_EVENT_UNDERPOWERED_MAKER_FORWARD_REQUIRED
  ...
  - Crypto long-expiry maker/cancel proxy: v2 crypto side_bid=0.90-0.95 candidates=471 markets=258 fills=103 pending_fills=0 resolved_indep=103/50 95W-8L pnl=-$14.13 Wilson 85.4% vs modeled BE 93.6% | 24hplus_candidates=93 24hplus_fills=9 24hplus_pending_fills=0 | cancels=345 late_cross_ttl=40 open=23 | gate=MAKER_FILL_FORWARD_REQUIRED
  ...
  - Crypto favorite taker native preflight: rows=9804 cohorts=2 contracts=54 actionable_obs=1956 latest=2026-07-03T18:04:30+00:00 | latest_run=2026-07-03T18:04:30+00:00 candidates=4 checked=4 actionable=0 reasons={"crypto_favorite_no_90_95_12_24h:native_no_ask_out_of_band:0.8800": 1, "crypto_favorite_no_90_95_12_24h:native_no_ask_out_of_band:0.9800": 1, "crypto_near_certain_95_99_12_24h:missing_native_no_ask": 1, "crypto_near_certain_95_99_12_24h:missing_native_yes_ask": 1} | no order path
  - Crypto favorite taker native cohorts: crypto_near_certain_95_99_12_24h rows=7713 contracts=42 actionable_obs=1562; crypto_favorite_no_90_95_12_24h rows=2091 contracts=12 actionable_obs=394
  - Crypto favorite taker latest cohort actionables: crypto_favorite_no_90_95_12_24h captured=2026-07-03T18:04:30+00:00 contracts=2 actionable_contracts=0; crypto_near_certain_95_99_12_24h captured=2026-07-03T18:04:30+00:00 contracts=2 actionable_contracts=0
  ...
  - Crypto contrarian NO recency: since_2026-06-17 13W-14L n=27 +$638.16 pending=0 Wilson 30.7% vs modeled BE 24.5% | forward_since_2026-06-25T10:40Z resolved=9 pending=0 | 2026-04 8W-27L -$37.12, 2026-06 13W-11L +$711.92 | BTC 8W-18L +$167.58 pending=0, ETH 9W-9L +$477.11 pending=0, SOL 4W-14L -$43.65 pending=1 | next_pending=KXSOLD-26APR2417-T83.9999 event=KXSOLD-26APR2417 due_est=2026-04-24T20:59:59.002927+00:00 ttl=-1677.1h ask=0.22 spread=0.09 active_pending=0 stale_pending=1 unknown_pending=0 | exploratory ask-priced shadow; no live orders
  - Crypto last-hour longshot NO shadow: event-first 1190W-77L n=1267 | +$6,266.38 avg_ask=0.883 | Wilson 92.5% vs modeled BE 89.0% | recent 769W-63L +$2,432.56 | gate=LIQUIDITY_PROXY_FAIL_FORWARD_ONLY
  - Crypto last-hour longshot liquidity: volume=0 600W-8L +$6,867.76; volume>=500/spread<=5c 384W-42L -$269.42 Wilson 86.9% vs BE 90.8%; 80-85c volume-backed 35W-5L +$146.99 Wilson 73.9% vs BE 83.8%; 90-95c volume-backed 256W-21L -$113.51 Wilson 88.7% vs BE 92.8%; 95-99c volume-backed 581W-22L -$471.00 Wilson 94.5% vs BE 97.1%; forward_since_2026-06-25T11:20Z 393W-39L +$446.78 Wilson 87.9% vs BE 89.9% resolved=432 pending=4 | no live orders
  - Crypto last-hour longshot native preflight: rows=5586 events=435 actionable_qty1=1473 latest=2026-07-03T18:04:15+00:00 | latest_run=2026-07-03T18:04:15+00:00 candidates=2 checked=2 actionable=2 reasons={"actionable_qty1_fee_positive": 2} | no order path
  - Crypto last-hour longshot latest actionables: captured=2026-07-03T18:04:15+00:00 events=2 contracts=2 actionable_contracts=2 best=KXBTCD-26JUL0315-T62299.99 asset=BTC event=KXBTCD-26JUL0315 due=2026-07-03T18:59:59.511784+00:00 no_ask=0.87 depth=25.00 win1=+$0.12 loss1=-$0.88
  - Crypto last-hour longshot native gate: native_events=326 resolved=324 pending=2 active_pending=2 stale_pending=0 unknown_pending=0 291W-33L native_pnl=-$3.34 Wilson 86.0% vs BE 90.8% next_pending=KXBTCD-26JUL0315-T62299.99 asset=BTC event=KXBTCD-26JUL0315 due=2026-07-03T18:59:59.511784+00:00 no_ask=0.86 depth=2626.00 win1=+$0.13 loss1=-$0.87 | gate=NATIVE_FORWARD_ACCUMULATING
  ...
  - Summary: rows=7173 open=194 fills=1803 markets=1625 cancels=5176 late_cross_ttl=447 resolved=1328 markets=1231 pnl=-2696.04 last=2026-07-03T18:03:05+00:00
  - Pending fills: unresolved=475 markets=394 next=KXETHD-26JUL0317-T949.99 crypto NO close=2026-07-03T21:00:00+00:00 expiration=2026-07-10T21:00:00+00:00 | units=475 active=475 stale=0 unknown=0
  - Overall independent fills: resolved=1328 895W-433L pnl=-2696.04 wilson_low=64.8% breakeven=87.7% toxic=433 status=NO_GO_REVIEW
  ...
  - Cell scan: resolved_cells=7 edge_positive_cells=0 leader=sports NO resolved_indep=388 best_edge_positive=none best_alternate=crypto YES resolved_indep=300 173W-127L pnl=-866.89 wilson_low=52.0% breakeven=86.6% toxic=127 status=NO_GO_REVIEW
  - KALSHI CRYPTO LOW-PRICE NO CELL AUDIT
  - Status: SHADOW_ONLY | broad low-price NO kill=present | standard DS kill=present
  - NO <10c first-market: n=8 4W-4L wr=50.0% wilson_low=21.5% breakeven=4.5% pnl=+3.66 avg=+0.4575
  - NO <10c first-eligible: n=8 4W-4L wr=50.0% wilson_low=21.5% breakeven=4.5% pnl=+3.66 avg=+0.4575
  - NO <10c concentration: underliers=2 top=BTC n=7 share=87.5% pnl=+2.76 worst=SOL n=1 pnl=+0.90
  - NO <10c day stability: days=2 positive=1 losing=1 worst=2026-06-26 n=2 pnl=-0.06
  - NO <10c UTC-hour stability: hours=3 positive=2 losing=1 worst=19Z n=2 pnl=-0.06
  - Post-kill NO <10c first-market: n=8 4W-4L wr=50.0% wilson_low=21.5% breakeven=4.5% pnl=+3.66 avg=+0.4575
  - Post-kill NO <10c first-eligible: n=8 4W-4L wr=50.0% wilson_low=21.5% breakeven=4.5% pnl=+3.66 avg=+0.4575
  - Review: post-kill NO <10c first-eligible progress 8/50 status=ACCUMULATING reason=native taker NO ask <10c evidence absent
  - Post-kill NO <10c first-eligible concentration: underliers=2 top=BTC n=7 share=87.5% pnl=+2.76 worst=SOL n=1 pnl=+0.90
  - Post-kill NO <10c first-eligible day stability: days=2 positive=1 losing=1 worst=2026-06-26 n=2 pnl=-0.06
  - Post-kill NO <10c first-eligible UTC-hour stability: hours=3 positive=2 losing=1 worst=19Z n=2 pnl=-0.06
  - Post-kill NO <10c first-eligible loss cluster: losses=4 loss_hours=2 top_hour=19Z top_hour_losses=2/4 share=50.0% top_underlier=BTC 2/2 | excluding_top_loss_hour=POST_HOC_FORWARD_ONLY n=6 4W-2L pnl=+3.72 Wilson 30.0% vs modeled BE 5.0%
  - Post-kill NO <10c first-eligible source provenance: rows=8 sources=1 top=kalshi.shadow_deterministic_settlement n=8 distinct_source_row_ids=8 missing_source_row_ids=0
  - Post-kill NO <10c first-eligible native source check: source_ids=8 checked=5 native_taker_ask_lt10c=0/5 min=0.7300 avg=0.9360 max=0.9900
  - Fresh non-04Z NO <10c first-eligible: n=8 4W-4L wr=50.0% wilson_low=21.5% breakeven=4.5% pnl=+3.66 avg=+0.4575
  - Forward gate: fresh non-04Z NO <10c first-eligible start=2026-06-25T08:30:00+00:00 excluded_hour=04Z progress 8/50 pending_markets=0 status=ACCUMULATING reason=resolved 8/50; needs 42 new markets after pending; native taker NO ask <10c evidence absent
  - Fresh non-04Z NO <10c first-eligible pending horizon: resolved=8/50 pending_markets=0 max_if_all_pending_resolve=8/50 need_new_after_pending=42 next_due=unknown last_due=unknown next_backfill_after=unknown last_backfill_after=unknown
  - Fresh 04Z excluded-control NO <10c first-eligible: no resolved rows
  - Fresh non-04Z NO <10c first-eligible source provenance: rows=8 sources=1 top=kalshi.shadow_deterministic_settlement n=8 distinct_source_row_ids=8 missing_source_row_ids=0
  - Fresh non-04Z NO <10c first-eligible native source check: source_ids=8 checked=5 native_taker_ask_lt10c=0/5 min=0.7300 avg=0.9360 max=0.9900
  - Fresh non-04Z NO <10c first-eligible concentration: underliers=2 top=BTC n=7 share=87.5% pnl=+2.76 worst=SOL n=1 pnl=+0.90
  - Fresh non-04Z NO <10c first-eligible day stability: days=2 positive=1 losing=1 worst=2026-06-26 n=2 pnl=-0.06
  - Fresh non-04Z NO <10c first-eligible UTC-hour stability: hours=3 positive=2 losing=1 worst=19Z n=2 pnl=-0.06
  ...
  - Post-kill NO <10c first-eligible pending horizon: resolved=8/50 pending_markets=0 max_if_all_pending_resolve=8/50 need_new_after_pending=42 next_due=unknown last_due=unknown next_backfill_after=unknown last_backfill_after=unknown
  - Post-kill NO <10c first-eligible live pending preview: pending_first_eligible=0 live_actionable=0 settlement_pending_or_ineligible=0 now=2026-07-03T18:04:42+00:00 | no order path
  - Pilot readiness: NOT_READY | proposed_strategy=kalshi_crypto_no_lt10c_first_eligible_pilot | new identity required; do not revive ds_low_price_no | reason=resolved 8/50; needs 42 new markets after pending; native taker NO ask <10c evidence absent
  ...
  - Pending native-actionable rows: FX=1403
  - Gate: failed; native executable rows disprove Index/FX favorite-tracking salvage

## Storage State
- DATABASE STORAGE HEALTH
-   Overall status: GREEN / TARGET
-   Disk: 163.87 GiB used / 936.79 GiB total (17.5%), 725.26 GiB free
-   Envelope: TARGET 50.0%, WARN 65.0%, CRITICAL 75.0%, HARD_LIMIT 85.0%
-   DS storage: active 1.17 GiB (state TARGET), hot 30.99 GiB, warm 0.02 GiB, cold 0.00 GiB, archive_state TARGET_EXCEEDED, total 32.21 GiB (3.4% of disk)
-   Archive sidecars: OK
...
- latest_run: id=26 captured_at=2026-07-03T17:28:33+00:00 | markets_seen=100000 post_expiration_open_unresolved=208 candidate_count=0 | direct_market_recheck=True pages=100 page_cap=True rate_limited=False | trigger_fields={"expected_expiration_time": 208} | top_series=KXMVESPORTSMULTIGAMEEXTENDED=150, KXMVECROSSCATEGORY=58
...
- latest_run: id=23 captured_at=2026-07-03T17:27:42+00:00 | markets_seen=100000 post_close_open_unresolved=0 candidates=0 min_age_min=1.00 max_ask=0.25 max_spread=0.15 min_depth=1 | pages=100 page_cap=true rate_limited=false | categories=none | top_series=unknown
...
- latest_run: id=28 captured_at=2026-07-03T17:26:50+00:00 | markets_seen=100000 public_result_active=0 candidates=0 max_ask=0.25 max_spread=0.15 min_depth=1 | pages=100 page_cap=true rate_limited=false | results=none | categories=none | top_series=unknown
...
- latest_run: id=18 captured_at=2026-07-03T17:31:56+00:00 | version=event_result_propagation_v1 events_seen=6907 events_examined=3162 mutex_events=1001 details=1000/1000 detail_cap=true markets=6754 locked=0 actionable_qty1=0 max_ask=0.25 min_depth=1 | pages=35 page_cap=false rate_limited=false | reasons=event_not_mutually_exclusive_summary=2161, no_exhaustive_proof=1000, detail_cap_reached=1
...
- reasons: resolved 8/50; wilson 21.5% < 90.0%; open_filled_trades=6; source reconciliation checked 189/8; source reconciliation mismatches 40; native taker NO ask <10c evidence absent
- resolved: 8/50 | 4W-4L | pnl=+3.66 | wilson=21.5%
- pending: 0 markets | max_if_pending=8/50 | need_new_after_pending=42
- risk: open_filled=6 | sports_open=0 | live_maker_open_like=0
...
- fresh_non04z_review: status=NOT_READY | ready=false | reason=fresh gate status ACCUMULATING; resolved 8/50; wilson 21.5% < 90.0%; open_filled_trades=6; source reconciliation checked 177/8; source reconciliation mismatches 40; native taker NO ask <10c evidence absent | resolved=8/50 | 4W-4L | pnl=+3.66 | wilson=21.5% | pending=0 | shadow_live_actionable=0 | native_taker_actionable=0 | native_taker_blocked=0 | expired_unresolved=0 | next_backfill_after=unknown | source_reconciliation=177/177 mismatches=40 | native_taker_ask_lt10c=0/172
...
- status: NO_LIVE_READY | ready=false | cells=9 | ready_cells=0 | min_resolved=30 | edge_buffer=+2.0pp | pending=25 active=25 stale=0 unknown=0 | next_pending=crypto_last_hour_longshot_no:KXBTCD-26JUL0315-T62299.99 status=active due=2026-07-03T18:59:59.511784+00:00
- best: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=326 resolved=324 pending=2 active=2 stale=0 unknown=0 | 291W-33L | pnl=-3.34 | Wilson 86.0% vs BE 90.8% | gap=-4.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=314 | next_pending=KXBTCD-26JUL0315-T62299.99 status=active due=2026-07-03T18:59:59.511784+00:00 ask=0.86
- rank 1: crypto_last_hour_longshot_no | gate=NATIVE_FORWARD_ACCUMULATING | native_events=326 resolved=324 pending=2 active=2 stale=0 unknown=0 | 291W-33L | pnl=-3.34 | Wilson 86.0% vs BE 90.8% | gap=-4.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=314 | next_pending=KXBTCD-26JUL0315-T62299.99 status=active due=2026-07-03T18:59:59.511784+00:00 ask=0.86
...
- rank 3: crypto_favorite_taker:crypto_near_certain_95_99_12_24h | gate=NATIVE_FORWARD_ACCUMULATING | native_events=39 resolved=37 pending=2 active=2 stale=0 unknown=0 | 36W-1L | pnl=-0.12 | Wilson 86.2% vs BE 97.6% | gap=-11.5pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=1538 | next_pending=KXSOLD-26JUL0317-T76.9999 status=active due=2026-07-03T20:59:59.685416+00:00 ask=0.97
...
- rank 5: weather_yes_90_93:yes_90_93_above_live_threshold_v1 | gate=NATIVE_FORWARD_ACCUMULATING | native_events=20 resolved=19 pending=1 active=1 stale=0 unknown=0 | 18W-1L | pnl=+0.42 | Wilson 75.4% vs BE 92.5% | gap=-17.2pp | blockers=resolved<30; wilson<BE+2pp | perfect_wins_needed=81 | next_pending=KXLOWTPHIL-26JUL03-B82.5 status=active due=2026-07-04T19:00:00+00:00 ask=0.92
...
- status: NO_NATIVE_CUT_READY | ready=false | observations=14602 | cuts=2284 | display_cuts=485 | candidate_cuts=0 | ready_cuts=0 | min_resolved=30 | min_display_resolved=10 | edge_buffer=+2.0pp | scope=posthoc_native_executable_cut_discovery_requires_predeclared_forward_gate
...
- rank 2: crypto_last_hour_longshot_no|minutes_to_expiry_band=20-40m|native_ask_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=57 resolved=57 pending=0 active=0 stale=0 unknown=0 | 54W-3L | pnl=+$6.22 | Wilson 85.6% vs target 85.8% (BE 83.8%) | gap=-0.2pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=1
...
- rank 4: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=44 resolved=43 pending=1 active=1 stale=0 unknown=0 | 41W-2L | pnl=+$3.73 | Wilson 84.5% vs target 88.7% (BE 86.7%) | gap=-4.1pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=18 | next_pending=KXBTCD-26JUL0315-T62299.99 status=active due=2026-07-03T18:59:59.511784+00:00 ask=0.86
- rank 5: crypto_last_hour_longshot_no|native_ask_band=85-90 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=184 resolved=182 pending=2 active=2 stale=0 unknown=0 | 165W-17L | pnl=+$4.18 | Wilson 85.6% vs target 90.3% (BE 88.3%) | gap=-4.8pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=94 | next_pending=KXBTCD-26JUL0315-T62299.99 status=active due=2026-07-03T18:59:59.511784+00:00 ask=0.86
- rank 6: crypto_last_hour_longshot_no|minutes_to_expiry_band=40-60m|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=pair | observations=199 resolved=198 pending=1 active=1 stale=0 unknown=0 | 186W-12L | pnl=+$1.65 | Wilson 89.7% vs target 95.1% (BE 93.1%) | gap=-5.4pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=225 | next_pending=KXSOLD-26JUL0315-T81.9999 status=active due=2026-07-03T18:59:59.755272+00:00 ask=0.91
- rank 7: crypto_last_hour_longshot_no|native_spread_band=<=1c | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=282 resolved=281 pending=1 active=1 stale=0 unknown=0 | 257W-24L | pnl=+$0.76 | Wilson 87.6% vs target 93.2% (BE 91.2%) | gap=-5.6pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=236 | next_pending=KXBTCD-26JUL0315-T62299.99 status=active due=2026-07-03T18:59:59.511784+00:00 ask=0.86
- rank 8: crypto_last_hour_longshot_no|native_ask_band=90-95 | gate=NATIVE_CUT_ACCUMULATING | type=single | observations=276 resolved=275 pending=1 active=1 stale=0 unknown=0 | 256W-19L | pnl=+$0.12 | Wilson 89.5% vs target 95.0% (BE 93.0%) | gap=-5.6pp | blockers=wilson<BE+2pp | promotion_blockers=none | perfect_wins_needed=318 | next_pending=KXSOLD-26JUL0315-T81.9999 status=active due=2026-07-03T18:59:59.755272+00:00 ask=0.91
...
- best: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=58 resolved=58 pending=0 active=0 stale=0 unknown=0 | 49W-9L | pnl=$-3.92 | Wilson 73.1% vs target 93.2% (BE 91.2%) | gap=-20.2pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=190 | excluded_post_start_actionables=261 (native_spread_band=<=5c=82, native_spread_band=<=2c=68, native_depth_band=1000+=66, native_depth_band=10-99=32) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=139 (not_actionable=139) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 1: native_watch|crypto_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=58 resolved=58 pending=0 active=0 stale=0 unknown=0 | 49W-9L | pnl=$-3.92 | Wilson 73.1% vs target 93.2% (BE 91.2%) | gap=-20.2pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=190 | excluded_post_start_actionables=261 (native_spread_band=<=5c=82, native_spread_band=<=2c=68, native_depth_band=1000+=66, native_depth_band=10-99=32) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_depth_band=10-99 ask=0.85 | target_window_misses=139 (not_actionable=139) | target_window_sample=KXBTCD-26JUL0108-T58799.99 not_actionable ask=0.99
- rank 2: native_watch|crypto_strong_no_90_95 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T11:00:00+00:00 | observations=42 resolved=42 pending=0 active=0 stale=0 unknown=0 | 34W-8L | pnl=$-5.16 | Wilson 66.7% vs target 95.2% (BE 93.2%) | gap=-28.5pp | blockers=pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=285 | excluded_post_start_actionables=274 (signal_tier=weak=101, signal_tier=moderate=87, native_ask_band=85-90=44, native_ask_band=95-98=26) | excluded_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89 | target_window_misses=574 (not_actionable_native_ask_band=missing=159, not_actionable_native_ask_band=<80=102, not_actionable_native_ask_band=95-98=83, not_actionable_native_ask_band=98-99=74) | target_window_sample=KXBTCD-26JUL0108-T58799.99 native_ask_band=85-90 ask=0.89
- rank 3: native_watch|crypto_20_40m_no_80_85 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-29T11:05:00+00:00 | observations=27 resolved=27 pending=0 active=0 stale=0 unknown=0 | 25W-2L | pnl=$+2.34 | Wilson 76.6% vs target 85.9% (BE 83.9%) | gap=-9.3pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=21 | excluded_post_start_actionables=799 (minutes_band=40-60m=443, native_ask_band=90-95=135, native_ask_band=85-90=78, minutes_band=10-20m=72) | excluded_sample=KXBTCD-26JUN2908-T60299.99 minutes_band=40-60m ask=0.95 | target_window_misses=1122 (not_actionable_native_ask_band=98-99=206, not_actionable_native_ask_band=missing=197, not_actionable_native_ask_band=99+=169, not_actionable_native_ask_band=95-98=156) | target_window_sample=KXBTCD-26JUN2908-T60299.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 4: native_watch|crypto_btc_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-06-30T07:13:19+00:00 | observations=28 resolved=27 pending=1 active=1 stale=0 unknown=0 | 20W-7L | pnl=$-3.91 | Wilson 55.3% vs target 90.6% (BE 88.6%) | gap=-35.2pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=121 | next_pending=KXBTCD-26JUL0315-T62299.99 status=active due=2026-07-03T18:59:59.511784+00:00 ask=0.86 | excluded_post_start_actionables=580 (asset=SOL=216, asset=ETH=177, native_ask_band=90-95=123, native_ask_band=95-98=43) | excluded_sample=KXBTCD-26JUN3005-T59699.99 native_ask_band=90-95 ask=0.94 | target_window_misses=972 (not_actionable_native_ask_band=missing=374, not_actionable_native_ask_band=98-99=124, native_ask_band=90-95=123, not_actionable_native_ask_band=95-98=104) | target_window_sample=KXBTCD-26JUN3004-T59799.99 not_actionable_native_ask_band=98-99 ask=0.98
- rank 5: native_watch|crypto_spread_le1_depth_10_99 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T07:10:00+00:00 | observations=26 resolved=25 pending=1 active=1 stale=0 unknown=0 | 20W-5L | pnl=$-2.61 | Wilson 60.9% vs target 92.4% (BE 90.4%) | gap=-31.6pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=126 | next_pending=KXBTCD-26JUL0315-T62299.99 status=active due=2026-07-03T18:59:59.511784+00:00 ask=0.87 | excluded_post_start_actionables=373 (native_depth_band=100-999=139, native_spread_band=<=5c=84, native_spread_band=<=2c=70, native_depth_band=1000+=67) | excluded_sample=KXBTCD-26JUL0104-T58899.99 native_depth_band=100-999 ask=0.93 | target_window_misses=37 (not_actionable=37) | target_window_sample=KXSOLD-26JUL0107-T75.9999 not_actionable ask=0.99
- rank 6: native_watch|crypto_sol_no_85_90 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T13:00:00+00:00 | observations=18 resolved=17 pending=1 active=1 stale=0 unknown=0 | 16W-1L | pnl=$+0.92 | Wilson 73.0% vs target 90.7% (BE 88.7%) | gap=-17.7pp | blockers=resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=40 | next_pending=KXSOLD-26JUL0315-T81.9999 status=active due=2026-07-03T18:59:59.755272+00:00 ask=0.86 | excluded_post_start_actionables=320 (asset=BTC=147, asset=ETH=90, native_ask_band=90-95=52, native_ask_band=80-85=20) | excluded_sample=KXBTCD-26JUL0110-T59199.99 asset=BTC ask=0.93 | target_window_misses=299 (not_actionable_native_ask_band=missing=69, native_ask_band=90-95=52, not_actionable_native_ask_band=99+=45, not_actionable_native_ask_band=<80=44) | target_window_sample=KXSOLD-26JUL0111-T79.9999 not_actionable_native_ask_band=missing
- rank 7: native_watch|crypto_btc_strong_no_90_95_spread_le1_depth_100_999 | gate=FORWARD_WATCH_ACCUMULATING | start=2026-07-01T14:00:00+00:00 | observations=12 resolved=12 pending=0 active=0 stale=0 unknown=0 | 11W-1L | pnl=$-0.23 | Wilson 64.6% vs target 95.6% (BE 93.6%) | gap=-31.0pp | blockers=resolved<30;pnl<=0;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=113 | excluded_post_start_actionables=322 (asset=SOL=123, asset=ETH=90, native_depth_band=1000+=44, signal_tier=moderate=18) | excluded_sample=KXETHD-26JUL0111-T1609.99 asset=ETH ask=0.90 | target_window_misses=74 (not_actionable_native_ask_band=95-98=20, not_actionable_native_ask_band=99+=15, native_ask_band=85-90=12, not_actionable_native_ask_band=<80=10) | target_window_sample=KXBTCD-26JUL0112-T60099.99 native_ask_band=85-90 ask=0.89
- rank 8: native_watch|crypto_tue_no_any_ask | gate=FORWARD_WATCH_WAITING | start=2026-07-01T07:10:00+00:00 | observations=0 resolved=0 pending=0 active=0 stale=0 unknown=0 | 0W-0L | pnl=$+0.00 | Wilson 0.0% vs target 2.0% (BE 0.0%) | gap=-2.0pp | blockers=no_forward_observations;resolved<30;wilson<BE+buffer | promotion_blockers=predeclared_forward_only_until_gate_ready | perfect_wins_needed=>5000_or_target_impossible | excluded_post_start_actionables=406 (captured_weekday=Thu=165, captured_weekday=Wed=133, captured_weekday=Fri=108) | excluded_sample=KXBTCD-26JUL0104-T58899.99 captured_weekday=Wed ask=0.93

## Kalshi Native Preflight Walk-Forward Validation
- command: `python3 scripts/kalshi_native_preflight_walkforward.py --limit 8`
- status: NO_WALKFORWARD_NATIVE_CUT | ready=false | observations=14602 | cuts=2284 | display_cuts=224 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-29T22:46:03+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_walkforward_native_cut_validation_requires_predeclared_forward_gate
...
- rank 5: crypto_last_hour_longshot_no|shadow_entry_band=80-85 | gate=WALKFORWARD_REJECT | type=single | train=21 resolved 19W-2L +$0.73 Wilson 71.1% vs target 89.0% gap=-17.9pp | validation=22 resolved 22W-0L +$3.00 Wilson 85.1% vs target 88.4% gap=-3.3pp | blockers=train_resolved<30;train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXBTCD-26JUL0315-T62299.99 status=active due=2026-07-03T18:59:59.511784+00:00 ask=0.86
- rank 6: crypto_last_hour_longshot_no|signal_tier=moderate|native_ask_band=90-95 | gate=WALKFORWARD_REJECT | type=pair | train=40 resolved 39W-1L +$1.85 Wilson 87.1% vs target 94.9% gap=-7.8pp | validation=36 resolved 36W-0L +$2.61 Wilson 90.4% vs target 94.8% gap=-4.4pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
- rank 7: crypto_last_hour_longshot_no|signal_tier=moderate | gate=WALKFORWARD_REJECT | type=single | train=50 resolved 45W-5L +$0.34 Wilson 78.6% vs target 91.3% gap=-12.7pp | validation=43 resolved 41W-2L +$2.35 Wilson 84.5% vs target 91.9% gap=-7.3pp | blockers=train_wilson<BE+buffer;validation_wilson<BE+buffer | promotion_blockers=none
...
- rank 2: crypto_last_hour_native_subcell:strong:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=157 resolved=157 pending=0 active=0 stale=0 unknown=0 | 142W-15L | pnl=-4.26 | Wilson 84.8% vs BE 93.2% | gap=-8.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=349
- rank 3: crypto_last_hour_native_subcell:weak:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=true | native_events=76 resolved=74 pending=2 active=2 stale=0 unknown=0 | 63W-11L | pnl=-1.77 | Wilson 75.3% vs BE 87.5% | gap=-12.2pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=109 | next_pending=KXBTCD-26JUL0315-T62299.99 status=active due=2026-07-03T18:59:59.511784+00:00 ask=0.86
- rank 4: crypto_last_hour_native_subcell:native_ask:80-90 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=142 resolved=140 pending=2 active=2 stale=0 unknown=0 | 122W-18L | pnl=+0.32 | Wilson 80.6% vs BE 86.9% | gap=-6.3pp | blockers=wilson<BE+2pp | perfect_wins_needed=111 | next_pending=KXBTCD-26JUL0315-T62299.99 status=active due=2026-07-03T18:59:59.511784+00:00 ask=0.86
- rank 5: crypto_last_hour_native_subcell:native_ask:90-95 | gate=NATIVE_FORWARD_ACCUMULATING | mapped_shadow_candidate=false | native_events=140 resolved=140 pending=0 active=0 stale=0 unknown=0 | 129W-11L | pnl=-1.42 | Wilson 86.5% vs BE 93.2% | gap=-6.7pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=262
...
- status: NO_ENTRY_TIMING_CANDIDATE | ready=false | posthoc_candidates=0 | source_actionable_rows=1475 | selected_observations=817 | cuts=375 | min_resolved=30 | edge_buffer=+2.0pp
- best: crypto_last_hour_entry_timing:latest_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=171 resolved=170 pending=1 | 164W-6L | pnl=+$4.93 | Wilson 92.5% vs target 95.6% (BE 93.6%) | gap=-3.0pp | blockers=wilson<BE+2pp
- rank 1: crypto_last_hour_entry_timing:latest_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=171 resolved=170 pending=1 | 164W-6L | pnl=+$4.93 | Wilson 92.5% vs target 95.6% (BE 93.6%) | gap=-3.0pp | blockers=wilson<BE+2pp
- rank 2: crypto_last_hour_entry_timing:first_actionable|signal_tier=weak|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=39 resolved=37 pending=2 | 36W-1L | pnl=+$3.52 | Wilson 86.2% vs target 89.7% (BE 87.7%) | gap=-3.6pp | blockers=wilson<BE+2pp
- rank 3: crypto_last_hour_entry_timing:first_actionable|asset=SOL|native_ask_band=85-90 | gate=ENTRY_TIMING_ACCUMULATING | observations=36 resolved=35 pending=1 | 34W-1L | pnl=+$3.02 | Wilson 85.5% vs target 90.5% (BE 88.5%) | gap=-5.0pp | blockers=wilson<BE+2pp
- rank 4: crypto_last_hour_entry_timing:latest_actionable|signal_tier=moderate|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=53 resolved=53 pending=0 | 52W-1L | pnl=+$2.52 | Wilson 90.1% vs target 95.4% (BE 93.4%) | gap=-5.3pp | blockers=wilson<BE+2pp
- rank 5: crypto_last_hour_entry_timing:first_actionable|native_spread_band=<=1c | gate=ENTRY_TIMING_ACCUMULATING | observations=227 resolved=226 pending=1 | 208W-18L | pnl=+$1.65 | Wilson 87.8% vs target 93.3% (BE 91.3%) | gap=-5.5pp | blockers=wilson<BE+2pp
- rank 6: crypto_last_hour_entry_timing:first_actionable|native_depth_band=1000+ | gate=ENTRY_TIMING_ACCUMULATING | observations=84 resolved=83 pending=1 | 79W-4L | pnl=+$2.65 | Wilson 88.3% vs target 93.9% (BE 91.9%) | gap=-5.7pp | blockers=wilson<BE+2pp
- rank 7: crypto_last_hour_entry_timing:latest_actionable|asset=BTC|native_ask_band=95-98 | gate=ENTRY_TIMING_ACCUMULATING | observations=45 resolved=45 pending=0 | 45W-0L | pnl=+$1.80 | Wilson 92.1% vs target 98.0% (BE 96.0%) | gap=-5.9pp | blockers=wilson<BE+2pp
- rank 8: crypto_last_hour_entry_timing:latest_le_20m_actionable|native_ask_band=90-95 | gate=ENTRY_TIMING_ACCUMULATING | observations=49 resolved=49 pending=0 | 48W-1L | pnl=+$2.32 | Wilson 89.3% vs target 95.2% (BE 93.2%) | gap=-5.9pp | blockers=wilson<BE+2pp

## Kalshi Crypto Ladder Dislocation Preflight
- command: `python3 scripts/kalshi_crypto_ladder_dislocation_preflight.py --json`
- latest_run: captured_at=2026-07-03T18:04:52+00:00 | lookahead=75m | events=5 rows_per_event=40 | candidates=101 checked=101 dislocation_qty1=0 | min_source_edge=0.03 max_source_age=300s | top_reasons=missing_native_no_ask=100, source_edge_below_min:-0.1100=1
- latest_rows: KXSOLD-26JUL0315-T81.9999 SOL/weak source_no=0.80 native_no_ask=0.91 edge=-0.11 age=160s spread=0.02 depth=201 win=0.08 due=2026-07-03T18:59:59.755272+00:00 reason=source_edge_below_min:-0.1100 ; KXETHD-26JUL0315-T1759.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=161s spread=missing depth=0 win=missing due=2026-07-03T18:59:59.216958+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0315-T1799.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=161s spread=missing depth=0 win=missing due=2026-07-03T18:59:59.227042+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0315-T1819.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=161s spread=missing depth=0 win=missing due=2026-07-03T18:59:59.231775+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0315-T1839.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=161s spread=missing depth=0 win=missing due=2026-07-03T18:59:59.236901+00:00 reason=missing_native_no_ask ; KXETHD-26JUL0315-T1859.99 ETH/extreme source_no=0.99 native_no_ask=missing edge=missing age=161s spread=missing depth=0 win=missing due=2026-07-03T18:59:59.242612+00:00 reason=missing_native_no_ask
...
- best: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=59 resolved=59 pending=0 active=0 stale=0 | 41W-18L pnl_qty1=-$7.46 | Wilson 56.9% vs target 84.1% gap=-27.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=114
- rank 1: event_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=59 resolved=59 pending=0 active=0 stale=0 | 41W-18L pnl_qty1=-$7.46 | Wilson 56.9% vs target 84.1% gap=-27.3pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=114
- rank 2: ticker_first | gate=LADDER_DISLOCATION_ACCUMULATING | observations=62 resolved=62 pending=0 active=0 stale=0 | 43W-19L pnl_qty1=-$8.29 | Wilson 57.0% vs target 84.7% gap=-27.7pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=126
- rank 3: all_rows | gate=LADDER_DISLOCATION_ACCUMULATING | observations=93 resolved=93 pending=0 active=0 stale=0 | 60W-33L pnl_qty1=-$13.78 | Wilson 54.4% vs target 81.3% gap=-26.9pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=148
...
- rank 6: asset_sol | gate=LADDER_DISLOCATION_ACCUMULATING | observations=45 resolved=45 pending=0 active=0 stale=0 | 30W-15L pnl_qty1=-$5.05 | Wilson 52.1% vs target 79.9% gap=-27.8pp | blockers=pnl<=0; wilson<BE+2pp | perfect_wins_needed=72
...
- status: live_rows=1 dry_runs=4 filled_rows=0 cancelled_rows=0 | strategy_open=0 strategy_open_cost=$0.00 | all_live_pilot_open=6 all_live_pilot_cost=$0.55
...
- status: live_rows=1 dry_runs=0 filled_rows=0 cancelled_rows=0 | strategy_open=0 strategy_open_cost=$0.00 | all_live_pilot_open=6 all_live_pilot_cost=$0.55
...
- status: live_rows=1 dry_runs=1 filled_rows=1 cancelled_rows=0 | strategy_open=1 strategy_open_cost=$0.05 | all_live_pilot_open=6 all_live_pilot_cost=$0.55
...
- latest_run: captured_at=2026-07-03T17:11:20+00:00 | markets_checked=128 parsed=128 espn_games=2 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWNBAPTS,KXWNBAREB,KXWNBAAST,KXWNBA3PT dates=2026-07-03 | state_games=2 titles=128 title_failures=0 summary_fetches=2 | counts=KXWNBA3PT=26, KXWNBAAST=11, KXWNBAPTS=49, KXWNBAREB=42 | reasons=wnba_player_boxscore_not_current=128
...
- status: live_rows=1 dry_runs=0 filled_rows=1 cancelled_rows=0 | strategy_open=0 strategy_open_cost=$0.00 | all_live_pilot_open=6 all_live_pilot_cost=$0.55
...
- latest_run: captured_at=2026-07-03T17:12:21+00:00 | markets_checked=14 parsed=14 espn_games=7 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXAFLGAME dates=2026-07-03,2026-07-04,2026-07-05,2026-07-06,2026-07-09,2026-07-10 | state_games=7 | counts=KXAFLGAME=14 | reasons=afl_game_not_final=14
...
- latest_run: captured_at=2026-07-03T17:12:21+00:00 | markets_checked=8 parsed=8 official_games=93 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXCFLGAME dates=2026-07-03,2026-07-04,2026-07-05,2026-07-09 | state_games=4 rounds_raw=27 tournaments_raw=93 supported_games=93 | counts=KXCFLGAME=8 | source_errors=0 | reasons=cfl_game_not_final=8
...
- latest_run: captured_at=2026-07-03T17:12:21+00:00 | markets_checked=44 parsed=44 official_games=22 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXKBOGAME,KXNPBGAME dates=2026-07-04,2026-07-05 | state_games=22 | counts=KXKBOGAME=20, KXNPBGAME=24 | source_errors=0 | reasons=npb_game_not_final=24, kbo_game_not_final=20
...
- latest_run: captured_at=2026-07-03T17:12:21+00:00 | markets_checked=68 parsed=68 official_games=50 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXLMBGAME dates=2026-07-03,2026-07-02,2026-07-04,2026-07-05,2026-07-06 | state_games=35 schedule_games=50 teams=20 | counts=KXLMBGAME=68 | source_errors=0 | reasons=lmb_game_not_final=52, no_matching_official_lmb_game_state=10, lmb_game_postponed_or_canceled=6
...
- latest_run: captured_at=2026-07-03T17:12:52+00:00 | markets_checked=32 parsed=32 official_games=80 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXVALORANTGAME dates=2026-07-03,2026-07-04,2026-07-05 | state_games=39 events_raw=80 supported_games=80 | counts=KXVALORANTGAME=32 | source_errors=0 | reasons=valorant_game_not_final=28, no_matching_official_valorant_game_state=4
...
- latest_run: captured_at=2026-07-03T17:12:52+00:00 | markets_checked=19 parsed=19 official_games=80 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXLOLGAME dates=2026-07-03,2026-07-02,2026-07-04,2026-07-05 | state_games=29 events_raw=80 supported_games=80 | counts=KXLOLGAME=19 | source_errors=0 | reasons=lol_game_not_final=16, lol_game_final_no_unique_winner=2, lol_game_target_not_in_game=1
...
- latest_run: captured_at=2026-07-03T17:22:04+00:00 | markets_checked=32 groups=16 hltv_results=144 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXCS2GAME counts=KXCS2GAME=32 | hltv_index_pairs=133 fetches=2 raw_results=144 | reasons=no_hltv_match_pair=16
...
- latest_run: captured_at=2026-07-03T17:22:06+00:00 | markets_checked=16 parsed=16 hltv_results=144 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXCS2TOTALMAPS counts=KXCS2TOTALMAPS=16 | hltv_index_pairs=133 fetches=2 raw_results=144 | reasons=no_hltv_match_pair=16
...
- latest_run: captured_at=2026-07-03T17:22:46+00:00 | kalshi_markets=96 groups=48 espn_matches=597 locked_rows=2 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXATPMATCH,KXWTAMATCH,KXATPDOUBLES,KXWTADOUBLES counts=KXATPDOUBLES=18, KXATPMATCH=24, KXWTADOUBLES=28, KXWTAMATCH=26 | espn_events=atp=1, wta=1 competitions=atp=302, wta=295 status_fetches=597 | reasons=espn_match_not_unique_completed=41, no_espn_match_pair=6, locked=1
- latest_rows: KXATPMATCH-26JUL03DAVFUC-FUC NO ask=1.00 depth=0 bid=0.99 win=0.00 series=KXATPMATCH player=Marton Fucsovics winner=Alejandro Davidovich Fokina status=STATUS_FINAL league=atp event=Wimbledon reason=espn_tennis_match_final actionable=0 ; KXATPMATCH-26JUL03DAVFUC-DAV YES ask=1.00 depth=0 bid=0.99 win=0.00 series=KXATPMATCH player=Alejandro Davidovich Fokina winner=Alejandro Davidovich Fokina status=STATUS_FINAL league=atp event=Wimbledon reason=espn_tennis_match_final actionable=0
...
- latest_run: captured_at=2026-07-03T17:23:32+00:00 | kalshi_markets=184 groups=68 espn_matches=597 locked_rows=8 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXATPSETWINNER,KXWTASETWINNER,KXATPEXACTMATCH,KXWTAEXACTMATCH counts=KXATPEXACTMATCH=72, KXATPSETWINNER=68, KXWTAEXACTMATCH=0, KXWTASETWINNER=44 | espn_events=atp=1, wta=1 competitions=atp=302, wta=295 status_fetches=597 linescore_fetches=1194 | reasons=espn_match_not_unique_completed=66, locked=2
- latest_rows: KXATPSETWINNER-26JUL03DAVFUC-3-FUC NO ask=1.00 depth=0 bid=0.99 win=0.00 series=KXATPSETWINNER kind=set_winner label=Marton Fucsovics winner=Alejandro Davidovich Fokina status=STATUS_FINAL league=atp event=Wimbledon reason=espn_final_set_score actionable=0 ; KXATPSETWINNER-26JUL03DAVFUC-3-DAV YES ask=1.00 depth=0 bid=0.99 win=0.00 series=KXATPSETWINNER kind=set_winner label=Alejandro Davidovich Fokina winner=Alejandro Davidovich Fokina status=STATUS_FINAL league=atp event=Wimbledon reason=espn_final_set_score actionable=0 ; KXATPEXACTMATCH-26JUL03DAVFUC-FUC32 NO ask=1.00 depth=0 bid=0.99 win=0.00 series=KXATPEXACTMATCH kind=exact_match label=Marton Fucsovics wins 3-2 winner=Alejandro Davidovich Fokina status=STATUS_FINAL league=atp event=Wimbledon reason=espn_final_exact_set_score actionable=0 ; KXATPEXACTMATCH-26JUL03DAVFUC-FUC31 NO ask=1.00 depth=0 bid=0.99 win=0.00 series=KXATPEXACTMATCH kind=exact_match label=Marton Fucsovics wins 3-1 winner=Alejandro Davidovich Fokina status=STATUS_FINAL league=atp event=Wimbledon reason=espn_final_exact_set_score actionable=0 ; KXATPEXACTMATCH-26JUL03DAVFUC-FUC30 NO ask=1.00 depth=0 bid=0.99 win=0.00 series=KXATPEXACTMATCH kind=exact_match label=Marton Fucsovics wins 3-0 winner=Alejandro Davidovich Fokina status=STATUS_FINAL league=atp event=Wimbledon reason=espn_final_exact_set_score actionable=0 ; KXATPEXACTMATCH-26JUL03DAVFUC-DAV32 NO ask=1.00 depth=0 bid=0.99 win=0.00 series=KXATPEXACTMATCH kind=exact_match label=Alejandro Davidovich Fokina wins 3-2 winner=Alejandro Davidovich Fokina status=STATUS_FINAL league=atp event=Wimbledon reason=espn_final_exact_set_score actionable=0 ; KXATPEXACTMATCH-26JUL03DAVFUC-DAV31 NO ask=1.00 depth=0 bid=0.99 win=0.00 series=KXATPEXACTMATCH kind=exact_match label=Alejandro Davidovich Fokina wins 3-1 winner=Alejandro Davidovich Fokina status=STATUS_FINAL league=atp event=Wimbledon reason=espn_final_exact_set_score actionable=0 ; KXATPEXACTMATCH-26JUL03DAVFUC-DAV30 YES ask=1.00 depth=0 bid=0.99 win=0.00 series=KXATPEXACTMATCH kind=exact_match label=Alejandro Davidovich Fokina wins 3-0 winner=Alejandro Davidovich Fokina status=STATUS_FINAL league=atp event=Wimbledon reason=espn_final_exact_set_score actionable=0
...
- latest_run: captured_at=2026-07-03T17:12:52+00:00 | markets_checked=96 parsed=96 official_games=160 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXVALORANTMAP,KXLOLMAP dates=2026-07-03,2026-07-04,2026-07-05 | state_games=57 events_raw=160 supported_games=160 | counts=KXLOLMAP=40, KXVALORANTMAP=56 | source_errors=0 | proof=completed_clean_sweep_only | reasons=valorant_match_not_final=52, lol_match_not_final=40, no_matching_official_valorant_map_sweep_state=4
...
- latest_run: captured_at=2026-07-03T17:10:36+00:00 | markets_checked=88 parsed=88 espn_games=8 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWCCORNERS,KXWCTCORNERS dates=2026-07-03,2026-07-04,2026-07-05,2026-07-06 | state_games=8 needed_events=8 | counts=KXWCCORNERS=40, KXWCTCORNERS=48 | reasons=team_corner_state_unknown=48, corner_state_unknown=40
...
- latest_run: captured_at=2026-07-03T17:09:10+00:00 | markets_checked=384 parsed=380 espn_games=9 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWCGOAL,KXWCAST,KXWCSOA dates=2026-07-03,2026-07-04,2026-07-05,2026-07-06 | state_games=9 needed_events=9 | counts=KXWCAST=129, KXWCGOAL=163, KXWCSOA=92 | reasons=wc_player_goal_waiting_for_threshold_or_final=161, wc_player_assist_waiting_for_threshold_or_final=128, wc_player_score_or_assist_waiting_for_threshold_or_final=91, unparsed_market=4
...
- latest_run: captured_at=2026-07-03T17:08:33+00:00 | markets_checked=153 parsed=153 espn_games=3 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXWCSTART dates=2026-07-03,2026-07-06 | state_games=3 needed_events=3 | counts=KXWCSTART=153 | reasons=wc_start_lineup_not_available=104, wc_start_lineup_pre_kickoff_wait=49
...
- latest_run: captured_at=2026-07-03T17:10:50+00:00 | markets_checked=63 parsed=57 espn_games=19 locked_rows=0 actionable_qty1=0 | max_ask=0.25 min_depth=1 | series=KXCHNSLGAME,KXALLSVENSKANGAME,KXBRASILEIROBGAME,KXBRASILEIROCGAME,KXUSLGAME,KXECULPGAME dates=2026-07-03,2026-07-02,2026-07-04,2026-07-01,2026-07-05,2026-07-06,2026-07-07,2026-07-08 | state_games=19 | counts=KXALLSVENSKANGAME=3, KXBRASILEIROBGAME=15, KXBRASILEIROCGAME=21, KXCHNSLGAME=0, KXECULPGAME=21, KXUSLGAME=3 | reasons=soccer_game_not_final=57
...
- rank 2: shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=597 | 552W-45L | pnl=+2481.25 | Wilson 90.1% vs target 89.5% (avg_price 87.5%) | target_gap=+0.5pp | blockers=none
- rank 3: shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_EVENT_FIRST_CANDIDATE | events=841 | 735W-106L | pnl=+3018.69 | Wilson 85.0% vs target 84.8% (avg_price 82.8%) | target_gap=+0.2pp | blockers=none

## Kalshi Shadow Longshot Stability Audit
- command: `python3 scripts/kalshi_shadow_longshot_stability_audit.py --limit 8`
- status: NO_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=7001 | eligible_cells=25 | base_candidate_cells=3 | stable_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=597ev 552W-45L +2481.25 Wilson 90.1% vs target 89.5% gap +0.5pp | train=417ev 387W-30L +1855.69 Wilson 89.9% vs target 89.6% gap +0.3pp | validation=180ev 165W-15L +625.56 Wilson 86.7% vs target 89.4% gap -2.7pp | worst_asset=KXSOLD 112ev 104W-8L +511.92 Wilson 86.5% vs target 89.5% gap -3.0pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
...
- 3. shadow_longshot_fading:crypto:NO:weak:80-90:<1h | gate=SHADOW_STABILITY_REJECT | aggregate=841ev 735W-106L +3018.69 Wilson 85.0% vs target 84.8% gap +0.2pp | train=588ev 524W-64L +3244.74 Wilson 86.3% vs target 84.6% gap +1.7pp | validation=253ev 211W-42L -226.05 Wilson 78.3% vs target 85.3% gap -7.0pp | worst_asset=KXBTCD 446ev 380W-66L +667.71 Wilson 81.6% vs target 84.7% gap -3.1pp | worst_hour=13Z 35ev 25W-10L -449.18 Wilson 54.9% vs target 85.3% gap -30.3pp | blockers=validation_pnl<=0;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXBTCD;utc_hour_slice_pnl<=0:13Z;utc_hour_slice_wilson<avg_price:13Z
...
- status: NO_FILTERED_SHADOW_STABILITY_CANDIDATES | ready=false | event_rows=7001 | base_candidate_cells=3 | filtered_cells=74 | filtered_candidate_cells=0 | ready_cells=0 | min_events=30 | min_train=30 | min_validation=15 | min_slice=20 | edge_buffer=+2.0pp
- 1. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=02Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=02Z | excluded=34 | aggregate=563ev 523W-40L +2566.32 Wilson 90.5% vs target 89.6% gap +0.9pp | train=394ev 365W-29L +1671.21 Wilson 89.6% vs target 89.6% gap -0.0pp | validation=169ev 158W-11L +895.11 Wilson 88.7% vs target 89.4% gap -0.7pp | worst_asset=KXSOLD 103ev 96W-7L +497.35 Wilson 86.6% vs target 89.6% gap -3.0pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 2. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=01Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=01Z | excluded=38 | aggregate=559ev 517W-42L +2346.88 Wilson 90.0% vs target 89.5% gap +0.5pp | train=391ev 361W-30L +1562.07 Wilson 89.3% vs target 89.6% gap -0.3pp | validation=168ev 156W-12L +784.81 Wilson 87.9% vs target 89.4% gap -1.5pp | worst_asset=KXSOLD 102ev 94W-8L +398.41 Wilson 85.3% vs target 89.5% gap -4.2pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 3. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=13Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=13Z | excluded=22 | aggregate=575ev 534W-41L +2624.12 Wilson 90.5% vs target 89.5% gap +0.9pp | train=402ev 374W-28L +1878.31 Wilson 90.1% vs target 89.6% gap +0.5pp | validation=173ev 160W-13L +745.81 Wilson 87.6% vs target 89.4% gap -1.8pp | worst_asset=KXETHD 93ev 87W-6L +503.57 Wilson 86.6% vs target 89.4% gap -2.7pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXETHD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 4. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=09Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=09Z | excluded=22 | aggregate=575ev 531W-44L +2325.09 Wilson 89.9% vs target 89.5% gap +0.3pp | train=402ev 371W-31L +1582.11 Wilson 89.3% vs target 89.6% gap -0.3pp | validation=173ev 160W-13L +742.98 Wilson 87.6% vs target 89.4% gap -1.8pp | worst_asset=KXSOLD 109ev 101W-8L +476.25 Wilson 86.2% vs target 89.5% gap -3.3pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 5. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_asset=KXETHD | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_asset=KXETHD | excluded=94 | aggregate=503ev 464W-39L +1964.53 Wilson 89.6% vs target 89.6% gap -0.0pp | train=352ev 324W-28L +1282.47 Wilson 88.7% vs target 89.6% gap -0.9pp | validation=151ev 140W-11L +682.06 Wilson 87.4% vs target 89.4% gap -2.0pp | worst_asset=KXSOLD 112ev 104W-8L +511.92 Wilson 86.5% vs target 89.5% gap -3.0pp | worst_hour=15Z 20ev 15W-5L -264.47 Wilson 53.1% vs target 89.5% gap -36.3pp | blockers=aggregate_wilson<avg_price+buffer;train_wilson<avg_price+buffer;validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 6. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=12Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=12Z | excluded=27 | aggregate=570ev 528W-42L +2456.49 Wilson 90.2% vs target 89.6% gap +0.6pp | train=399ev 370W-29L +1744.54 Wilson 89.8% vs target 89.6% gap +0.2pp | validation=171ev 158W-13L +711.95 Wilson 87.4% vs target 89.5% gap -2.0pp | worst_asset=KXSOLD 106ev 98W-8L +436.80 Wilson 85.8% vs target 89.6% gap -3.8pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 7. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=08Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=08Z | excluded=17 | aggregate=580ev 537W-43L +2485.15 Wilson 90.2% vs target 89.5% gap +0.6pp | train=406ev 377W-29L +1831.87 Wilson 89.9% vs target 89.6% gap +0.3pp | validation=174ev 160W-14L +653.28 Wilson 86.9% vs target 89.4% gap -2.5pp | worst_asset=KXSOLD 110ev 102W-8L +491.30 Wilson 86.3% vs target 89.5% gap -3.2pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
- 8. shadow_longshot_fading:crypto:NO:moderate:80-90:<1h|exclude_hour=05Z | gate=FILTERED_SHADOW_STABILITY_REJECT | filter=exclude_hour=05Z | excluded=18 | aggregate=579ev 535W-44L +2362.53 Wilson 90.0% vs target 89.6% gap +0.4pp | train=405ev 375W-30L +1712.08 Wilson 89.6% vs target 89.6% gap +0.0pp | validation=174ev 160W-14L +650.45 Wilson 86.9% vs target 89.4% gap -2.5pp | worst_asset=KXSOLD 111ev 103W-8L +500.66 Wilson 86.4% vs target 89.5% gap -3.1pp | worst_hour=15Z 23ev 18W-5L -231.64 Wilson 58.1% vs target 89.6% gap -31.5pp | blockers=validation_wilson<avg_price+buffer;asset_slice_wilson<avg_price:KXSOLD;utc_hour_slice_pnl<=0:15Z;utc_hour_slice_wilson<avg_price:15Z
...
- latest_run: captured_at=2026-07-03T18:01:21+00:00 | cohort=moderate_favorites_eth_yes_80_90_0_1h_v1 | start=2026-07-03T16:50:00+00:00 | include_pre_cutoff_live=false | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- latest_run: captured_at=2026-07-03T18:05:27+00:00 | cohort=yes_90_93_above_live_threshold_v1 | start=2026-06-25T11:45:00+00:00 | include_pre_cutoff_live=true | candidates=1 checked=1 actionable_qty1=1 | top_reasons=yes_90_93_above_live_threshold_v1:actionable_qty1_fee_positive=1
- latest_rows: KXLOWTPHIL-26JUL03-B82.5 city=PHIL yes_ask=0.91 no_depth=6 reason=actionable_qty1_fee_positive
...
- latest_run: captured_at=2026-07-03T18:01:12+00:00 | start=2026-06-25T07:05:00+00:00 | include_pre_cutoff_live=true | candidates=16 checked=16 actionable_qty1=4 | top_reasons=no_95_98_zero_loss_cities_v1:missing_native_no_ask=6, no_95_98_zero_loss_cities_v1:actionable_qty1_fee_positive=3, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9900=3, no_95_98_zero_loss_cities_v1:native_no_ask_out_of_band:0.9300=2, no_90_95_min_probe_v1:actionable_qty1_fee_positive=1, no_90_95_min_probe_v1:native_no_ask_out_of_band:0.9700=1
- latest_rows: KXHIGHTMIN-26JUL03-B87.5 cohort=no_90_95_min_probe_v1 city=MIN no_ask=0.93 no_ask_depth=1 qty1=+0.06/-0.94 reason=actionable_qty1_fee_positive due=2026-07-04T19:00:00+00:00 ; KXLOWTAUS-26JUL04-B72.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=0.97 no_ask_depth=25 qty1=+0.02/-0.98 reason=actionable_qty1_fee_positive due=2026-07-05T19:00:00+00:00 ; KXHIGHTOKC-26JUL04-B104.5 cohort=no_95_98_zero_loss_cities_v1 city=OKC no_ask=0.97 no_ask_depth=6 qty1=+0.02/-0.98 reason=actionable_qty1_fee_positive due=2026-07-05T19:00:00+00:00 ; KXHIGHTSEA-26JUL04-B78.5 cohort=no_95_98_zero_loss_cities_v1 city=SEA no_ask=0.98 no_ask_depth=275 qty1=+0.01/-0.99 reason=actionable_qty1_fee_positive due=2026-07-05T19:00:00+00:00 ; KXHIGHTMIN-26JUL04-T78 cohort=no_90_95_min_probe_v1 city=MIN no_ask=0.97 no_ask_depth=3 qty1=+0.02/-0.98 reason=native_no_ask_out_of_band:0.9700 due=2026-07-05T19:00:00+00:00 ; KXLOWTAUS-26JUL03-B70.5 cohort=no_95_98_zero_loss_cities_v1 city=AUS no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-04T19:00:00+00:00 ; KXHIGHTDAL-26JUL03-B101.5 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=missing no_ask_depth=0 qty1=n/a/n/a reason=missing_native_no_ask due=2026-07-04T19:00:00+00:00 ; KXHIGHTDAL-26JUL04-T96 cohort=no_95_98_zero_loss_cities_v1 city=DAL no_ask=0.99 no_ask_depth=354 qty1=+0.00/-1.00 reason=native_no_ask_out_of_band:0.9900 due=2026-07-05T19:00:00+00:00
...
- latest_run: captured_at=2026-07-03T18:04:50+00:00 | cohort=all | start=2026-06-25T20:00:00+00:00 | include_pre_cutoff_live=true | candidates=0 checked=0 actionable_qty1=0 | top_reasons=none
...
- status: NO_LIVE_READY | ready=false | cells=15 | ready_cells=0 | review_min=50 | fills=1803 pending_units=475 active=475 stale=0 unknown=0 overall_resolved_indep=1328 toxic=433 | next_pending=cell_crypto_yes:KXETHD-26JUL0317-T1429.99 status=active close=2026-07-03T21:00:00+00:00
...
- rank 2: cell_crypto_yes | gate=NO_GO_REVIEW | resolved_indep=300/50 max_if_pending_resolve=319 new_needed_after_pending=0 | 173W-127L | pnl=-866.89 | Wilson 52.0% vs BE 86.6% | gap=-34.5pp | fills=319/1136 fill_rate=28.1% pending_units=19 active=19 stale=0 unknown=0 toxic=127 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXETHD-26JUL0317-T1429.99 status=active close=2026-07-03T21:00:00+00:00 price=0.88
- rank 3: cell_crypto_no | gate=NO_GO_REVIEW | resolved_indep=278/50 max_if_pending_resolve=291 new_needed_after_pending=0 | 161W-117L | pnl=-811.27 | Wilson 52.0% vs BE 87.1% | gap=-35.1pp | fills=291/1007 fill_rate=28.9% pending_units=13 active=13 stale=0 unknown=0 toxic=117 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXETHD-26JUL0317-T1669.99 status=active close=2026-07-03T21:00:00+00:00 price=0.80
...
- rank 6: cell_weather_no | gate=NO_GO_REVIEW | resolved_indep=110/50 max_if_pending_resolve=134 new_needed_after_pending=0 | 90W-20L | pnl=-87.20 | Wilson 73.6% vs BE 89.7% | gap=-16.2pp | fills=134/285 fill_rate=47.0% pending_units=24 active=24 stale=0 unknown=0 toxic=20 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000 | next_pending=KXHIGHMIA-26JUL03-B88.5 status=active close=2026-07-04T04:59:00+00:00 price=0.94
- rank 7: watch_crypto_bid_90_95 | gate=NO_GO_REVIEW | resolved_indep=103/50 max_if_pending_resolve=103 new_needed_after_pending=0 | 95W-8L | pnl=-14.13 | Wilson 85.4% vs BE 93.6% | gap=-8.2pp | fills=103/471 fill_rate=21.9% pending_units=0 active=0 stale=0 unknown=0 toxic=8 | blockers=pnl<=0; wilson<=BE; toxic>0 | perfect_benign_wins_needed=blocked_or_>5000
...
- rank 4: crypto YES maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=95/50 | 85W-10L | pnl=-34.58 | Wilson 81.7% vs BE 93.1% | gap=-11.4pp | candidates=364 fills=95 fill_rate=26.1% pending_units=0 toxic=10 | blockers=pnl<=0; wilson<=BE; toxic>0
...
- rank 8: weather NO maker_band=90-95 | gate=NO_GO_REVIEW | resolved_indep=60/50 | 53W-7L | pnl=-30.73 | Wilson 77.8% vs BE 93.5% | gap=-15.6pp | candidates=166 fills=68 fill_rate=41.0% pending_units=8 toxic=7 | blockers=pnl<=0; wilson<=BE; toxic>0

## Kalshi Maker Walk-Forward Validation
- command: `python3 scripts/kalshi_maker_walkforward.py --limit 8`
- status: NO_MAKER_WALKFORWARD_CUT | ready=false | observations=1803 | cuts=187 | display_cuts=121 | validated_cuts=0 | ready_cuts=0 | split_cutoff=2026-06-28T17:07:37+00:00 | min_train=30 | min_validation=15 | edge_buffer=+2.0pp | scope=posthoc_maker_cut_walkforward_requires_predeclared_live_spec
- best: maker_all_fills|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=single | train=174 resolved 145W-29L -$89.10 toxic=29 Wilson 77.1% vs target 90.4% gap=-13.4pp | validation=162 resolved 147W-15L +$24.76 toxic=15 Wilson 85.3% vs target 91.2% gap=-5.9pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUN301840PITPHI-PHI7 status=active due=2026-07-03T22:40:00+00:00 price=0.91
- rank 1: maker_all_fills|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=single | train=174 resolved 145W-29L -$89.10 toxic=29 Wilson 77.1% vs target 90.4% gap=-13.4pp | validation=162 resolved 147W-15L +$24.76 toxic=15 Wilson 85.3% vs target 91.2% gap=-5.9pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUN301840PITPHI-PHI7 status=active due=2026-07-03T22:40:00+00:00 price=0.91
- rank 2: maker_all_fills|category=crypto|spread_band=<=2c | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=56 resolved 49W-7L -$5.25 toxic=7 Wilson 76.4% vs target 90.4% gap=-14.1pp | validation=102 resolved 94W-8L +$30.02 toxic=8 Wilson 85.3% vs target 91.2% gap=-5.9pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none
...
- rank 4: maker_all_fills|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=39 resolved 35W-4L -$12.46 toxic=4 Wilson 76.4% vs target 94.9% gap=-18.5pp | validation=50 resolved 47W-3L +$5.80 toxic=3 Wilson 83.8% vs target 94.8% gap=-11.0pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXMLBSPREAD-26JUN301840PITPHI-PHI7 status=active due=2026-07-03T22:40:00+00:00 price=0.91
- rank 5: maker_all_fills|category=crypto|side_bid_band=90-92 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=15 resolved 12W-3L -$19.32 toxic=3 Wilson 54.8% vs target 94.9% gap=-40.1pp | validation=30 resolved 29W-1L +$11.36 toxic=1 Wilson 83.3% vs target 94.9% gap=-11.6pp | blockers=train_resolved<30;train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none
- rank 6: maker_all_fills|side=YES|side_bid_band=80-85 | gate=MAKER_WALKFORWARD_REJECT | type=pair | train=27 resolved 24W-3L +$8.79 toxic=3 Wilson 71.9% vs target 87.6% gap=-15.7pp | validation=42 resolved 37W-5L +$11.60 toxic=5 Wilson 75.0% vs target 87.3% gap=-12.3pp | blockers=train_resolved<30;train_toxic>0;train_wilson<BE+buffer;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXETHD-26JUL0317-T1429.99 status=active due=2026-07-03T21:00:00+00:00 price=0.88
- rank 7: maker_all_fills|side_bid_band=80-85 | gate=MAKER_WALKFORWARD_REJECT | type=single | train=103 resolved 83W-20L -$54.98 toxic=20 Wilson 71.9% vs target 87.9% gap=-16.0pp | validation=106 resolved 89W-17L -$26.63 toxic=17 Wilson 75.8% vs target 88.5% gap=-12.6pp | blockers=train_pnl<=0;train_toxic>0;train_wilson<BE+buffer;validation_pnl<=0;validation_toxic>0;validation_wilson<BE+buffer | promotion_blockers=none | next_pending=KXETHD-26JUL0317-T1429.99 status=active due=2026-07-03T21:00:00+00:00 price=0.88
...
- status: native=NO_LIVE_READY pending=25 active=25 stale=0 unknown=0 | maker=NO_LIVE_READY pending_units=475 active=475 stale=0 unknown=0 | queued=15
- 1. native:crypto_last_hour_longshot_no | ticker=KXBTCD-26JUL0315-T62299.99 | status=active | time=2026-07-03T18:59:59.511784+00:00 | resolved=324 pending=2
- 2. native:crypto_favorite_taker:crypto_favorite_no_90_95_12_24h | ticker=KXETHD-26JUL0317-T1749.99 | status=active | time=2026-07-03T20:59:59.235036+00:00 | resolved=8 pending=2
- 3. native:crypto_favorite_taker:crypto_near_certain_95_99_12_24h | ticker=KXSOLD-26JUL0317-T76.9999 | status=active | time=2026-07-03T20:59:59.685416+00:00 | resolved=37 pending=2
- 4. maker:cell_crypto_no | ticker=KXETHD-26JUL0317-T1669.99 | status=active | time=2026-07-03T21:00:00+00:00 | resolved_indep=278 pending_units=13
- 5. maker:cell_crypto_yes | ticker=KXETHD-26JUL0317-T1429.99 | status=active | time=2026-07-03T21:00:00+00:00 | resolved_indep=300 pending_units=19
- 6. maker:watch_crypto_no_bid_75_80 | ticker=KXETHD-26JUL0317-T1669.99 | status=active | time=2026-07-03T21:00:00+00:00 | resolved_indep=23 pending_units=1
- 7. maker:cell_sports_no | ticker=KXMLBSPREAD-26JUN301835CWSBAL-BAL3 | status=active | time=2026-07-03T22:35:00+00:00 | resolved_indep=388 pending_units=283
- 8. maker:cell_sports_yes | ticker=KXMLBSPREAD-26JUN301835CWSBAL-CWS11 | status=active | time=2026-07-03T22:35:00+00:00 | resolved_indep=113 pending_units=135
- 9. maker:cell_weather_no | ticker=KXHIGHMIA-26JUL03-B88.5 | status=active | time=2026-07-04T04:59:00+00:00 | resolved_indep=110 pending_units=24
- 10. maker:cell_weather_yes | ticker=KXHIGHNY-26JUL03-B98.5 | status=active | time=2026-07-04T04:59:00+00:00 | resolved_indep=26 pending_units=1

## Kalshi Academic-Prior Aligned Queue
- command: `python3 scripts/kalshi_academic_prior_queue.py --report --per-family 2`
- KALSHI ACADEMIC-PRIOR ALIGNED QUEUE
- generated_at=2026-07-03T18:06:10.263289+00:00 db=/home/eric-king/kalshi_favorites_bot/trades.db
- Lower rank_score means closer to review, not approval.
- 1. high_price_native_taker:crypto_last_hour_longshot_no | status=NATIVE_FORWARD_ACCUMULATING rank=0.0678 | 324 resolved 291W-33L -$3.34 | Wilson 86.0% vs target 92.8% | next=KXBTCD-26JUL0315-T62299.99 active due=2026-07-03T18:59:59.511784+00:00 | blockers=pnl<=0, wilson<BE+2pp | next=wait for native-actionable forward rows to resolve; no live order until target clears
...
- 6. maker_adverse_selection:cell_crypto_yes | status=NO_GO_REVIEW rank=0.8455 | 300 independent resolved 173W-127L -$866.89 | Wilson 52.0% vs BE 86.6% | toxic=127 fill_rate=28.1% | blockers=pnl<=0, wilson<=BE, toxic>0 | next=continue shadow fill/toxicity measurement; no maker pilot with toxic or Wilson blockers
- 7. structural_arbitrage:same_strike_last_24h | status=WATCH_ONLY rank=1.0000 | 45856 observations | fresh_pairs=45518 execution_ready_tier=4502 gross_positive=2 execution_ready_gross_positive=0 qty10_positive=2 execution_ready_qty10_positive=0 best_gross_edge=0.02 | blockers=no_execution_ready_gross_positive, no_execution_ready_fee_net_qty10_positive | next=continue simultaneous quote scans; only trade fee-net positive executable dislocations
...
- recent_36h_backlog: unresolved=259 | expired_after_60s_grace=7 | oldest_expired=2026-07-02 13:59:59 | oldest_expected=2026-07-02 13:59:59
- recent_36h_crypto_backlog: unresolved=171 | expired_after_60s_grace=0 | oldest_expired=none | oldest_expected=2026-07-03 18:59:59
- native_gate_stale_unresolved=0
- resolved_last_30m=134
...
- legacy_pre36h_expired_backlog: unresolved=6519 | crypto=6171 | other=345 | weather=3 | oldest_expired=2026-04-15 21:59:59 | newest_expired=2026-07-02 16:59:59
...
- recent_72h_backlog: unresolved=279 | expired_after_60s_grace=0 | oldest_expired=none | oldest_expected=2026-07-04 04:58:59
...
-   5-10c: candidates=61168 fill=0.2% resolved=31 benign/toxic=9/22 net=$-13.96 benign=$+7.48 Wilson=70.1% BE=0.0% margin=+70.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   10-20c: candidates=58113 fill=0.4% resolved=47 benign/toxic=15/32 net=$-16.67 benign=$+44.57 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   20-35c: candidates=58465 fill=0.6% resolved=59 benign/toxic=21/38 net=$-17.84 benign=$+64.14 Wilson=84.5% BE=0.0% margin=+84.5pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   35-50c: candidates=35959 fill=0.6% resolved=41 benign/toxic=15/26 net=$+22.03 benign=$+65.98 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   50-65c: candidates=35768 fill=0.8% resolved=41 benign/toxic=12/29 net=$-42.10 benign=$+50.56 Wilson=75.7% BE=0.0% margin=+75.7pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   65-80c: candidates=30927 fill=0.7% resolved=51 benign/toxic=15/36 net=$-6.55 benign=$+68.80 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   80-90c: candidates=29026 fill=0.7% resolved=58 benign/toxic=15/43 net=$+13.69 benign=$+35.81 Wilson=79.6% BE=0.0% margin=+79.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT
-   90-95c: candidates=17052 fill=0.5% resolved=36 benign/toxic=11/25 net=$-16.37 benign=$+10.53 Wilson=74.1% BE=0.0% margin=+74.1pp | NO-GO_FILL_RATE+TOXIC_DOMINANT+NONPOSITIVE_NET_PNL
-   95-99c: candidates=35670 fill=0.2% resolved=40 benign/toxic=7/33 net=$+0.30 benign=$+2.55 Wilson=64.6% BE=0.0% margin=+64.6pp | NO-GO_FILL_RATE+TOXIC_DOMINANT

## Timers
```
NEXT                                  LEFT LAST                              PASSED UNIT                                                   ACTIVATES
Fri 2026-07-03 13:06:16 CDT             3s Fri 2026-07-03 13:05:11 CDT  1min 1s ago kalshi-mve-component-result-live-pilot.timer           kalshi-mve-component-result-live-pilot.service
Fri 2026-07-03 13:06:20 CDT             7s Fri 2026-07-03 13:05:44 CDT      28s ago kalshi-worldcup-score-state-live-pilot.timer           kalshi-worldcup-score-state-live-pilot.service
Fri 2026-07-03 13:06:25 CDT            12s Fri 2026-07-03 13:05:25 CDT      47s ago gateway-watchdog.timer                                 gateway-watchdog.service
Fri 2026-07-03 13:06:25 CDT            12s Fri 2026-07-03 13:05:25 CDT      47s ago gemini-ds-index-parity.timer                           gemini-ds-index-parity.service
Fri 2026-07-03 13:06:25 CDT            12s Fri 2026-07-03 13:05:25 CDT      47s ago goal-loop-watchdog.timer                               goal-loop-watchdog.service
Fri 2026-07-03 13:06:27 CDT            14s Fri 2026-07-03 13:01:21 CDT 4min 51s ago kalshi-moderate-favorites-eth-yes-preflight.timer      kalshi-moderate-favorites-eth-yes-preflight.service
Fri 2026-07-03 13:06:30 CDT            17s Fri 2026-07-03 13:06:00 CDT      12s ago gemini-cushion-ds-scanner.timer                        gemini-cushion-ds-scanner.service
Fri 2026-07-03 13:06:37 CDT            24s Fri 2026-07-03 13:04:37 CDT 1min 35s ago gemini-ds-index-micro-parity.timer                     gemini-ds-index-micro-parity.service
Fri 2026-07-03 13:06:50 CDT            38s Fri 2026-07-03 13:05:50 CDT      22s ago kalshi-worldcup-final-state-live-pilot.timer           kalshi-worldcup-final-state-live-pilot.service
Fri 2026-07-03 13:07:00 CDT            47s Fri 2026-07-03 13:02:00 CDT 4min 12s ago claude-crossing-no-v3.timer                            claude-crossing-no-v3.service
Fri 2026-07-03 13:07:00 CDT            47s Fri 2026-07-03 13:06:00 CDT      12s ago cushion-ds-multi-series-scanner.timer                  cushion-ds-multi-series-scanner.service
Fri 2026-07-03 13:07:13 CDT        1min 1s Fri 2026-07-03 13:02:13 CDT 3min 58s ago btc-moderate-v2-shadow-scanner.timer                   btc-moderate-v2-shadow-scanner.service
Fri 2026-07-03 13:07:13 CDT        1min 1s Fri 2026-07-03 13:02:13 CDT 3min 58s ago gemini-fp-orderbook-capture.timer                      gemini-fp-orderbook-capture.service
Fri 2026-07-03 13:07:13 CDT        1min 1s Fri 2026-07-03 13:02:13 CDT 3min 58s ago gemini-reward-post-only-safety.timer                   gemini-reward-post-only-safety.service
Fri 2026-07-03 13:08:02 CDT       1min 50s Fri 2026-07-03 13:02:58 CDT 3min 14s ago kalshi-shadow-deterministic-settlement-backfill.timer  kalshi-shadow-deterministic-settlement-backfill.service
Fri 2026-07-03 13:08:12 CDT        2min 0s Fri 2026-07-03 13:03:12 CDT 2min 59s ago gemini-maker-fill-simulator.timer                      gemini-maker-fill-simulator.service
Fri 2026-07-03 13:09:06 CDT       2min 53s Fri 2026-07-03 13:05:53 CDT      18s ago kalshi-sports-final-state-live-pilot.timer             kalshi-sports-final-state-live-pilot.service
Fri 2026-07-03 13:09:39 CDT       3min 27s Fri 2026-07-03 13:04:29 CDT 1min 42s ago kalshi-crypto-favorite-taker-preflight.timer           kalshi-crypto-favorite-taker-preflight.service
Fri 2026-07-03 13:09:52 CDT       3min 39s Fri 2026-07-03 13:04:50 CDT 1min 22s ago kalshi-other-longshot-no-80-90-preflight.timer         kalshi-other-longshot-no-80-90-preflight.service
Fri 2026-07-03 13:09:54 CDT       3min 41s Fri 2026-07-03 13:04:52 CDT 1min 20s ago kalshi-crypto-ladder-dislocation-preflight.timer       kalshi-crypto-ladder-dislocation-preflight.service
Fri 2026-07-03 13:10:00 CDT       3min 47s Fri 2026-07-03 13:00:00 CDT     6min ago full-picture-latest-refresh.timer                      full-picture-latest-refresh.service
Fri 2026-07-03 13:10:12 CDT        4min 0s Fri 2026-07-03 13:05:03 CDT  1min 8s ago kalshi-crypto-last-hour-longshot-no-preflight.timer    kalshi-crypto-last-hour-longshot-no-preflight.service
Fri 2026-07-03 13:10:27 CDT       4min 15s Fri 2026-07-03 13:05:27 CDT      44s ago kalshi-weather-yes-90-93-preflight.timer               kalshi-weather-yes-90-93-preflight.service
Fri 2026-07-03 13:10:29 CDT       4min 16s Fri 2026-07-03 13:05:20 CDT      51s ago kalshi-weather-high-ask-no-preflight.timer             kalshi-weather-high-ask-no-preflight.service
Fri 2026-07-03 13:10:42 CDT       4min 30s Fri 2026-07-03 13:05:42 CDT      29s ago kalshi-shadow-forecast-accuracy-backfill.timer         kalshi-shadow-forecast-accuracy-backfill.service
Fri 2026-07-03 13:10:56 CDT       4min 43s Fri 2026-07-03 13:05:47 CDT      24s ago kalshi-shadow-longshot-fading-backfill.timer           kalshi-shadow-longshot-fading-backfill.service
Fri 2026-07-03 13:11:00 CDT       4min 47s Fri 2026-07-03 12:56:00 CDT    10min ago gemini-ds-source-parity.timer                          gemini-ds-source-parity.service
Fri 2026-07-03 13:12:00 CDT           5min Fri 2026-07-03 12:57:00 CDT     9min ago ds-storage-pressure-monitor.timer                      ds-storage-pressure-monitor.service
Fri 2026-07-03 13:13:00 CDT           6min Fri 2026-07-03 12:58:00 CDT     8min ago kalshi-side-equivalence-resolver.timer                 kalshi-side-equivalence-resolver.service
Fri 2026-07-03 13:13:57 CDT           7min Fri 2026-07-03 12:43:57 CDT    22min ago ds-storage-monitor.timer                               ds-storage-monitor.service
Fri 2026-07-03 13:14:01 CDT           7min Fri 2026-07-03 12:59:01 CDT     7min ago btc-moderate-v2-shadow-resolver.timer                  btc-moderate-v2-shadow-resolver.service
Fri 2026-07-03 13:14:01 CDT           7min Fri 2026-07-03 12:59:01 CDT     7min ago gemini-categorical-scanner.timer                       gemini-categorical-scanner.service
Fri 2026-07-03 13:15:00 CDT           8min Fri 2026-07-03 13:00:00 CDT     6min ago cushion-ds-multi-series-resolver.timer                 cushion-ds-multi-series-resolver.service
Fri 2026-07-03 13:15:00 CDT           8min Fri 2026-07-03 13:00:00 CDT     6min ago gemini-cushion-ds-resolver.timer                       gemini-cushion-ds-resolver.service
Fri 2026-07-03 13:15:02 CDT           8min Fri 2026-07-03 13:05:00 CDT 1min 12s ago ds-shadow-continuous-archive.timer                     ds-shadow-continuous-archive.service
Fri 2026-07-03 13:17:00 CDT          10min Fri 2026-07-03 07:17:00 CDT            - ds-shadow-retention-engine.timer                       ds-shadow-retention-engine.service
Fri 2026-07-03 13:18:57 CDT          12min Fri 2026-07-03 12:18:57 CDT    47min ago gemini-db-retention.timer                              gemini-db-retention.service
Fri 2026-07-03 13:18:57 CDT          12min Fri 2026-07-03 12:48:57 CDT    17min ago eth-ds-fg-filter-blocks-resolver.timer                 eth-ds-fg-filter-blocks-resolver.service
Fri 2026-07-03 13:19:03 CDT          12min Fri 2026-07-03 13:04:03 CDT  2min 9s ago gemini-categorical-resolver.timer                      gemini-categorical-resolver.service
Fri 2026-07-03 13:23:57 CDT          17min Fri 2026-07-03 12:53:57 CDT    12min ago gemini-db-size-monitor.timer                           gemini-db-size-monitor.service
Fri 2026-07-03 13:24:53 CDT          18min Fri 2026-07-03 12:22:58 CDT    43min ago ladder-coherence-two-leg-resolver.timer                ladder-coherence-two-leg-resolver.service
Fri 2026-07-03 13:28:33 CDT          22min Fri 2026-07-03 12:26:46 CDT    39min ago macro-release-resolver.timer                           macro-release-resolver.service
Fri 2026-07-03 13:30:00 CDT          23min Fri 2026-07-03 12:30:00 CDT    36min ago gemini-direct-index-ds-first-resolution-verifier.timer gemini-direct-index-ds-first-resolution-verifier.service
Fri 2026-07-03 15:18:56 CDT       2h 12min Fri 2026-07-03 09:18:56 CDT 3h 47min ago ds-shadow-db-maintenance.timer                         ds-shadow-db-maintenance.service
Fri 2026-07-03 15:18:57 CDT       2h 12min Fri 2026-07-03 12:18:57 CDT    47min ago db-auto-vacuum.timer                                   db-auto-vacuum.service
Fri 2026-07-03 15:24:20 CDT       2h 18min Fri 2026-07-03 09:24:20 CDT 3h 41min ago ds-shadow-archive.timer                                ds-shadow-archive.service
Fri 2026-07-03 16:13:00 CDT        3h 6min -                                      - claude-calibration-logger.timer                        claude-calibration-logger.service
Fri 2026-07-03 18:10:00 CDT        5h 3min Fri 2026-07-03 12:10:00 CDT    56min ago claude-chat-sync.timer                                 claude-chat-sync.service
Sat 2026-07-04 03:15:00 CDT            14h Fri 2026-07-03 03:15:00 CDT            - shadow-verification.timer                              shadow-verification.service
Sat 2026-07-04 03:30:00 CDT            14h Fri 2026-07-03 03:30:00 CDT            - ibkr-independent-verification.timer                    ibkr-independent-verification.service
Sat 2026-07-04 04:30:00 CDT            15h Fri 2026-07-03 04:30:00 CDT            - tax-ledger-ingest.timer                                tax-ledger-ingest.service
Sat 2026-07-04 04:46:58 CDT            15h Fri 2026-07-03 04:46:50 CDT            - ds-archive-tier-rotation.timer                         ds-archive-tier-rotation.service
Sat 2026-07-04 05:20:00 CDT            16h Fri 2026-07-03 05:20:01 CDT            - logrotate-user.timer                                   logrotate-user.service
Sat 2026-07-04 05:30:00 CDT            16h Fri 2026-07-03 05:30:01 CDT            - disk-hygiene-audit.timer                               disk-hygiene-audit.service
Sat 2026-07-04 05:30:00 CDT            16h Fri 2026-07-03 05:30:01 CDT            - full-picture-daily-save.timer                          full-picture-daily-save.service
Sat 2026-07-04 05:40:00 CDT            16h Fri 2026-07-03 05:40:00 CDT            - database-autonomous-maintenance.timer                  database-autonomous-maintenance.service
Sat 2026-07-04 06:40:00 CDT            17h -                                      - ibkr-deterministic-fx-poc.timer                        ibkr-deterministic-fx-poc.service
Sat 2026-07-04 09:14:12 CDT            20h Fri 2026-07-03 09:14:12 CDT 3h 52min ago launchpadlib-cache-clean.timer                         launchpadlib-cache-clean.service
Sat 2026-07-04 09:18:56 CDT            20h Fri 2026-07-03 09:18:56 CDT 3h 47min ago gemini-fp-retention.timer                              gemini-fp-retention.service
Sun 2026-07-05 02:00:00 CDT      1 day 12h Sun 2026-06-28 02:00:00 CDT            - gemini-archive-compression.timer                       gemini-archive-compression.service
Fri 2026-07-10 09:16:55 CDT         6 days Fri 2026-07-03 09:16:55 CDT 3h 49min ago ubuntu-insights-upload.timer                           ubuntu-insights-upload.service
Sun 2026-08-02 19:43:55 CDT 4 weeks 2 days Fri 2026-07-03 09:13:55 CDT 3h 52min ago ubuntu-insights-collect.timer                          ubuntu-insights-collect.service
-                                        - Fri 2026-07-03 13:06:09 CDT       2s ago gemini-liquidity-rewards-scanner.timer                 gemini-liquidity-rewards-scanner.service
-                                        - Fri 2026-07-03 12:48:16 CDT    17min ago gemini-reward-account-monitor.timer                    gemini-reward-account-monitor.service
-                                        - Fri 2026-07-03 12:44:16 CDT    21min ago gemini-reward-inventory-exit.timer                     gemini-reward-inventory-exit.service
-                                        - Fri 2026-07-03 12:46:08 CDT    20min ago gemini-reward-live-readiness.timer                     gemini-reward-live-readiness.service
-                                        - Fri 2026-07-03 12:43:50 CDT    22min ago gemini-reward-quote-pilot.timer                        gemini-reward-quote-pilot.service
-                                        - Fri 2026-07-03 13:05:13 CDT      59s ago gemini-trade-print-capture.timer                       gemini-trade-print-capture.service
-                                        - Fri 2026-07-03 13:06:12 CDT    451ms ago kalshi-side-equivalence-scanner.timer                  kalshi-side-equivalence-scanner.service
-                                        - Fri 2026-07-03 13:06:12 CDT    450ms ago kalshi-weather-no-candidate-preflight.timer            kalshi-weather-no-candidate-preflight.service
-                                        - Fri 2026-07-03 12:00:00 CDT  1h 6min ago snap.firmware-updater.firmware-notifier.timer          snap.firmware-updater.firmware-notifier.service
